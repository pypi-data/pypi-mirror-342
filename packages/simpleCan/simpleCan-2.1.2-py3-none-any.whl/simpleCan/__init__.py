...
class SimpleCan:
    ...
    def __init__(self, dbcPaths=None):
        self.tasklist = [] # list of threads
        self.messageList = MessageList()
        if dbcPaths is not None:
            self.dbcReader = dbcReader.DBCReader(dbcPaths=dbcPaths)
    ...
    def updateDBC(self, dbcPath):
        self.dbcReader = dbcReader.DBCReader(dbcPaths=dbcPath)
