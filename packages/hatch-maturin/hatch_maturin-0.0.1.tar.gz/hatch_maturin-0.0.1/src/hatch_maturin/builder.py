...
def build_crate(
    ...
    app.display_mini_status("hatch-maturin", f"Compiling Rust crate{module_info}…")
    ...
    try:
        ...
        raise RuntimeError(f"[hatch-maturin] Maturin build failed: {e}") from e
...
def extract_wheel(
    ...
    """
    Extract a wheel file into the build directory.
    """
