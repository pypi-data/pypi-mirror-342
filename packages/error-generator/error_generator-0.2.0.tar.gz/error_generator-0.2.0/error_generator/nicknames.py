...
# Load name lookup data
# Note: You'll need to provide these lookup tables as CSV files in a data directory
nick_real_lookup = pd.read_csv('data/nick_real_lookup.csv')

# Initialize names_lookup as None - will be loaded on demand only if nickname functions are used
names_lookup = None
