...
class GenerationProvider(abc.ABC):
    ...
    def create_generation_by_prompt[T = None](
        self,
        *,
        model: str,
    ...
    async def create_generation_by_prompt_async[T = None](
        self,
        *,
        model: str,
        prompt: str | Prompt | Part | Sequence[Part],
    ...
    @abc.abstractmethod
    async def create_generation_async[T = None](
        self,
        *,
        model: str,
        messages: Sequence[Message],
