...
class ConfigurationManager(ConfigurationManagerBase):
    ...
    @property
    def n_bin_cal(self):
        return int(self.config('N_BIN_CAL', default=20))
    ...
    @property
    def meta_model_path(self):
        return str(self.config('META_MODEL_PATH'))

    @property
    def meta_ordinal_encoder_path(self):
        return str(self.config('META_ORDINAL_ENCODER_PATH'))
    ...
    @property
    def meta_feature_selector_path(self):
        return str(self.config('META_FEATURE_SELECTOR_PATH'))

    @property
    def meta_scaler_path(self):
        return str(self.config('META_SCALER_PATH'))
