...
class FeeStationTransfer(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["token_id", "destination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "destination": FeeStationDestination.from_dict(obj["destination"]) if obj.get("destination") is not None else None
        })
        return _obj
