...
@assistant_tool   
async def get_structured_output(message: str, response_type, model: str = "o4-mini"):
    """
    ...
    :param model: The model to be used for processing the input message. Defaults to "o4-mini".
