...
def all_stocks_close_on_date(str_date, shift=1, token='dyrZWjkJWYCrHnLrnfj3kI7BCTw/jLBDHfsAc7RI8EwcUs/+dv70ktgffV867g9v#vip_m'):
    finlab.login(token)
    with data.universe("TSE_OTC"):
...
if __name__ == '__main__':
    ...
    if True:
        ...
        list_targets_to_trade = put2_select_targets_for_tomorrow(threshold_amount=1200 * 1000,
                                                                 threshold_max_capital=6500 * 10000,
                                                                 threshold_amp=0.03,
                                                                 threshold_turn_over=0.05,
                                                                 threshold_yesterday_co_gt_rate=0.025,
                                                                 bool_limit_up_targets=False
