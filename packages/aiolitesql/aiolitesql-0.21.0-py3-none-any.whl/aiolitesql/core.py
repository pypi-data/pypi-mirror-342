...
"""
Core implementation of aiolitesql proxies
"""
...
LOG = logging.getLogger("aiolitesql")
...
class Connection(Thread):
    def __init__(
        ...
        if loop is not None:
            warn(
                "aiolitesql.Connection no longer uses the `loop` parameter",
                DeprecationWarning,
            )
    ...
    async def cursor(self) -> Cursor:
        """Create an aiolitesql cursor wrapping a sqlite3 cursor object."""
    ...
    async def backup(
        ...
        *,
        ...
        Takes either a standard sqlite3 or aiolitesql Connection object as the target.
        """
...
def connect(
    ...
    **kwargs: Any,
    ...
    if loop is not None:
        warn(
            "aiolitesql.connect() no longer uses the `loop` parameter",
            DeprecationWarning,
        )
