...
from scrawlpy.utils.email_sender import EmailSender
...
def get_all_params(url):
    """
    >>> get_all_params("https://www.baidu.com/s?wd=scrawlpy")
    {'wd': 'scrawlpy'}
    """
    params_json = {}
...
def get_cache_path(filename, root_dir=None, local=False):
    ...
    if root_dir is None:
        if local:
            ...
            root_dir = os.path.join(os.path.expanduser("~"), ".scrawlpy/cache")
