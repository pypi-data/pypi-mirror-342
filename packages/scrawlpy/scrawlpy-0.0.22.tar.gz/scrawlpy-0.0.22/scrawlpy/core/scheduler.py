...
from scrawlpy.setting import BaseSettings as setting as setting
import scrawlpy.utils.tools as tools
from scrawlpy.buffer.item_buffer import ItemBuffer
from scrawlpy.buffer.request_buffer import RequestBuffer
from scrawlpy.core.base_parser import BaseParser
from scrawlpy.core.collector import Collector
...
from scrawlpy.core.parser_control import ParserControl
from scrawlpy.db.redisdb import RedisDB
from scrawlpy.network.item import Item
from scrawlpy.network.request import Request
from scrawlpy.utils import metrics
from scrawlpy.utils.log import log
from scrawlpy.utils.redis_lock import RedisLock
...
class Scheduler(TailThread):
    ...
    def add_parser(self, parser, **kwargs):
        ...
        if isinstance(parser, BaseParser):
            ...
            raise ValueError("类型错误，爬虫需继承scrawlpy.BaseParser或scrawlpy.BatchParser")
