...
from scrawlpy import setting
from scrawlpy.db.redisdb import RedisDB
from scrawlpy.dedup import Dedup
from scrawlpy.network.item import Item, UpdateItem
from scrawlpy.pipelines import BasePipeline
from scrawlpy.pipelines.mysql_pipeline import MysqlPipeline
from scrawlpy.utils import metrics
from scrawlpy.utils.log import log

MYSQL_PIPELINE_PATH = "scrawlpy.pipelines.mysql_pipeline.MysqlPipeline"
    ...
    def load_pipelines(self):
        ...
        for pipeline_path in setting.ITEM_PIPELINES:
            ...
            if not isinstance(pipeline, BasePipeline):
                raise ValueError(f"{pipeline_path} 需继承 scrawlpy.pipelines.BasePipeline")
