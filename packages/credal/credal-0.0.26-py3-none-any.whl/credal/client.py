...
from .permissions_service.client import PermissionsServiceClient
...
from .permissions_service.client import AsyncPermissionsServiceClient
...
class CredalApi:
    ...
    def __init__(
        ...
        *,
        ...
        self.permissions_service = PermissionsServiceClient(client_wrapper=self._client_wrapper)
...
class AsyncCredalApi:
    ...
    def __init__(
        ...
        *,
        ...
        self.permissions_service = AsyncPermissionsServiceClient(client_wrapper=self._client_wrapper)
