...
PACKAGE = "alibabacloud_tea_openapi_sse"
NAME = "alibabacloud_tea_openapi_sse" or "alibabacloud-package"
...
REQUIRES = [
    "alibabacloud_tea_sse>=1.0.3, <2.0.0",
    "alibabacloud_tea_util_sse>=1.0.1, <2.0.0",
...
if sys.version_info.minor <= 7:
    REQUIRES.append('aiohttp>=3.7.0, <3.9.0')
else:
    REQUIRES.append('aiohttp>=3.7.0, <4.0.0')
