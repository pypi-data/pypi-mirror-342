...
def scatter_plot(
    ...
    """Scatter plot with regression line and optional density grid using hexbin.
...
def plot_data_diffs_analysis(
    ...
    """Comprehensive analysis of differences between two data arrays.
    ...
    )  # Apply percentage formatter here
