...
class EntityAnonymizer:
    def __init__(self, context: dict, multilingua: bool = False):
        """
        Initialize the anonymizer with a chosen entity context and language setting.

        Args:
            context (dict): Entity replacement sets, e.g. MARVEL_ENTITIES.
            multilingua (bool): Use multilingual model if True, else monolingual.
        """
        self.context = context

        model_name = (
            'aimarbp02/ner-bert-base-multilingual-cased' if multilingua
