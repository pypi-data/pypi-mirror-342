...
from ColorTransferLib.Algorithms.CFM.basicsr.archs.vgg_arch import VGGFeatureExtractor
from ColorTransferLib.Algorithms.CFM.basicsr.utils.registry import LOSS_REGISTRY
