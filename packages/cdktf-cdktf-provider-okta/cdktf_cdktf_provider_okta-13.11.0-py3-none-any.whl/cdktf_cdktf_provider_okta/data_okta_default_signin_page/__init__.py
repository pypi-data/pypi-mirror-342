...
Refer to the Terraform Registry for docs: [`data_okta_default_signin_page`](https://registry.terraform.io/providers/okta/okta/4.17.0/docs/data-sources/default_signin_page).
'''
...
class DataOktaDefaultSigninPage(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/okta/okta/4.17.0/docs/data-sources/default_signin_page okta_default_signin_page}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/okta/okta/4.17.0/docs/data-sources/default_signin_page okta_default_signin_page} Data Source.

        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param brand_id: brand id of the preview signin page. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.17.0/docs/data-sources/default_signin_page#brand_id DataOktaDefaultSigninPage#brand_id}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataOktaDefaultSigninPage that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.17.0/docs/data-sources/default_signin_page#import import section} in the documentation of this resource for the id to use
...
class DataOktaDefaultSigninPageConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def brand_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.17.0/docs/data-sources/default_signin_page#brand_id DataOktaDefaultSigninPage#brand_id}
        '''
