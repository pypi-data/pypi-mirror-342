#!/usr/bin/python3
# ------------------------------------------------------------------------------
# Script Name: examples/model/__init__.py
# Description: Model for the GSEWidgets example application.
#
...
from gsewidgets.examples.model.path_model import PathModel
