#!/usr/bin/python3
# ------------------------------------------------------------------------------
# Script Name: examples/controller/__init__.py
# Description: Controller for the GSEWidgets example application.
#
...
from gsewidgets.examples.controller.main_controller import MainController
