...
static std::vector<int>  __pyx_f_11cython_test_array2vector_int(PyObject *__pyx_v_a) {
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("array2vector_int", 1);
 ...
 *     return v
 */
  __pyx_t_1 = PyObject_Length(__pyx_v_a); if (unlikely(__pyx_t_1 == ((Py_ssize_t)-1))) __PYX_ERR(0, 11, __pyx_L1_error)
  __pyx_t_2 = __pyx_t_1;
 ...
 * 
 */
    __pyx_t_4 = __Pyx_GetItemInt(__pyx_v_a, __pyx_v_i, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 12, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_AddTraceback("cython_test.array2vector_int", __pyx_clineno, __pyx_lineno, __pyx_filename);
