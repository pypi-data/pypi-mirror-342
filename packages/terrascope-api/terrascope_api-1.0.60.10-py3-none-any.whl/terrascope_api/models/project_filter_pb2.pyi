...
class ProjectFilter(_message.Message):
    __slots__ = ("filter", "analysis_config_id", "node_name", "project_id", "input_filter")
    ...
    project_id: str
    input_filter: bool
    def __init__(self, filter: _Optional[_Union[_filter_pb2.Filter, _Mapping]] = ..., analysis_config_id: _Optional[str] = ..., node_name: _Optional[str] = ..., project_id: _Optional[str] = ..., input_filter: bool = ...) -> None: ...
