...
class FilterCreateRequest(_message.Message):
    __slots__ = ("data_type", "expression", "description", "name", "filter_language", "metadata")
    ...
    def __init__(self, data_type: _Optional[str] = ..., expression: _Optional[str] = ..., description: _Optional[str] = ..., name: _Optional[str] = ..., filter_language: _Optional[str] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...
...
class FilterListRequest(_message.Message):
    __slots__ = ("pagination", "data_types", "search_text")
    ...
    search_text: str
    def __init__(self, pagination: _Optional[_Union[_common_models_pb2.Pagination, _Mapping]] = ..., data_types: _Optional[_Iterable[str]] = ..., search_text: _Optional[str] = ...) -> None: ...

class Filter(_message.Message):
    __slots__ = ("id", "name", "description", "expression", "data_type", "filter_language", "metadata")
    ...
    metadata: _struct_pb2.Struct
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., description: _Optional[str] = ..., expression: _Optional[str] = ..., data_type: _Optional[str] = ..., filter_language: _Optional[_Union[Filter.FilterLanguage, str]] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...
