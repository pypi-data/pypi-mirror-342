...
class Brewery:
    ...
    def __post_init__(self) -> None:
        ...
        self.brewery_name = self._brewery_details.name

        self._activity_details = brewery_activity(self._soup, brewery_id=self.brewery_id)
    ...
    def from_slug(cls, brewery_slug: str) -> Self | None:
        ...
        if not href:
            logger.debug("No brewery found for slug %s", brewery_slug)
            return None
