...
from untappd_scraper.structs.web import WebActivityBeer, WebUserDetails, WebUserHistoryVenue
...
class User:
    ...
    _user_details: WebUserDetails = field(init=False)

    _activity_details: tuple[WebActivityBeer, ...] | None = field(default=None, init=False)
    _lists: list[WebUserList] = field(default_factory=list, init=False)
    _venue_history: Collection[WebUserHistoryVenue] = field(default_factory=set, init=False)
