...
class BaseSpider(abc.ABC):
    ...
    def __init__(self, name, group_name=None, monitor=False, monitor_endpoint='http://127.0.0.1:12000/endpoint',
                 headers=None, cookies=None, proxy_url=None):
