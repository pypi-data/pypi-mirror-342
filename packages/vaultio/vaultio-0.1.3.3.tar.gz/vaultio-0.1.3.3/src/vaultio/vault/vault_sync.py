...
class VaultSync:
    ...
    def __init__(self, encrypted=None, email=None, password=None, provider_choice=None, provider_token=None, cache=None) -> None:
        ...
        if encrypted is None:
            ...
            if cache is not None:
                with open(sync_path, "w") as fout:
                    encrypted = json.dump(vault.encrypted, fout)
        else:
