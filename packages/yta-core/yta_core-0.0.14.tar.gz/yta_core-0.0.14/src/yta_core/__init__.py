...
class YTA:
    ...
    def insert_test_project(
        ...
        """
        Insert a valid project in the database for testing purposes.
        """
        from yta_general_utils.file.reader import FileReader

        # File containing a valid test project data
        project_data = FileReader.read_json('C:/Users/dania/Desktop/PROYECTOS/yta-laravel-docker-api/public/files/example_project.json')
