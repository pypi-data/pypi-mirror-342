...
class PatchedVisitorRestriction(BaseModel):
    """
    Serializer for VisitorRestriction model.
    """ # noqa: E501
    ...
    purpose_id: Annotated[str, Field(strict=True, max_length=255)] | None = Field(default=None, description="Generic key of the entity that created the instance.")
    purpose_name: Annotated[str, Field(strict=True, max_length=255)] | None = Field(default=None, description="Log of the entity that created the instance.")
    created_at: datetime | None = None
    updated_at: datetime | None = None
    provider_config: StrictStr | None = Field(default=None, description="The provider configuration for the visitor.")
    visitor: StrictInt | None = Field(default=None, description="The visitor to restrict.")
    __properties: ClassVar[list[str]] = ["id", "start_datetime", "end_datetime", "from_time", "to_time", "monday", "tuesday", "wednesday", "thursday", "friday", "saturday", "sunday", "purpose_id", "purpose_name", "created_at", "updated_at", "provider_config", "visitor"]
    ...
    def from_json(cls, json_str: str) -> Self | None:
        """Create an instance of PatchedVisitorRestriction from a JSON string"""
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        """Create an instance of PatchedVisitorRestriction from a dict"""
        if obj is None:
            return None
