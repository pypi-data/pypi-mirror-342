...
class PatchedPlaceRestriction(BaseModel):
    """
    Serializer for PlaceRestriction model.
    """ # noqa: E501
    ...
    place: StrictInt | None = Field(default=None, description="The place to restrict.")
    provider_config: StrictStr | None = Field(default=None, description="The provider configuration for the place.")
    __properties: ClassVar[list[str]] = ["id", "start_datetime", "end_datetime", "from_time", "to_time", "monday", "tuesday", "wednesday", "thursday", "friday", "saturday", "sunday", "purpose_id", "purpose_name", "created_at", "updated_at", "place", "provider_config"]
    ...
    def from_json(cls, json_str: str) -> Self | None:
        """Create an instance of PatchedPlaceRestriction from a JSON string"""
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        """Create an instance of PatchedPlaceRestriction from a dict"""
        if obj is None:
            return None
