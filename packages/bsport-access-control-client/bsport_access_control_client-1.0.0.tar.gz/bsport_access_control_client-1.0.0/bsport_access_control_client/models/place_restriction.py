...
class PlaceRestriction(BaseModel):
    """
    ...
    created_at: datetime
    updated_at: datetime
    place: StrictInt = Field(description="The place to restrict.")
    ...
    def from_json(cls, json_str: str) -> Self | None:
        """Create an instance of PlaceRestriction from a JSON string"""
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        """Create an instance of PlaceRestriction from a dict"""
        if obj is None:
            return None
