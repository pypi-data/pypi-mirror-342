...
class PatchedVisitorAccessRight(BaseModel):
    """
    ...
    provider_config: StrictStr | None = Field(default=None, description="Related provider configuration. This field determines to which API this access will be synchronized.")
    visitor: StrictInt | None = Field(default=None, description="The visitor the access right is for.")
    ...
    def from_json(cls, json_str: str) -> Self | None:
        """Create an instance of PatchedVisitorAccessRight from a JSON string"""
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        """Create an instance of PatchedVisitorAccessRight from a dict"""
        if obj is None:
            return None
