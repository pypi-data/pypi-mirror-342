...
class VisitorRestriction(BaseModel):
    """
    ...
    created_at: datetime
    updated_at: datetime
    provider_config: StrictStr = Field(description="The provider configuration for the visitor.")
    visitor: StrictInt = Field(description="The visitor to restrict.")
    ...
    def from_json(cls, json_str: str) -> Self | None:
        """Create an instance of VisitorRestriction from a JSON string"""
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        """Create an instance of VisitorRestriction from a dict"""
        if obj is None:
            return None
