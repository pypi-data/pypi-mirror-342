...
if TYPE_CHECKING:
    from ..models.create_webhook_integration_args_headers import CreateWebhookIntegrationArgsHeaders


T = TypeVar("T", bound="CreateWebhookIntegrationArgs")


@_attrs_define
class CreateWebhookIntegrationArgs:
    """
    Attributes:
        url (str):
        headers (Union[Unset, CreateWebhookIntegrationArgsHeaders]):
    ...
    url: str
    headers: Union[Unset, "CreateWebhookIntegrationArgsHeaders"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_headers, Unset):
            ...
            headers = CreateWebhookIntegrationArgsHeaders.from_dict(_headers)
        ...
        create_webhook_integration_args = cls(
            url=url,
            headers=headers,
            webhook_type=webhook_type,
        )

        create_webhook_integration_args.additional_properties = d
        return create_webhook_integration_args
