...
class MemberStiffnessModification(_message.Message):
    ...
    class SteelStructureDetermineTauB(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        STEEL_STRUCTURE_DETERMINE_TAU_B_ITERATIVE: _ClassVar[MemberStiffnessModification.SteelStructureDetermineTauB]
        STEEL_STRUCTURE_DETERMINE_TAU_B_SET_TO_1: _ClassVar[MemberStiffnessModification.SteelStructureDetermineTauB]
    STEEL_STRUCTURE_DETERMINE_TAU_B_ITERATIVE: MemberStiffnessModification.SteelStructureDetermineTauB
    STEEL_STRUCTURE_DETERMINE_TAU_B_SET_TO_1: MemberStiffnessModification.SteelStructureDetermineTauB
    class SteelStructureDesignMethod(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        STEEL_STRUCTURE_DESIGN_METHOD_LRFD: _ClassVar[MemberStiffnessModification.SteelStructureDesignMethod]
        STEEL_STRUCTURE_DESIGN_METHOD_ASD: _ClassVar[MemberStiffnessModification.SteelStructureDesignMethod]
    STEEL_STRUCTURE_DESIGN_METHOD_LRFD: MemberStiffnessModification.SteelStructureDesignMethod
    STEEL_STRUCTURE_DESIGN_METHOD_ASD: MemberStiffnessModification.SteelStructureDesignMethod
    ...
    steel_structure_determine_tau_b: MemberStiffnessModification.SteelStructureDetermineTauB
    steel_structure_design_method: MemberStiffnessModification.SteelStructureDesignMethod
