...
class ClippingPlane(_message.Message):
    ...
    class RotationAnglesSequence(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        ROTATION_ANGLES_SEQUENCE_SEQUENCE_UVW: _ClassVar[ClippingPlane.RotationAnglesSequence]
        ROTATION_ANGLES_SEQUENCE_SEQUENCE_UWV: _ClassVar[ClippingPlane.RotationAnglesSequence]
        ROTATION_ANGLES_SEQUENCE_SEQUENCE_VUW: _ClassVar[ClippingPlane.RotationAnglesSequence]
        ROTATION_ANGLES_SEQUENCE_SEQUENCE_VWU: _ClassVar[ClippingPlane.RotationAnglesSequence]
        ROTATION_ANGLES_SEQUENCE_SEQUENCE_WUV: _ClassVar[ClippingPlane.RotationAnglesSequence]
        ROTATION_ANGLES_SEQUENCE_SEQUENCE_WVU: _ClassVar[ClippingPlane.RotationAnglesSequence]
    ...
    ROTATION_ANGLES_SEQUENCE_SEQUENCE_UVW: ClippingPlane.RotationAnglesSequence
    ROTATION_ANGLES_SEQUENCE_SEQUENCE_UWV: ClippingPlane.RotationAnglesSequence
    ROTATION_ANGLES_SEQUENCE_SEQUENCE_VUW: ClippingPlane.RotationAnglesSequence
    ROTATION_ANGLES_SEQUENCE_SEQUENCE_VWU: ClippingPlane.RotationAnglesSequence
    ROTATION_ANGLES_SEQUENCE_SEQUENCE_WUV: ClippingPlane.RotationAnglesSequence
    ROTATION_ANGLES_SEQUENCE_SEQUENCE_WVU: ClippingPlane.RotationAnglesSequence
