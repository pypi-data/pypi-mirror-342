...
class FreeConcentratedLoad(_message.Message):
    ...
    class LoadDirection(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        LOAD_DIRECTION_GLOBAL_X_OR_USER_DEFINED_U_TRUE: _ClassVar[FreeConcentratedLoad.LoadDirection]
        LOAD_DIRECTION_GLOBAL_X_TRUE: _ClassVar[FreeConcentratedLoad.LoadDirection]
        LOAD_DIRECTION_GLOBAL_Y_OR_USER_DEFINED_V_TRUE: _ClassVar[FreeConcentratedLoad.LoadDirection]
        LOAD_DIRECTION_GLOBAL_Y_TRUE: _ClassVar[FreeConcentratedLoad.LoadDirection]
        LOAD_DIRECTION_GLOBAL_Z_OR_USER_DEFINED_W_TRUE: _ClassVar[FreeConcentratedLoad.LoadDirection]
        LOAD_DIRECTION_GLOBAL_Z_TRUE: _ClassVar[FreeConcentratedLoad.LoadDirection]
    ...
    LOAD_DIRECTION_GLOBAL_X_OR_USER_DEFINED_U_TRUE: FreeConcentratedLoad.LoadDirection
    LOAD_DIRECTION_GLOBAL_X_TRUE: FreeConcentratedLoad.LoadDirection
    LOAD_DIRECTION_GLOBAL_Y_OR_USER_DEFINED_V_TRUE: FreeConcentratedLoad.LoadDirection
    LOAD_DIRECTION_GLOBAL_Y_TRUE: FreeConcentratedLoad.LoadDirection
    LOAD_DIRECTION_GLOBAL_Z_OR_USER_DEFINED_W_TRUE: FreeConcentratedLoad.LoadDirection
    LOAD_DIRECTION_GLOBAL_Z_TRUE: FreeConcentratedLoad.LoadDirection
