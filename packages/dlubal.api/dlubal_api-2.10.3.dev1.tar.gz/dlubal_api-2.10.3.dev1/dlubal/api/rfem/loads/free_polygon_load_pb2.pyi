...
class FreePolygonLoad(_message.Message):
    ...
    class LoadDirection(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        LOAD_DIRECTION_GLOBAL_X_OR_USER_DEFINED_U_PROJECTED: _ClassVar[FreePolygonLoad.LoadDirection]
        LOAD_DIRECTION_GLOBAL_X_OR_USER_DEFINED_U_TRUE: _ClassVar[FreePolygonLoad.LoadDirection]
        LOAD_DIRECTION_GLOBAL_X_PROJECTED: _ClassVar[FreePolygonLoad.LoadDirection]
        LOAD_DIRECTION_GLOBAL_X_TRUE: _ClassVar[FreePolygonLoad.LoadDirection]
        LOAD_DIRECTION_GLOBAL_Y_OR_USER_DEFINED_V_PROJECTED: _ClassVar[FreePolygonLoad.LoadDirection]
        LOAD_DIRECTION_GLOBAL_Y_OR_USER_DEFINED_V_TRUE: _ClassVar[FreePolygonLoad.LoadDirection]
        LOAD_DIRECTION_GLOBAL_Y_PROJECTED: _ClassVar[FreePolygonLoad.LoadDirection]
        LOAD_DIRECTION_GLOBAL_Y_TRUE: _ClassVar[FreePolygonLoad.LoadDirection]
        LOAD_DIRECTION_GLOBAL_Z_OR_USER_DEFINED_W_PROJECTED: _ClassVar[FreePolygonLoad.LoadDirection]
        LOAD_DIRECTION_GLOBAL_Z_OR_USER_DEFINED_W_TRUE: _ClassVar[FreePolygonLoad.LoadDirection]
        LOAD_DIRECTION_GLOBAL_Z_PROJECTED: _ClassVar[FreePolygonLoad.LoadDirection]
        LOAD_DIRECTION_GLOBAL_Z_TRUE: _ClassVar[FreePolygonLoad.LoadDirection]
    ...
    LOAD_DIRECTION_GLOBAL_X_OR_USER_DEFINED_U_PROJECTED: FreePolygonLoad.LoadDirection
    LOAD_DIRECTION_GLOBAL_X_OR_USER_DEFINED_U_TRUE: FreePolygonLoad.LoadDirection
    LOAD_DIRECTION_GLOBAL_X_PROJECTED: FreePolygonLoad.LoadDirection
    LOAD_DIRECTION_GLOBAL_X_TRUE: FreePolygonLoad.LoadDirection
    LOAD_DIRECTION_GLOBAL_Y_OR_USER_DEFINED_V_PROJECTED: FreePolygonLoad.LoadDirection
    LOAD_DIRECTION_GLOBAL_Y_OR_USER_DEFINED_V_TRUE: FreePolygonLoad.LoadDirection
    LOAD_DIRECTION_GLOBAL_Y_PROJECTED: FreePolygonLoad.LoadDirection
    LOAD_DIRECTION_GLOBAL_Y_TRUE: FreePolygonLoad.LoadDirection
    LOAD_DIRECTION_GLOBAL_Z_OR_USER_DEFINED_W_PROJECTED: FreePolygonLoad.LoadDirection
    LOAD_DIRECTION_GLOBAL_Z_OR_USER_DEFINED_W_TRUE: FreePolygonLoad.LoadDirection
    LOAD_DIRECTION_GLOBAL_Z_PROJECTED: FreePolygonLoad.LoadDirection
    LOAD_DIRECTION_GLOBAL_Z_TRUE: FreePolygonLoad.LoadDirection
    ...
    def __init__(self, no: _Optional[int] = ..., surfaces: _Optional[_Iterable[int]] = ..., load_case: _Optional[int] = ..., coordinate_system: _Optional[int] = ..., load_projection: _Optional[_Union[FreePolygonLoad.LoadProjection, str]] = ..., load_direction: _Optional[_Union[FreePolygonLoad.LoadDirection, str]] = ..., load_acting_region_from: _Optional[float] = ..., load_acting_region_to: _Optional[float] = ..., load_distribution: _Optional[_Union[FreePolygonLoad.LoadDistribution, str]] = ..., magnitude_uniform: _Optional[float] = ..., magnitude_linear_1: _Optional[float] = ..., magnitude_linear_2: _Optional[float] = ..., magnitude_linear_3: _Optional[float] = ..., magnitude_linear_location_1: _Optional[int] = ..., magnitude_linear_location_2: _Optional[int] = ..., magnitude_linear_location_3: _Optional[int] = ..., load_location: _Optional[_Union[FreePolygonLoad.LoadLocationTable, _Mapping]] = ..., comment: _Optional[str] = ..., is_generated: bool = ..., generating_object_info: _Optional[str] = ..., id_for_export_import: _Optional[str] = ..., metadata_for_export_import: _Optional[str] = ...) -> None: ...
