...
class FreeCircularLoad(_message.Message):
    ...
    class LoadDirection(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        LOAD_DIRECTION_GLOBAL_X_OR_USER_DEFINED_U_PROJECTED: _ClassVar[FreeCircularLoad.LoadDirection]
        LOAD_DIRECTION_GLOBAL_X_OR_USER_DEFINED_U_TRUE: _ClassVar[FreeCircularLoad.LoadDirection]
        LOAD_DIRECTION_GLOBAL_X_PROJECTED: _ClassVar[FreeCircularLoad.LoadDirection]
        LOAD_DIRECTION_GLOBAL_X_TRUE: _ClassVar[FreeCircularLoad.LoadDirection]
        LOAD_DIRECTION_GLOBAL_Y_OR_USER_DEFINED_V_PROJECTED: _ClassVar[FreeCircularLoad.LoadDirection]
        LOAD_DIRECTION_GLOBAL_Y_OR_USER_DEFINED_V_TRUE: _ClassVar[FreeCircularLoad.LoadDirection]
        LOAD_DIRECTION_GLOBAL_Y_PROJECTED: _ClassVar[FreeCircularLoad.LoadDirection]
        LOAD_DIRECTION_GLOBAL_Y_TRUE: _ClassVar[FreeCircularLoad.LoadDirection]
        LOAD_DIRECTION_GLOBAL_Z_OR_USER_DEFINED_W_PROJECTED: _ClassVar[FreeCircularLoad.LoadDirection]
        LOAD_DIRECTION_GLOBAL_Z_OR_USER_DEFINED_W_TRUE: _ClassVar[FreeCircularLoad.LoadDirection]
        LOAD_DIRECTION_GLOBAL_Z_PROJECTED: _ClassVar[FreeCircularLoad.LoadDirection]
        LOAD_DIRECTION_GLOBAL_Z_TRUE: _ClassVar[FreeCircularLoad.LoadDirection]
    ...
    LOAD_DIRECTION_GLOBAL_X_OR_USER_DEFINED_U_PROJECTED: FreeCircularLoad.LoadDirection
    LOAD_DIRECTION_GLOBAL_X_OR_USER_DEFINED_U_TRUE: FreeCircularLoad.LoadDirection
    LOAD_DIRECTION_GLOBAL_X_PROJECTED: FreeCircularLoad.LoadDirection
    LOAD_DIRECTION_GLOBAL_X_TRUE: FreeCircularLoad.LoadDirection
    LOAD_DIRECTION_GLOBAL_Y_OR_USER_DEFINED_V_PROJECTED: FreeCircularLoad.LoadDirection
    LOAD_DIRECTION_GLOBAL_Y_OR_USER_DEFINED_V_TRUE: FreeCircularLoad.LoadDirection
    LOAD_DIRECTION_GLOBAL_Y_PROJECTED: FreeCircularLoad.LoadDirection
    LOAD_DIRECTION_GLOBAL_Y_TRUE: FreeCircularLoad.LoadDirection
    LOAD_DIRECTION_GLOBAL_Z_OR_USER_DEFINED_W_PROJECTED: FreeCircularLoad.LoadDirection
    LOAD_DIRECTION_GLOBAL_Z_OR_USER_DEFINED_W_TRUE: FreeCircularLoad.LoadDirection
    LOAD_DIRECTION_GLOBAL_Z_PROJECTED: FreeCircularLoad.LoadDirection
    LOAD_DIRECTION_GLOBAL_Z_TRUE: FreeCircularLoad.LoadDirection
