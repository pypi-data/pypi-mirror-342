...
class LineReleaseType(_message.Message):
    ...
    class ForceMomentDiagramAroundXStart(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        FORCE_MOMENT_DIAGRAM_AROUND_X_START_FORCE_MOMENT_DIAGRAM_ENDING_TYPE_FAILURE: _ClassVar[LineReleaseType.ForceMomentDiagramAroundXStart]
        FORCE_MOMENT_DIAGRAM_AROUND_X_START_FORCE_MOMENT_DIAGRAM_ENDING_TYPE_CONTINUOUS: _ClassVar[LineReleaseType.ForceMomentDiagramAroundXStart]
        FORCE_MOMENT_DIAGRAM_AROUND_X_START_FORCE_MOMENT_DIAGRAM_ENDING_TYPE_YIELDING: _ClassVar[LineReleaseType.ForceMomentDiagramAroundXStart]
    FORCE_MOMENT_DIAGRAM_AROUND_X_START_FORCE_MOMENT_DIAGRAM_ENDING_TYPE_FAILURE: LineReleaseType.ForceMomentDiagramAroundXStart
    FORCE_MOMENT_DIAGRAM_AROUND_X_START_FORCE_MOMENT_DIAGRAM_ENDING_TYPE_CONTINUOUS: LineReleaseType.ForceMomentDiagramAroundXStart
    FORCE_MOMENT_DIAGRAM_AROUND_X_START_FORCE_MOMENT_DIAGRAM_ENDING_TYPE_YIELDING: LineReleaseType.ForceMomentDiagramAroundXStart
    class ForceMomentDiagramAroundXEnd(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        FORCE_MOMENT_DIAGRAM_AROUND_X_END_FORCE_MOMENT_DIAGRAM_ENDING_TYPE_FAILURE: _ClassVar[LineReleaseType.ForceMomentDiagramAroundXEnd]
        FORCE_MOMENT_DIAGRAM_AROUND_X_END_FORCE_MOMENT_DIAGRAM_ENDING_TYPE_CONTINUOUS: _ClassVar[LineReleaseType.ForceMomentDiagramAroundXEnd]
        FORCE_MOMENT_DIAGRAM_AROUND_X_END_FORCE_MOMENT_DIAGRAM_ENDING_TYPE_YIELDING: _ClassVar[LineReleaseType.ForceMomentDiagramAroundXEnd]
    FORCE_MOMENT_DIAGRAM_AROUND_X_END_FORCE_MOMENT_DIAGRAM_ENDING_TYPE_FAILURE: LineReleaseType.ForceMomentDiagramAroundXEnd
    FORCE_MOMENT_DIAGRAM_AROUND_X_END_FORCE_MOMENT_DIAGRAM_ENDING_TYPE_CONTINUOUS: LineReleaseType.ForceMomentDiagramAroundXEnd
    FORCE_MOMENT_DIAGRAM_AROUND_X_END_FORCE_MOMENT_DIAGRAM_ENDING_TYPE_YIELDING: LineReleaseType.ForceMomentDiagramAroundXEnd
