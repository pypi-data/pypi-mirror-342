...
class LineHinge(_message.Message):
    ...
    class ForceMomentDiagramAroundXStart(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        FORCE_MOMENT_DIAGRAM_AROUND_X_START_FORCE_MOMENT_DIAGRAM_ENDING_TYPE_FAILURE: _ClassVar[LineHinge.ForceMomentDiagramAroundXStart]
        FORCE_MOMENT_DIAGRAM_AROUND_X_START_FORCE_MOMENT_DIAGRAM_ENDING_TYPE_CONTINUOUS: _ClassVar[LineHinge.ForceMomentDiagramAroundXStart]
        FORCE_MOMENT_DIAGRAM_AROUND_X_START_FORCE_MOMENT_DIAGRAM_ENDING_TYPE_YIELDING: _ClassVar[LineHinge.ForceMomentDiagramAroundXStart]
    FORCE_MOMENT_DIAGRAM_AROUND_X_START_FORCE_MOMENT_DIAGRAM_ENDING_TYPE_FAILURE: LineHinge.ForceMomentDiagramAroundXStart
    FORCE_MOMENT_DIAGRAM_AROUND_X_START_FORCE_MOMENT_DIAGRAM_ENDING_TYPE_CONTINUOUS: LineHinge.ForceMomentDiagramAroundXStart
    FORCE_MOMENT_DIAGRAM_AROUND_X_START_FORCE_MOMENT_DIAGRAM_ENDING_TYPE_YIELDING: LineHinge.ForceMomentDiagramAroundXStart
    class ForceMomentDiagramAroundXEnd(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        FORCE_MOMENT_DIAGRAM_AROUND_X_END_FORCE_MOMENT_DIAGRAM_ENDING_TYPE_FAILURE: _ClassVar[LineHinge.ForceMomentDiagramAroundXEnd]
        FORCE_MOMENT_DIAGRAM_AROUND_X_END_FORCE_MOMENT_DIAGRAM_ENDING_TYPE_CONTINUOUS: _ClassVar[LineHinge.ForceMomentDiagramAroundXEnd]
        FORCE_MOMENT_DIAGRAM_AROUND_X_END_FORCE_MOMENT_DIAGRAM_ENDING_TYPE_YIELDING: _ClassVar[LineHinge.ForceMomentDiagramAroundXEnd]
    FORCE_MOMENT_DIAGRAM_AROUND_X_END_FORCE_MOMENT_DIAGRAM_ENDING_TYPE_FAILURE: LineHinge.ForceMomentDiagramAroundXEnd
    FORCE_MOMENT_DIAGRAM_AROUND_X_END_FORCE_MOMENT_DIAGRAM_ENDING_TYPE_CONTINUOUS: LineHinge.ForceMomentDiagramAroundXEnd
    FORCE_MOMENT_DIAGRAM_AROUND_X_END_FORCE_MOMENT_DIAGRAM_ENDING_TYPE_YIELDING: LineHinge.ForceMomentDiagramAroundXEnd
