...
class MemberImperfection(_message.Message):
    ...
    class ImperfectionDirection(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        IMPERFECTION_DIRECTION_GLOBAL_X_OR_USER_DEFINED_U_NEGATIVE: _ClassVar[MemberImperfection.ImperfectionDirection]
        IMPERFECTION_DIRECTION_GLOBAL_X_OR_USER_DEFINED_U_TRUE: _ClassVar[MemberImperfection.ImperfectionDirection]
        IMPERFECTION_DIRECTION_GLOBAL_Y_OR_USER_DEFINED_V_NEGATIVE: _ClassVar[MemberImperfection.ImperfectionDirection]
        IMPERFECTION_DIRECTION_GLOBAL_Y_OR_USER_DEFINED_V_TRUE: _ClassVar[MemberImperfection.ImperfectionDirection]
        IMPERFECTION_DIRECTION_GLOBAL_Z_OR_USER_DEFINED_W_NEGATIVE: _ClassVar[MemberImperfection.ImperfectionDirection]
        IMPERFECTION_DIRECTION_GLOBAL_Z_OR_USER_DEFINED_W_TRUE: _ClassVar[MemberImperfection.ImperfectionDirection]
    ...
    IMPERFECTION_DIRECTION_GLOBAL_X_OR_USER_DEFINED_U_NEGATIVE: MemberImperfection.ImperfectionDirection
    IMPERFECTION_DIRECTION_GLOBAL_X_OR_USER_DEFINED_U_TRUE: MemberImperfection.ImperfectionDirection
    IMPERFECTION_DIRECTION_GLOBAL_Y_OR_USER_DEFINED_V_NEGATIVE: MemberImperfection.ImperfectionDirection
    IMPERFECTION_DIRECTION_GLOBAL_Y_OR_USER_DEFINED_V_TRUE: MemberImperfection.ImperfectionDirection
    IMPERFECTION_DIRECTION_GLOBAL_Z_OR_USER_DEFINED_W_NEGATIVE: MemberImperfection.ImperfectionDirection
    IMPERFECTION_DIRECTION_GLOBAL_Z_OR_USER_DEFINED_W_TRUE: MemberImperfection.ImperfectionDirection
