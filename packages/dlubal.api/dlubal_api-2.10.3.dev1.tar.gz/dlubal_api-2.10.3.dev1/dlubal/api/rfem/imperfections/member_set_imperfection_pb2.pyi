...
class MemberSetImperfection(_message.Message):
    ...
    class ImperfectionDirection(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        IMPERFECTION_DIRECTION_GLOBAL_X_OR_USER_DEFINED_U_NEGATIVE: _ClassVar[MemberSetImperfection.ImperfectionDirection]
        IMPERFECTION_DIRECTION_GLOBAL_X_OR_USER_DEFINED_U_TRUE: _ClassVar[MemberSetImperfection.ImperfectionDirection]
        IMPERFECTION_DIRECTION_GLOBAL_Y_OR_USER_DEFINED_V_NEGATIVE: _ClassVar[MemberSetImperfection.ImperfectionDirection]
        IMPERFECTION_DIRECTION_GLOBAL_Y_OR_USER_DEFINED_V_TRUE: _ClassVar[MemberSetImperfection.ImperfectionDirection]
        IMPERFECTION_DIRECTION_GLOBAL_Z_OR_USER_DEFINED_W_NEGATIVE: _ClassVar[MemberSetImperfection.ImperfectionDirection]
        IMPERFECTION_DIRECTION_GLOBAL_Z_OR_USER_DEFINED_W_TRUE: _ClassVar[MemberSetImperfection.ImperfectionDirection]
    ...
    IMPERFECTION_DIRECTION_GLOBAL_X_OR_USER_DEFINED_U_NEGATIVE: MemberSetImperfection.ImperfectionDirection
    IMPERFECTION_DIRECTION_GLOBAL_X_OR_USER_DEFINED_U_TRUE: MemberSetImperfection.ImperfectionDirection
    IMPERFECTION_DIRECTION_GLOBAL_Y_OR_USER_DEFINED_V_NEGATIVE: MemberSetImperfection.ImperfectionDirection
    IMPERFECTION_DIRECTION_GLOBAL_Y_OR_USER_DEFINED_V_TRUE: MemberSetImperfection.ImperfectionDirection
    IMPERFECTION_DIRECTION_GLOBAL_Z_OR_USER_DEFINED_W_NEGATIVE: MemberSetImperfection.ImperfectionDirection
    IMPERFECTION_DIRECTION_GLOBAL_Z_OR_USER_DEFINED_W_TRUE: MemberSetImperfection.ImperfectionDirection
