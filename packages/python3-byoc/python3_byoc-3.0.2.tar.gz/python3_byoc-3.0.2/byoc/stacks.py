...
class MemoryStack(Stack):
    ...
    def __init__(self, content=None, id=None):
        ...
        """
        if id is None:
            # By default, all stacks share the same id (and therefore the same
            # content).
            id = '<string>'
        store = stores.FileStore(id)
...
# FIXME: Should that be a registry ? -- vila 2024-10-10
