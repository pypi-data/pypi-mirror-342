def calcular_retorno_investimento(valor_inicial: float, valor_final: float):
    """
...
def calcular_juros_compostos(principal: float, taxa_juros_anual: float, periodos: int):
    """
    ...
    Args:
        ...
        periodos (int): Número de periodos(anos).
