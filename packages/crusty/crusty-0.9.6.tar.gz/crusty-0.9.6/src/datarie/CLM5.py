...
BGC_EUR0275_8daily = {'name': 'CLM5_DETECT',
                      'version': (0, 1, 0),
                      'path': '/p/data1/jibg31/CLM5_EU3_DETECT/BGC_outputs/carbon_control_DETECT/',
                      'type_file': 'netcdf',
                      'year_start': 1960,
                      'month_start': 1,
                      'year_end': 1989,
                      ...
                      'variable_units': {'NEE': 'g C / m^2 / s', 
                                         ...
                                         'TOTVEGC': 'g C / m^2',
                                         'LEAFC': 'g C / m^2',
                                         'QFLX_EVAP_TOT': 'kg / m^2 / s',
                                         'QFLX_EVAP_VEG': 'mm H2O / s',
                                         'ZWT': 'm'},
                      'mask_value': None}

BGC_EUR0275_8daily_control = {'name': 'CLM5_DETECT_control',
                              'version': (0, 1, 0),
                              'path': '/p/data1/jibg31/CLM5_EU3_DETECT/BGC_outputs/carbon_control_DETECT/control/',
                              'type_file': 'netcdf',
                              'year_start': 1960,
                              'month_start': 1,
                              'year_end': 1989,
