...
def poscar_to_cif():
    ...
    if args.output_cif_file:
        ...
        output_path = input_path.with_suffix('.cif')
    print(f"-"*100)
    ...
    writer = CifWriter(refined, symprec=symprec,write_site_properties=True)
    writer.write_file(output_path)
    print(f"    Generated CIF: {output_path}")
    print(f"-"*100)
...
def generate_defect_models():
    ...
    if args.print_template:
        str_input_template = """
input_grouped_POSCAR = "../outInt_06_POSCAR_withAllInt_grouped.vasp"
# clean_before_run = true
# outID_start = 100

supercell_size = [2,2,2]
# allow_selfdefect = true
...
# unsort_complexes = true
    ...
    if "allow_selfdefect" in in_params:
        allow_selfdefect = in_params["allow_selfdefect"]
    ...
    for subs1 in subs_list:
        ...
        label_subssite2 = f"{label_intelem}[0]"
