    ...
    def get_query_embedding(self, query: str) -> Embedding:
        ...
        **Example**
        ...
        .. code-block:: python
            ...
            embedded_query = watsonx_embedding.get_query_embedding("Pineflow is a data framework to load any data in one line of code and connect with AI applications.")
        """
