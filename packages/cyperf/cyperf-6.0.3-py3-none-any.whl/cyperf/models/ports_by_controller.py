...
class PortsByController(BaseModel):
    """
    PortsByController
    """ # noqa: E501
    compute_nodes: Optional[List[PortsByNode]] = Field(default=None, description="The compute nodes that the ports are part of.", alias="computeNodes")
    controller_id: Optional[StrictStr] = Field(default=None, description="The id of the controller that the ports are part of.", alias="controllerId")
