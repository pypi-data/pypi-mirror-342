...
class GetResourcesHttpProfiles200ResponseOneOf(BaseModel):
    """
    GetResourcesHttpProfiles200ResponseOneOf
    """ # noqa: E501
    data: Optional[List[HTTPProfile]] = None
...
#            _obj.api_client = client
        ...
        _obj = cls.model_validate({
            "data": [HTTPProfile.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
