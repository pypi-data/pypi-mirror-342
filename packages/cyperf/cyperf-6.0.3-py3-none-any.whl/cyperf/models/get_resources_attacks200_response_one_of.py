...
class GetResourcesAttacks200ResponseOneOf(BaseModel):
    """
    GetResourcesAttacks200ResponseOneOf
    """ # noqa: E501
    data: Optional[List[AppsecAttack]] = None
...
#            _obj.api_client = client
        ...
        _obj = cls.model_validate({
            "data": [AppsecAttack.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
