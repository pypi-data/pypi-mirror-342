...
class ReorderActionInput(BaseModel):
    """
    ReorderActionInput
    """ # noqa: E501
    action_idx: Optional[StrictInt] = Field(default=None, alias="ActionIdx")
    action_name: Optional[StrictStr] = Field(default=None, alias="ActionName")
    __properties: ClassVar[List[str]] = ["ActionIdx", "ActionName"]
