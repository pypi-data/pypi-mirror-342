...
class ParamMetadataTypeInfoArrayV2(BaseModel):
    """
    ParamMetadataTypeInfoArrayV2
    """ # noqa: E501
    elements: Optional[List[ParamMetadataTypeInfoArrayV2ElementsInner]] = None
...
#            _obj.api_client = client
        ...
        _obj = cls.model_validate({
            "elements": [ParamMetadataTypeInfoArrayV2ElementsInner.from_dict(_item) for _item in obj["elements"]] if obj.get("elements") is not None else None
            ,
            "links": obj.get("links")
        })
        return _obj
