...
class GetConfigs200ResponseOneOf(BaseModel):
    """
    GetConfigs200ResponseOneOf
    """ # noqa: E501
    data: Optional[List[ConfigMetadata]] = None
...
#            _obj.api_client = client
        ...
        _obj = cls.model_validate({
            "data": [ConfigMetadata.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
