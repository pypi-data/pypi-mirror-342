...
class FindParamMatchesOperation(BaseModel):
    """
    FindParamMatchesOperation
    """ # noqa: E501
    actions: Optional[List[ActionInputFindParam]] = Field(default=None, alias="Actions")
    ...
    __properties: ClassVar[List[str]] = ["Actions", "AppId", "MatchLocation", "Pattern"]
