...
class GetResults200ResponseOneOf(BaseModel):
    """
    GetResults200ResponseOneOf
    """ # noqa: E501
    data: Optional[List[ResultMetadata]] = None
...
#            _obj.api_client = client
        ...
        _obj = cls.model_validate({
            "data": [ResultMetadata.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
