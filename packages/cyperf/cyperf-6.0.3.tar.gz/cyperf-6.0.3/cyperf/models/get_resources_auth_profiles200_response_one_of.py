...
class GetResourcesAuthProfiles200ResponseOneOf(BaseModel):
    """
    GetResourcesAuthProfiles200ResponseOneOf
    """ # noqa: E501
    data: Optional[List[AuthProfile]] = None
...
#            _obj.api_client = client
        ...
        _obj = cls.model_validate({
            "data": [AuthProfile.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
