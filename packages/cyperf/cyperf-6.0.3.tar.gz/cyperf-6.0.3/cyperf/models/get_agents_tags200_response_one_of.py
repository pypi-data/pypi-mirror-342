...
class GetAgentsTags200ResponseOneOf(BaseModel):
    """
    GetAgentsTags200ResponseOneOf
    """ # noqa: E501
    data: Optional[List[AgentsGroup]] = None
...
#            _obj.api_client = client
        ...
        _obj = cls.model_validate({
            "data": [AgentsGroup.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
