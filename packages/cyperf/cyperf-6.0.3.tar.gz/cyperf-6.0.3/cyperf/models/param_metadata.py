...
class ParamMetadata(BaseModel):
    ...
    ParamMetadata
    """ # noqa: E501
    type_info: Optional[ParamMetadataTypeInfo] = Field(default=None, alias="TypeInfo")
    __properties: ClassVar[List[str]] = ["TypeInfo"]
...
#            _obj.api_client = client
        ...
        _obj = cls.model_validate({
            "TypeInfo": ParamMetadataTypeInfo.from_dict(obj["TypeInfo"]) if obj.get("TypeInfo") is not None else None
            ,
            "links": obj.get("links")
        })
        return _obj
