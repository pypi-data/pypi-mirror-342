...
class GetResultsTags200ResponseOneOf(BaseModel):
    """
    GetResultsTags200ResponseOneOf
    """ # noqa: E501
    data: Optional[List[ResultsGroup]] = None
...
#            _obj.api_client = client
        ...
        _obj = cls.model_validate({
            "data": [ResultsGroup.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
