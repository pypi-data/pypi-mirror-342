...
class GetResourcesApps200ResponseOneOf(BaseModel):
    """
    GetResourcesApps200ResponseOneOf
    """ # noqa: E501
    data: Optional[List[AppsecApp]] = None
...
#            _obj.api_client = client
        ...
        _obj = cls.model_validate({
            "data": [AppsecApp.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
