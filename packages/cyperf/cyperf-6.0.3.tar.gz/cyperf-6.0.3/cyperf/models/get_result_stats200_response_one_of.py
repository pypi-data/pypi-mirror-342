...
class GetResultStats200ResponseOneOf(BaseModel):
    """
    GetResultStats200ResponseOneOf
    """ # noqa: E501
    data: Optional[List[StatsResult]] = None
...
#            _obj.api_client = client
        ...
        _obj = cls.model_validate({
            "data": [StatsResult.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
