...
class GetControllers200ResponseOneOf(BaseModel):
    """
    GetControllers200ResponseOneOf
    """ # noqa: E501
    data: Optional[List[Controller]] = None
...
#            _obj.api_client = client
        ...
        _obj = cls.model_validate({
            "data": [Controller.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
