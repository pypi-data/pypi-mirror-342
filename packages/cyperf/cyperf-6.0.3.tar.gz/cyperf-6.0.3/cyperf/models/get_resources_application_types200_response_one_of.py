...
class GetResourcesApplicationTypes200ResponseOneOf(BaseModel):
    """
    GetResourcesApplicationTypes200ResponseOneOf
    """ # noqa: E501
    data: Optional[List[ApplicationType]] = None
...
#            _obj.api_client = client
        ...
        _obj = cls.model_validate({
            "data": [ApplicationType.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
