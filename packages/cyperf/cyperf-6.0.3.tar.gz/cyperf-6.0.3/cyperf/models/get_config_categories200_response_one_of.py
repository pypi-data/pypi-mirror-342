...
class GetConfigCategories200ResponseOneOf(BaseModel):
    """
    GetConfigCategories200ResponseOneOf
    """ # noqa: E501
    data: Optional[List[ConfigCategory]] = None
...
#            _obj.api_client = client
        ...
        _obj = cls.model_validate({
            "data": [ConfigCategory.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
