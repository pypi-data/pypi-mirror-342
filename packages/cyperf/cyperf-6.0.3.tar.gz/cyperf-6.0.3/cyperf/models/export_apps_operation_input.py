...
class ExportAppsOperationInput(BaseModel):
    """
    ExportAppsOperationInput
    """ # noqa: E501
    app_ids: Optional[List[AppId]] = Field(default=None, description="An optional list of applications to be included. All are included if the list is empty.", alias="appIds")
