...
class SetAggregationModeOperation(BaseModel):
    """
    SetAggregationModeOperation
    """ # noqa: E501
    aggregated: Optional[StrictBool] = Field(default=None, description="The desired aggregation mode.")
    ...
    __properties: ClassVar[List[str]] = ["aggregated", "controllers"]
...
#            _obj.api_client = client
        ...
        _obj = cls.model_validate({
            "aggregated": obj.get("aggregated"),
                        "controllers": [NodesByController.from_dict(_item) for _item in obj["controllers"]] if obj.get("controllers") is not None else None
            ,
            "links": obj.get("links")
        })
        return _obj
