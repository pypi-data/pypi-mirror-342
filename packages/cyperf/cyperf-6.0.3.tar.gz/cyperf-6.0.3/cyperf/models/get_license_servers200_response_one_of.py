...
class GetLicenseServers200ResponseOneOf(BaseModel):
    """
    GetLicenseServers200ResponseOneOf
    """ # noqa: E501
    data: Optional[List[LicenseServerMetadata]] = None
...
#            _obj.api_client = client
        ...
        _obj = cls.model_validate({
            "data": [LicenseServerMetadata.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
