...
class GetResourcesCustomImportOperations200ResponseOneOf(BaseModel):
    """
    GetResourcesCustomImportOperations200ResponseOneOf
    """ # noqa: E501
    data: Optional[List[CustomImportHandler]] = None
...
#            _obj.api_client = client
        ...
        _obj = cls.model_validate({
            "data": [CustomImportHandler.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
