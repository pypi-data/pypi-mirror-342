...
class ActivationCodeListRequest(BaseModel):
    ...
    """ # noqa: E501
    activation_code: Optional[List[StrictStr]] = Field(default=None, description="The activation codes", alias="activationCode")
    __properties: ClassVar[List[str]] = ["activationCode"]
