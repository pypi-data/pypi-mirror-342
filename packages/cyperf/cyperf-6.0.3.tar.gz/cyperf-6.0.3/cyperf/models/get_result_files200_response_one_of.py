...
class GetResultFiles200ResponseOneOf(BaseModel):
    """
    GetResultFiles200ResponseOneOf
    """ # noqa: E501
    data: Optional[List[ResultFileMetadata]] = None
...
#            _obj.api_client = client
        ...
        _obj = cls.model_validate({
            "data": [ResultFileMetadata.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
