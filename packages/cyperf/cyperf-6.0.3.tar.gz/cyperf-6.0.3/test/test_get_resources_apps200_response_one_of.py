...
class TestGetResourcesApps200ResponseOneOf(unittest.TestCase):
    """GetResourcesApps200ResponseOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetResourcesApps200ResponseOneOf:
        """Test GetResourcesApps200ResponseOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetResourcesApps200ResponseOneOf`
        """
        model = GetResourcesApps200ResponseOneOf()
        if include_optional:
            return GetResourcesApps200ResponseOneOf(
                data = [
    ...
    def testGetResourcesApps200ResponseOneOf(self):
        """Test GetResourcesApps200ResponseOneOf"""
