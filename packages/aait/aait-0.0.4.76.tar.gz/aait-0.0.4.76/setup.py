...
VERSION = "0.0.4.76"  # la version doit être supérieure à la précédente sinon la publication sera refusée
...
PACKAGES = [pack for pack in PACKAGES if "orangecontrib" in pack and "OWInterface" not in pack and "HLIT" not in pack and "IO4IT" not in pack]
print(PACKAGES)
