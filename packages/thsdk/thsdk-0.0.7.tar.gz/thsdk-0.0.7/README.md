...
```python
from thsdk import THS, AdjustedType, KlinePeriod
import pandas as pd
...
def main():
    ...
    try:
        ...
        # 获取历史日级别数据
        reply = ths.security_bars("USHA600519", 20240101, 20250420, AdjustedType.NONE, KlinePeriod.DAY)
