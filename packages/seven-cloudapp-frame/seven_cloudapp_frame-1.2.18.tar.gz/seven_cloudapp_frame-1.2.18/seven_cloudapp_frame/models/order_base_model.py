...
@LastEditTime: 2025-04-07 13:58:58
...
class OrderBaseModel(FrameBaseModel):
    ...
    def get_horseracelamp_list(self, app_id, act_id, module_id, is_search_module=False, condition="", params=[], page_size=30):
        ...
        if total < page_size:
            ...
            false_act_prize_list = act_prize_model.get_cache_list(prize_condition, order_by="probability desc,chance desc", limit="30", field="prize_name,tag_id,module_id", params=prize_params,cache_expire=60)
