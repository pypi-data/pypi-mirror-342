...
class GARClient:
    ...
    def register_subscription_status_handler(self, handler: Callable[[str, str], None]):
        """
    ...
    def clear_subscription_status_handler(self):
    ...
    def register_default_handlers(self):
        ...
        self.register_subscription_status_handler(
            lambda name, status: self.logger.info("Subscription %s status: %s", name, status))
