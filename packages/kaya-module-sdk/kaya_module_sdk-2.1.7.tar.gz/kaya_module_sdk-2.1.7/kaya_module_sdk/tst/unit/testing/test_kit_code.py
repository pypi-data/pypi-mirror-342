...
def tes_run_decorator_success(monkeypatch, args_type, rets_type_cls):
    # NOTE: Dummy module_request: simulate a response dictionary.
    fake_response = {"response": {"foo": "bar"}, "errors": [], "exit": 0}
    ...
    decorated = KIT.run(args_type, package="dummy_pkg", module="dummy_module")(
        dummy_test
    )
...
# TODO: Re-enable this test
def tes_run_decorator_missing_result(monkeypatch, args_type):
