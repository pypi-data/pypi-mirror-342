...
class Module(ABC):
    ...
    def _get_return_metadata(self, main_method: Callable, type_hints: dict) -> dict:
        ...
        return {
            ...
            "details": (
                self._get_class_metadata(expected_type)
    ...
    def _build_record(
        self, detail: str, unpacked: tuple, type_name: str
        ...
        record: dict = {
            ...
            "label": detail,
            "type": (
                type_name if type_name.startswith("list") else type_name.split("'")[1]
            ),
            "description": None,
            "validations": [],
        }
    ...
    def _get_class_metadata(self, cls: type) -> dict[str, Any]:
        ...
        for attr_name, attr_type in cls.__annotations__.items():
            class_metadata[attr_name] = {
                "type": attr_type,
                "details": (
                    self._get_class_metadata(attr_type)
