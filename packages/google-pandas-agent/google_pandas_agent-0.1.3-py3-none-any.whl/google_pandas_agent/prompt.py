"""
Prompt templates and utilities for Google Pandas Agent
"""
...
PREFIX = """\
You are an expert data analyst using Google Pandas Agent. You have access to a Python REPL that can
