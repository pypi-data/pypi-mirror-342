...
class ARSC:
    ...
    def get_id(self, package: str, rid: int) -> tuple[Union[str, None], Union[str, None], Union[int, None]]:
        """get id
    ...
    def get_resource_xml_name(self, r_id: int, package: Union[str, None] = None) -> Union[str, None]:
