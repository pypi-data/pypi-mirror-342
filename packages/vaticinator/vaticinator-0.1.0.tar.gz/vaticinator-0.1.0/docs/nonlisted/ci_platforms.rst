...
<https://github.com/zaharazod/vaticinator/pull/10>`_ and
another where `tests fail
<https://github.com/zaharazod/vaticinator/pull/11>`_.

Version release
```````````````

Every time a Pull Request is merged to `main` branch, the `deployment workflow
<https://github.com/zaharazod/vaticinator/blob/master/.github/workflows/version-bump-and-package.yml>`_
...
`Network plot
<https://github.com/zaharazod/vaticinator/network>`_.
...
`Discussion tab
<https://github.com/zaharazod/vaticinator/discussions>`_.
...
.. _.travis.yml: https://github.com/zaharazod/vaticinator/blob/latest/.travis.yml
.. _tox: https://tox.readthedocs.io/en/latest/
.. _Appveyor-CI: https://www.appveyor.com/
.. _tox.ini: https://github.com/zaharazod/vaticinator/blob/latest/tox.ini
.. _.appveyor.yml: https://github.com/zaharazod/vaticinator/blob/latest/.appveyor.yml
.. _.codacy.yaml: https://github.com/zaharazod/vaticinator/blob/latest/.codacy.yaml
.. _.codeclimate.yml: https://github.com/zaharazod/vaticinator/blob/latest/.codeclimate.yml
.. _Codacy: https://app.codacy.com/
.. _Code Climate: https://codeclimate.com/
.. _coverage: https://pypi.org/project/coverage/
.. _.coveragerc: https://github.com/zaharazod/vaticinator/blob/latest/.coveragerc
