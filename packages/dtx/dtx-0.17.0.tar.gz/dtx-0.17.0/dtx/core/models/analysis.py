...
class PromptDataset(str, Enum):
    ...
    def descriptions(cls):
        ...
        return {
            ...
            cls.HF_AISAFETY.value: "A dataset design by AI Safety Lab with prompt related to misinformation, toxicity, and unsafe behaviors.",
    ...
    def derived_from_hf(self) -> bool:
        """Returns True if the dataset has the 'HF_' prefix, indicating an HF dataset."""
