...
__all__ = ["ItemReceiptUpdateParams", "ExpenseLine", "ItemLineGroup", "ItemLineGroupItemLine", "ItemLine"]


class ItemReceiptUpdateParams(TypedDict, total=False):
    revision_number: Required[Annotated[str, PropertyInfo(alias="revisionNumber")]]
    """
    The current QuickBooks-assigned revision number of the item receipt object you
    ...
    """
    When `true`, removes all existing expense lines associated with this item
    ...
    """When `true`, removes all existing item lines associated with this item receipt.
