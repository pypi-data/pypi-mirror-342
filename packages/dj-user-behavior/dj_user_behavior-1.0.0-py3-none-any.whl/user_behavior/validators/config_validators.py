    ...
    if not isinstance(value, bool):
        errors.append(
            Error(
                ...
                id=f"user_behavior.E001_{config_name}",
            )
        )
    return errors
    ...
    if not isinstance(fields, list):
        errors.append(
            Error(
                ...
                id=f"user_behavior.E002_{config_name}",
            )
        )
        ...
        errors.append(
            Error(
                ...
                id=f"user_behavior.E003_{config_name}",
            )
        )
    else:
        ...
        if invalid_fields:
            errors.append(
                Error(
                    ...
                    id=f"user_behavior.E004_{config_name}",
                )
            )
    ...
    if not isinstance(rate, str) or "/" not in rate:
        errors.append(
            Error(
                ...
                id=f"user_behavior.E005_{setting_name}",
            )
        )
        return errors
    ...
    if len(parts) != 2:
        errors.append(
            Error(
                ...
                id=f"user_behavior.E006_{setting_name}",
            )
        )
        return errors
    ...
    if not number.isdigit():
        errors.append(
            Error(
                ...
                id=f"user_behavior.E007_{setting_name}",
            )
        )
    ...
    if time_unit not in VALID_TIME_UNITS:
        errors.append(
            Error(
                ...
                id=f"user_behavior.E008_{setting_name}",
            )
        )
    ...
    if not isinstance(setting_value, str):
        errors.append(
            Error(
                ...
                id=f"user_behavior.E009_{setting_name}",
            )
        )
        return errors
    ...
    try:
        ...
        errors.append(
            Error(
                ...
                id=f"user_behavior.E010_{setting_name}",
            )
        )
    ...
    if not isinstance(setting_value, list):
        errors.append(
            Error(
                ...
                id=f"user_behavior.E011_{setting_name}",
            )
        )
        return errors
        ...
        if not isinstance(path, str):
            errors.append(
                Error(
                    ...
                    id=f"user_behavior.E012_{setting_name}",
                )
            )
        else:
            ...
            try:
                ...
                errors.append(
                    Error(
                        ...
                        id=f"user_behavior.E013_{setting_name}",
                    )
                )
