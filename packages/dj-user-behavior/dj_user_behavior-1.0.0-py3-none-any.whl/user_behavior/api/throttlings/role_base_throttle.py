...
class RoleBasedUserRateThrottle(UserRateThrottle):
    ...
    def get_rate(self) -> str:
        ...
        self.base_rate = config.base_user_throttle_rate
        self.staff_rate = config.staff_user_throttle_rate
    ...
    def allow_request(self, request: Request, view: APIView) -> bool:
        ...
        Unauthenticated (anonymous) users are not allowed to proceed if this throttle applied.
