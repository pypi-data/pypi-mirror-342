...
class RandomForest(Estimator):
    ...
    def __init__(self, n_estimators: int = 15, *, max_depth: int = 10, min_samples_leaf: int = 5, **kwargs):
        ...
        self.estimator = RandomForestRegressor(n_estimators=n_estimators, max_depth=max_depth, min_samples_leaf=min_samples_leaf, **kwargs)
    ...
    def get_template(self) -> TemplateDef:
        ...
        return {
            "trees": [wrap(tree) for tree in self.estimator.estimators_]
        }
