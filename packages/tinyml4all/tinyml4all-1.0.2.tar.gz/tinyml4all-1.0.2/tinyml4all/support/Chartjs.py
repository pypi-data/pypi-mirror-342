...
class Chartjs(Convertible):
    ...
    def add_dataset(self, label: str, data: Union[List[dict], List[float], np.ndarray[float]], **kwargs):
        """
    ...
    def add_annotation_box(self, x1: str, x2: str, y1: float = 0, y2: float = 1, text: str|dict = None, **kwargs) -> str:
        """
        Add annotation box
        :param x1:
        :param x2:
        ...
        self.definition["options"]["plugins"]["annotation"]["annotations"][uid] = annotation
    ...
    def get_annotations(self, type: str = None) -> List[dict]:
        ...
        :return:
        """
        annotations = list(self.definition["options"]["plugins"]["annotation"]["annotations"].values())
    ...
    def custom_tooltip(self, expr: JsExpr = None):
        ...
        :return:
        """
        expr = coalesce(expr, JsExpr("(ctx) => ctx.dataset.data[ctx.dataIndex].tooltip"))
