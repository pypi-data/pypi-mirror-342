...
class DecisionTree(Estimator):
    """
    Proxy to sklearn.tree.DecisiontTreeClassifier
    """
    def __init__(self, *args, max_depth: int = 10, min_samples_leaf: int = 5, **kwargs):
        Estimator.__init__(self)

        self.estimator = DecisionTreeClassifier(*args, max_depth=max_depth, min_samples_leaf=min_samples_leaf, **kwargs)
    ...
    def get_template(self) -> TemplateDef:
        ...
        return {
            ...
            "classes": self.estimator.tree_.value,
        }