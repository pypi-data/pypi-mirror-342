...
def spread_signature(variables: List[Variable], pointer: bool = False, const: bool = False) -> str:
    """
    Spread variables
    :param variables:
    :param pointer:
    ...
    return ", ".join(f"{const}{var.c_type()}{pointer} {to_var_name(var.name)}" for var in variables)
