...
class LabelGUI:
    ...
    def __call__(self, *args, **kwargs):
        ...
        chart.add_var("annotationPalette", hex_colors("tab10", n_colors=10, opacity=0.1))
        chart.set_alpine(script=asset("time-continuous-label-ui/alpine.js"), template=asset("time-continuous-label-ui/alpine.html"))
