...
class Test1HeatPump1GasBoiler1HeatDemandMapping:
    ...
    def test_mapping(self):
        ...
        gb_data = {
            ...
            'mdot_gas_kg_per_s': [0., 0., 0.00325, 0.]
        }
        ...
        gb_mdot_kg_per_s = prosumer.time_series.loc[1].data_source.df.mdot_kg_per_s
        ...
        t_mix_c = (hp_mdot_cond_kg_per_s * hp_t_cond_out_c + gb_mdot_kg_per_s * gb_t_out_c) / mdot_prod_kg_per_s
