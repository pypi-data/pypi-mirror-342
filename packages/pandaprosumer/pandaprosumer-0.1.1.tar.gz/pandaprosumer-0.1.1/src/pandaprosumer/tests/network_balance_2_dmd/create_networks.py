...
def create_pandapipes_net_loop(ow_time_steps, mdot_dmd_kg_per_s, t_feed_prod_k, p_feed_prod_bar, p_return_prod_bar):
    ...
    j8 = pandapipes.create_junction(net, pn_bar=10, tfluid_k=350, geodata=(2, 3))
    j9 = pandapipes.create_junction(net, pn_bar=10, tfluid_k=350, geodata=(2, 2))
    j10 = pandapipes.create_junction(net, pn_bar=10, tfluid_k=350, geodata=(2, 1))
    j11 = pandapipes.create_junction(net, pn_bar=10, tfluid_k=350, geodata=(2, 0))
    ...
    pandapipes.create_heat_consumer(net, from_junction=j9, to_junction=j10,
                                    qext_w=100e3, controlled_mdot_kg_per_s=mdot_dmd_kg_per_s[0],
                                    _pandaprosumer_max_mdot_dmd_kg_per_s=10000,
                                    _pandaprosumer_min_mdot_dmd_kg_per_s=0.05,
                                    _pandaprosumer_min_t_dmd_return_k=10 + 273.15)
    pandapipes.create_flow_control(net, from_junction=j9, to_junction=j10, controlled_mdot_kg_per_s=0.1,
                                   role="demander_bypass")
