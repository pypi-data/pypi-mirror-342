...
CONFIG = _cleanup(
  {
    "Build Dependencies": {
      "blas": {
        ...
        "include directory": r"/opt/_internal/cpython-3.12.9/lib/python3.12/site-packages/scipy_openblas64/include",
        "lib directory": r"/opt/_internal/cpython-3.12.9/lib/python3.12/site-packages/scipy_openblas64/lib",
    ...
    "Python Information": {
      "path": r"/tmp/build-env-ovaduw7e/bin/python",
      "version": "3.12",
    },
  }
)
