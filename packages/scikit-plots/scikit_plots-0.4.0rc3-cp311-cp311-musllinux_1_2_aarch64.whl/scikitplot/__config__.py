...
CONFIG = _cleanup(
  {
    "Build Dependencies": {
      "blas": {
        ...
        "include directory": r"/opt/_internal/cpython-3.11.11/lib/python3.11/site-packages/scipy_openblas64/include",
        "lib directory": r"/opt/_internal/cpython-3.11.11/lib/python3.11/site-packages/scipy_openblas64/lib",
    ...
    "Python Information": {
      "path": r"/tmp/build-env-5w2iek4n/bin/python",
      "version": "3.11",
    },
  }
)
