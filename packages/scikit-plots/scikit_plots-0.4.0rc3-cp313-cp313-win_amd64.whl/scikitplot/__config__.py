...
CONFIG = _cleanup(
  {
    "Build Dependencies": {
      "blas": {
        ...
        "include directory": r"C:/Users/runneradmin/AppData/Local/Temp/cibw-run-fvukg_zt/cp313-win_amd64/build/venv/Lib/site-packages/scipy_openblas64/include",
        "lib directory": r"C:/Users/runneradmin/AppData/Local/Temp/cibw-run-fvukg_zt/cp313-win_amd64/build/venv/Lib/site-packages/scipy_openblas64/lib",
    ...
    "Python Information": {
      "path": r"C:\Users\runneradmin\AppData\Local\Temp\build-env-e_la50yx\Scripts\python.exe",
      "version": "3.13",
    },
  }
)
