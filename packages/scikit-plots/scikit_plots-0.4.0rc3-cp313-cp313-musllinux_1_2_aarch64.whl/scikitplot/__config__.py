...
CONFIG = _cleanup(
  {
    "Build Dependencies": {
      "blas": {
        ...
        "include directory": r"/opt/_internal/cpython-3.13.2/lib/python3.13/site-packages/scipy_openblas64/include",
        "lib directory": r"/opt/_internal/cpython-3.13.2/lib/python3.13/site-packages/scipy_openblas64/lib",
    ...
    "Python Information": {
      "path": r"/tmp/build-env-u8_kal5n/bin/python",
      "version": "3.13",
    },
  }
)
