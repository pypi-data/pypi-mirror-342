...
class COPTimeseries(GraphObject):
    def __init__(self, dm : DataManager, title : str = "System COP Timeseries", summary_group : str = None):
        ...
        self.seen_events = []
        self.cop_affecting_events = ['MV_COMMISSIONED', 'PLANT_COMMISSIONED','DATA_LOSS_COP','EQUIPMENT_MALFUNCTION','ALARM',
            'INSTALLATION_ERROR_COP','PARTIAL_OCCUPANCY','SOO_PERIOD_COP','SYSTEM_MAINTENANCE','SYSTEM_TESTING']
        self.shader_colors = {
            'DATA_LOSS_COP' : 'red',
            'EQUIPMENT_MALFUNCTION' : 'orange',
            'ALARM' : 'darkred',
            'PLANT_COMMISSIONED' : 'yellow',
            'PARTIAL_OCCUPANCY' : 'violet',
            'SYSTEM_TESTING' : "grey",
            'SOO_PERIOD_COP' : 'darkviolet',
            'SYSTEM_MAINTENANCE' : 'green',
            'INSTALLATION_ERROR_COP': 'darkblue',
            'MV_COMMISSIONED' : 'limegreen'
        }
