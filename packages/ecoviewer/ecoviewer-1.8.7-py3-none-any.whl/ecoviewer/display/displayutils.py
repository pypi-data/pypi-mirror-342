...
def hpwh_summary_table(dm : DataManager):
    ...
    for site in all_sites:
        ...
        if not exp_cop is None and not pd.isna(exp_cop):
            ...
            proj_cop = site_dm.get_annual_extrapolated_COP(['MV_COMMISSIONED','PLANT_COMMISSIONED','DATA_LOSS_COP','SYSTEM_MAINTENANCE','SYSTEM_TESTING'])
            optim_cop = site_dm.get_annual_extrapolated_COP(['MV_COMMISSIONED','PLANT_COMMISSIONED','DATA_LOSS_COP','INSTALLATION_ERROR_COP',
