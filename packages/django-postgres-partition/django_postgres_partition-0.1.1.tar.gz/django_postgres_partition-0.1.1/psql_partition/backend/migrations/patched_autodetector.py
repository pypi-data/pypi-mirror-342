...
from psql_partition.models import (
...
class AddOperationHandler:
    ...
    def add_create_model(self, operation: CreateModel):
        ...
        if django.VERSION >= (4, 0):
            ...
            model = self.autodetector.new_apps.get_model(self.app_label, operation.name)
    ...
    def add_delete_model(self, operation: DeleteModel):
        ...
        if django.VERSION >= (4, 0):
            ...
            model = self.autodetector.old_apps.get_model(self.app_label, operation.name)
    ...
    def add_delete_partitioned_model(self, operation: DeleteModel):
        ...
        _, args, kwargs = operation.deconstruct()
        return self.add(operations.PostgresDeletePartitionedModel(*args, **kwargs))
    ...
    def add_delete_materialized_view_model(self, operation: DeleteModel):
        ...
        _, args, kwargs = operation.deconstruct()
        return self.add(operations.PostgresDeleteMaterializedViewModel(*args, **kwargs))
...
def patched_autodetector():
    ...
    autodetector_class_path = f"{autodetector_module_path}.MigrationAutodetector"
