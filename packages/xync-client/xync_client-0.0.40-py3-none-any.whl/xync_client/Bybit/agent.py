...
from xync_client.Bybit.etype.order import OrderRequest, PreOrderResp
...
class AgentClient(BaseAgentClient):  # Bybit client
    ...
    async def order_request(self, br: BaseOrderReq):
