...
"""
    ...
    def check_text(self, content: str) -> str:
        """
...
if __name__ == "__main__":
    ...
    print(image_analyzer.extract_alt_texts(content))

    # # Phân tích mối quan hệ hình ảnh-văn bản 
    # alignment_result = image_analyzer.check_image(content)
    # print("===== PHÂN TÍCH MỐI QUAN HỆ HÌNH ẢNH-VĂN BẢN =====")
    # print(alignment_result)
    
    # # Phân tích SEO hình ảnh
    # seo_result = image_analyzer.analyze_image_seo(content)
    # print("\n\n===== PHÂN TÍCH SEO HÌNH ẢNH =====")
    # print(seo_result)
    
    # # Báo cáo tổng hợp
    comprehensive_report = image_analyzer.check_text(content)
    print("\n\n===== BÁO CÁO TỔNG HỢP HÌNH ẢNH =====")
