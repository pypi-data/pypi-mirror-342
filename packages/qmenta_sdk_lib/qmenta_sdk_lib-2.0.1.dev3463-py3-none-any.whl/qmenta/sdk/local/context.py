...
class LocalAnalysisContext:
    ...
    def download_resource(self, resource_path, destination_path):
        ...
        logger.info("Downloading resource {!r} to {!r}".format(resource_path, destination_path))

        os.makedirs(os.path.dirname(destination_path), exist_ok=True)
        try:
            shutil.copyfile(os.path.join(self.__res_folder, resource_path), destination_path)
