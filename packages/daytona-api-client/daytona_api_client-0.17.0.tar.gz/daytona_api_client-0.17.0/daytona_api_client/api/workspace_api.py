...
from daytona_api_client.models.list_workspaces_labels_parameter import ListWorkspacesLabelsParameter
...
class WorkspaceApi:
    ...
    def list_workspaces(
        ...
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        verbose: Annotated[Optional[StrictBool], Field(description="Include verbose output")] = None,
        labels: Annotated[Optional[ListWorkspacesLabelsParameter], Field(description="Filter workspaces by labels")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param verbose: Include verbose output
        :type verbose: bool
        :param labels: Filter workspaces by labels
        :type labels: ListWorkspacesLabelsParameter
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
