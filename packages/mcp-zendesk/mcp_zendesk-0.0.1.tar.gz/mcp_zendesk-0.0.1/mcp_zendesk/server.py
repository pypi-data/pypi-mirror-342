...
def create_ticket_prompt(subject: str = None, description: str = None, priority: str = None):
    """
            ...
            "messages": [
                {
                    ...
                    "content": {
                        "type": "text",
                        "text": f"I need to create a new support ticket in Zendesk. Please help me with the required details and best practices for writing effective ticket subjects and descriptions."
                    }
                }
            ]
        }
...
def ticket_response_prompt(ticket_id: str = None, summary: str = None):
    """
            ...
            "messages": [
                {
                    ...
                    "content": {
                        "type": "text",
                        "text": f"Please help me draft a professional and helpful response to Zendesk ticket #{ticket_id}. The customer issue is: {summary}\n\nDraft a response that is empathetic, clear, and provides actionable next steps."
                    }
                }
            ]
        }
            ...
            "messages": [
                {
                    ...
                    "content": {
                        "type": "text",
                        "text": f"I need to respond to a support ticket in Zendesk. Can you help me draft a professional, empathetic response that follows best practices for customer support communication?"
                    }
                }
            ]
        }
        ...
        "messages": [
            {
                ...
                "content": {
                    "type": "text",
                    "text": "I'd like to analyze our Zendesk ticket data to identify trends and areas for improvement. Can you help me understand what metrics and patterns to look for, and how to interpret the results to improve our customer support process?"
                }
            }
        ]
    }
