...
class V1SendFlare(BaseModel):
    ...
    __properties = ["journalSizeLimitBytes", "diagnoseMount", "diagnoseAstroCamera", "diagnoseAllSkyCamera", "diagnoseFocuser", "diagnoseWeatherStation", "diagnoseRelays", "diagnoseRoof", "diagnosePlatformConnection"]
