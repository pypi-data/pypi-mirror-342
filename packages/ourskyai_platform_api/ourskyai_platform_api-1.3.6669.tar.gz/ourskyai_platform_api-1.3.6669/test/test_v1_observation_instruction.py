...
from ourskyai_platform_api.models.v1_observation_instruction import V1ObservationInstruction  # noqa: E501

class TestV1ObservationInstruction(unittest.TestCase):
    """V1ObservationInstruction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ObservationInstruction:
        """Test V1ObservationInstruction
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ObservationInstruction`
        """
        model = V1ObservationInstruction()  # noqa: E501
        if include_optional:
            return V1ObservationInstruction(
                id = '',
                norad_id = '',
    ...
    def testV1ObservationInstruction(self):
        """Test V1ObservationInstruction"""
