...
from ourskyai_platform_api.models.v1_image_set_image import V1ImageSetImage  # noqa: E501
    ...
    def make_instance(self, include_optional) -> V1ImageSetImage:
        ...
        if include_optional:
            return V1ImageSetImage(
                ...
                predicted_streak_location = ourskyai_platform_api.models.v1_predicted_streak_location.V1PredictedStreakLocation(
                    start_x = 1.337, 
                    start_y = 1.337, 
                    end_x = 1.337, 
                    end_y = 1.337, )
