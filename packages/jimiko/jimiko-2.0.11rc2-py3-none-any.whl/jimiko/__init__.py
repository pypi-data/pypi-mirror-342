...
# For backward compatibility, but these will trigger immediate loading
PyJimikoClient = property(lambda _: get_ssh_client())
PyJimikoSFTPClient, PyFileInfo = property(lambda _: get_sftp_client())