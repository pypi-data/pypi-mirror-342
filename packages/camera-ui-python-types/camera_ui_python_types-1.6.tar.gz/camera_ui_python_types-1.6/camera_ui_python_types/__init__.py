...
class BaseCameraConfig(TypedDict):
    ...
    hasMotionDetection: Optional[bool]
    hasObjectDetection: Optional[bool]
    hasAudioDetection: Optional[bool]
    hasPtz: Optional[bool]
...
J = TypeVar("J", bound=Union[str, list[str], int, list[int], bool, list[bool], Any])
...
class JsonBaseSchema(JsonBaseSchmaWithoutCallbacks[J], Generic[J]):
    ...
    onGet: NotRequired[Union[Callable[[], Awaitable[Union[Any, None]]], Callable[[], Union[Any, None]]]]
...
class JsonSchemaArray(JsonBaseSchema[Union[list[str], list[int], list[bool]]], JsonArraySchema):
    pass


class JsonSchemaArrayWithoutCallbacks(
    JsonBaseSchmaWithoutCallbacks[Union[list[str], list[int], list[bool]]], JsonArraySchema
):
    pass
...
class JsonSchemaSubmit(JsonFactorySchema):
    type: Literal["submit"]
    color: NotRequired[Literal["success", "info", "warn", "danger"]]
    onClick: Union[Callable[["FormSubmitResponse"], None], Awaitable[Union["FormSubmitResponse", None]]]
...
class JsonSchemaArrayWithoutCallbacksAndKey(TypedDict):
    ...
    readonly: NotRequired[bool]
    placeholder: NotRequired[str]
    defaultValue: NotRequired[Union[list[str], list[int], list[bool]]]
    opened: NotRequired[bool]
    items: "JsonSchemaWithoutCallbacksAndKey"
