...
J = TypeVar("J", bound=str | list[str] | int | list[int] | bool | list[bool] | Any)
...
class JsonSchemaNumber(JsonBaseSchema[int], JsonNumberSchema): ...
class JsonSchemaNumberWithoutCallbacks(JsonBaseSchmaWithoutCallbacks[int], JsonNumberSchema): ...
...
class JsonSchemaArray(JsonBaseSchema[list[str] | list[int] | list[bool]], JsonArraySchema): ...
class JsonSchemaArrayWithoutCallbacks(
    JsonBaseSchmaWithoutCallbacks[list[str] | list[int] | list[bool]], JsonArraySchema
): ...

class JsonSchemaButton(JsonFactorySchema):
    type: Literal["button"]
    color: NotRequired[Literal["success", "info", "warn", "danger"]]
    onSet: Callable[[], Awaitable[None]]

class JsonSchemaSubmit(JsonFactorySchema):
    type: Literal["submit"]
    color: NotRequired[Literal["success", "info", "warn", "danger"]]
    onClick: Callable[[FormSubmitResponse], None] | Awaitable[FormSubmitResponse | None]
...
class JsonSchemaArrayWithoutCallbacksAndKey(TypedDict):
    ...
    readonly: NotRequired[bool]
    placeholder: NotRequired[str]
    defaultValue: NotRequired[list[str] | list[int] | list[bool]]
    opened: NotRequired[bool]
    items: JsonSchemaWithoutCallbacksAndKey
