...
class BaseCameraConfig(TypedDict):
    ...
    hasMotionDetection: bool | None
    hasObjectDetection: bool | None
    hasAudioDetection: bool | None
    hasPtz: bool | None
...
PTZCommand = PTZHomeCommand | PTZPresetCommand | PTZMoveCommand | PTZContinuousMoveCommand
...
class Camera(TypedDict):
    ...
    hasMotionDetection: bool
    hasObjectDetection: bool
    hasAudioDetection: bool
    hasPtz: bool
    hasBattery: bool
...
class CameraDevice(Protocol):
    ...
    @property
    def snapshot_source(self) -> CameraSource | None: ...
    @property
    def ptz(self) -> CameraPTZDelegate: ...
    @property
    def delegate(self) -> CameraDelegate: ...
    @property
...
class DeviceManager(Protocol):
    ...
    async def get_camera(self, camera_id_or_name: str) -> CameraDevice | None: ...
...
class HWAccelOptions(TypedDict):
    targetCodec: Literal["h264"] | Literal["h265"]
    keepOnHardware: NotRequired[bool | None]
    pixelFormat: NotRequired[str | None]
    scale: NotRequired[HWAccelScale | None]
...
J = TypeVar("J", bound=str | list[str] | float | list[float] | bool | list[bool] | Any)
...
class JsonSchemaEnum(JsonBaseSchema[str | list[str]], JsonEnumSchema): ...
class JsonSchemaEnumWithoutCallbacks(JsonBaseSchmaWithoutCallbacks[str | list[str]], JsonEnumSchema): ...
class JsonSchemaArray(JsonBaseSchema[list[str] | list[float] | list[bool]], JsonArraySchema): ...
class JsonSchemaArrayWithoutCallbacks(
    JsonBaseSchmaWithoutCallbacks[list[str] | list[float] | list[bool]], JsonArraySchema
): ...
...
class JsonSchemaSubmit(JsonFactorySchema):
    ...
    color: NotRequired[Literal["success", "info", "warn", "danger"]]
    onClick: (
        Callable[[Any], FormSubmitResponse | None]
        | Callable[[Any], Awaitable[FormSubmitResponse | None]]
        | Callable[[Any], Coroutine[Any, Any, FormSubmitResponse | None]]
    )
...
class JsonSchemaEnumWithoutCallbacksAndKey(TypedDict):
    ...
    readonly: NotRequired[bool]
    placeholder: NotRequired[str]
    defaultValue: NotRequired[str | list[str]]
    enum: list[str]
    multiple: NotRequired[bool]
...
class JsonSchemaArrayWithoutCallbacksAndKey(TypedDict):
    ...
    readonly: NotRequired[bool]
    placeholder: NotRequired[str]
    defaultValue: NotRequired[list[str] | list[float] | list[bool]]
    opened: NotRequired[bool]
    items: JsonSchemaWithoutCallbacksAndKey
...
JsonSchemaWithoutCallbacksAndKey = (
...
class BasePlugin(metaclass=ABCMeta):
    ...
    @abstractmethod
    async def getCapabilities(self) -> list[CuiCapability]: ...
...
class PtzPlugin(BasePlugin, metaclass=abc.ABCMeta): ...
...
class StorageController(Protocol[S]):
    def create_camera_storage(
        self, instance: Any, camera_id: str, schemas: list[JsonSchema] | None = None
    ) -> S: ...
    def create_plugin_storage(self, instance: Any, schemas: list[JsonSchema] | None = None) -> S: ...
    def get_camera_storage(self, camera_id: str) -> S | None: ...
    def get_plugin_storage(self) -> S | None: ...
    async def remove_camera_storage(self, camera_id: str) -> None: ...
    async def remove_plugin_storage(self) -> None: ...
