...
class CameraDevice(Protocol):
    ...
    def extend(self, interfaces: PTZInterface | SnapshotInterface | StreamingInterface) -> None: ...
    ...
    async def add_capabilities(self, capabilities: list[CameraDeviceCapability]) -> None: ...
...
class CoreManager(Protocol):
    async def connect_to_plugin(self, plugin_name: str) -> CuiPlugin | None: ...
