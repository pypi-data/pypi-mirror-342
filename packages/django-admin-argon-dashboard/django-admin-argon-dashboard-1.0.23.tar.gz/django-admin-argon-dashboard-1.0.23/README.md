# [Argon Dashboard](https://app-generator.dev/product/argon-dashboard/) Django Integration
...
- [Argon Dashboard](https://app-generator.dev/product/argon-dashboard/) 
...
- Simple, Easy-to-Extend Codebase
- [Argon Dashboard](https://app-generator.dev/product/argon-dashboard/) PRO Design Integration 
- Bootstrap Styling 
- Dynamic Tables - read [docs](https://app-generator.dev/docs/developer-tools/dynamic-datatables.html)
- Dynamic API - read [docs](https://app-generator.dev/docs/developer-tools/dynamic-api.html)
- Charts
