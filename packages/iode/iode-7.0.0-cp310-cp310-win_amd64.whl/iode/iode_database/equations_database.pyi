import pandas as pd
from iode.common import EqTest as EqTest, PrintEquationsAs as PrintEquationsAs, PrintEquationsLecAs as PrintEquationsLecAs
...
from iode.util import JUSTIFY as JUSTIFY, enable_msgs as enable_msgs, join_lines as join_lines, suppress_msgs as suppress_msgs, table2str as table2str
from pathlib import Path
from typing import Any, Self

Self = Any
EquationInput = str | dict[str, Any] | Equation
...
class Equations(IodeDatabase):
    ...
    def get_lec(self, key: str | int) -> str:
        '''
    ...
    def i(self) -> PositionalIndexer:
        ...
        Equation(endogenous = \'ZZF_\',
                ...
                block = \'ZZF_\')
        '''
    def __getitem__(self, key: str | list[str]) -> Equation | Self:
        '''
        ...
        [\'ACAF\', \'AOUC\', \'BQY\', \'BVY\']
        '''
    def __setitem__(self, key: str | list[str], value: str | Equation | dict[str, Any] | list[str | Equation | dict[str, Any]]):
        '''
    ...
    def variables(self) -> list[str]:
        ...
        '''
    def estimate(self, from_period: str | Period = None, to_period: str | Period = None, list_eqs: str | list[str] = None, quiet: bool = False) -> bool:
        '''
    ...
    def print_equations_as(self, value: PrintEquationsAs | str | int): ...
    @property
    ...
    def print_equations_lec_as(self, value: PrintEquationsLecAs | str | int): ...
