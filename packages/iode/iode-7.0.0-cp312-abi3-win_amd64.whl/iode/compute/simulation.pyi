from iode.iode_cython import SimulationInitialization as SimulationInitialization, SimulationSort as SimulationSort
...
class Simulation:
    ...
    '''
    def __init__(self, convergence_threshold: float = 0.001, relax: float = 1.0, max_nb_iterations: int = 100, sort_algorithm: SimulationSort | str = ..., initialization_method: SimulationInitialization | str = ..., debug: bool = False, nb_passes: int = 5, debug_newton: bool = False) -> None: ...
    @property
    ...
    def sort_algorithm(self, value: SimulationSort | str | int): ...
    @property
    ...
    def initialization_method(self, value: SimulationInitialization | str | int): ...
    @property
    def debug(self) -> bool:
        '''
    ...
    def model_exchange(self, list_exo: str | list[str] = None):
        '''
        ...
        <BLANKLINE>
        '''
    def model_compile(self, list_eqs: str | list[str] = None, quiet: bool = False) -> bool:
        """
        ...
        """
    def model_simulate(self, from_period: str | Period, to_period: str | Period, list_eqs: str | list[str] = None, quiet: bool = False) -> bool:
        '''
        ...
        <BLANKLINE>
        '''
    def model_calculate_SCC(self, nb_iterations: int, pre_name: str = '_PRE', inter_name: str = '_INTER', post_name: str = '_POST', list_eqs: str | list[str] = None, quiet: bool = False) -> bool:
        '''
        ...
        39
        '''
    def model_simulate_SCC(self, from_period: str | Period, to_period: str | Period, pre_name: str = '_PRE', inter_name: str = '_INTER', post_name: str = '_POST', quiet: bool = False) -> bool:
        '''
