import pandas as pd
from iode.common import IodeFileType as IodeFileType
from iode.iode_cython import ImportFormats as ImportFormats, TableLang as TableLang
...
from iode.util import JUSTIFY as JUSTIFY, check_filepath as check_filepath, join_lines as join_lines, table2str as table2str
...
class Comments(IodeDatabase):
    ...
    def i(self) -> PositionalIndexer:
        ...
        \'New Comment\'
        '''
    def __getitem__(self, key: str | list[str]) -> str | Self:
        '''
        ...
        [\'ACAF\', \'AOUC\', \'BQY\', \'BVY\']
        '''
    def __setitem__(self, key: str | list[str], value: str | list[str]):
        '''
    ...
    def series(self) -> pd.Series:
        ...
        '''
    @classmethod
    def convert_file(cls, input_file: str | Path, input_format: str | ImportFormats, save_file: str | Path, rule_file: str | Path, lang: str | TableLang = ..., debug_file: str | Path = None):
        '''
