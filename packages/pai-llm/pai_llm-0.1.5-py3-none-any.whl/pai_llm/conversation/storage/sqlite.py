...
class SQLiteStorage(BaseStorage):
    ...
    def __init__(self, db_file_path: str | Path, max_messages: typing.Optional[int] = None):
        super().__init__()
    ...
    def _message_to_row(self, message: Message, conversation_id: str, index: int) -> typing.Tuple:
