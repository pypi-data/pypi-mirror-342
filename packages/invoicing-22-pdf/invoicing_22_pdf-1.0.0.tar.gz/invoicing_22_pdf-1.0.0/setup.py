...
setup(
  name = 'invoicing-22-pdf',         #* Your package will have this name
  ...
  author = 'Vadim Rusu',                   # Your name
  author_email = 'rvadim76@gmail.com',  # Your email
  url = 'https://github.com/rvadim76',              # Homepage of your library (e.g. github or your website)
