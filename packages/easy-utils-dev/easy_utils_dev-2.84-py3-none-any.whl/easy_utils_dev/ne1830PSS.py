...
class PSS1830 :
    ...
    def connect(self , mode='cli' , neip=None , port=22  , user=None , pw=None , rootpw=None,jumpserver = None , resetRequired = False, tmpPassword = None , maxReconnectAttemp=40,auto_disable_paging=True) :
        if not user :
            user = 'admin'
        if not pw :
            pw = 'YWRtaW4='
