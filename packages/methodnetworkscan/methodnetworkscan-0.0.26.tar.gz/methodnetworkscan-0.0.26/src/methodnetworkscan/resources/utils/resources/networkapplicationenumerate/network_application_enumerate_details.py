...
import typing
from ....ssh.resources.enumerate.auth_method import AuthMethod
import pydantic
from ....ssh.resources.enumerate.key_exchange_algorithm import KeyExchangeAlgorithm
from ....ssh.resources.enumerate.host_key_algorithm import HostKeyAlgorithm
from ....ssh.resources.enumerate.cipher_algorithm import CipherAlgorithm
from ....ssh.resources.enumerate.mac_algorithm import MacAlgorithm
...
NetworkApplicationEnumerateDetails = typing.Union[
    NetworkApplicationEnumerateDetails_SshEnumerateDetails, NetworkApplicationEnumerateDetails_FtpEnumerateDetails
]
