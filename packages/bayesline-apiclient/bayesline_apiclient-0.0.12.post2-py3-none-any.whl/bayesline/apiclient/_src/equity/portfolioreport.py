...
class PortfolioReportAccessorClient(PortfolioReportAccessor):
...
class AsyncPortfolioReportAccessorClient(AsyncPortfolioReportAccessor):
...
class PortfolioReportApiClient(PortfolioReportApi):
    ...
    def get_report(
        ...
        *,
        ...
        return PortfolioReportAccessorClient(
            self._client,
...
class AsyncPortfolioReportApiClient(AsyncPortfolioReportApi):
    ...
    async def get_report(
        ...
        *,
        ...
        accessor_description = response.json()
        return AsyncPortfolioReportAccessorClient(
            self._client,
            accessor_description["identifier"],
            PortfolioReportAccessorSettings(
                axes=accessor_description["axes"],
...
class BayeslinePortfolioReportApiClient(BayeslinePortfolioReportApi):
    def __init__(
        ...
        self._accessor_settings = HttpSettingsRegistryClient(
            ...
            PortfolioReportAccessorSettings,
            SettingsMenu[PortfolioReportAccessorSettings],
        )
    ...
    def load(
        ...
        *,
        ...
        return PortfolioReportApiClient(
...
class AsyncBayeslinePortfolioReportApiClient(AsyncBayeslinePortfolioReportApi):
    ...
    async def load(
        ...
        *,
        ...
        report_id = response.json()["report_id"]
        return AsyncPortfolioReportApiClient(
            self._client, report_id, settings, persister=self._persister
        )
