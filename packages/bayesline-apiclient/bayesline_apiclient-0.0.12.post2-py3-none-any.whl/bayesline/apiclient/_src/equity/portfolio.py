...
class AsyncBayeslinePortfolioApiClient(AsyncBayeslinePortfolioApi):
...
class BayeslinePortfolioApiClient(BayeslinePortfolioApi):
...
class PortfolioParserClient(PortfolioParser):
...
class AsyncPortfolioParserClient(AsyncPortfolioParser):
...
class BayeslinePortfolioUploadApiClient(BayeslinePortfolioUploadApi):
...
class AsyncBayeslinePortfolioUploadApiClient(AsyncBayeslinePortfolioUploadApi):
...
class BayeslineEquityPortfolioUploadApiClient(BayeslineEquityPortfolioUploadApi):
    ...
    def load(
        ...
        return BayeslinePortfolioUploadApiClient(
    ...
    def get_parser(self, parser: str) -> PortfolioParser:
        if parser not in self.get_parser_names():
            raise KeyError(parser)
        return PortfolioParserClient(
...
class AsyncBayeslineEquityPortfolioUploadApiClient(
    AsyncBayeslineEquityPortfolioUploadApi
):
    ...
    async def load(
        ...
        return AsyncBayeslinePortfolioUploadApiClient(
            self._client.append_base_path(str(identifier))
        )
    ...
    async def get_parser(self, parser: str) -> AsyncPortfolioParser:
        if parser not in await self.get_parser_names():
            raise KeyError(parser)
        return AsyncPortfolioParserClient(
            self._client.append_base_path("parser"), parser_name=parser
        )
...
class AsyncBayeslineEquityPortfolioApiClient(AsyncBayeslineEquityPortfolioApi):
    def __init__(self, client: AsyncApiClient):
        ...
        self._uploader = AsyncBayeslineEquityPortfolioUploadApiClient(client)
    ...
    async def load(
        ...
        if isinstance(ref_or_settings, PortfolioSettings):
            ...
            return AsyncBayeslinePortfolioApiClient(self._client, ref_or_settings)
        else:
            portfoliohierarchy_settings = await self.settings.get(ref_or_settings)
            return AsyncBayeslinePortfolioApiClient(
                self._client,
                portfoliohierarchy_settings,
            )

    @property
    def uploader(self) -> AsyncBayeslineEquityPortfolioUploadApi:
...
class BayeslineEquityPortfolioApiClient(BayeslineEquityPortfolioApi):
    def __init__(self, client: ApiClient):
        ...
        self._uploader = BayeslineEquityPortfolioUploadApiClient(client)
    ...
    def load(
        ...
        if isinstance(ref_or_settings, PortfolioSettings):
            ...
            settings_menu.validate_settings(ref_or_settings)
            return BayeslinePortfolioApiClient(self._client, ref_or_settings)
        else:
            portfoliohierarchy_settings = self.settings.get(ref_or_settings)
            return BayeslinePortfolioApiClient(
                self._client,
                portfoliohierarchy_settings,
            )

    @property
    def uploader(self) -> BayeslineEquityPortfolioUploadApi:
        return self._uploader
