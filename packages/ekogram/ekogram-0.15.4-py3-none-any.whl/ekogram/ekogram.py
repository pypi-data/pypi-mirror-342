...
class FreeGpt:
    ...
    def chat(self, messages: dict = None, model: str = "deepseek-ai/DeepSeek-R1-Turbo", temperature: float = 0.7, max_tokens: int = 4000) -> str:
...
class ChatGPT:
    ...
    def generate_chat(self, messages: list = None, model: str = None) -> Union[list, str]:
        try:
            if messages is None:
    ...
    def get_models(self, headers: list = {}) -> Union[list, str]:
        try:
