...
from presidio_anonymizer import AnonymizerEngine, ConflictResolutionStrategy as ConflictResolutionStrategy
...
class TextAnonymizer(BaseTextAnonymizer):
    ...
    def __init__(self, text_analyzer: BaseTextAnalyzer, operators: dict[str, OperatorConfig] | None = None, add_default_faker_operators: bool = False, faker_seed: int | None = 42, anonymizer_engine: AnonymizerEngine | None = None, deanonymizer_mapping: DeanonymizerMapping | None = None) -> None:
        ...
        Args:
            ...
            add_default_faker_operators (bool, optional): Whether to add default faker operators. Default is False.
            faker_seed (int | None, optional): The seed used for faker. Default is 42.
            ...
            deanonymizer_mapping (DeanonymizerMapping, optional): The deanonymizer mapping used to record mapping
                    between anonymized and original text. Default is None.
        """
    @property
