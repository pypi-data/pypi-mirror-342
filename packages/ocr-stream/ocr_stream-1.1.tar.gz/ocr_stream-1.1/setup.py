...
pip3 install 'https://gitlab.com/bschavesbr/file-utils/-/archive/main/file-utils-main.zip'
pip3 install https://gitlab.com/bschaves/pdflib/-/archive/V1.0/pdflib-V1.0.zip
"""
import os
import sys
