...
from .audio_utils_clean import transcribe_audio_file_clean
...
def transcribe_video_path(video_path,
    ...
    transcribe_audio_file_clean(audio_path=info['audio_path'],
                                       output_json=info['info_path'])
...
def get_info_data(video_path,
    ...
    if os.path.isfile(info_path):
        ...
        prior_chunk_length = info.get('chunk_length_ms')
        video_text = info.get('video_text')
        if prior_chunk_length and remove_text and  chunk_length_ms != prior_chunk_length and video_text != None:
            del info['video_text']
