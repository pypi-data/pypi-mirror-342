...
def get_title_description(string,leng = 65):
    ...
    return string, ""
def analyze_video_text(video_path,output_dir=None,remove_phrases=None):
    ...
    def extract_text_from_image(image_path,remove_phrases=None):
        remove_phrases=remove_phrases or []
    ...
    for frame_file in os.listdir(output_dir):
        if frame_file.endswith(".jpg"):
            ...
            text = extract_text_from_image(image_dir,remove_phrases=remove_phrases)
...
def derive_all_video_meta(video_path,output_dir=None,video_text_path=None,keywords=None,description=None,title=None,remove_phrases = None):
    remove_phrases=remove_phrases or []
    ...
    thumbnail_texts = get_thumbnail_texts(thumbnails_dir)
