...
class TableEditor(QWidget):
    def __init__(self, db: Database, table: str, is_admin: bool):
        ...
        self.inputs = {}
        for idx, (col_name, col_type) in enumerate(self.columns):
            ...
            controls_layout.addWidget(label, idx, 0)
            controls_layout.addWidget(self.inputs[col_name], idx, 1)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, db: Database, is_admin: bool):
        ...
        header_layout.addWidget(import_excel_button)
