...
def test_clients_equality():
    client = RestApiConfig().fit_class()
    assert client.fit_config == client_default.fit_config
    assert client.fit_config != client_with_specific_args.fit_config
    assert client.fit_config == client_from_json.fit_config
    assert client.fit_config == client_from_yaml.fit_config
    assert client.fit_config == client_from_dict.fit_config
    assert client.fit_config == client_lazy_config.fit_config
    assert client.fit_config == client_decorated.fit_config
    assert client.fit_config == client_mix.fit_config

    assert client.fit_config == client_default_custom_init_session.fit_config
    assert client.fit_config == client_from_json_custom_init_session.fit_config
    assert client.fit_config == client_from_yaml_custom_init_session.fit_config
    assert client.fit_config == client_from_dict_custom_init_session.fit_config
...
def test_class_attributes(client):
    ...
    assert client.session.raw_auth == Auth()
...
def test_custom_session_config(client):
    ...
    assert session_base_url is None
