...
class ContainerContainerPullThroughDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["hidden", "content_guard", "prn", "pulp_labels", "pulp_href", "no_content_change_since", "repository", "pulp_created", "base_path", "name", "pulp_last_updated", "remote", "distributions", "namespace", "private", "description"]
