...
class ContainerContainerDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["hidden", "content_guard", "prn", "pulp_labels", "pulp_href", "no_content_change_since", "repository", "pulp_created", "base_path", "name", "pulp_last_updated", "repository_version", "registry_path", "remote", "namespace", "private", "description"]
