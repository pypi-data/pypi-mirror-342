...
class ZhuguangSDK:
    ...
    def login_qrcode(self):
        ...
        tread, stop_event = utils.generate_qr_and_show(res_data.get('url', ''))
        while True and tread.is_alive():
            # print("等待扫码中...")
            if self._check_qrcode_login(ticket, stop_event):
                break
    ...
    def _check_qrcode_login(self, ticket, stop_event):
