...
def get_text2text_max_length() -> Optional[int]:
    text2text_max_len = os.environ.get('TEXT2TEXT_MAX_LENGTH')
    return int(text2text_max_len) if text2text_max_len is not None else None
