...
def create(name):
    ...
    archivos = {
        ...
        'app/components/filter/domain/value_objects/filter.py': (
            ...
            "\n"
            "    @classmethod\n"
            "    def from_raw(cls, raw: Dict[str, Any]) -> \"FiltersValueObject\":\n"
            "        if not raw:\n"
            "            return cls()\n"
            "\n"
        ...
        'app/components/filter/infrastructure/dto/input_filter.py': (
            ...
            "\n"
            "    @classmethod\n"
            "    def from_request_body(cls, body: Dict[str, Any]) -> \"InputFilter\":\n"
            "        return cls(\n"
    ...
    if os.path.exists(name):
        print(f"ℹ️ El microservicio '{name}' ya existe.")
        return
    ...
    print(f"✅ El microservicio '{name}' creado con éxito.")