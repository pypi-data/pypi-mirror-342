...
from AgentEngine.vector_database.utils import format_size, format_timestamp, format_search_results, print_index_info
...
class ElasticSearchCore:
    ...
    def get_cleanse_source_info(self, index_name: str) -> str:
        """Get information about cleanse_source field"""
        agg_query = {
            "size": 0,
            "aggs": {
                "cleanse_sources": {
                    "terms": {
                        "field": "cleanse_source",
                        "size": 10
                    }
                }
            }
        ...
        try:
            ...
            sources = result['aggregations']['cleanse_sources']['buckets']
            if sources:
                return sources[0]['key']  # Return the most common cleanse_source
            return "Unknown"
        except Exception as e:
            print(f"Error getting cleanse source info: {str(e)}")
            return "Unknown"
    ...
    def get_index_stats(self, index_names: List[str]) -> Dict[str, Dict[str, Dict[str, Any]]]:
        ...
        for index_name in index_names:
            try:
                ...
                cleanse_source = self.get_cleanse_source_info(index_name)
    ...
    def create_test_knowledge_base(
        ...
        try:
            ...
            for article in articles:
                ...
                article["cleanse_source"] = "Unstructured"  # Add metadata
