...
class JinaEmbedding(BaseEmbedding):
    ...
    def get_embeddings(self, inputs: List[Dict[str, str]], with_metadata: bool = False, timeout: float = None) -> Union[List[List[float]], Dict[str, Any]]:
        """
...
class OpenAIBaseEmbedding(BaseEmbedding):
    ...
    def get_embeddings(self, inputs: List[str], with_metadata: bool = False, timeout: float = None) -> Union[List[List[float]], Dict[str, Any]]:
        """
