...
async def test_data_cleanse_to_es_integration():
    ...
    try:
        ...
        es_service_url = "http://localhost:5001"
        data_cleanse_service_url = "http://localhost:5001"
        
        # Get example docs directory
        example_docs_dir = Path(os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "AgentEngine", "data_cleanse", "example_docs")))
