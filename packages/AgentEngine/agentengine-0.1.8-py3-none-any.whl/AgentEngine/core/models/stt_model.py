...
class STTConfig(BaseModel):
    ...
    test_voice_path: str = r'C:\Project\AgentEngine\example_docs\test.wav'
    ...
    def from_env(cls, env_file: Union[str, Path] = None):
        ...
        return cls(
            ...
            test_voice_path=os.getenv("TEST_VOICE_PATH", r'C:\Project\AgentEngine\example_docs\test.wav'),
        )
