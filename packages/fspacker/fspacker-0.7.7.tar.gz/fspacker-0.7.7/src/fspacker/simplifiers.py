...
# 简化配置
__simplifier_options_dict: typing.Dict[str, SimplifierOption] = dict(
...
def get_simplify_options(name: str) -> SimplifierOption:
    """获取库打包精简配置
    ...
    """
    global __simplifier_options_dict

    return __simplifier_options_dict.get(name, None)
