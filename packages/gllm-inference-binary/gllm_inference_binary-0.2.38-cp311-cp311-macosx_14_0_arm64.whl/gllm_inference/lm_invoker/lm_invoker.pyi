...
from gllm_inference.schema import MultimodalContent as MultimodalContent, MultimodalOutput as MultimodalOutput, MultimodalPrompt as MultimodalPrompt, PromptRole as PromptRole, ToolCall as ToolCall, ToolResult as ToolResult, UnimodalPrompt as UnimodalPrompt
    ...
    def __init__(self, default_hyperparameters: dict[str, Any] | None = None, valid_extensions_map: dict[str, set[str]] | None = None, tools: list[Tool] | None = None) -> None:
        ...
        Args:
            ...
            tools (list[Tool] | None, optional): Tools provided to the language model to enable tool calling.
                Defaults to None.
        '''
    async def invoke(self, prompt: MultimodalPrompt | UnimodalPrompt, hyperparameters: dict[str, Any] | None = None, event_emitter: EventEmitter | None = None) -> MultimodalOutput | BaseModel:
        ...
        Returns:
            MultimodalOutput | BaseModel: The generated response from the language model.
