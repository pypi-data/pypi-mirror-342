...
PATHS_DIR="/lv0/yada/procslib/data/danbooru_path_chunks"

# Default arguments; check src/procslib/model_builder.py for available models
MODELS="test_anatomy_min3"  # Example multi-model

PATH_COLUMN="lepton_image_path"
SAVE_DIR="/lv0/yada/procslib/data/danbooru_path_res"
