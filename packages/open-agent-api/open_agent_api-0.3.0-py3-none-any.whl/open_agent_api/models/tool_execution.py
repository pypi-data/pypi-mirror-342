...
class ToolExecution(BaseModel):
    ...
    ToolExecution
    """ # noqa: E501
    role: Optional[StrictStr] = Field(default=None, description="The role of the message sender")
    content: Optional[StrictStr] = Field(default=None, description="The content of the message")
    tool_call_id: StrictStr = Field(description="The ID of the tool call")
    tool_name: StrictStr = Field(description="The name of the tool")
    tool_args: Dict[str, Any] = Field(description="The arguments passed to the tool")
    tool_call_error: Optional[StrictBool] = Field(default=False, description="Whether the tool execution resulted in an error")
    __properties: ClassVar[List[str]] = ["role", "content", "tool_call_id", "tool_name", "tool_args", "tool_call_error"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tool_call_error": obj.get("tool_call_error") if obj.get("tool_call_error") is not None else False
        })
        return _obj
