...
class TestAgentsAgentIdRunPostRequest(unittest.TestCase):
    """AgentsAgentIdRunPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AgentsAgentIdRunPostRequest:
        """Test AgentsAgentIdRunPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AgentsAgentIdRunPostRequest`
        """
        model = AgentsAgentIdRunPostRequest()
        if include_optional:
            return AgentsAgentIdRunPostRequest(
                messages = [
    ...
    def testAgentsAgentIdRunPostRequest(self):
        """Test AgentsAgentIdRunPostRequest"""
