...
from open_agent_api.models.tool_call_completed import ToolCallCompleted

class TestToolCallCompleted(unittest.TestCase):
    """ToolCallCompleted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ToolCallCompleted:
        """Test ToolCallCompleted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ToolCallCompleted`
        """
    ...
    def testToolCallCompleted(self):
        """Test ToolCallCompleted"""
