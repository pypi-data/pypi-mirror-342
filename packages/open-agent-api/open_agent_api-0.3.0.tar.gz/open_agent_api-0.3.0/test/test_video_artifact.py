...
class TestVideoArtifact(unittest.TestCase):
    """VideoArtifact unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VideoArtifact:
        """Test VideoArtifact
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VideoArtifact`
        """
        model = VideoArtifact()
        if include_optional:
