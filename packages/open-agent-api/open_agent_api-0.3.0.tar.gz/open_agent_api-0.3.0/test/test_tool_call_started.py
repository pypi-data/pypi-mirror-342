...
from open_agent_api.models.tool_call_started import ToolCallStarted

class TestToolCallStarted(unittest.TestCase):
    """ToolCallStarted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ToolCallStarted:
        """Test ToolCallStarted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ToolCallStarted`
        """
        model = ToolCallStarted()
        if include_optional:
