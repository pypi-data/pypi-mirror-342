...
class TestAudioArtifact(unittest.TestCase):
    """AudioArtifact unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AudioArtifact:
        """Test AudioArtifact
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AudioArtifact`
        """
        model = AudioArtifact()
        if include_optional:
