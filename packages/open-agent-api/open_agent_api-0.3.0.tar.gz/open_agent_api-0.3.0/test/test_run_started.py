...
class TestRunStarted(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RunStarted:
        """Test RunStarted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RunStarted`
        """
        model = RunStarted()
        if include_optional:
            return RunStarted(
