...
from .pdf.client import AsyncPdfClient
...
class SarvamAI:
    ...
    def __init__(
        ...
        *,
        ...
        self.pdf = PdfClient(client_wrapper=self._client_wrapper)
...
class AsyncSarvamAI:
    ...
    def __init__(
        ...
        *,
        ...
        self.pdf = AsyncPdfClient(client_wrapper=self._client_wrapper)
