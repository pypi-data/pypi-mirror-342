...
class GenericSession(BaseSession):
    ...
    __query: typing.Type[GenericModel] | None = None
    __order_by: tuple[str, typing.Literal["asc", "desc"]] | None = None
    __filters: list[
        tuple[
        ...
        if self.__filters:
            items = [
                ...
                if all(
                    ...
                    for filter_cmd in self.__filters
                )
            ]

        # Sort the items based on the order_by
        if self.__order_by:
            items = self._order_by(items)

        # Apply the offset
        if self.__offset is not None:
            items = items[self.__offset :]

        # Apply the limit
        if self.__limit is not None:
            items = items[: self.__limit]
    ...
    def order_by(self, column: str, direction: typing.Literal["asc", "desc"]):
        ...
        Returns:
            GenericSession: The session instance.
        """
        self.__order_by = (column, direction)
        return self

    def _order_by(self, data: list[GenericModel]):
        if not self.__order_by:
            return data

        col_name, direction = self.__order_by
    ...
    def text_contains(self, col_name: str, value):
        self.__filters.append((self._text_contains, col_name, value))
        return self
    ...
    def _text_contains(
        ...
        try:
            col_value = str(
                self.__convert_value(item, col_name, getattr(item, col_name))
            )
            col_value = col_value.lower()
            value = str(self.__convert_value(item, col_name, value))
    ...
    def starts_with(self, col_name: str, value):
        self.__filters.append((self._starts_with, col_name, value))
        return self
    ...
    def _starts_with(
        ...
        try:
            col_value = self.__convert_value(item, col_name, getattr(item, col_name))
            col_value = col_value.lower()
            value = self.__convert_value(item, col_name, value)
            value = value.lower()
    ...
    def not_starts_with(self, col_name: str, value):
        self.__filters.append((self._not_starts_with, col_name, value))
        return self
    ...
    def ends_with(self, col_name: str, value):
        self.__filters.append((self._ends_with, col_name, value))
        return self
    ...
    def not_ends_with(self, col_name: str, value):
        self.__filters.append((self._not_ends_with, col_name, value))
        return self
    ...
    def greater(self, col_name: str, value):
        self.__filters.append((self._greater, col_name, value))
        return self

    def _greater(self, item: GenericModel, col_name: str, value) -> bool:
        return self.__compare(item, col_name, value, ">")

    def greater_equal(self, col_name: str, value):
        self.__filters.append((self._greater_equal, col_name, value))
        return self
    ...
    def smaller(self, col_name: str, value):
        self.__filters.append((self._smaller, col_name, value))
        return self
    ...
    def smaller_equal(self, col_name: str, value):
        self.__filters.append((self._smaller_equal, col_name, value))
        return self
    ...
    def like(self, col_name: str, value):
        self.__filters.append((self._like, col_name, value))
        return self
    ...
    def not_like(self, col_name: str, value):
        self.__filters.append((self._not_like, col_name, value))
        return self
    ...
    def ilike(self, col_name: str, value):
        self.__filters.append((self._ilike, col_name, value))
        return self
    ...
    def equal(self, col_name: str, value):
        self.__filters.append((self._equal, col_name, value))
        return self
    ...
    def not_equal(self, col_name: str, value):
        self.__filters.append((self._not_equal, col_name, value))
        return self
    ...
    def in_(self, col_name: str, value):
        self.__filters.append((self._in, col_name, value))
        return self
    ...
    def __compare(
        ...
        try:
            ...
            col_value = self.__convert_value(item, col_name, col_value)
            value = self.__convert_value(item, col_name, value)
    ...
    def __convert_value(self, item: GenericModel, col_name: str, value):
