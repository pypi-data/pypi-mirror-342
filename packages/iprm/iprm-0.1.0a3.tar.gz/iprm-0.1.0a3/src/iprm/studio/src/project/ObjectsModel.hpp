...
enum ObjectsModelRole { ObjectNameIconsRole = Qt::UserRole + 1 };
...
struct ObjectNodeEntry {
  ...
  QIcon icon;
  QHash<QString, QPair<QIcon, Object>> platform_objects_;
};
...
class ObjectsModel : public QAbstractItemModel {
 ...
 public:
  ...
  [[nodiscard]] ObjectNodeEntry& get_object_node(const QModelIndex& index);
