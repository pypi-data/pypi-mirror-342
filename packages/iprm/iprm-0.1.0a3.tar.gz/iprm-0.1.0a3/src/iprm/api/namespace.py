...
from iprm.api.cpp import (CppExecutable, CppStaticLibrary, CppSharedLibrary, CppTest, CppPythonModule, CppThirdParty)
...
from iprm.core.typeflags import NONE, PROJECT, SUBDIR, CPP, THIRDPARTY, RUST, PYTHON
