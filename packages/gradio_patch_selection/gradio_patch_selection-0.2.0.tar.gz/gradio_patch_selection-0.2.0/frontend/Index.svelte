...
<script lang="ts">
	...
	export let img_size: number | null = null;
	export let patch_size: number = 16;
	export let show_grid: boolean = true;
	export let grid_color: string = "rgba(200, 200, 200, 0.5)";
...
>
	...
	<ImageAnnotator
		...
		on:patch_select={({ detail }) => gradio.dispatch("patch_select", detail)}
		on:clear={() => {
