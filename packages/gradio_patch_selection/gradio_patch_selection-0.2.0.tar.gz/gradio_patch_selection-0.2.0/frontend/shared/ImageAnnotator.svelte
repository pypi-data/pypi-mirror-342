<script lang="ts">
	...
	import PatchSelector from "./PatchSelector.svelte";
	...
	// Calculate effective dimensions based on imgSize parameter
	$: effectiveHeight = imgSize !== null ? imgSize : height;
	$: effectiveWidth = imgSize !== null ? imgSize : width;
</script>
			...
			<div class="image-frame">
				<div class="patch-selector-container">
					<PatchSelector
						...
						on:patch_select={(event) => {
							dispatch("patch_select", event.detail);
						}}
					/>
				</div>
			</div>
