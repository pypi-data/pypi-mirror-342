...
class DataFactory():
    ...
    @abstractmethod
    def export_waymo_product(self, source_data, out_path=None, sensor_mapping=None):
        pass
...
class ExportFactory(DataFactory):
    ...
    def export_waymo_product(self, source_data, out_path=None, sensor_mapping=None):
        print(self.type, "process has been created.")
        from ..io.export.waymo.export_waymo import ExportWaymo
        return ExportWaymo(source_data, out_path, sensor_mapping)
