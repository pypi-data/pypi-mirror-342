...
from . import EthernetFrameBuilder, ScriptStatus
...
class Record:
	...
	SequenceNumber: int
	Timestamp: vspyx.Runtime.Timestamp
	def assign(self, arg0: vspyx.Frames.Record) -> vspyx.Frames.Record: ...
...
class CoreminiHeaderNotFound(typing.Any):
	...
	"""
	def assign(self, arg0: vspyx.Frames.CoreminiHeaderNotFound) -> vspyx.Frames.CoreminiHeaderNotFound: ...
...
class Coremini:
	...
	Version: int
	def assign(self, arg0: vspyx.Frames.Coremini) -> vspyx.Frames.Coremini: ...
...
class FileId:
	...
	Timestamp: vspyx.Runtime.Timestamp
	UnixTimestamp: int
	def assign(self, arg0: vspyx.Frames.FileId) -> vspyx.Frames.FileId: ...
...
class VSAFile:
	...
	EndPosition: int
	EndSector: int
	FileId: vspyx.Frames.FileId
	FileName: str
	Name: str
	Priority: vspyx.Frames.UploadPriority
	ScriptChecksum: str
	Size: int
	StartPosition: int
	StartSector: int
	Timestamp: vspyx.Runtime.Timestamp
	def GetType(self) -> vspyx.Frames.VSAFile.Type: ...

	def IsCellular(self) -> bool: ...

	def IsWiFI(self) -> bool: ...

	def __eq__(self, rhs: vspyx.Frames.VSAFile) -> bool: ...
...
class VSAFilesystem(vspyx.IO.Filesystem):
	...
	@staticmethod
	@typing.overload
	def __str__(attribute: vspyx.Frames.VSAFilesystem.NumericAttribute) -> str: ...


	@staticmethod
	@typing.overload
	def __str__(attribute: vspyx.Frames.VSAFilesystem.StringAttribute) -> str: ...


	@staticmethod
	def StringToVSAFileType(type: str) -> vspyx.Frames.VSAFile.Type: ...


	@staticmethod
	def VSAFileTypeToString(type: vspyx.Frames.VSAFile.Type) -> str: ...
...
class DynamicVSAFilesystem(vspyx.Frames.VSAFilesystem):
	"""DynamicVSAFilesystem
	"""
	...
	def AddManualUpload(self, startSector: int, endSector: int, captureMask: int, scriptChecksum: str, startTime: vspyx.Runtime.Timestamp, endTime: vspyx.Runtime.Timestamp) -> bool: ...

	def AddRawUpload(self, startSector: int, endSector: int) -> bool: ...

class StaticVSAFilesystem(vspyx.Frames.VSAFilesystem):
	"""StaticVSAFilesystem
	"""

class VSAFilterInputStream(vspyx.IO.FileInputStream):
	"""VSAFilterInputStream
	"""

class VSAStreamOnChangeParameters(vspyx.IO.OnChangeParameters):
	"""VSAStreamOnChangeParameters
	"""
	CaptureIndex: int
	EndSector: int
	PreTriggerSize: int
