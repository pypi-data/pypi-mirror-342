...
class ListCommonControlsPaginator(_ListCommonControlsPaginatorBase):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_controlcatalog/paginators/#listcommoncontrolspaginator)
    """
...
class ListControlsPaginator(_ListControlsPaginatorBase):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_controlcatalog/paginators/#listcontrolspaginator)
    """
    def paginate(  # type: ignore[override]
...
class ListDomainsPaginator(_ListDomainsPaginatorBase):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_controlcatalog/paginators/#listdomainspaginator)
    """
    def paginate(  # type: ignore[override]
...
class ListObjectivesPaginator(_ListObjectivesPaginatorBase):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_controlcatalog/paginators/#listobjectivespaginator)
    """
    def paginate(  # type: ignore[override]
