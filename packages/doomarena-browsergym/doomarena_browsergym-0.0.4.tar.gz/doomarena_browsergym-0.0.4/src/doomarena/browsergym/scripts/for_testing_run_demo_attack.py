...
# Run as
#  /Users/krishnamur.dvijotham/.pyenv/versions/3.10.6/bin/python /Users/krishnamur.dvijotham/AgenticAttacks/research-agent-attacks/run_demo_attack.py --task_name=miniwob.email-inbox-delete --attack_args="AxTreeObsAttack"
#  After finishing setup of browsergym/miniwob
