...
class RedditCommentTask(AbstractBrowserTask):
    ...
    def setup(self, page) -> Tuple[str, Dict]:
        page.goto(
            "http://webarena-leo.eastus.cloudapp.azure.com:8080/f/allentown/80621/has-anyone-taken-the-greyhound-from-ny-to-allentown"
        )
...
dummy_attack_config_base = AttackConfig(
    ...
    filter=FilterByUrl(
        allowed_urls=["http://webarena-leo.eastus.cloudapp.azure.com:8080"]
    ),
