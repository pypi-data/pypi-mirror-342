...
class CredentialsManager:
    ...
    def get_credentials_by_code(self, alias: str= None) -> Dict[str, Any]:
        ...
        if not alias:
            return {"host": "trino.ird.vng.vn", "port": 8443, "username": "trino", "password": "gwu8TXB9mbu9mda_nmx", "database": "nessie"}
        try:
    ...
    def get_jdbc_credentials(self, source: str, dbname: str) -> str:
