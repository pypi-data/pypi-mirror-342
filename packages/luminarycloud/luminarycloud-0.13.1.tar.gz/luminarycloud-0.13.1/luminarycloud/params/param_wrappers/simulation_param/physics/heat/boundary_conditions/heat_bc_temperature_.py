...
class HeatBcTemperature(BoundaryConditionsHeat):
    ...
    def _to_proto(self) -> clientpb.BoundaryConditionsHeat:
        ...
        _proto.heat_physical_boundary = enum.HeatPhysicalBoundary.HEAT_BC_ISOTHERMAL.value
    ...
    def _from_proto(self, proto: clientpb.BoundaryConditionsHeat) -> None:
        ...
        assert proto.heat_physical_boundary == enum.HeatPhysicalBoundary.HEAT_BC_ISOTHERMAL.value
