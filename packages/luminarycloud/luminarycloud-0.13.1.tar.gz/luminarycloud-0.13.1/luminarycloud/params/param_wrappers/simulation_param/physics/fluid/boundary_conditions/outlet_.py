...
from luminarycloud.params.param_wrappers.simulation_param.physics.fluid.boundary_conditions_fluid_ import *
from luminarycloud.params.param_wrappers.simulation_param.physics.fluid.boundary_conditions.outlet.outlet_strategy.fan_curve_outlet_ import (
    FanCurveOutlet,
)
from luminarycloud.params.param_wrappers.simulation_param.physics.fluid.boundary_conditions.outlet.outlet_strategy.fan_curve_outlet_ import *
from luminarycloud.params.param_wrappers.simulation_param.physics.fluid.boundary_conditions.outlet.outlet_strategy.outlet_pressure_ import (
    OutletPressure,
)
from luminarycloud.params.param_wrappers.simulation_param.physics.fluid.boundary_conditions.outlet.outlet_strategy.outlet_pressure_ import *
from luminarycloud.params.param_wrappers.simulation_param.physics.fluid.boundary_conditions.outlet.outlet_strategy_ import (
    OutletStrategy,
)
from luminarycloud.params.param_wrappers.simulation_param.physics.fluid.boundary_conditions.outlet.outlet_strategy_ import *
from luminarycloud.params.param_wrappers.simulation_param.physics.fluid.boundary_conditions.outlet.outlet_strategy.outlet_target_corrected_mass_flow_rate_ import (
    OutletTargetCorrectedMassFlowRate,
)
from luminarycloud.params.param_wrappers.simulation_param.physics.fluid.boundary_conditions.outlet.outlet_strategy.outlet_target_corrected_mass_flow_rate_ import *
from luminarycloud.params.param_wrappers.simulation_param.physics.fluid.boundary_conditions.outlet.outlet_strategy.outlet_target_mass_flow_rate_ import (
...
class Outlet(BoundaryConditionsFluid):
    ...
    def _to_proto(self) -> clientpb.BoundaryConditionsFluid:
        ...
        _proto.physical_boundary = enum.PhysicalBoundary.OUTLET.value
    ...
    def _from_proto(self, proto: clientpb.BoundaryConditionsFluid) -> None:
        ...
        assert proto.physical_boundary == enum.PhysicalBoundary.OUTLET.value
