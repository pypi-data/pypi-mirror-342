...
from luminarycloud.params.param_wrappers.simulation_param.physics.fluid.boundary_conditions_fluid_ import *
from luminarycloud.params.param_wrappers.simulation_param.physics.fluid.boundary_conditions.wall.momentum.no_slip_ import (
    NoSlip,
)
from luminarycloud.params.param_wrappers.simulation_param.physics.fluid.boundary_conditions.wall.momentum.no_slip_ import *
from luminarycloud.params.param_wrappers.simulation_param.physics.fluid.boundary_conditions.wall.energy.prescribed_heat_flux_ import (
    PrescribedHeatFlux,
)
from luminarycloud.params.param_wrappers.simulation_param.physics.fluid.boundary_conditions.wall.energy.prescribed_heat_flux_ import *
from luminarycloud.params.param_wrappers.simulation_param.physics.fluid.boundary_conditions.wall.energy.prescribed_temperature_ import (
    PrescribedTemperature,
)
from luminarycloud.params.param_wrappers.simulation_param.physics.fluid.boundary_conditions.wall.energy.prescribed_temperature_ import *
from luminarycloud.params.param_wrappers.simulation_param.physics.fluid.boundary_conditions.wall.momentum.slip_ import (
    Slip,
)
from luminarycloud.params.param_wrappers.simulation_param.physics.fluid.boundary_conditions.wall.momentum.slip_ import *
from luminarycloud.params.param_wrappers.simulation_param.physics.fluid.boundary_conditions.wall.wall_energy_ import (
    WallEnergy,
)
from luminarycloud.params.param_wrappers.simulation_param.physics.fluid.boundary_conditions.wall.wall_energy_ import *
from luminarycloud.params.param_wrappers.simulation_param.physics.fluid.boundary_conditions.wall.momentum.wall_model_ import (
    WallModel,
)
from luminarycloud.params.param_wrappers.simulation_param.physics.fluid.boundary_conditions.wall.momentum.wall_model_ import *
...
class Wall(BoundaryConditionsFluid):
    ...
    def _to_proto(self) -> clientpb.BoundaryConditionsFluid:
        ...
        _proto.physical_boundary = enum.PhysicalBoundary.WALL.value
    ...
    def _from_proto(self, proto: clientpb.BoundaryConditionsFluid) -> None:
        ...
        assert proto.physical_boundary == enum.PhysicalBoundary.WALL.value
