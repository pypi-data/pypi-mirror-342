...
class VolumePhysicsRelationship(CodeRepr, ParamGroupWrapper[clientpb.VolumePhysicsRelationship]):
    ...
    def _from_proto(self, proto: clientpb.VolumePhysicsRelationship) -> None:
