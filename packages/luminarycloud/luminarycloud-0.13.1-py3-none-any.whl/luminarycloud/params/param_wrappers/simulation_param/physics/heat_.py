...
from luminarycloud.params.param_wrappers.simulation_param.physics.heat.adjoint_controls_heat_ import (
    AdjointControlsHeat,
)
from luminarycloud.params.param_wrappers.simulation_param.physics.heat.adjoint_controls_heat_ import *
from luminarycloud.params.param_wrappers.simulation_param.physics.heat.boundary_conditions_heat_ import (
    BoundaryConditionsHeat,
)
from luminarycloud.params.param_wrappers.simulation_param.physics.heat.boundary_conditions_heat_ import *
from luminarycloud.params.param_wrappers.simulation_param.physics.heat.boundary_conditions.heat_bc_convection_ import (
    HeatBcConvection,
)
from luminarycloud.params.param_wrappers.simulation_param.physics.heat.boundary_conditions.heat_bc_convection_ import *
from luminarycloud.params.param_wrappers.simulation_param.physics.heat.boundary_conditions.heat_bc_heat_flux_ import (
    HeatBcHeatFlux,
)
from luminarycloud.params.param_wrappers.simulation_param.physics.heat.boundary_conditions.heat_bc_heat_flux_ import *
from luminarycloud.params.param_wrappers.simulation_param.physics.heat.boundary_conditions.heat_bc_integrated_heat_flux_ import (
    HeatBcIntegratedHeatFlux,
)
from luminarycloud.params.param_wrappers.simulation_param.physics.heat.boundary_conditions.heat_bc_integrated_heat_flux_ import *
from luminarycloud.params.param_wrappers.simulation_param.physics.heat.boundary_conditions.heat_bc_symmetry_ import (
    HeatBcSymmetry,
)
from luminarycloud.params.param_wrappers.simulation_param.physics.heat.boundary_conditions.heat_bc_symmetry_ import *
from luminarycloud.params.param_wrappers.simulation_param.physics.heat.boundary_conditions.heat_bc_temperature_ import (
    HeatBcTemperature,
)
from luminarycloud.params.param_wrappers.simulation_param.physics.heat.boundary_conditions.heat_bc_temperature_ import *
from luminarycloud.params.param_wrappers.simulation_param.physics.heat.initialization.heat_existing_solution_ import (
    HeatExistingSolution,
)
from luminarycloud.params.param_wrappers.simulation_param.physics.heat.initialization.heat_existing_solution_ import *
from luminarycloud.params.param_wrappers.simulation_param.physics.heat.initialization.heat_prescribed_values_ import (
    HeatPrescribedValues,
)
from luminarycloud.params.param_wrappers.simulation_param.physics.heat.initialization.heat_prescribed_values_ import *
from luminarycloud.params.param_wrappers.simulation_param.physics.heat.heat_source_ import (
    HeatSource,
)
from luminarycloud.params.param_wrappers.simulation_param.physics.heat.heat_source_ import *
from luminarycloud.params.param_wrappers.simulation_param.physics.heat.initialization_heat_ import (
    InitializationHeat,
)
from luminarycloud.params.param_wrappers.simulation_param.physics.heat.initialization_heat_ import *
...
from luminarycloud.params.param_wrappers.simulation_param.sliding_interfaces_ import *
from luminarycloud.params.param_wrappers.simulation_param.physics.heat.solution_controls_heat_ import (
    SolutionControlsHeat,
)
from luminarycloud.params.param_wrappers.simulation_param.physics.heat.solution_controls_heat_ import *
from luminarycloud.params.param_wrappers.simulation_param.physics.heat.spatial_discretization_heat_ import (
...
class Heat(CodeRepr, ParamGroupWrapper[clientpb.Heat]):
    ...
    solution_controls: Optional[SolutionControlsHeat] = field(default_factory=SolutionControlsHeat)
    "Solution controls for a heat transfer physics solver."
    adjoint_controls: Optional[AdjointControlsHeat] = field(default_factory=AdjointControlsHeat)
    ""
    spatial_discretization: Optional[SpatialDiscretizationHeat] = field(
    ...
    initialization: Optional[InitializationHeat] = field(default_factory=HeatPrescribedValues)
