...
class HeatExistingSolution(InitializationHeat):
    ...
    def _to_proto(self) -> clientpb.InitializationHeat:
        ...
        _proto.initialization_type = enum.InitializationType.EXISTING_SOLUTION.value
    ...
    def _from_proto(self, proto: clientpb.InitializationHeat) -> None:
        ...
        assert proto.initialization_type == enum.InitializationType.EXISTING_SOLUTION.value
