...
class Project(ProtoWrapperBase):
    ...
    def create_hex_mesh(self, file_path: PathLike | str, params: hexmeshpb.HexMeshSpec) -> "Mesh":
        """
        ...
        file_meta = util.get_file_metadata(file_path)
        ...
        params.file_url = finish_res.url
