...
class Shrinkwrap(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["body", b"body", "mode", b"mode", "resolution_max", b"resolution_max", "resolution_min", b"resolution_min", "resolution_uniform", b"resolution_uniform"]) -> None: ...
