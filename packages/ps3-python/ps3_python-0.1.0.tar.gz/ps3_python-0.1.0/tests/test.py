...
# Load HF model
vision_model = PS3VisionModel.from_pretrained("/home/baifengs/baifengs/projects/open_clip/hf_ckpt/250123_1112").cuda()
text_model = PS3TextModel.from_pretrained("/home/baifengs/baifengs/projects/open_clip/hf_ckpt/250123_1112").cuda()
# model = PS3Model.from_pretrained("/home/baifengs/baifengs/projects/open_clip/hf_ckpt/250123_1112").cuda()
processor = PS3ImageProcessor.from_pretrained("/home/baifengs/baifengs/projects/open_clip/hf_ckpt/250123_1112")
tokenizer = PS3Tokenizer.from_pretrained("/home/baifengs/baifengs/projects/open_clip/hf_ckpt/250123_1112")
...
openclip_model, openclip_processor = create_model_from_pretrained("ViT-SO400M-14-SigLIP-384-S3-1536-2560token-nonlinear_proj-kvcache-separate_pos_emb-highdim_highres_select", 
                                                                  "/home/baifengs/baifengs/projects/open_clip/output/250123_1112/checkpoints/epoch_latest.pt", load_weights_only=False)
...
print([torch.allclose(a, b) for a, b in zip(out, openclip_out)])
