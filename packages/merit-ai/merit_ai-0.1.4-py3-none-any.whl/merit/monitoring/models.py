...
class LLMInteraction(BaseInteraction):
    ...
    def __init__(self, 
        ...
        Args:
            ...
            timestamp: Timestamp for the interaction (will be applied to request if creating new)
        ...
        if request is not None and response is not None:
            ...
            # Apply timestamp to request if provided
            ...
            if metadata is not None:
                if not self.request.metadata:
                    self.request.metadata = {}
                self.request.metadata.update(metadata)
