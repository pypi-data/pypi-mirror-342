    ...
    def _calculate_embedding_similarities(self, claims, document_content):
        ...
        try:
            ...
            try:
                ...
                logger.warning(f"Error getting document embedding: {str(e)}")
                return None
            ...
            for claim in claims:
                try:
                    ...
                    logger.warning(f"Error processing claim '{claim_text[:50]}...': {str(e)}")
                    # Add the claim with a default similarity of 0
                    similarity_scores.append({
                        "claim": claim_text,
                        "similarity": 0.0,
                        "supported_by_embedding": False,
                        "error": str(e)
                    })
            ...
            logger.warning(f"Error calculating embedding similarities: {str(e)}")
            return None
