...
layer_label = LAYER.BB_parameter
...
def xs_metal(
    ...
    **kwargs,
    ...
    Will use a signal track for ports. This is important to remember for GS tracks!
    ...
    sections = []
    sections.append(gf.Section(layer=LAYER.M1, width=total_width))
...
@xsection
def DC(section_width: float = TECH.width_m1, **kwargs) -> gf.CrossSection:
    """HHI metal tracks for DC routing.

    Args:
        section_width: width of the metal tracks

    """
    return xs_metal(section_width=section_width, **kwargs)


@xsection
def GS(
    section_width: tuple[float, ...] = (150, 150), gap: float = 24, radius=500, **kwargs
) -> gf.CrossSection:
...
@xsection
def GSG_ground(section_width=100.0, radius=500, **kwargs) -> gf.CrossSection:
    return xs_metal(section_width=section_width, radius=radius, **kwargs)


@xsection
def GSG_signal(section_width=60.0, radius=500, **kwargs) -> gf.CrossSection:
    return xs_metal(section_width=section_width, radius=radius, **kwargs)


@xsection
def GS_ground(section_width=150.0, radius=500, **kwargs) -> gf.CrossSection:
    return xs_metal(section_width=section_width, radius=radius, **kwargs)


@xsection
def GS_signal(section_width=150.0, radius=500, **kwargs) -> gf.CrossSection:
    return xs_metal(section_width=section_width, radius=radius, **kwargs)


@xsection
def RF(section_width=100.0, radius=500, **kwargs) -> gf.CrossSection:
    return xs_metal(section_width=section_width, radius=radius, **kwargs)


@xsection
def RF_ground(section_width=150.0, radius=500, **kwargs) -> gf.CrossSection:
    return xs_metal(section_width=section_width, radius=radius, **kwargs)


@xsection
def RF_signal(section_width=150.0, radius=500, **kwargs) -> gf.CrossSection:
    return xs_metal(section_width=section_width, radius=radius, **kwargs)
...
route_bundle_gs = partial(gf.routing.route_bundle, cross_section="GS", auto_taper=False)
route_bundle_gsg = partial(
    gf.routing.route_bundle, cross_section="GSG", auto_taper=False
)
route_bundle_rf = partial(gf.routing.route_bundle, cross_section="RF", auto_taper=False)

route_bundle_sbend_e200 = partial(
    gf.routing.route_bundle_sbend, cross_section="E200", bend_s="sbend_bezier"
)
route_bundle_sbend_e600 = partial(
    gf.routing.route_bundle_sbend, cross_section="E600", bend_s="sbend_bezier"
)
route_bundle_sbend_e1700 = partial(
    gf.routing.route_bundle_sbend, cross_section="E1700", bend_s="sbend_bezier"
)
route_bundle_sbend_dc = partial(
    gf.routing.route_bundle_sbend, cross_section="DC", bend_s="sbend_bezier"
)
route_bundle_sbend_gs = partial(
    gf.routing.route_bundle_sbend, cross_section="GS", bend_s="sbend_bezier"
)
route_bundle_sbend_gsg = partial(
    gf.routing.route_bundle_sbend, cross_section="GSG", bend_s="sbend_bezier"
)
route_bundle_sbend_rf = partial(
    gf.routing.route_bundle_sbend, cross_section="RF", bend_s="sbend_bezier"
)
...
routing_strategies = dict(
    ...
    route_bundle_sbend_rf=route_bundle_sbend_rf,
    route_bundle=route_bundle_e1700,
)
