...
class MCPClient:
    ...
    async def _connect_to_server(self, server_name, *args, debug_list_tools:bool=False):
    ...
    async def connect_to_stdio_server(self, server_name:str, command:str, *args: str, env:dict=None, debug_list_tools=False):
        ...
        return await self._connect_to_server(server_name, *stdio_transport, debug_list_tools=debug_list_tools)
