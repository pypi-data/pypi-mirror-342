...
mod.add_function('Slice_x509_PolicyMapping_CTor', retval('int64_t'), [])
mod.add_function('Slice_x509_PolicyMapping_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('Slice_x509_PolicyMapping_elem', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'idx')])
mod.add_function('Slice_x509_PolicyMapping_subslice', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'st'), param('int', 'ed')])
mod.add_function('Slice_x509_PolicyMapping_set', None, [param('int64_t', 'handle'), param('int', 'idx'), param('int64_t', 'value')])
mod.add_function('Slice_x509_PolicyMapping_append', None, [param('int64_t', 'handle'), param('int64_t', 'value')])
...
mod.add_function('client_TLSBoundRoundTripper_ExpectedPublicKey_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('client_TLSBoundRoundTripper_ExpectedPublicKey_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
...
mod.add_function('client_GroundTruth_PublicKey_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('client_GroundTruth_PublicKey_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
