...
//
extern long long int Slice_x509_OID_CTor();
extern GoInt Slice_x509_OID_len(long long int handle);
extern long long int Slice_x509_OID_elem(long long int handle, GoInt _idx);
extern long long int Slice_x509_OID_subslice(long long int handle, GoInt _st, GoInt _ed);
extern void Slice_x509_OID_set(long long int handle, GoInt _idx, long long int _vl);
extern void Slice_x509_OID_append(long long int handle, long long int _vl);

// --- wrapping slice: []x509.PolicyMapping ---
//
extern long long int Slice_x509_PolicyMapping_CTor();
extern GoInt Slice_x509_PolicyMapping_len(long long int handle);
extern long long int Slice_x509_PolicyMapping_elem(long long int handle, GoInt _idx);
extern long long int Slice_x509_PolicyMapping_subslice(long long int handle, GoInt _st, GoInt _ed);
extern void Slice_x509_PolicyMapping_set(long long int handle, GoInt _idx, long long int _vl);
extern void Slice_x509_PolicyMapping_append(long long int handle, long long int _vl);
...
//
extern long long int client_Response_CTor();
extern char* client_Response_Status_Get(long long int handle);
extern void client_Response_Status_Set(long long int handle, char* val);
extern long long int client_Response_StatusCode_Get(long long int handle);
extern void client_Response_StatusCode_Set(long long int handle, long long int val);
extern long long int client_Response_Body_Get(long long int handle);
extern void client_Response_Body_Set(long long int handle, long long int val);

// --- wrapping struct: client.SecureClient ---
//
extern long long int client_SecureClient_CTor();
extern long long int client_SecureClient_GroundTruth(long long int _handle);
extern long long int client_SecureClient_Verify(long long int _handle);
extern long long int client_SecureClient_HTTPClient(long long int _handle);
extern long long int client_SecureClient_Post(long long int _handle, char* url, long long int headers, long long int body);
extern long long int client_SecureClient_Get(long long int _handle, char* url, long long int headers);

// --- wrapping struct: client.TLSBoundRoundTripper ---
//
extern long long int client_TLSBoundRoundTripper_CTor();
extern char* client_TLSBoundRoundTripper_ExpectedPublicKey_Get(long long int handle);
extern void client_TLSBoundRoundTripper_ExpectedPublicKey_Set(long long int handle, char* val);
extern long long int client_TLSBoundRoundTripper_RoundTrip(long long int _handle, long long int r);

// --- wrapping struct: client.GroundTruth ---
//
extern long long int client_GroundTruth_CTor();
extern char* client_GroundTruth_PublicKey_Get(long long int handle);
extern void client_GroundTruth_PublicKey_Set(long long int handle, char* val);
extern char* client_GroundTruth_Digest_Get(long long int handle);
extern void client_GroundTruth_Digest_Set(long long int handle, char* val);
extern char* client_GroundTruth_Measurement_Get(long long int handle);
extern void client_GroundTruth_Measurement_Set(long long int handle, char* val);
extern long long int client_NewSecureClient(char* enclave, char* repo);
