...
bstack111l1l111l1_opy_ = 1000
bstack111l11ll111_opy_ = 2
class bstack111l11llll1_opy_:
    def __init__(self, handler, bstack111l1l1111l_opy_=bstack111l1l111l1_opy_, bstack111l11lll1l_opy_=bstack111l11ll111_opy_):
        self.queue = []
    ...
    def bstack111l1l11111_opy_(self):
        try:
            ...
            logger.debug(bstack11111ll_opy_ (u"ࠧ࡜ࡵࡷࡳࡵࡥࡴࡪ࡯ࡨࡶࡢࠦࡅࡹࡥࡨࡴࡹ࡯࡯࡯࠼ࠣࠫᵞ") + (str(e) or bstack11111ll_opy_ (u"ࠣࡇࡻࡧࡪࡶࡴࡪࡱࡱࠤࡨࡵࡵ࡭ࡦࠣࡲࡴࡺࠠࡣࡧࠣࡧࡴࡴࡶࡦࡴࡷࡩࡩࠦࡴࡰࠢࡶࡸࡷ࡯࡮ࡨࠤᵟ")))
        finally:
            self.timer = None
    ...
    def add(self, event):
        with self.lock:
            ...
            if len(self.queue) >= self.bstack111l1l1111l_opy_:
                threading.Thread(target=self.bstack111l11ll1ll_opy_).start()
    def bstack111l11ll1ll_opy_(self, source = bstack11111ll_opy_ (u"ࠩࠪᵠ")):
        with self.lock:
            if not self.queue:
                self.bstack111l11ll11l_opy_()
                return
            data = self.queue[:self.bstack111l1l1111l_opy_]
            del self.queue[:self.bstack111l1l1111l_opy_]
        self.handler(data)
        if source != bstack11111ll_opy_ (u"ࠪࡷ࡭ࡻࡴࡥࡱࡺࡲࠬᵡ"):
            self.bstack111l11ll11l_opy_()
    def shutdown(self):
        self.bstack111l1l11111_opy_()
        while self.queue:
            self.bstack111l11ll1ll_opy_(source=bstack11111ll_opy_ (u"ࠫࡸ࡮ࡵࡵࡦࡲࡻࡳ࠭ᵢ"))