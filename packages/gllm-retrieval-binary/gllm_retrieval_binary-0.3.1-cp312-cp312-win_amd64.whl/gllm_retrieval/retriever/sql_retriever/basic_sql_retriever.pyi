...
class BasicSQLRetriever(BaseSQLRetriever):
    ...
    logger: Incomplete
    def __init__(self, sql_data_store: BaseSQLDataStore, lm_request_processor: LMRequestProcessor | None = None, extract_func: Callable[[str | list[str] | dict[str, str | list[str]]], str | list[str]] = None, max_retries: int = 0) -> None:
