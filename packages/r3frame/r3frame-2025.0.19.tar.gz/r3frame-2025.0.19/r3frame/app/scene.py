...
from r3frame.app.rsrc import Tilemap
from r3frame.game import StaticPartition
...
class Scene:
    def __init__(
        ...
        self.world_cellsize: list[int] = world_cellsize
