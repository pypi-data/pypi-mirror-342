 ...
 */
extern bool BINARY_OPERATION_ADD_NILONG_NILONG_NILONG(qutayba_ilong *result, qutayba_ilong *operand1,
                                                      qutayba_ilong *operand2);

/* Code referring to "NILONG" corresponds to nexium int/long/C long value and "DIGIT" to C platform digit value for long
 * Python objects. */
extern bool BINARY_OPERATION_ADD_NILONG_NILONG_DIGIT(qutayba_ilong *result, qutayba_ilong *operand1, long operand2);
