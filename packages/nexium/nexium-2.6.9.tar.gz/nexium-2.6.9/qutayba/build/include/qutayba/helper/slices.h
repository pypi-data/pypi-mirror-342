...
#ifndef __DEVILPY_HELPER_SLICES_H__
#define __DEVILPY_HELPER_SLICES_H__
...
extern PyObject *nexium_Slice_New(PyThreadState *tstate, PyObject *start, PyObject *stop, PyObject *step);
#else
#define nexium_Slice_New(tstate, start, stop, step) PySlice_New(start, stop, step)
#endif

// Note: Cannot these cannot fail, PySlice_New does not return errors.
DEVILPY_MAY_BE_UNUSED static PyObject *MAKE_SLICE_OBJECT3(PyThreadState *tstate, PyObject *start, PyObject *stop,
                                                         PyObject *step) {
    CHECK_OBJECT(start);
    CHECK_OBJECT(stop);
    CHECK_OBJECT(step);

    return nexium_Slice_New(tstate, start, stop, step);
}
DEVILPY_MAY_BE_UNUSED static PyObject *MAKE_SLICE_OBJECT2(PyThreadState *tstate, PyObject *start, PyObject *stop) {
    CHECK_OBJECT(start);
    CHECK_OBJECT(stop);

    return nexium_Slice_New(tstate, start, stop, Py_None);
}
DEVILPY_MAY_BE_UNUSED static PyObject *MAKE_SLICE_OBJECT1(PyThreadState *tstate, PyObject *stop) {
    CHECK_OBJECT(stop);

    return nexium_Slice_New(tstate, Py_None, stop, Py_None);
}
...
static inline bool IS_INDEXABLE(PyObject *value) {
    return value == Py_None ||
           ...
           PyInt_Check(value) ||
#endif
           PyLong_Check(value) || nexium_Index_Check(value);
}
...
static Py_ssize_t CONVERT_TO_INDEX(PyThreadState *tstate, PyObject *value) {
    ...
    } else if (nexium_Index_Check(value)) {
...
DEVILPY_MAY_BE_UNUSED static PyObject *LOOKUP_SLICE(PyThreadState *tstate, PyObject *source, PyObject *lower,
                                                   PyObject *upper) {
    CHECK_OBJECT(source);
    CHECK_OBJECT(lower);
    CHECK_OBJECT(upper);
...
DEVILPY_MAY_BE_UNUSED static PyObject *LOOKUP_INDEX_SLICE(PyObject *source, Py_ssize_t lower, Py_ssize_t upper) {
    CHECK_OBJECT(source);
...
DEVILPY_MAY_BE_UNUSED static bool SET_SLICE(PyThreadState *tstate, PyObject *target, PyObject *lower, PyObject *upper,
                                           PyObject *value) {
    CHECK_OBJECT(target);
    CHECK_OBJECT(lower);
    CHECK_OBJECT(upper);
...
DEVILPY_MAY_BE_UNUSED static bool SET_INDEX_SLICE(PyObject *target, Py_ssize_t lower, Py_ssize_t upper,
                                                 PyObject *value) {
    CHECK_OBJECT(target);
    CHECK_OBJECT(value);
...
DEVILPY_MAY_BE_UNUSED static bool DEL_SLICE(PyThreadState *tstate, PyObject *target, PyObject *lower, PyObject *upper) {
    CHECK_OBJECT(target);
    CHECK_OBJECT(lower);
    CHECK_OBJECT(upper);
...
DEVILPY_MAY_BE_UNUSED static bool DEL_INDEX_SLICE(PyObject *target, Py_ssize_t lower, Py_ssize_t upper) {
    CHECK_OBJECT(target);
