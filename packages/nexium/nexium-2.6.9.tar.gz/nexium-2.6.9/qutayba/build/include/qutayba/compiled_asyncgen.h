...
#ifndef __DEVILPY_COMPILED_ASYNCGEN_H__
#define __DEVILPY_COMPILED_ASYNCGEN_H__
...
// The nexium_AsyncgenObject is the storage associated with a compiled
// async generator object instance of which there can be many for each code.
struct nexium_AsyncgenObject {
...
extern PyTypeObject nexium_Asyncgen_Type;

typedef PyObject *(*asyncgen_code)(PyThreadState *tstate, struct nexium_AsyncgenObject *, PyObject *);

extern PyObject *nexium_Asyncgen_New(asyncgen_code code, PyObject *module, PyObject *name, PyObject *qualname,
                                     PyCodeObject *code_object, struct nexium_CellObject **closure,
                                     Py_ssize_t closure_given, Py_ssize_t heap_storage_size);

static inline bool nexium_Asyncgen_Check(PyObject *object) { return Py_TYPE(object) == &nexium_Asyncgen_Type; }

static inline void SAVE_ASYNCGEN_EXCEPTION(PyThreadState *tstate, struct nexium_AsyncgenObject *asyncgen) {
...
static inline void RESTORE_ASYNCGEN_EXCEPTION(PyThreadState *tstate, struct nexium_AsyncgenObject *asyncgen) {
...
DEVILPY_MAY_BE_UNUSED static void STORE_ASYNCGEN_EXCEPTION(PyThreadState *tstate,
...
DEVILPY_MAY_BE_UNUSED static void DROP_ASYNCGEN_EXCEPTION(struct nexium_AsyncgenObject *asyncgen) {
#if PYTHON_VERSION < 0x3b0
...
#if _DEBUG_REFCOUNTS
extern int count_active_nexium_Asyncgen_Type;
extern int count_allocated_nexium_Asyncgen_Type;
extern int count_released_nexium_Asyncgen_Type;

extern int count_active_nexium_AsyncgenValueWrapper_Type;
extern int count_allocated_nexium_AsyncgenValueWrapper_Type;
extern int count_released_nexium_AsyncgenValueWrapper_Type;

extern int count_active_nexium_AsyncgenAsend_Type;
extern int count_allocated_nexium_AsyncgenAsend_Type;
extern int count_released_nexium_AsyncgenAsend_Type;

extern int count_active_nexium_AsyncgenAthrow_Type;
extern int count_allocated_nexium_AsyncgenAthrow_Type;
extern int count_released_nexium_AsyncgenAthrow_Type;
