...
#ifndef __DEVILPY_FILESYSTEM_PATH_OPS_H__
#define __DEVILPY_FILESYSTEM_PATH_OPS_H__
...
#define nexium_String_FromFilename(filename) nexiumUnicode_FromWideChar(filename, -1)
#else
...
#define nexium_String_FromFilename nexium_String_FromString
#endif
