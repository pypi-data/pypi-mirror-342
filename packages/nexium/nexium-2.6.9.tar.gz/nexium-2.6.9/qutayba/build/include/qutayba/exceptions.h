...
#ifndef __DEVILPY_EXCEPTIONS_H__
#define __DEVILPY_EXCEPTIONS_H__
...
#include "qutayba/checkers.h"
#include "qutayba/constants.h"
#include "qutayba/printing.h"

// Did an error occur.
DEVILPY_MAY_BE_UNUSED static inline bool HAS_ERROR_OCCURRED(PyThreadState const *tstate) {
...
DEVILPY_MAY_BE_UNUSED static inline PyObject *GET_ERROR_OCCURRED(PyThreadState const *const tstate) {
#if PYTHON_VERSION < 0x3c0
...
DEVILPY_MAY_BE_UNUSED static inline void ASSERT_NORMALIZED_EXCEPTION_VALUE_X(PyObject const *const exception_value) {
...
DEVILPY_MAY_BE_UNUSED static inline void ASSERT_NORMALIZED_EXCEPTION_VALUE(PyObject *exception_value) {
...
DEVILPY_MAY_BE_UNUSED static inline void CLEAR_ERROR_OCCURRED(PyThreadState *tstate) {
#if PYTHON_VERSION < 0x3c0
...
DEVILPY_MAY_BE_UNUSED static inline bool DROP_ERROR_OCCURRED(PyThreadState *tstate) {
...
DEVILPY_MAY_BE_UNUSED static void FETCH_ERROR_OCCURRED(PyThreadState *tstate, PyObject **exception_type,
...
DEVILPY_MAY_BE_UNUSED static void FETCH_ERROR_OCCURRED_UNTRACED(PyThreadState *tstate, PyObject **exception_type,
                                                               PyObject **exception_value,
                                                               PyTracebackObject **exception_traceback) {
    *exception_type = tstate->curexc_type;
    *exception_value = tstate->curexc_value;
...
DEVILPY_MAY_BE_UNUSED static void RESTORE_ERROR_OCCURRED(PyThreadState *tstate, PyObject *exception_type,
                                                        PyObject *exception_value,
                                                        PyTracebackObject *exception_traceback) {
...
DEVILPY_MAY_BE_UNUSED static void RESTORE_ERROR_OCCURRED_UNTRACED(PyThreadState *tstate, PyObject *exception_type,
                                                                 PyObject *exception_value,
                                                                 PyTracebackObject *exception_traceback) {
    PyObject *old_exception_type = tstate->curexc_type;
    PyObject *old_exception_value = tstate->curexc_value;
...
extern PyTracebackObject *MAKE_TRACEBACK(struct nexium_FrameObject *frame, int lineno);

// Add a frame to an existing exception trace-back.
DEVILPY_MAY_BE_UNUSED static PyTracebackObject *ADD_TRACEBACK(PyTracebackObject *exception_tb,
                                                             struct nexium_FrameObject *frame, int lineno) {
...
struct nexium_ExceptionStackItem {
...
static const struct nexium_ExceptionStackItem nexium_ExceptionStackItem_Empty = {NULL, NULL, NULL};
#else
#define nexium_ExceptionStackItem_Empty                                                                                \
    (struct nexium_ExceptionStackItem) { .exception_type = NULL, .exception_value = NULL, .exception_tb = NULL }
#endif
#else
struct nexium_ExceptionStackItem {
    PyObject *exception_value;
...
#if defined(__cplusplus)
static const struct nexium_ExceptionStackItem nexium_ExceptionStackItem_Empty = {NULL};
#else
#define nexium_ExceptionStackItem_Empty                                                                                \
    (struct nexium_ExceptionStackItem) { .exception_value = NULL }
#endif

#endif

// Helper that gets the current thread exception, for use in exception handlers
DEVILPY_MAY_BE_UNUSED inline static struct nexium_ExceptionStackItem GET_CURRENT_EXCEPTION(PyThreadState *tstate) {
    struct nexium_ExceptionStackItem result;
#if PYTHON_VERSION < 0x3b0
...
#if PYTHON_VERSION < 0x300 && !defined(_DEVILPY_EXPERIMENTAL_DISABLE_SYS_EXC_VARS)
#define _DEVILPY_MAINTAIN_SYS_EXC_VARS 1
#endif

// Helper that sets the current thread exception, releasing the current one, for
// use in this file only.
DEVILPY_MAY_BE_UNUSED inline static void SET_CURRENT_EXCEPTION(PyThreadState *tstate,
                                                              struct nexium_ExceptionStackItem *exc_state) {
#if PYTHON_VERSION < 0x3b0
...
DEVILPY_MAY_BE_UNUSED static inline void NORMALIZE_EXCEPTION(PyThreadState *tstate, PyObject **exception_type,
                                                            PyObject **exception_value,
                                                            PyTracebackObject **exception_tb);
...
DEVILPY_MAY_BE_UNUSED inline static void SET_CURRENT_EXCEPTION_TYPE0(PyThreadState *tstate, PyObject *exception_type) {
...
DEVILPY_MAY_BE_UNUSED inline static void
...
DEVILPY_MAY_BE_UNUSED inline static void SET_CURRENT_EXCEPTION_TYPE0_STR(PyThreadState *tstate, PyObject *exception_type,
                                                                        char const *value) {
    PyObject *exception_value = nexium_String_FromString(value);
...
DEVILPY_MAY_BE_UNUSED static inline void PRESERVE_FRAME_EXCEPTION(PyThreadState *tstate,
...
DEVILPY_MAY_BE_UNUSED static inline void RESTORE_FRAME_EXCEPTION(PyThreadState *tstate,
                                                                struct nexium_FrameObject *frame_object) {
    PyFrameObject *frame = (PyFrameObject *)frame_object;
...
#else
DEVILPY_MAY_BE_UNUSED static inline void ATTACH_TRACEBACK_TO_EXCEPTION_VALUE(PyObject *exception_value,
                                                                            PyTracebackObject *exception_tb) {
    CHECK_OBJECT(exception_value);
...
DEVILPY_MAY_BE_UNUSED static inline PyTracebackObject *GET_EXCEPTION_TRACEBACK(PyObject *exception_value) {
    CHECK_OBJECT(exception_value);
    assert(PyExceptionInstance_Check(exception_value));
...
DEVILPY_MAY_BE_UNUSED static bool EXCEPTION_MATCH_BOOL_SINGLE(PyThreadState *tstate, PyObject *exception_value,
                                                             PyObject *exception_checked);

DEVILPY_MAY_BE_UNUSED static bool _CHECK_AND_CLEAR_EXCEPTION_OCCURRED(PyThreadState *tstate, PyObject *exception_type) {
#if PYTHON_VERSION < 0x3c0
...
*/
DEVILPY_MAY_BE_UNUSED static bool CHECK_AND_CLEAR_STOP_ITERATION_OCCURRED(PyThreadState *tstate) {
...
*/
DEVILPY_MAY_BE_UNUSED static bool CHECK_AND_CLEAR_KEY_ERROR_OCCURRED(PyThreadState *tstate) {
    return _CHECK_AND_CLEAR_EXCEPTION_OCCURRED(tstate, PyExc_KeyError);
}

DEVILPY_MAY_BE_UNUSED static bool CHECK_AND_CLEAR_ATTRIBUTE_ERROR_OCCURRED(PyThreadState *tstate) {
    return _CHECK_AND_CLEAR_EXCEPTION_OCCURRED(tstate, PyExc_AttributeError);
}

#if PYTHON_VERSION >= 0x3c0
DEVILPY_MAY_BE_UNUSED static PyObject *MAKE_TUPLE1(PyThreadState *tstate, PyObject *element1);

DEVILPY_MAY_BE_UNUSED static PyObject *MAKE_EXCEPTION_FROM_TYPE_ARG0(PyThreadState *tstate, PyObject *type,
                                                                    PyObject *arg) {
...
static const struct nexium_ExceptionPreservationItem Empty_nexium_ExceptionPreservationItem = {0};

// Fetch the current exception into state, transfers reference coming from tstate ownership. Old values are overwritten.
DEVILPY_MAY_BE_UNUSED static void FETCH_ERROR_OCCURRED_STATE(PyThreadState *tstate,
...
DEVILPY_MAY_BE_UNUSED static void
RESTORE_ERROR_OCCURRED_STATE(PyThreadState *tstate, struct nexium_ExceptionPreservationItem *exception_state) {
    RESTORE_ERROR_OCCURRED(tstate, exception_state->exception_type, exception_state->exception_value,
                           exception_state->exception_tb);
}

DEVILPY_MAY_BE_UNUSED static void
FETCH_ERROR_OCCURRED_STATE_UNTRACED(PyThreadState *tstate, struct nexium_ExceptionPreservationItem *exception_state) {
    FETCH_ERROR_OCCURRED_UNTRACED(tstate, &exception_state->exception_type, &exception_state->exception_value,
                                  &exception_state->exception_tb);
}

DEVILPY_MAY_BE_UNUSED static void
RESTORE_ERROR_OCCURRED_STATE_UNTRACED(PyThreadState *tstate, struct nexium_ExceptionPreservationItem *exception_state) {
    RESTORE_ERROR_OCCURRED_UNTRACED(tstate, exception_state->exception_type, exception_state->exception_value,
                                    exception_state->exception_tb);
}

DEVILPY_MAY_BE_UNUSED static void
ASSERT_SAME_EXCEPTION_STATE(struct nexium_ExceptionPreservationItem const *exception_state1,
                            struct nexium_ExceptionPreservationItem const *exception_state2) {
...
DEVILPY_MAY_BE_UNUSED static void
ASSERT_EMPTY_EXCEPTION_STATE(struct nexium_ExceptionPreservationItem const *exception_state) {
...
DEVILPY_MAY_BE_UNUSED static void INIT_ERROR_OCCURRED_STATE(struct nexium_ExceptionPreservationItem *exception_state) {
...
DEVILPY_MAY_BE_UNUSED static void
RELEASE_ERROR_OCCURRED_STATE(struct nexium_ExceptionPreservationItem *exception_state) {
...
DEVILPY_MAY_BE_UNUSED static void
RELEASE_ERROR_OCCURRED_STATE_X(struct nexium_ExceptionPreservationItem *exception_state) {
...
DEVILPY_MAY_BE_UNUSED static void SET_EXCEPTION_PRESERVATION_STATE_FROM_ARGS(
    PyThreadState *tstate, struct nexium_ExceptionPreservationItem *exception_state, PyObject *exception_type,
...
DEVILPY_MAY_BE_UNUSED static void
ASSIGN_ARGS_FROM_EXCEPTION_PRESERVATION_STATE(struct nexium_ExceptionPreservationItem *exception_state,
...
DEVILPY_MAY_BE_UNUSED static PyTracebackObject *
GET_EXCEPTION_STATE_TRACEBACK(struct nexium_ExceptionPreservationItem *exception_state) {
    return exception_state->exception_tb;
}

// Transfer ownership of the traceback to the exception state.
DEVILPY_MAY_BE_UNUSED static void SET_EXCEPTION_STATE_TRACEBACK(struct nexium_ExceptionPreservationItem *exception_state,
                                                               PyTracebackObject *exception_tb) {
    CHECK_OBJECT_X(exception_state->exception_tb);
    CHECK_OBJECT_X(exception_tb);
...
DEVILPY_MAY_BE_UNUSED static bool HAS_EXCEPTION_STATE(struct nexium_ExceptionPreservationItem const *exception_state) {
    return exception_state->exception_type != NULL;
}

DEVILPY_MAY_BE_UNUSED static bool
EXCEPTION_STATE_MATCH_BOOL_SINGLE(PyThreadState *tstate, struct nexium_ExceptionPreservationItem *exception_state,
                                  PyObject *exception_checked) {
    return EXCEPTION_MATCH_BOOL_SINGLE(tstate, exception_state->exception_type, exception_checked);
}

DEVILPY_MAY_BE_UNUSED inline static void
CHECK_EXCEPTION_STATE(struct nexium_ExceptionPreservationItem const *exception_state) {
    CHECK_OBJECT(exception_state->exception_type);
    CHECK_OBJECT_X(exception_state->exception_value);
    CHECK_OBJECT_X(exception_state->exception_tb);
}
...
DEVILPY_MAY_BE_UNUSED inline static void
CHECK_EXCEPTION_STATE_X(struct nexium_ExceptionPreservationItem const *exception_state) {
    CHECK_OBJECT_X(exception_state->exception_type);
    CHECK_OBJECT_X(exception_state->exception_value);
    CHECK_OBJECT_X(exception_state->exception_tb);
}
...
DEVILPY_MAY_BE_UNUSED static void
ASSERT_SAME_EXCEPTION_STATE(struct nexium_ExceptionPreservationItem *exception_state1,
                            struct nexium_ExceptionPreservationItem *exception_state2) {
    assert(exception_state1->exception_value == exception_state2->exception_value);
}
...
DEVILPY_MAY_BE_UNUSED static bool
EXCEPTION_STATE_MATCH_BOOL_SINGLE(PyThreadState *tstate, struct nexium_ExceptionPreservationItem const *exception_state,
                                  PyObject *exception_checked) {
...
DEVILPY_MAY_BE_UNUSED inline static void SET_EXCEPTION_PRESERVATION_STATE_FROM_TYPE0(
    PyThreadState *tstate, struct nexium_ExceptionPreservationItem *exception_state, PyObject *exception_type) {
...
#define SET_EXCEPTION_PRESERVATION_STATE_FROM_TYPE0_FORMAT1(tstate, exception_state, exception_type, message, arg1)    \
    {                                                                                                                  \
        PyObject *exception_value = nexium_String_FromFormat(message, arg1);                                           \
        CHECK_OBJECT(exception_value);                                                                                 \
        SET_EXCEPTION_PRESERVATION_STATE_FROM_TYPE0_VALUE1(tstate, exception_state, exception_type, exception_value);  \
    }
...
#define SET_EXCEPTION_PRESERVATION_STATE_FROM_TYPE0_FORMAT2(tstate, exception_state, exception_type, message, arg1,    \
                                                            arg2)                                                      \
    {                                                                                                                  \
        PyObject *exception_value = nexium_String_FromFormat(message, arg1, arg2);                                     \
        CHECK_OBJECT(exception_value);                                                                                 \
        SET_EXCEPTION_PRESERVATION_STATE_FROM_TYPE0_VALUE1(tstate, exception_state, exception_type, exception_value);  \
    }

DEVILPY_MAY_BE_UNUSED static bool EXCEPTION_MATCH_GENERATOR(PyThreadState *tstate, PyObject *exception_value) {
    CHECK_OBJECT(exception_value);
...
DEVILPY_MAY_BE_UNUSED static bool
EXCEPTION_STATE_MATCH_GENERATOR(PyThreadState *tstate, struct nexium_ExceptionPreservationItem *exception_state) {
#if PYTHON_VERSION < 0x3c0
...
DEVILPY_MAY_BE_UNUSED static bool EXCEPTION_MATCH_BOOL_SINGLE(PyThreadState *tstate, PyObject *exception_value,
    ...
    if (PyExceptionClass_Check(exception_value)) {
        ...
        return res == 1;
#else
        int res = nexium_Type_IsSubtype((PyTypeObject *)exception_value, (PyTypeObject *)exception_checked);
        return res == 1;
#endif
    }
...
DEVILPY_MAY_BE_UNUSED static inline int _EXCEPTION_MATCH_BOOL(PyThreadState *tstate, PyObject *exception_value,
                                                             PyObject *exception_checked) {
    CHECK_OBJECT(exception_value);
    CHECK_OBJECT(exception_checked);
...
#else
    if (PyExceptionClass_Check(exception_class) && PyExceptionClass_Check(exception_checked)) {
        return nexium_Type_IsSubtype((PyTypeObject *)exception_class, (PyTypeObject *)exception_checked);
    } else {
        return exception_class == exception_checked;
    }
#endif
...
DEVILPY_MAY_BE_UNUSED static inline int EXCEPTION_MATCH_BOOL(PyThreadState *tstate, PyObject *exception_value,
                                                            PyObject *exception_checked) {
    CHECK_OBJECT(exception_value);
    CHECK_OBJECT(exception_checked);
...
extern void nexium_Err_NormalizeException(PyThreadState *tstate, PyObject **exc, PyObject **val,
...
DEVILPY_MAY_BE_UNUSED static inline void NORMALIZE_EXCEPTION(PyThreadState *tstate, PyObject **exception_type,
    ...
    if (*exception_type != Py_None && *exception_type != NULL) {
        nexium_Err_NormalizeException(tstate, exception_type, exception_value, exception_tb);
    }
...
PUBLISH_CURRENT_EXCEPTION(PyThreadState *tstate, struct nexium_ExceptionPreservationItem *exception_state) {
#if _DEBUG_EXCEPTIONS
...
DEVILPY_MAY_BE_UNUSED static bool
_CHECK_AND_CLEAR_EXCEPTION_STATE(PyThreadState *tstate, struct nexium_ExceptionPreservationItem *exception_state,
                                 PyObject *exception_type) {
#if PYTHON_VERSION < 0x3c0
...
// its name.
DEVILPY_MAY_BE_UNUSED static bool
CHECK_AND_CLEAR_STOP_ITERATION_STATE(PyThreadState *tstate, struct nexium_ExceptionPreservationItem *exception_state) {
...
extern void FORMAT_UNBOUND_LOCAL_ERROR(PyThreadState *tstate, struct nexium_ExceptionPreservationItem *exception_state,
...
// reference.
DEVILPY_MAY_BE_UNUSED static inline PyObject *nexium_Exception_GetContext(PyObject *self) {
...
// consume a reference.
DEVILPY_MAY_BE_UNUSED static inline void nexium_Exception_SetContext(PyObject *self, PyObject *context) {
...
DEVILPY_MAY_BE_UNUSED static inline void nexium_Exception_DeleteContext(PyObject *self) {
...
DEVILPY_MAY_BE_UNUSED static inline void
ADD_EXCEPTION_CONTEXT(PyThreadState *tstate, struct nexium_ExceptionPreservationItem *exception_state) {
    ...
    if (context != NULL) {
        ...
        NORMALIZE_EXCEPTION_STATE(tstate, exception_state);
#endif
        nexium_Exception_SetContext(exception_state->exception_value, context);
    }
}
#endif

// Our replacement for "PyException_SetCause", consumes a reference.
DEVILPY_MAY_BE_UNUSED static inline void nexium_Exception_SetCause(PyObject *self, PyObject *cause) {
