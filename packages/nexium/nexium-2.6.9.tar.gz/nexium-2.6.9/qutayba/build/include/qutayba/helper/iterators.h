...
#ifndef __DEVILPY_HELPER_ITERATORS_H__
#define __DEVILPY_HELPER_ITERATORS_H__
...
DEVILPY_MAY_BE_UNUSED static inline bool HAS_ITERNEXT(PyObject *value) {
...
DEVILPY_MAY_BE_UNUSED static PyObject *MAKE_ITERATOR_INFALLIBLE(PyObject *iterated) {
    ...
    if (tp_iter) {
        ...
        seqiterobject *result = (seqiterobject *)nexium_GC_New(&PySeqIter_Type);
        assert(result);
...
DEVILPY_MAY_BE_UNUSED static PyObject *MAKE_ITERATOR(PyThreadState *tstate, PyObject *iterated) {
    CHECK_OBJECT(iterated);

#if _DEVILPY_EXPERIMENTAL_DISABLE_ITERATOR_OPT
...
DEVILPY_MAY_BE_UNUSED static PyObject *MAKE_UNPACK_ITERATOR(PyObject *iterated) {
    CHECK_OBJECT(iterated);
...
DEVILPY_MAY_BE_UNUSED static PyObject *ITERATOR_NEXT_ITERATOR(PyObject *iterator) {
...
DEVILPY_MAY_BE_UNUSED static PyObject *ITERATOR_NEXT(PyObject *iterator) {
    CHECK_OBJECT(iterator);
...
DEVILPY_MAY_BE_UNUSED static PyObject *BUILTIN_NEXT2(PyThreadState *tstate, PyObject *iterator,
...
DEVILPY_MAY_BE_UNUSED static PyObject *UNPACK_NEXT_INFALLIBLE(PyObject *iterator) {
    CHECK_OBJECT(iterator);
...
DEVILPY_MAY_BE_UNUSED static PyObject *UNPACK_NEXT(PyThreadState *tstate,
...
DEVILPY_MAY_BE_UNUSED static PyObject *UNPACK_NEXT_STARRED(PyThreadState *tstate,
                                                          struct nexium_ExceptionPreservationItem *exception_state,
                                                          PyObject *iterator, int seq_size_so_far, int expected) {
    CHECK_OBJECT(iterator);
    assert(HAS_ITERNEXT(iterator));
...
DEVILPY_MAY_BE_UNUSED static bool UNPACK_ITERATOR_CHECK(PyThreadState *tstate,
                                                       struct nexium_ExceptionPreservationItem *exception_state,
