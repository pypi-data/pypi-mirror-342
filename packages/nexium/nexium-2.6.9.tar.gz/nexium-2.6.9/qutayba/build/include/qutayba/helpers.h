...
#ifndef __DEVILPY_HELPERS_H__
#define __DEVILPY_HELPERS_H__
...
// For profiling of nexium compiled binaries
#if _DEVILPY_PROFILE
extern void startProfiling(void);
extern void stopProfiling(void);
#endif

#include "qutayba/helper/boolean.h"
#include "qutayba/helper/dictionaries.h"
#include "qutayba/helper/indexes.h"
#include "qutayba/helper/mappings.h"
#include "qutayba/helper/operations_builtin_types.h"
#include "qutayba/helper/sets.h"
#include "qutayba/helper/strings.h"

#include "qutayba/helper/raising.h"

#include "qutayba/helper/ints.h"
#include "qutayba/helper/richcomparisons.h"
#include "qutayba/helper/sequences.h"

static inline bool nexium_Function_Check(PyObject *object);
static inline PyObject *nexium_Function_GetName(PyObject *object);

static inline bool nexium_Generator_Check(PyObject *object);
static inline PyObject *nexium_Generator_GetName(PyObject *object);

#include "qutayba/calling.h"
#include "qutayba/helper/bytes.h"
#include "qutayba/helper/complex.h"
#include "qutayba/helper/floats.h"

DEVILPY_MAY_BE_UNUSED static PyObject *LOOKUP_VARS(PyThreadState *tstate, PyObject *source) {
    CHECK_OBJECT(source);
...
#include "qutayba/helper/attributes.h"
#include "qutayba/helper/bytearrays.h"
#include "qutayba/helper/iterators.h"
#include "qutayba/helper/lists.h"
#include "qutayba/helper/rangeobjects.h"
#include "qutayba/helper/slices.h"
#include "qutayba/helper/subscripts.h"
#include "qutayba/helper/tuples.h"

#include "qutayba/builtins.h"
...
qutayba_bool compareFilePaths(PyThreadState *tstate, PyObject *filename_a, PyObject *filename_b);
...
#include "qutayba/importing.h"

// Hard imports have their own helpers.
#include "qutayba/helper/import_hard.h"
...
#include "qutayba/constants_blob.h"
...
DEVILPY_MAY_BE_UNUSED static PyObject *MODULE_NAME1(PyThreadState *tstate, PyObject *module) {
...
DEVILPY_MAY_BE_UNUSED static PyObject *MODULE_NAME0(PyThreadState *tstate, PyObject *module) {
    assert(PyModule_Check(module));
    PyObject *module_dict = ((PyModuleObject *)module)->md_dict;
...
extern PyTypeObject *nexium_PyUnion_Type;

// Force a garbage collection, for debugging purposes.
DEVILPY_MAY_BE_UNUSED static void forceGC(void) {
...
extern void nexium_PyType_Ready(PyTypeObject *type, PyTypeObject *base, bool generic_get_attr, bool generic_set_attr,
                                bool self_iter, bool await_self_iter, bool self_aiter);

#if PYTHON_VERSION >= 0x3b0
#include "qutayba/exception_groups.h"
#endif

#if PYTHON_VERSION >= 0x3c0
#include "qutayba/type_aliases.h"
#endif
