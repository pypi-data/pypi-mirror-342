...
#ifndef __DEVILPY_COMPILED_GENERATOR_H__
#define __DEVILPY_COMPILED_GENERATOR_H__
...
// The nexium_GeneratorObject is the storage associated with a compiled
// generator object instance of which there can be many for each code.
struct nexium_GeneratorObject {
...
#if PYTHON_VERSION >= 0x300
    struct nexium_ExceptionStackItem m_resume_exception;
#endif
...
extern PyTypeObject nexium_Generator_Type;

typedef PyObject *(*generator_code)(PyThreadState *tstate, struct nexium_GeneratorObject *, PyObject *);

extern PyObject *nexium_Generator_New(generator_code code, PyObject *module, PyObject *name,
#if PYTHON_VERSION >= 0x350
                                      PyObject *qualname,
#endif
...
extern PyObject *nexium_Generator_NewEmpty(PyObject *module, PyObject *name,
#if PYTHON_VERSION >= 0x350
                                           PyObject *qualname,
#endif
                                           PyCodeObject *code_object, struct nexium_CellObject **closure,
...
extern PyObject *nexium_Generator_qiter(PyThreadState *tstate, struct nexium_GeneratorObject *generator,
                                        bool *finished);

static inline bool nexium_Generator_Check(PyObject *object) { return Py_TYPE(object) == &nexium_Generator_Type; }

static inline PyObject *nexium_Generator_GetName(PyObject *object) {
    return ((struct nexium_GeneratorObject *)object)->m_name;
}

static inline void SAVE_GENERATOR_EXCEPTION(PyThreadState *tstate, struct nexium_GeneratorObject *generator) {
...
static inline void RESTORE_GENERATOR_EXCEPTION(PyThreadState *tstate, struct nexium_GeneratorObject *generator) {
...
extern void nexium_PreserveHeap(void *dest, ...);
extern void nexium_RestoreHeap(void *source, ...);

DEVILPY_MAY_BE_UNUSED static void STORE_GENERATOR_EXCEPTION(PyThreadState *tstate,
...
DEVILPY_MAY_BE_UNUSED static void DROP_GENERATOR_EXCEPTION(struct nexium_GeneratorObject *generator) {
#if PYTHON_VERSION < 0x3b0
...
#if _DEBUG_REFCOUNTS
extern int count_active_nexium_Generator_Type;
extern int count_allocated_nexium_Generator_Type;
extern int count_released_nexium_Generator_Type;
#endif
