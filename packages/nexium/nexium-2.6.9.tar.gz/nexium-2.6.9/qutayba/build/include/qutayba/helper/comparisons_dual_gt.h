...
extern PyObject *RICH_COMPARE_GT_OBJECT_NILONG_CLONG(qutayba_ilong *operand1, long operand2);

/* Code referring to "NILONG" corresponds to nexium int/long/C long value and "CLONG" to C platform long value. */
extern bool RICH_COMPARE_GT_CBOOL_NILONG_CLONG(qutayba_ilong *operand1, long operand2);

/* Code referring to "NILONG" corresponds to nexium int/long/C long value and "DIGIT" to C platform digit value for long
 * Python objects. */
extern PyObject *RICH_COMPARE_GT_OBJECT_NILONG_DIGIT(qutayba_ilong *operand1, long operand2);

/* Code referring to "NILONG" corresponds to nexium int/long/C long value and "DIGIT" to C platform digit value for long
 * Python objects. */
extern bool RICH_COMPARE_GT_CBOOL_NILONG_DIGIT(qutayba_ilong *operand1, long operand2);
