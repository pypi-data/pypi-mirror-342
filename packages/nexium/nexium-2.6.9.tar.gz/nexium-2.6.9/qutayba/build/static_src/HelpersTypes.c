...
bool nexium_Type_IsSubtype(PyTypeObject *a, PyTypeObject *b) {
    CHECK_OBJECT(a);
    CHECK_OBJECT(b);
...
// TODO: We cannot really do this, until nexium_TypeLookup (_PyType_Lookup) is
...
#if 0
int nexium_Object_IsSubclass(PyThreadState *tstate, PyObject *derived, PyObject *cls)
{
    ...
    if (PyTuple_Check(cls)) {
        ...
        for (Py_ssize_t i = 0; i < n; ++i) {
            ...
            r = nexium_Object_IsSubclass(tstate, derived, item);
    ...
    PyObject *checker = nexium_TypeLookup((PyTypeObject *)cls, const_str_plain___subclasscheck__);
...
void nexium_PyType_Ready(PyTypeObject *type, PyTypeObject *base, bool generic_get_attr, bool generic_set_attr,
    ...
    DEVILPY_MAY_BE_UNUSED int res = PyType_Ready(type);
    assert(res >= 0);
}
...
PyObject *MAKE_TYPE_ALIAS(PyObject *name, PyObject *type_params, PyObject *value, PyObject *module_name) {
    ...
    typealiasobject *ta = nexium_GC_New(getTypeAliasType());
...
static typevarobject *_nexium_typevar_alloc(PyThreadState *tstate, PyObject *name, PyObject *bound,
    ...
    typevarobject *result = nexium_GC_New(tp);
...
PyObject *MAKE_TYPE_VAR(PyThreadState *tstate, PyObject *name) {
    ...
    return (PyObject *)_nexium_typevar_alloc(tstate, name, NULL, NULL, NULL, NULL, false, false, true, NULL);
}
...
static PyObject *_nexium_unpack_typevartuples(PyObject *params) {
...
PyObject *MAKE_TYPE_GENERIC(PyThreadState *tstate, PyObject *params) {
    CHECK_OBJECT(params);
    PyObject *unpacked_params = _nexium_unpack_typevartuples(params);
