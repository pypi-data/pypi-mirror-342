...
#if defined(_WIN32)
#if defined(_DEVILPY_ATTACH_CONSOLE_WINDOW)
#include <io.h>
...
#if !defined(DEVILPY_FORCED_STDERR_PATH) && !defined(DEVILPY_FORCED_STDERR_NONE_BOOL) &&                                 \
    !defined(DEVILPY_FORCED_STDERR_NULL_BOOL)
