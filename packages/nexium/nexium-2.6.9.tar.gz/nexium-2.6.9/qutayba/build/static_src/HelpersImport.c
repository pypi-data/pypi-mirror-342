 ...
 *
 * These make the actual built-in importing mechanic work with nexium. We
...
DEVILPY_DEFINE_BUILTIN(__import__);
...
PyObject *IMPORT_MODULE_KW(PyThreadState *tstate, PyObject *module_name, PyObject *globals, PyObject *locals,
    ...
    DEVILPY_ASSIGN_BUILTIN(__import__);

    PyObject *import_result = CALL_FUNCTION_WITH_KW_ARGS(tstate, DEVILPY_ACCESS_BUILTIN(__import__), kw_args);
...
PyObject *IMPORT_MODULE1(PyThreadState *tstate, PyObject *module_name) {
    ...
    PyObject *import_result = CALL_FUNCTION_WITH_SINGLE_ARG(tstate, DEVILPY_ACCESS_BUILTIN(__import__), module_name);
...
PyObject *IMPORT_MODULE2(PyThreadState *tstate, PyObject *module_name, PyObject *globals) {
    ...
    PyObject *import_result = CALL_FUNCTION_WITH_ARGS2(tstate, DEVILPY_ACCESS_BUILTIN(__import__), pos_args);
...
PyObject *IMPORT_MODULE3(PyThreadState *tstate, PyObject *module_name, PyObject *globals, PyObject *locals) {
    ...
    PyObject *import_result = CALL_FUNCTION_WITH_ARGS3(tstate, DEVILPY_ACCESS_BUILTIN(__import__), pos_args);
...
PyObject *IMPORT_MODULE4(PyThreadState *tstate, PyObject *module_name, PyObject *globals, PyObject *locals,
    ...
    PyObject *import_result = CALL_FUNCTION_WITH_ARGS4(tstate, DEVILPY_ACCESS_BUILTIN(__import__), pos_args);
...
PyObject *IMPORT_MODULE5(PyThreadState *tstate, PyObject *module_name, PyObject *globals, PyObject *locals,
    ...
    DEVILPY_ASSIGN_BUILTIN(__import__);
    PyObject *import_function = DEVILPY_ACCESS_BUILTIN(__import__);
...
PyObject *IMPORT_NAME_FROM_MODULE(PyThreadState *tstate, PyObject *module, PyObject *import_name) {
    ...
    if (unlikely(result == NULL)) {
        if (CHECK_AND_CLEAR_ATTRIBUTE_ERROR_OCCURRED(tstate)) {
            ...
            PyObject *filename = nexium_GetFilenameObject(tstate, module);
...
#elif PYTHON_VERSION >= 0x300 || !defined(_DEVILPY_FULL_COMPAT)
            PyErr_Format(PyExc_ImportError, "cannot import name '%s'", nexium_String_AsString(import_name));
#else
            PyErr_Format(PyExc_ImportError, "cannot import name %s", nexium_String_AsString(import_name));
#endif
        }
...
static PyObject *resolveParentModuleName(PyThreadState *tstate, PyObject *module, PyObject *name, int level) {
    ...
    if (package != NULL) {
        ...
        if (spec != NULL && spec != Py_None) {
            ...
            qutayba_bool nbool_equal = RICH_COMPARE_EQ_NBOOL_OBJECT_OBJECT(package, parent);

            Py_DECREF(parent);

            if (unlikely(nbool_equal == DEVILPY_BOOL_EXCEPTION)) {
                return NULL;
            }

            if (unlikely(nbool_equal == DEVILPY_BOOL_FALSE)) {
        ...
        if (EXCEPTION_MATCH_BOOL_SINGLE(tstate, GET_ERROR_OCCURRED(tstate), PyExc_AttributeError)) {
            ...
            if (level_int > 0) {
                ...
                if (result != NULL) {
                    ...
                    result = nexium_GetModule(tstate, name);
                }
...
PyObject *IMPORT_MODULE_FIXED(PyThreadState *tstate, PyObject *module_name, PyObject *value_name) {
    ...
    PyObject *result = nexium_GetModule(tstate, value_name);
