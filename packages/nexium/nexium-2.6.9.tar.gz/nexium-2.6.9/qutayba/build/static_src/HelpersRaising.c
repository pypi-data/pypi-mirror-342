...
static void FORMAT_TYPE_ERROR1(PyThreadState *tstate, struct nexium_ExceptionPreservationItem *exception_state,
                               char const *format, char const *arg) {
    PyObject *exception_value = nexium_String_FromFormat(format, arg);
...
static void FORMAT_TYPE_ERROR2(PyThreadState *tstate, struct nexium_ExceptionPreservationItem *exception_state,
                               char const *format, char const *arg1, char const *arg2) {
    PyObject *exception_value = nexium_String_FromFormat(format, arg1, arg2);
    CHECK_OBJECT(exception_value);
...
static void UNPACK_TUPLE_EXCEPTION_TYPE(struct nexium_ExceptionPreservationItem *exception_state) {
...
#if PYTHON_VERSION < 0x3c0
void RAISE_EXCEPTION_WITH_TYPE(PyThreadState *tstate, struct nexium_ExceptionPreservationItem *exception_state) {
...
void RAISE_EXCEPTION_WITH_VALUE(PyThreadState *tstate, struct nexium_ExceptionPreservationItem *exception_state) {
...
#if PYTHON_VERSION >= 0x300
void RAISE_EXCEPTION_WITH_CAUSE(PyThreadState *tstate, struct nexium_ExceptionPreservationItem *exception_state,
    ...
    if (PyExceptionClass_Check(exception_state->exception_type)) {
        ...
        nexium_Exception_SetCause(exception_state->exception_value, exception_cause);
        CHAIN_EXCEPTION(tstate, exception_state->exception_value);
    } else if (PyExceptionInstance_Check(exception_state->exception_type)) {
        exception_state->exception_value = exception_state->exception_type;
        exception_state->exception_type = PyExceptionInstance_Class(exception_state->exception_type);
...
#if PYTHON_VERSION < 0x300
void RAISE_EXCEPTION_WITH_TRACEBACK(PyThreadState *tstate, struct nexium_ExceptionPreservationItem *exception_state) {
...
bool RERAISE_EXCEPTION(PyThreadState *tstate, struct nexium_ExceptionPreservationItem *exception_state) {
...
void RAISE_CURRENT_EXCEPTION_NAME_ERROR(PyThreadState *tstate, struct nexium_ExceptionPreservationItem *exception_state,
                                        PyObject *variable_name) {
#if PYTHON_VERSION < 0x300
    PyObject *exception_value_str =
        nexium_String_FromFormat("name '%s' is not defined", nexium_String_AsString_Unchecked(variable_name));
#else
    PyObject *exception_value_str = nexium_String_FromFormat("name '%U' is not defined", variable_name);
#endif
...
void RAISE_CURRENT_EXCEPTION_GLOBAL_NAME_ERROR(PyThreadState *tstate,
                                               ...
                                               PyObject *variable_name) {
    PyObject *exception_value_str =
        nexium_String_FromFormat("global name '%s' is not defined", nexium_String_AsString_Unchecked(variable_name));
    PyObject *exception_value = MAKE_EXCEPTION_FROM_TYPE_ARG0(tstate, PyExc_NameError, exception_value_str);
    Py_DECREF(exception_value_str);
...
PyObject *MAKE_STOP_ITERATION_EMPTY(void) {
    ...
    return nexium_CreateStopIteration(NULL, NULL);
}
...
PyObject *MAKE_BASE_EXCEPTION_DERIVED_EMPTY(PyObject *exception_type) {
    ...
    // in args.
    PyBaseExceptionObject *result = nexium_BaseExceptionSingleArg_new(NULL, (PyTypeObject *)exception_type, NULL);
