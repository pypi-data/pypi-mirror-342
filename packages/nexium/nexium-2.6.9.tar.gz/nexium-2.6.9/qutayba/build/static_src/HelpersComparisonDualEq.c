 ...
 */
PyObject *RICH_COMPARE_EQ_OBJECT_NILONG_NILONG(qutayba_ilong *operand1, qutayba_ilong *operand2) {
...
/* Code referring to "NILONG" corresponds to nexium int/long/C long value and "NILONG" to nexium int/long/C long value.
 */
bool RICH_COMPARE_EQ_CBOOL_NILONG_NILONG(qutayba_ilong *operand1, qutayba_ilong *operand2) {
    CHECK_NILONG_OBJECT(operand1);
    CHECK_NILONG_OBJECT(operand2);
...
PyObject *RICH_COMPARE_EQ_OBJECT_NILONG_CLONG(qutayba_ilong *operand1, long operand2) {
    CHECK_NILONG_OBJECT(operand1);
...
/* Code referring to "NILONG" corresponds to nexium int/long/C long value and "CLONG" to C platform long value. */
bool RICH_COMPARE_EQ_CBOOL_NILONG_CLONG(qutayba_ilong *operand1, long operand2) {
    CHECK_NILONG_OBJECT(operand1);
 ...
 * Python objects. */
PyObject *RICH_COMPARE_EQ_OBJECT_NILONG_DIGIT(qutayba_ilong *operand1, long operand2) {
    CHECK_NILONG_OBJECT(operand1);
...
/* Code referring to "NILONG" corresponds to nexium int/long/C long value and "DIGIT" to C platform digit value for long
 * Python objects. */
bool RICH_COMPARE_EQ_CBOOL_NILONG_DIGIT(qutayba_ilong *operand1, long operand2) {
    CHECK_NILONG_OBJECT(operand1);
    assert(Py_ABS(operand2) < (1 << PyLong_SHIFT));
