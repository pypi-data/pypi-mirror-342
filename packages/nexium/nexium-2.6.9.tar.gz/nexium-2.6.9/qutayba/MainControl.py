...
from qutayba.Tracing import general, inclusion_logger, pgo_logger
...
from qutayba.utils.Importing import (
...
def _main():
    ...
    general.info(
        "Starting Python compilation with nexium %r on Python (flavor %s), %r commercial grade %r."
        % (
            getnexiumVersion(),
            getPythonFlavorName(),
            python_version_str,
