...
def list_notes(folder):
  ...
  all_folders_panel = Panel(folder_content, title="[bold blue]Folders[/bold blue]", expand=True)
  folder_panel = Panel(content, title=f"[bold blue]{folder}[/bold blue]", expand=True)
