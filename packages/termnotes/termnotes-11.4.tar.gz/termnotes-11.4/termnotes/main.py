...
def list_folders():
  ...
  inner_panel = Panel(content, title="[bold blue]Folders[/bold blue]", expand=True, width=console.width)  # Set width to console width
  empty_panel = Panel("Nothing open", title="", expand=True, width=console.width)  # Set width to console width

  inner_columns = Columns(
    [inner_panel, empty_panel],
    equal=True,
    expand=True,
    width=console.width  # Set width to console width
  )

  outer_panel = Panel(inner_columns, title="[spring_green1 bold]Termnotes[/spring_green1 bold]", width=console.width)  # Set width to console width
...
def list_notes(folder):
  ...
  all_folders_panel = Panel(folder_content, title="[bold blue]Folders[/bold blue]", expand=True, width=console.width)  # Customize title color 

  panel_title = f"[bold blue]{folder}[/bold blue]"  # Customize title color
  folder_panel = Panel(content, title=panel_title, expand=True, width=console.width)
  ...
  outer_panel = Panel(inner_columns, title="[spring_green1 bold]Termnotes[/spring_green1 bold]", width=console.width)
...
def read_note(folder, name):
  ...
  folder_panel = Panel(folder_content, title=folder_title, expand=True, width=console.width)  # Customize title color 

  note_panel = Panel("\n" + content, title=title, expand=True, width=console.width)
