...
from maleo_metadata.clients.http.controllers.user_type import MaleoMetadataUserTypeHTTPClientController
...
class MaleoMetadataUserTypeClientService:
    @staticmethod
    ...
    async def get_user_types(
        ...
        if controller_type == MaleoMetadataGeneralEnums.ClientControllerType.HTTP:
            controller_result = await MaleoMetadataUserTypeHTTPClientController.get_user_types(parameters=parameters)
        else:
            message = "Invalid controller type"
    ...
    async def get_user_type(
        ...
        if controller_type == MaleoMetadataGeneralEnums.ClientControllerType.HTTP:
            controller_result = await MaleoMetadataUserTypeHTTPClientController.get_user_type(parameters=parameters)
        else:
            message = "Invalid controller type"
            description = "The provided controller type has not been implemented"
            return MaleoMetadataUserTypeGeneralResultsTransfers.Fail(message=message, description=description)
