...
import tc66c2mqtt
from tc66c2mqtt.cli_dev import PACKAGE_ROOT, app
...
def install():
    """
    Install requirements and 'tc66c2mqtt' via pip as editable.
    """
...
def publish():
    ...
    publish_package(module=tc66c2mqtt, package_path=PACKAGE_ROOT)
