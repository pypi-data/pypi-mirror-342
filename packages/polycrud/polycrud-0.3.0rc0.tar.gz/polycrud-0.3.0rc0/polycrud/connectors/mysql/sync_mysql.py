...
class MySQLConnector(BaseConnector):
    ...
    def __init__(self, host: str, port: int, user: str, password: str, db: str, redis_cache_connector: RedisConnector | None = None):
        """
    ...
    @cache.cache()
    def delete_many(
        self, collection: type[T], *, ids: list[int], _use_cache: bool | None = None, _cache_ttl: int = DEFAULT_CACHE_TTL
    ) -> None:
        """
