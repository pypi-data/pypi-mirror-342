...
from ._base import BaseRedisConnector, T
...
class RedisConnector(BaseRedisConnector):
    ...
    def set_object(self, key: str, value: Any, expire_seconds: int = 0) -> bool:
        """
    ...
    def get_object(self, model_class: type[T], *, key: str) -> T | None:
        """
