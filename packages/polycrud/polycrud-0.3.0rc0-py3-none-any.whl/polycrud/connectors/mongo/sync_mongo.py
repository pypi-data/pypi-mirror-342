...
class MongoConnector(BaseConnector):
    def __init__(
        ...
        password: str,
        auth_source: str,
        redis_cache_connector: RedisConnector | None = None,
        **kwargs: Any,
    ) -> None:
        super().__init__(redis_connector=redis_cache_connector)
    ...
    @cache.cache()
    def find_one(self, collection: type[T], _use_cache: bool | None = None, _cache_ttl: int = DEFAULT_CACHE_TTL, **kwargs: Any) -> T | None:
    ...
    @cache.cache()
    def delete_one(self, collection: type[T], *, id: str, _use_cache: bool | None = None, _cache_ttl: int = DEFAULT_CACHE_TTL) -> None:
        if not id:
            return
    ...
    @cache.cache()
    def delete_many(
        self, collection: type[T], *, ids: list[str], _use_cache: bool | None = None, _cache_ttl: int = DEFAULT_CACHE_TTL
    ) -> None:
        if not ids:
            return
    ...
    @cache.cache()
    def count(self, collection: type[T], _use_cache: bool | None = None, _cache_ttl: int = DEFAULT_CACHE_TTL, **kwargs: Any) -> int:
