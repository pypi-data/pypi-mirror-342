...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["base_path", "hidden", "pulp_href", "name", "pulp_last_updated", "prn", "pulp_created", "base_url", "content_guard", "pulp_labels", "no_content_change_since"]
