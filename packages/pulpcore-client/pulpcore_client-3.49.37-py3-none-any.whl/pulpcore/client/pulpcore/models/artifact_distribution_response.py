...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_url=None, pulp_labels=None, base_path=None, name=None, pulp_created=None, hidden=False, pulp_href=None, content_guard=None, pulp_last_updated=None, local_vars_configuration=None):  # noqa: E501
