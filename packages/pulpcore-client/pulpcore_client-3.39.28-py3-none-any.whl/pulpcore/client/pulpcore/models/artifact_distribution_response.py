...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, pulp_labels=None, pulp_href=None, pulp_created=None, base_url=None, hidden=False, base_path=None, name=None, local_vars_configuration=None):  # noqa: E501
