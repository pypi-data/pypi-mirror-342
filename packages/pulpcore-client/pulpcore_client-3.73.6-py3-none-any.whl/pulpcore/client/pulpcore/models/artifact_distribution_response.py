...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["base_path", "pulp_created", "content_guard", "pulp_last_updated", "pulp_labels", "hidden", "pulp_href", "prn", "name", "no_content_change_since", "base_url"]
