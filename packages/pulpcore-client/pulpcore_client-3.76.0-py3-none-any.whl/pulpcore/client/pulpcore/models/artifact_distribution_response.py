...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["base_url", "pulp_href", "name", "base_path", "pulp_last_updated", "no_content_change_since", "pulp_created", "pulp_labels", "content_guard", "hidden", "prn"]
