...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_path=None, prn=None, content_guard=None, pulp_last_updated=None, pulp_created=None, hidden=False, name=None, no_content_change_since=None, pulp_labels=None, pulp_href=None, base_url=None, local_vars_configuration=None):  # noqa: E501
