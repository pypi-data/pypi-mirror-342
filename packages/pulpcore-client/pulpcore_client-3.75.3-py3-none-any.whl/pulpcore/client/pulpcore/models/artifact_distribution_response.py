...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_created", "pulp_href", "prn", "no_content_change_since", "hidden", "pulp_labels", "pulp_last_updated", "name", "base_path", "content_guard", "base_url"]
