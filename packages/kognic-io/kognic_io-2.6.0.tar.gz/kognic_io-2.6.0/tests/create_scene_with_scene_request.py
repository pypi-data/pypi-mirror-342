...
class TestCreateSceneWithExternalResources:
    def test_create_scene_with_external_resources(self, client: IOC.KognicIOClient):
        ...
        request = IAM.scene.SceneRequest(
            ...
            metadata={},
            imudata_resource=IAM.scene.Resource(
                external_resource_uri="s3://jesper-test-chain-of-trust-2/zod/000000/dummy_imu.json", local_file=None
            ),
        ...
        wait_for_scene_job(client, response.scene_uuid, timeout=60)
