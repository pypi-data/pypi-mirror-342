...
def image_file_to_sticker(
    ...
    enlarged_filename = Temp.create_filename('enlarged.png')
    ...
    without_background_filename = Temp.create_filename('without_background.png')
    ...
    large_result_filename = Temp.create_filename('large.png')
