...
class AuxiliaryFunction:
    def __hash__(self) -> AuxiliaryFunction: ...
...
class AuxiliaryFunctionExpressionFunction:
    def __hash__(self) -> AuxiliaryFunctionExpressionFunction: ...
...
class AuxiliaryFunctionSkeleton:
    def __hash__(self) -> AuxiliaryFunctionSkeleton: ...
...
class AuxiliaryGroundFunction:
    def __hash__(self) -> AuxiliaryGroundFunction: ...
...
class AuxiliaryGroundFunctionExpressionFunction:
    def __hash__(self) -> AuxiliaryGroundFunctionExpressionFunction: ...
...
class AuxiliaryGroundFunctionValue:
    def __hash__(self) -> AuxiliaryGroundFunctionValue: ...
...
class AuxiliaryGroundNumericEffect:
    def __hash__(self) -> AuxiliaryGroundNumericEffect: ...
...
class AuxiliaryNumericEffect:
    def __hash__(self) -> AuxiliaryNumericEffect: ...
...
class ConditionalEffect:
    def __hash__(self) -> ConditionalEffect: ...
...
class ConjunctiveCondition:
    def __hash__(self) -> ConjunctiveCondition: ...
...
class ConjunctiveEffect:
    def __hash__(self) -> ConjunctiveEffect: ...
...
class DerivedGroundAtom:
    def __hash__(self) -> DerivedGroundAtom: ...
...
class DerivedGroundLiteral:
    def __hash__(self) -> DerivedGroundLiteral: ...
...
class DerivedLiteral:
    def __hash__(self) -> DerivedLiteral: ...
...
class DerivedPredicate:
    def __hash__(self) -> DerivedPredicate: ...
...
class Domain:
    def __hash__(self) -> Domain: ...

    def __eq__(self, arg: Domain, /) -> bool: ...
...
class FluentFunction:
    def __hash__(self) -> FluentFunction: ...
...
class FluentFunctionExpressionFunction:
    def __hash__(self) -> FluentFunctionExpressionFunction: ...
...
class FluentFunctionSkeleton:
    def __hash__(self) -> FluentFunctionSkeleton: ...
...
class FluentGroundAtom:
    def __hash__(self) -> FluentGroundAtom: ...
...
class FluentGroundFunction:
    def __hash__(self) -> FluentGroundFunction: ...
...
class FluentGroundFunctionExpressionFunction:
    def __hash__(self) -> FluentGroundFunctionExpressionFunction: ...
...
class FluentGroundFunctionValue:
    def __hash__(self) -> FluentGroundFunctionValue: ...
...
class FluentGroundLiteral:
    def __hash__(self) -> FluentGroundLiteral: ...
...
class FluentGroundNumericEffect:
    def __hash__(self) -> FluentGroundNumericEffect: ...
...
class FluentLiteral:
    def __hash__(self) -> FluentLiteral: ...
...
class FluentNumericEffect:
    def __hash__(self) -> FluentNumericEffect: ...
...
class FluentPredicate:
    def __hash__(self) -> FluentPredicate: ...
...
class FunctionExpression:
    def __hash__(self) -> FunctionExpression: ...
...
class FunctionExpressionBinaryOperator:
    def __hash__(self) -> FunctionExpressionBinaryOperator: ...
...
class FunctionExpressionMinus:
    def __hash__(self) -> FunctionExpressionMinus: ...
...
class FunctionExpressionMultiOperator:
    def __hash__(self) -> FunctionExpressionMultiOperator: ...
...
class FunctionExpressionNumber:
    def __hash__(self) -> FunctionExpressionNumber: ...
...
class GeneralizedProblem:
    @overload
    @staticmethod
    def create(domain_filepath: str, problem_filepaths: Sequence[str], options: ParserOptions = ...) -> GeneralizedProblem: ...

    @overload
    @staticmethod
    def create(domain_filepath: str, problems_directory: str, options: ParserOptions = ...) -> GeneralizedProblem: ...
...
class GroundAction:
    def __hash__(self) -> GroundAction: ...
...
class GroundConditionalEffect:
    def __hash__(self) -> GroundConditionalEffect: ...
...
class GroundConjunctiveCondition:
    def __hash__(self) -> GroundConjunctiveCondition: ...
...
class GroundConjunctiveEffect:
    def __hash__(self) -> GroundConjunctiveEffect: ...
...
class GroundFunctionExpression:
    def __hash__(self) -> GroundFunctionExpression: ...
...
class GroundFunctionExpressionBinaryOperator:
    def __hash__(self) -> GroundFunctionExpressionBinaryOperator: ...
...
class GroundFunctionExpressionMinus:
    def __hash__(self) -> GroundFunctionExpressionMinus: ...
...
class GroundFunctionExpressionMultiOperator:
    def __hash__(self) -> GroundFunctionExpressionMultiOperator: ...
...
class GroundFunctionExpressionNumber:
    def __hash__(self) -> GroundFunctionExpressionNumber: ...
...
class GroundNumericConstraint:
    def __hash__(self) -> GroundNumericConstraint: ...
...
class NumericConstraint:
    def __hash__(self) -> NumericConstraint: ...
...
class OptimizationMetric:
    def __hash__(self) -> OptimizationMetric: ...
...
class Parser:
    def __init__(self, domain_filepath: str, options: ParserOptions = ...) -> None: ...

    def parse_problem(self, problem_filepath: str, options: ParserOptions = ...) -> Problem: ...
...
class Problem:
    @staticmethod
    def create(domain_filepath: str, problem_filepath: str, options: ParserOptions = ...) -> Problem: ...

    def __hash__(self) -> Problem: ...

    def __eq__(self, arg: Problem, /) -> bool: ...
    ...
    @overload
    def get_or_create_ground_atom(self, predicate: StaticPredicate, objects: ObjectList) -> StaticGroundAtom: ...

    @overload
    def get_or_create_ground_atom(self, predicate: FluentPredicate, objects: ObjectList) -> FluentGroundAtom: ...

    @overload
    def get_or_create_ground_atom(self, predicate: DerivedPredicate, objects: ObjectList) -> DerivedGroundAtom: ...
    ...
    @overload
    def get_or_create_function_expression_function(self, static_function: StaticFunction) -> StaticFunctionExpressionFunction: ...

    @overload
    def get_or_create_function_expression_function(self, fluent_function: FluentFunction) -> FluentFunctionExpressionFunction: ...
    ...
    def get_or_create_conjunctive_condition(self, parameters: VariableList, literals: "boost::hana::detail::map_impl<boost::hana::detail::hash_table<boost::hana::detail::bucket<mimir::formalism::StaticTag, 0ul>, boost::hana::detail::bucket<mimir::formalism::FluentTag, 1ul>, boost::hana::detail::bucket<mimir::formalism::DerivedTag, 2ul>>, boost::hana::basic_tuple<boost::hana::pair<boost::hana::type_impl<mimir::formalism::StaticTag>::_, std::__1::vector<mimir::formalism::LiteralImpl<mimir::formalism::StaticTag> const*, std::__1::allocator<mimir::formalism::LiteralImpl<mimir::formalism::StaticTag> const*>>>, boost::hana::pair<boost::hana::type_impl<mimir::formalism::FluentTag>::_, std::__1::vector<mimir::formalism::LiteralImpl<mimir::formalism::FluentTag> const*, std::__1::allocator<mimir::formalism::LiteralImpl<mimir::formalism::FluentTag> const*>>>, boost::hana::pair<boost::hana::type_impl<mimir::formalism::DerivedTag>::_, std::__1::vector<mimir::formalism::LiteralImpl<mimir::formalism::DerivedTag> const*, std::__1::allocator<mimir::formalism::LiteralImpl<mimir::formalism::DerivedTag> const*>>>>>", numeric_constraints: NumericConstraintList) -> ConjunctiveCondition: ...
...
class Requirements:
    def __hash__(self) -> Requirements: ...
...
class StaticFunction:
    def __hash__(self) -> StaticFunction: ...
...
class StaticFunctionExpressionFunction:
    def __hash__(self) -> StaticFunctionExpressionFunction: ...
...
class StaticFunctionSkeleton:
    def __hash__(self) -> StaticFunctionSkeleton: ...
...
class StaticGroundAtom:
    def __hash__(self) -> StaticGroundAtom: ...
...
class StaticGroundFunction:
    def __hash__(self) -> StaticGroundFunction: ...
...
class StaticGroundFunctionExpressionFunction:
    def __hash__(self) -> StaticGroundFunctionExpressionFunction: ...
...
class StaticGroundFunctionValue:
    def __hash__(self) -> StaticGroundFunctionValue: ...
...
class StaticGroundLiteral:
    def __hash__(self) -> StaticGroundLiteral: ...
...
class StaticLiteral:
    def __hash__(self) -> StaticLiteral: ...
...
class StaticPredicate:
    def __hash__(self) -> StaticPredicate: ...
