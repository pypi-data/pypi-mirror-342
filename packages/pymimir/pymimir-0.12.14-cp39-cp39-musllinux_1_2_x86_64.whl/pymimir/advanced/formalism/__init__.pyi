...
class Problem:
    ...
    def get_or_create_conjunctive_condition(self, parameters: VariableList, literals: "boost::hana::detail::map_impl<boost::hana::detail::hash_table<boost::hana::detail::bucket<mimir::formalism::StaticTag, 0ul>, boost::hana::detail::bucket<mimir::formalism::FluentTag, 1ul>, boost::hana::detail::bucket<mimir::formalism::DerivedTag, 2ul> >, boost::hana::basic_tuple<boost::hana::pair<boost::hana::type_impl<mimir::formalism::StaticTag>::_, std::vector<mimir::formalism::LiteralImpl<mimir::formalism::StaticTag> const*, std::allocator<mimir::formalism::LiteralImpl<mimir::formalism::StaticTag> const*> > >, boost::hana::pair<boost::hana::type_impl<mimir::formalism::FluentTag>::_, std::vector<mimir::formalism::LiteralImpl<mimir::formalism::FluentTag> const*, std::allocator<mimir::formalism::LiteralImpl<mimir::formalism::FluentTag> const*> > >, boost::hana::pair<boost::hana::type_impl<mimir::formalism::DerivedTag>::_, std::vector<mimir::formalism::LiteralImpl<mimir::formalism::DerivedTag> const*, std::allocator<mimir::formalism::LiteralImpl<mimir::formalism::DerivedTag> const*> > > > >", numeric_constraints: NumericConstraintList) -> ConjunctiveCondition: ...
