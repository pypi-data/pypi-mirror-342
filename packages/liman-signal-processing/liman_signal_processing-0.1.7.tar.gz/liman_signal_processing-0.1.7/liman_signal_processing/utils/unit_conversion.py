...
def acceleration_to_velocity_time(a, t, remove_dc=True):
    """
    ...
    t : array-like
        Массив времени с равномерной дискретизацией (в секундах).
...
def velocity_to_displacement_time(v, t, remove_dc=True):
    """
...
def acceleration_to_displacement_time(a, t, remove_dc=True):
    """
