...
from fleet_control.resources.commands import change, clone, purge, get, delete, move, schedule, initialize
...
if not BALENA_API_TOKEN:
    raise EnvironmentError("BALENA_API_KEY is not set. Define it in a .env file or export it.")
