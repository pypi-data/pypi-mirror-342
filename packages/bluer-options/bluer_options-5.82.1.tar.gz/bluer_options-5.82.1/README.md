...
let the function receive one or more `options` arguments (example below) then parse them with `bluer_ai_option`, `bluer_ai_option_choice`, and `bluer_ai_option_int`.
