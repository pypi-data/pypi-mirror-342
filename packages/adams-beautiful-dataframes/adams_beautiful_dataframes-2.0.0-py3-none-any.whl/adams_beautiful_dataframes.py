def load_ipython_extension(ipython):
  ...
  def hook(result):
    display(HTML('<style>table { font-family: "Comic Sans MS"; }</style>'))
    display(HTML('<img src="https://variety.com/wp-content/uploads/2021/07/Rick-Astley-Never-Gonna-Give-You-Up.png" />'))
