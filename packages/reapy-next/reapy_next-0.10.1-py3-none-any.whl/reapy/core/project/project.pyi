...
class Project(ReapyObject):
    ...
    def current_surface_change_play_rate(self, r: float) -> None:
        """
    ...
    def current_surface_go_end(self) -> None:
        """Go to end of current surface."""
        ...

    def current_surface_go_start(self) -> None:
        """Go to start of current surface."""
        ...

    def current_surface_play(self) -> None:
        """Start play on current surface."""
        ...

    def current_surface_record(self) -> None:
        """Start record on current surface."""
        ...

    def current_surface_stop(self) -> None:
