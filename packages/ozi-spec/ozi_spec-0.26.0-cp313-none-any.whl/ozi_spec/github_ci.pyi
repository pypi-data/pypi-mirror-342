...
class Publish(Default):
    ...
    version: str = 'df67e9c0f38d22c078568807d2eefed313340e2d'

@dataclass(slots=True, frozen=True, eq=True)
class Draft(Default):
    """Draft release patterns for packaged project."""

    version: str = 'ed08d630ad83cfd14061b78cf695c20eb51984a5'

@dataclass(slots=True, frozen=True, eq=True)
class Release(Default):
    """Release patterns for packaged project."""

    version: str = 'afbdfe0866a7b046820c232d2a8c3256d2d70ed7'
...
class Checkpoint(Default):
    ...
    version: str = 'dbe6f38e4bb6ed375129d0cf718b6d6968340a13'
...
class HardenRunner(Default):
    ...
    version: str = 'c6295a65d1254861815972266d5933fd6e532bdf'
