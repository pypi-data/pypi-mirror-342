...
from contentor_video.files import ResumableFile
from contentor_video.models import VideoProcessingRequest
    ...
    try:
        ...
        if status == "completed":
            ...
            if res == "1080p":
                ...
                video.video_720.name = relative_path
            elif res == "480p":
                video.video_480.name = relative_path
            elif res == "360p":
                video.video_360.name = relative_path
