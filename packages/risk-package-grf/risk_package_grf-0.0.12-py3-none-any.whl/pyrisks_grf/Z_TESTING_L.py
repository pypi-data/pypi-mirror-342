...
Checker = obtencion_tabla_maestra(where_to_run='local_bloomberg') # Se obtiene el registro con fecha más nueva en la tabla maestra.
...
cargador_estructura(matriz=matriz,where_to_run='local_bloomberg') # Se concatena el registro a la tabla maestra