...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ("artd_siigo", "0023_siigocustomertype"),
    ]

    operations = [
        migrations.CreateModel(
            name="SiigoCustomerPersonType",
            fields=[
                (
                    "id",
                    models.BigAutoField(
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Name of the customer person type",
                        max_length=250,
                        verbose_name="Name",
                    ),
                ),
            ...
            options={
                ...
                "verbose_name_plural": "Siigo Customer Person Types",
            },
        ),
    ]
