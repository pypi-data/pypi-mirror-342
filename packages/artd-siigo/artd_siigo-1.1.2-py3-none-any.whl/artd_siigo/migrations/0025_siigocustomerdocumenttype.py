...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ("artd_siigo", "0024_siigocustomerpersontype"),
    ]

    operations = [
        migrations.CreateModel(
            name="SiigoCustomerDocumentType",
            fields=[
                (
                    "id",
                    models.BigAutoField(
                ...
                (
                    "code",
                    models.CharField(
                        help_text="Code of the customer document type",
                        max_length=250,
                        verbose_name="Code",
                    ),
                ),
                (
                    "name",
                    models.CharField(
                        help_text="Name of the customer document type",
                        max_length=250,
                        verbose_name="Name",
                    ),
                ),
            ...
            options={
                ...
                "verbose_name_plural": "Siigo Customer Document Types",
            },
        ),
    ]
