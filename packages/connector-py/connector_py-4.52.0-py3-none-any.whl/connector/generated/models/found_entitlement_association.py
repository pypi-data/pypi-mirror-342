...
class FoundEntitlementAssociation(BaseModel):
    ...
    integration_specific_entitlement_id: StrictStr = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FoundEntitlementAssociation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FoundEntitlementAssociation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "integration_specific_entitlement_id": obj.get(
                    "integration_specific_entitlement_id"
                ),
