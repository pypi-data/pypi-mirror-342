...
from connector.generated.models.account_status import AccountStatus
from connector.generated.models.account_type import AccountType
...
class FoundAccountData(BaseModel):
    """
    A representation of a user within a connector. The fields provided here are the most commonly occurring across all connectors. For a complete list of fields specific to your connector, please refer to the [info endpoint](#tag/Describe/operation/info).
    """
    ...
    given_name: Optional[StrictStr] = Field(
        default=None, description="The given name (first name) of the account holder."
    )
    family_name: Optional[StrictStr] = Field(
        default=None, description="The family name (last name) of the account holder."
    )
    username: Optional[StrictStr] = Field(
        default=None, description="The username associated with the account."
    )
    user_status: Optional[AccountStatus] = Field(
        default=None, description="The current status of the account."
    )
    ...
    account_type: Optional[AccountType] = Field(
        default=None, description="The type of the account (e.g., service account or user account)."
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FoundAccountData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FoundAccountData from a dict"""
        if obj is None:
            return None
