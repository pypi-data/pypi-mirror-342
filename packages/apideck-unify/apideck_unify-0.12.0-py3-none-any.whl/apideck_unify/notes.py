...
class Notes(BaseSDK):
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.CrmNotesAllResponse(
                get_notes_response=utils.unmarshal_json(
                    http_res.text, Optional[models.GetNotesResponse]
                ),
        ...
        *,
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.note, False, False, "json", models.NoteInput
            ),
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return models.CrmNotesAddResponse(
                create_note_response=utils.unmarshal_json(
                    http_res.text, Optional[models.CreateNoteResponse]
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(http_res, "400", "application/json"):
    ...
    def get(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.CrmNotesOneResponse(
                get_note_response=utils.unmarshal_json(
                    http_res.text, Optional[models.GetNoteResponse]
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(http_res, "400", "application/json"):
    ...
    def update(
        ...
        *,
        ...
        request = models.CrmNotesUpdateRequest(
            id=id,
            consumer_id=consumer_id,
            app_id=app_id,
            service_id=service_id,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.CrmNotesUpdateResponse(
                update_note_response=utils.unmarshal_json(
                    http_res.text, Optional[models.UpdateNoteResponse]
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(http_res, "400", "application/json"):
    ...
    def delete(
        ...
        *,
        ...
        request = models.CrmNotesDeleteRequest(
            id=id,
            consumer_id=consumer_id,
            app_id=app_id,
            service_id=service_id,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.CrmNotesDeleteResponse(
                delete_note_response=utils.unmarshal_json(
                    http_res.text, Optional[models.DeleteNoteResponse]
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(http_res, "400", "application/json"):
