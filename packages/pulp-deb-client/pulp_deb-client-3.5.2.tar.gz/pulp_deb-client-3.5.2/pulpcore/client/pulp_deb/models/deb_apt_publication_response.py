...
class DebAptPublicationResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["pulp_href", "prn", "pulp_created", "pulp_last_updated", "repository_version", "repository", "simple", "structured", "signing_service", "publish_upstream_release_fields"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DebAptPublicationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DebAptPublicationResponse from a dict"""
        if obj is None:
            return None
