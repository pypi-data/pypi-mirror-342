...
class DebCopyApi:
    ...
    def copy_content(
        ...
        _param = self._copy_content_serialize(
            copy=copy,
    ...
    @validate_call
    def copy_content_with_http_info(
        self,
        copy: Copy,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def copy_content_without_preload_content(
        self,
        copy: Copy,
        _request_timeout: Union[
            None,
    ...
    def _copy_content_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/pulp/api/v3/deb/copy/',
