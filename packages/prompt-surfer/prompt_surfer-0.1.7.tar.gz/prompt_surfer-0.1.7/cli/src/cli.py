...
def main():
    try:
        ...
        # Initialize the composer - it will prompt for API key if needed
        ...
        if "No OpenAI API key provided" in str(e):
            console.print("\n[bold yellow]Welcome to Prompt Surfer![/bold yellow]")
            console.print("[yellow]To use this application, you need to provide an OpenAI API key.[/yellow]")
            console.print("[info]You can get an API key from https://platform.openai.com/api-keys[/info]")
            console.print("\n[cyan]Run the application again and you'll be prompted to enter your API key.[/cyan]")
        else:
