...
class ForumTopic(Object):
    # todo
    # notify_settings: `~pyroitaly.types.PeerNotifySettings`
    # draft: `~pyroitaly.types.DraftMessage`
    """A forum topic.
    ...
    Parameters:
        ...
        from_id (:obj:`~pyroitaly.types.PeerChannel` | :obj:`~pyroitaly.types.PeerUser`):
            Topic creator.
