...
class SentCode(Object):
    ...
    Parameters:
        type (:obj:`~pyroitaly.enums.SentCodeType`):
            Type of the current sent code.

        phone_code_hash (``str``):
            Confirmation code identifier useful for the next authorization steps (either
            :meth:`~pyroitaly.Client.sign_in` or :meth:`~pyroitaly.Client.sign_up`).

        next_type (:obj:`~pyroitaly.enums.NextCodeType`, *optional*):
            Type of the next code to be sent with :meth:`~pyroitaly.Client.resend_code`.

        timeout (``int``, *optional*):
            Delay in seconds before calling :meth:`~pyroitaly.Client.resend_code`.
    """
