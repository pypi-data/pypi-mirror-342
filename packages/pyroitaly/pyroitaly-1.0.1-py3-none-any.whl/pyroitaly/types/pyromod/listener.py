...
class Listener:
    ...
    Parameters:
        ...
        filters (:meth:`~pyroitaly.filters.Filter`):
        ...
        identifier (:obj:`~pyroitaly.types.Identifier`):
            An :obj:`~pyroitaly.types.Identifier` instance that defines the criteria for the event.
    ...
    filters: "pyroitaly.filters.Filter"
    unallowed_click_alert: bool
