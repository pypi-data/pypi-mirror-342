...
import pyroitaly
from pyroitaly import raw, enums, utils
...
class Poll(Object, Update):
    ...
    Parameters:
        ...
        explanation_entities (List of :obj:`~pyroitaly.types.MessageEntity`, *optional*):
        ...
        recent_voters (List of :obj:`~pyroitaly.types.User`, *optional*):
