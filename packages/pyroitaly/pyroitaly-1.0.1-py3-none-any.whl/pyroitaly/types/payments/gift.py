...
class Gift(Object):
    ...
    Parameters:
        ...
        attributes (List of :obj:`~pyroitaly.types.GiftAttribute`, *optional*):
        ...
        owner (:obj:`~pyroitaly.types.Chat`, *optional*):
            Current gift owner.
        ...
        raw (:obj:`~pyroitaly.raw.base.StarGift`, *optional*):
    ...
    async def show(self) -> bool:
        """Bound method *show* of :obj:`~pyroitaly.types.Gift`.
    ...
    async def hide(self) -> bool:
        """Bound method *hide* of :obj:`~pyroitaly.types.Gift`.
    ...
    async def convert(self) -> bool:
        """Bound method *convert* of :obj:`~pyroitaly.types.Gift`.
    ...
    async def upgrade(self) -> bool:
        """Bound method *upgrade* of :obj:`~pyroitaly.types.Gift`.
    ...
    async def transfer(self, to_chat_id: Union[int, str]) -> bool:
        """Bound method *transfer* of :obj:`~pyroitaly.types.Gift`.
    ...
    async def wear(self) -> bool:
        """Bound method *wear* of :obj:`~pyroitaly.types.Gift`.
