...
class PaidMedia(Object):
    ...
    Parameters:
        ...
        extended_media (List of :obj:`~pyroitaly.types.Animation` | :obj:`~pyroitaly.types.ExtendedMediaPreview` | :obj:`~pyroitaly.types.Photo` | :obj:`~pyroitaly.types.Video`, *optional*):
            Extended media.
    """
    def __init__(
            self,
