...
from pyroitaly import types, enums
...
class SendPoll:
    async def send_poll(
        ...
        Returns:
            :obj:`~pyroitaly.types.Message`: On success, the sent poll message is returned.

        Example:
            .. code-block:: python

                from pyroitaly.types import PollOption
        ...
        q, q_entities = (await pyroitaly.utils.parse_text_entities(self, question, None, question_entities)).values()
