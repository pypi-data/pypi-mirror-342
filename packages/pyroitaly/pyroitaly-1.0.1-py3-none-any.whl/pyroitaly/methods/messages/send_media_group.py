...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~pyroitaly.types.InputMediaPhoto`, :obj:`~pyroitaly.types.InputMediaVideo`, :obj:`~pyroitaly.types.InputMediaAudio`, :obj:`~pyroitaly.types.InputMediaDocument` and :obj:`~pyroitaly.types.InputMediaAnimation`):
        ...
        Returns:
            List of :obj:`~pyroitaly.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from pyroitaly.types import InputMediaPhoto, InputMediaVideo
