...
import pyroitaly
from pyroitaly import StopTransmission, enums
from pyroitaly import raw
from pyroitaly import types
from pyroitaly import utils
from pyroitaly.errors import FilePartMissing
from pyroitaly.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~pyroitaly.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~pyroitaly.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~pyroitaly.Client.stop_transmission`, None is returned.
