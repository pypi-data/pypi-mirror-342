...
from pyroitaly.errors import AuthBytesInvalid
from pyroitaly.session import Session
from pyroitaly.session.auth import Auth


async def get_session(client: "pyroitaly.Client", dc_id: int):
