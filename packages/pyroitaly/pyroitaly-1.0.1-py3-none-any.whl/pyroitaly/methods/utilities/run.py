...
import pyroitaly
from pyroitaly.methods.utilities.idle import idle
...
class Run:
    def run(
        ...
        :meth:`~pyroitaly.Client.start`, :meth:`~pyroitaly.idle` and :meth:`~pyroitaly.Client.stop` in sequence.
        ...
        If you want to run multiple clients at once, see :meth:`~pyroitaly.compose`.
