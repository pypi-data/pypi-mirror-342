...
class OnChatMemberUpdated:
    def on_chat_member_updated(
        ...
        :obj:`~pyroitaly.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroitaly.Client):
                self.add_handler(pyroitaly.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroitaly.handlers.ChatMemberUpdatedHandler(func, self),
