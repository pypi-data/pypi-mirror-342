...
class OnChatJoinRequest:
    def on_chat_join_request(
        ...
        :obj:`~pyroitaly.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroitaly.Client):
                self.add_handler(pyroitaly.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroitaly.handlers.ChatJoinRequestHandler(func, self),
