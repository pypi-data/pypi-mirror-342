...
class OnMessageReactionCountUpdated:
    def on_message_reaction_count_updated(
        ...
        :obj:`~pyroitaly.handlers.MessageReactionCountUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroitaly.Client):
                self.add_handler(pyroitaly.handlers.MessageReactionCountUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroitaly.handlers.MessageReactionCountUpdatedHandler(func, self),
