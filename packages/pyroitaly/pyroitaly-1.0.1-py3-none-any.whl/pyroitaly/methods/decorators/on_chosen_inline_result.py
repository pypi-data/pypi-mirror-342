...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        :obj:`~pyroitaly.handlers.ChosenInlineResultHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroitaly.Client):
                self.add_handler(pyroitaly.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroitaly.handlers.ChosenInlineResultHandler(func, self),
