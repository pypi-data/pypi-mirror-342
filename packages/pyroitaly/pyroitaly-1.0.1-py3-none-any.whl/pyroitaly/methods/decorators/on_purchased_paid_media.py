...
class OnPurchasedPaidMedia:
    def on_purchased_paid_media(
        ...
        :obj:`~pyroitaly.handlers.PurchasedPaidMediaHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroitaly.Client):
                self.add_handler(pyroitaly.handlers.MessageReactionHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroitaly.handlers.MessageReactionHandler(func, self),
