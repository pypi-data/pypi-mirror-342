...
class Filter:
    async def __call__(self, client: "pyroitaly.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~pyroitaly.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~pyroitaly.handlers.MessageHandler` the *update* argument will be a :obj:`~pyroitaly.types.Message`; in a :obj:`~pyroitaly.handlers.CallbackQueryHandler` the *update* will be a :obj:`~pyroitaly.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~pyroitaly.filters.command` or :meth:`~pyroitaly.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~pyroitaly.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~pyroitaly.types.Document` objects."""
...
"""Filter messages that contain :obj:`~pyroitaly.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~pyroitaly.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~pyroitaly.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~pyroitaly.types.Game` objects."""
...
"""Filter messages that contain :obj:`~pyroitaly.types.Giveaway` objects."""
# endregion
...
"""Filter messages that contain :obj:`~pyroitaly.types.GiveawayWinners` or :obj:`~pyroitaly.types.GiveawayCompleted` objects."""
# endregion
...
"""Filter messages that contain :obj:`~pyroitaly.types.GiftCode` objects."""
# endregion
...
"""Filter messages that contain :obj:`~pyroitaly.types.Gift` objects."""
# endregion
...
"""Filter messages that contain :obj:`~pyroitaly.types.Video` objects."""
...
"""Filter messages that contain :obj:`~pyroitaly.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~pyroitaly.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~pyroitaly.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~pyroitaly.types.Location` objects."""
...
"""Filter messages that contain :obj:`~pyroitaly.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~pyroitaly.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~pyroitaly.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~pyroitaly.types.Message`.
    ...
    async def func(flt, client: pyroitaly.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~pyroitaly.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~pyroitaly.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~pyroitaly.types.InlineQuery`: The filter will match ``query``.
    - :obj:`~pyroitaly.types.PreCheckoutQuery`: The filter will match ``payload``.
