...
from pyroitaly.types import CallbackQuery, Identifier, Listener
...
class CallbackQueryHandler(Handler):
    ...
    :meth:`~pyroitaly.Client.on_callback_query` decorator.
    ...
    Other parameters:
        ...
        callback_query (:obj:`~pyroitaly.types.CallbackQuery`):
    ...
    async def check_if_has_matching_listener(
        self, client: "pyroitaly.Client", query: CallbackQuery
    ) -> Tuple[bool, Listener]:
        """
        ...
        listener = client.get_listener_matching_with_data(
            data, pyroitaly.enums.ListenerTypes.CALLBACK_QUERY
        )
    ...
    async def check(self, client: "pyroitaly.Client", query: CallbackQuery):
        """
    ...
    async def resolve_future_or_callback(
        self, client: "pyroitaly.Client", query: CallbackQuery, *args
    ):
        """
