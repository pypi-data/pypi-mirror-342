...
class ErrorHandler(Handler):
    ...
    :meth:`~pyroitaly.Client.on_error` decorator.
    ...
    async def check(self, client: pyroitaly.Client, update: Update, exception: Exception) -> bool:
