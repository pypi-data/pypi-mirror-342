...
class DeletedBotBusinessMessagesHandler(Handler):
    ...
    (private, group, channel). It is intended to be used with :meth:`~pyroitaly.Client.add_handler`

    For a nicer way to register this handler, have a look at the
    :meth:`~pyroitaly.Client.on_deleted_bot_business_messages` decorator.
    ...
    Other parameters:
        ...
        messages (List of :obj:`~pyroitaly.types.Message`):
    ...
    async def check(self, client: "pyroitaly.Client", messages: List[Message]):
