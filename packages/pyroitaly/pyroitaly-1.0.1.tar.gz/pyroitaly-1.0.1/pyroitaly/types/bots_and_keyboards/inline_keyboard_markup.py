...
class InlineKeyboardMarkup(Object):
    ...
    Parameters:
        inline_keyboard (List of List of :obj:`~pyroitaly.types.InlineKeyboardButton` | :obj:`~pyroitaly.types.InlineKeyboardButtonBuy`):
            List of button rows, each represented by a List of InlineKeyboardButton objects.
            :obj:`~pyroitaly.types.InlineKeyboardButtonBuy` objects is only for :meth:`~pyroitaly.Client.send_invoice`.
