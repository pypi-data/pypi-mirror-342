...
class InlineKeyboardButton(Object):
    ...
    Parameters:
        ...
        web_app (:obj:`~pyroitaly.types.WebAppInfo`, *optional*):
            ...
            method :meth:`~pyroitaly.Client.answer_web_app_query`. Available only in private chats between a user and the
            bot.

        login_url (:obj:`~pyroitaly.types.LoginUrl`, *optional*):
        ...
        callback_game (:obj:`~pyroitaly.types.CallbackGame`, *optional*):
