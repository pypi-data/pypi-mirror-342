...
class Wallpaper(Object):
    ...
    parameters:
        ...
        document (:obj:`~pyroitaly.types.Document`):
        ...
        settings (:obj:`~pyroitaly.types.WallpaperSettings`, optional):
    ...
    @staticmethod
    def _parse(client: "pyroitaly.Client", wallpaper: "raw.base.WallPaper") -> "Wallpaper":
