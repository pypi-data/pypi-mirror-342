...
class MessageOrigin(Object):
    ...
    - :obj:`~pyroitaly.types.MessageOriginChannel`
    - :obj:`~pyroitaly.types.MessageOriginChat`
    - :obj:`~pyroitaly.types.MessageOriginHiddenUser`
    - :obj:`~pyroitaly.types.MessageOriginImport`
    - :obj:`~pyroitaly.types.MessageOriginUser`
    """
