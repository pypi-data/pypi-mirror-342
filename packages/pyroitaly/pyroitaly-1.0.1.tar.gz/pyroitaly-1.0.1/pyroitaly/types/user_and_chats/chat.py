...
import pyroitaly
from pyroitaly import raw, enums
from pyroitaly import types
from pyroitaly import utils
...
class Chat(Object):
    ...
    Parameters:
        ...
        type (:obj:`~pyroitaly.enums.ChatType`):
            Type of chat.
        ...
        is_participants_hidden (``bool``, *optional*):
            ...
            Returned only in :meth:`~pyroitaly.Client.get_chat`.
        ...
        photo (:obj:`~pyroitaly.types.ChatPhoto`, *optional*):
            Chat photo. Suitable for downloads only.

        stories (List of :obj:`~pyroitaly.types.Story`, *optional*):
            The list of chat's stories if available.

        wallpaper (:obj:`~pyroitaly.types.Document`, *optional*):
            Chat wallpaper.
        ...
        join_requests_count (``int``, *optional*):
            ...
            Returned only in :meth:`~pyroitaly.Client.get
        ...
        restrictions (List of :obj:`~pyroitaly.types.Restriction`, *optional*):
            The list of reasons why this chat might be unavailable to some users.
            This field is available only in case *is_restricted* is True.

        permissions (:obj:`~pyroitaly.types.ChatPermissions` *optional*):
            Default chat member permissions, for groups and supergroups.

        distance (``int``, *optional*):
            Distance in meters of this group chat from your location.
            Returned only in :meth:`~pyroitaly.Client.get_nearby_chats`.

        linked_chat (:obj:`~pyroitaly.types.Chat`, *optional*):
            The linked discussion group (in case of channels) or the linked channel (in case of supergroups).
            Returned only in :meth:`~pyroitaly.Client.get_chat`.

        send_as_chat (:obj:`~pyroitaly.types.Chat`, *optional*):
            The default "send_as" chat.
            Returned only in :meth:`~pyroitaly.Client.get_chat`.

        available_reactions (:obj:`~pyroitaly.types.ChatReactions`, *optional*):
        ...
        usernames (List of :obj:`~pyroitaly.types.Username`, *optional*):
        ...
        reply_color (:obj:`~pyroitaly.types.ChatColor`, *optional*):
            Chat reply color.

        profile_color (:obj:`~pyroitaly.types.ChatColor`, *optional*):
            Chat profile color.

        business_info (:obj:`~pyroitaly.types.BusinessInfo`, *optional*):
            Business information of a chat.

        birthday (:obj:`~pyroitaly.types.Birthday`, *optional*):
            User Date of birth.
            Returned only in :meth:`~pyroitaly.Client.get_chat`.

        personal_chat (:obj:`~pyroitaly.types.Chat`, *optional*):
        ...
        bot_verification (:obj:`~pyroitaly.types.BotVerification`, *optional*):
    ...
    def listen(self, *args, **kwargs):
        """Bound method *listen* of :obj:`~pyroitaly.types.Chat`.
        ...
        Parameters:
            args (*optional*):
                The arguments to pass to the :meth:`~pyroitaly.Client.listen` method.

            kwargs (*optional*):
                The keyword arguments to pass to the :meth:`~pyroitaly.Client.listen` method.
    ...
    def ask(self, text, *args, **kwargs):
        """Bound method *ask* of :obj:`~pyroitaly.types.Chat`.
    ...
    def stop_listening(self, *args, **kwargs):
        """Bound method *stop_listening* of :obj:`~pyroitaly.types.Chat`.
    ...
    async def archive(self):
        """Bound method *archive* of :obj:`~pyroitaly.types.Chat`.
    ...
    async def unarchive(self):
        """Bound method *unarchive* of :obj:`~pyroitaly.types.Chat`.
    ...
    async def set_title(self, title: str) -> bool:
        """Bound method *set_title* of :obj:`~pyroitaly.types.Chat`.
    ...
    async def set_description(self, description: str) -> bool:
        """Bound method *set_description* of :obj:`~pyroitaly.types.Chat`.
    ...
    async def set_photo(
        ...
        *,
        ...
        """Bound method *set_photo* of :obj:`~pyroitaly.types.Chat`.
        ...
        Parameters:
            photo (``str`` | ``BinaryIO``, *optional*):
                New chat photo. You can pass a :obj:`~pyroitaly.types.Photo` file_id, a file path to upload a new photo
        ...
        Returns:
            :obj:`~pyroitaly.types.Message` | ``bool``: On success, a service message will be returned (when applicable),
    ...
    async def ban_member(
        ...
        """Bound method *ban_member* of :obj:`~pyroitaly.types.Chat`.
        ...
        Returns:
            :obj:`~pyroitaly.types.Message` | ``bool``: On success, a service message will be returned (when applicable), otherwise, in
    ...
    async def unban_member(
        ...
        """Bound method *unban_member* of :obj:`~pyroitaly.types.Chat`.
    ...
    async def restrict_member(
        ...
        Parameters:
            ...
            permissions (:obj:`~pyroitaly.types.ChatPermissions`):
    ...
    async def promote_member(
        ...
        """Bound method *promote_member* of :obj:`~pyroitaly.types.Chat`.
        ...
        Parameters:
            ...
            privileges (:obj:`~pyroitaly.types.ChatPrivileges`, *optional*):
                New user privileges.

            title (``str``, *optional*):
                A custom title that will be shown to all members instead of "Owner" or "Admin".
                Pass None or "" (empty string) will keep the current title.
                If you want to delete the custom title, use :meth:`~pyroitaly.Client.set_administrator_title()` method.
    ...
    async def join(self):
        """Bound method *join* of :obj:`~pyroitaly.types.Chat`.
    ...
    async def leave(self):
        """Bound method *leave* of :obj:`~pyroitaly.types.Chat`.
    ...
    async def export_invite_link(self):
        """Bound method *export_invite_link* of :obj:`~pyroitaly.types.Chat`.
    ...
    async def get_member(
        ...
        """Bound method *get_member* of :obj:`~pyroitaly.types.Chat`.
        ...
        Returns:
            :obj:`~pyroitaly.types.ChatMember`: On success, a chat member is returned.
        """
    ...
    def get_members(
        ...
        """Bound method *get_members* of :obj:`~pyroitaly.types.Chat`.
        ...
        Parameters:
            query (``str``, *optional*):
                ...
                A query string is applicable only for :obj:`~pyroitaly.enums.ChatMembersFilter.SEARCH`,
                :obj:`~pyroitaly.enums.ChatMembersFilter.BANNED` and :obj:`~pyroitaly.enums.ChatMembersFilter.RESTRICTED`
                filters only.

            limit (``int``, *optional*):
                Limits the number of members to be retrieved.

            filter (:obj:`~pyroitaly.enums.ChatMembersFilter`, *optional*):
                Filter used to select the kind of members you want to retrieve. Only applicable for supergroups
                and channels.

        Returns:
            ``Generator``: On success, a generator yielding :obj:`~pyroitaly.types.ChatMember` objects is returned.
        """
    ...
    async def add_members(
        ...
        """Bound method *add_members* of :obj:`~pyroitaly.types.Chat`.
    ...
    async def mark_unread(self, ) -> bool:
        """Bound method *mark_unread* of :obj:`~pyroitaly.types.Chat`.
    ...
    async def set_protected_content(self, enabled: bool) -> bool:
        """Bound method *set_protected_content* of :obj:`~pyroitaly.types.Chat`.
    ...
    async def unpin_all_messages(self) -> bool:
        """Bound method *unpin_all_messages* of :obj:`~pyroitaly.types.Chat`.
