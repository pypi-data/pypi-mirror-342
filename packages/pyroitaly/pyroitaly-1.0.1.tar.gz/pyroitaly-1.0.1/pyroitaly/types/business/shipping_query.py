...
class ShippingQuery(Object, Update):
    ...
    Parameters:
        ...
        shipping_address (:obj:`~pyroitaly.types.ShippingAddress`):
    ...
    async def answer(
        ...
        """Bound method *answer* of :obj:`~pyroitaly.types.ShippingQuery`.
        ...
        Parameters:
            ...
            shipping_options (:obj:`~pyroitaly.types.ShippingOptions`, *optional*):
