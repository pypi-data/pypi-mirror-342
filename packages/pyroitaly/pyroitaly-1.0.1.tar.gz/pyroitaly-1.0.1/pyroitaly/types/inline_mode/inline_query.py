...
class InlineQuery(Object, Update):
    ...
    Parameters:
        ...
        chat_type (:obj:`~pyroitaly.enums.ChatType`, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the query of this inline query. Only applicable when using :obj:`Filters.regex <pyroitaly.Filters.regex>`.
    """
    ...
    async def answer(
        ...
        """Bound method *answer* of :obj:`~pyroitaly.types.InlineQuery`.
        ...
        Parameters:
            results (List of :obj:`~pyroitaly.types.InlineQueryResult`):
