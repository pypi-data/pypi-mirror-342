...
import pyroitaly
from pyroitaly import __version__, __license__
from pyroitaly import enums
from pyroitaly import raw
from pyroitaly import utils
from pyroitaly.crypto import aes
from pyroitaly.errors import CDNFileHashMismatch
from pyroitaly.errors import (
...
from pyroitaly.methods import Methods
from pyroitaly.session import Auth, Session
from pyroitaly.storage import FileStorage, MemoryStorage, Storage
from pyroitaly.types import User, TermsOfService
from pyroitaly.utils import ainput
...
try:
    ...
    from pyroitaly.storage import MongoStorage
    MONGO_AVAIL = True
...
class Client(Methods):
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~pyroitaly.Client.export_session_string` before stopping the client to get a session string you can
        ...
        storage (:obj:`~pyroitaly.storage.Storage`, *optional*):
        ...
        client_platform (:obj:`~pyroitaly.enums.ClientPlatform`, *optional*):
    ...
    def __init__(
        ...
        self.listeners = {listener_type: [] for listener_type in pyroitaly.enums.ListenerTypes}
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~pyroitaly.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError("The API key is required for new authorizations. "
                                     "More info: https://pyroitaly.wulan17.top/main/start/auth")
    ...
    async def handle_download(self, packet):
        ...
        try:
            ...
            if isinstance(e, pyroitaly.errors.FloodWait):
                raise e
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except pyroitaly.StopTransmission:
                raise
            except pyroitaly.errors.FloodWait:
                raise
            except Exception as e:
                log.exception(e)
            finally:
