...
from pyroitaly.file_id import FileId, FileType, PHOTO_TYPES
...
class DownloadMedia:
    async def download_media(
        ...
        Parameters:
            message (:obj:`~pyroitaly.types.Message` | :obj:`~pyroitaly.types.Story` | ``str``):
        ...
        Returns:
            ...
            :meth:`~pyroitaly.Client.stop_transmission`, None is returned.
