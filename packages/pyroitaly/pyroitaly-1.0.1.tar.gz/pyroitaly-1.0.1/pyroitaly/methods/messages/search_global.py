...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~pyroitaly.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~pyroitaly.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~pyroitaly.types.Message` objects.
