...
import pyroitaly
from pyroitaly import StopTransmission, enums, raw, types, utils
...
class SendVideo:
    async def send_video(
        ...
        Returns:
            :obj:`~pyroitaly.types.Message` | ``None``: On success, the sent video message is returned, otherwise, in
