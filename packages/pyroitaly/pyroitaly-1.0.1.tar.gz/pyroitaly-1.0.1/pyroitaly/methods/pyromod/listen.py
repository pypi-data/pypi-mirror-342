...
from pyroitaly.errors import ListenerTimeout
...
class Listen:
    async def listen(
        ...
        listener_type: "pyroitaly.enums.ListenerTypes" = pyroitaly.enums.ListenerTypes.MESSAGE,
        ...
        Parameters:
            ...
            listener_type (:obj:`~pyroitaly.enums.ListenerTypes`, *optional*):
        ...
        Returns:
            :obj:`~pyroitaly.types.Message` | :obj:`~pyroitaly.types.CallbackQuery`: On success, a message/callbackquery is returned.
