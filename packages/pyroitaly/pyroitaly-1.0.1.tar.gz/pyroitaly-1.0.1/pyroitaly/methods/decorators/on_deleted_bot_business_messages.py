...
class OnDeletedBotBusinessMessages:
    def on_deleted_bot_business_messages(
        ...
        :obj:`~pyroitaly.handlers.DeletedBotBusinessMessagesHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroitaly.Client):
                self.add_handler(pyroitaly.handlers.DeletedBotBusinessMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroitaly.handlers.DeletedBotBusinessMessagesHandler(func, self),
