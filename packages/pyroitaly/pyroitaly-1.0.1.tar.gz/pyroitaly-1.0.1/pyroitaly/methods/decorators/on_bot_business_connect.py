...
class OnBotBusinessConnect:
    def on_bot_business_connect(
        ...
        :obj:`~pyroitaly.handlers.BotBusinessConnectHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroitaly.Client):
                self.add_handler(pyroitaly.handlers.BotBusinessConnectHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroitaly.handlers.BotBusinessConnectHandler(func, self),
