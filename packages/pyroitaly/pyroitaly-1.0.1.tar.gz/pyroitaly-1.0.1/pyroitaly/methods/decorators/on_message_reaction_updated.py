...
class OnMessageReactionUpdated:
    def on_message_reaction_updated(
        ...
        :obj:`~pyroitaly.handlers.MessageReactionUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroitaly.Client):
                self.add_handler(pyroitaly.handlers.MessageReactionUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroitaly.handlers.MessageReactionUpdatedHandler(func, self),
