...
class OnShippingQuery:
    def on_shipping_query(
        ...
        :obj:`~pyroitaly.handlers.ShippingQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroitaly.Client):
                self.add_handler(pyroitaly.handlers.ShippingQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroitaly.handlers.ShippingQueryHandler(func, self),
