...
class OnPreCheckoutQuery:
    def on_pre_checkout_query(
        ...
        :obj:`~pyroitaly.handlers.PreCheckoutQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroitaly.Client):
                self.add_handler(pyroitaly.handlers.PreCheckoutQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroitaly.handlers.PreCheckoutQueryHandler(func, self),
