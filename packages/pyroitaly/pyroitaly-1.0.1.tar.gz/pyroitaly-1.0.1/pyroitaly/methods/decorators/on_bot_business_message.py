...
class OnBotBusinessMessage:
    def on_bot_business_message(
        ...
        :obj:`~pyroitaly.handlers.BotBusinessMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroitaly.Client):
                self.add_handler(pyroitaly.handlers.BotBusinessMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroitaly.handlers.BotBusinessMessageHandler(func, self),
