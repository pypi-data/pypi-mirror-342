...
async def compose(
    ...
    If you want to run a single client, you can use Client's bound method :meth:`~pyroitaly.Client.run`.

    Parameters:
        clients (List of :obj:`~pyroitaly.Client`):
    ...
    Example:
        .. code-block:: python
            ...
            import asyncio
            from pyroitaly import Client, compose
