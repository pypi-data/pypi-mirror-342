...
from pyroitaly import types, raw, utils
...
class SendInvoice:
    async def send_invoice(
        ...
        Parameters:
            ...
            prices (:obj:`~pyroitaly.types.LabeledPrice` | List of :obj:`~pyroitaly.types.LabeledPrice`):
                Price with label.
            ...
            extended_media (:obj:`~pyroitaly.types.InputMedia`, *optional*):
                Additional media.
