...
from pyroitaly.types import Message, Identifier
...
class BotBusinessMessageHandler(Handler):
    ...
    :meth:`~pyroitaly.Client.on_bot_business_message` decorator.
    ...
    Other parameters:
        ...
        message (:obj:`~pyroitaly.types.Message`):
    ...
    async def check_if_has_matching_listener(self, client: "pyroitaly.Client", message: Message):
        """
        ...
        listener = client.get_listener_matching_with_data(data, pyroitaly.enums.ListenerTypes.MESSAGE)
    ...
    async def check(self, client: "pyroitaly.Client", message: Message):
        """
    ...
    async def resolve_future_or_callback(self, client: "pyroitaly.Client", message: Message, *args):
        """
        ...
        if listener and listener_does_match:
            ...
            if listener.future and not listener.future.done():
                ...
                raise pyroitaly.StopPropagation
