        ...
        while True:
            ...
            try:
                ...
                if silentMode is False:
                    ...
                    if self.keystackLogger: self.keystackLogger.info(statusCode)
                    print(statusCode)
                ...
                if restExecutionFailures < maxRetries:
                    getError = f'GET error: {traceback.format_exc(None, errMsg)}'
                    if self.keystackLogger: self.keystackLogger.error(getError)
                    print(getError)
                    ...
                    if response.status_code != 200:
                        ...
                        if ignoreError == False:
                            if 'errors' in response.json():
                                ...
                                if self.keystackLogger: self.keystackLogger.error(errMsg)
                                print(errMsg)
                                
                            if self.keystackLogger: self.keystackLogger.error(f'POST error: {response.text}\n')
