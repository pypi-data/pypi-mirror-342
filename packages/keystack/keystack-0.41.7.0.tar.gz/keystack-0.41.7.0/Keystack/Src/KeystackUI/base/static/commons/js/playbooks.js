...
const closeText = () => {
    ...
    document.querySelector('#modifyPlaybookButton').style.display = "none";
...
const getTableData = async () => {
    ...
    document.querySelector('#topbarTitlePage').innerHTML = `Playbooks&emsp;|&emsp;${domain} &ensp;&ensp;${playbookGroup}`;
