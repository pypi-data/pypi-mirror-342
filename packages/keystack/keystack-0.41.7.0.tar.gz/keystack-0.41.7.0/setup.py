...
# Assuming that the dev folder is in /opt/Keystack
# currentDir: /opt/Keystack/BuildPackages
currentDir = os.path.abspath(os.path.dirname(__file__))
rootPath = '/opt/Keystack'
srcPath = '/opt/Keystack/Src'
...
# /opt/Keystack/BuildPackages/PackageKeystack/Keystack. 
