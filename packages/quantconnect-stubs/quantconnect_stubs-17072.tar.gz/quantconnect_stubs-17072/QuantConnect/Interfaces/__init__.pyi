...
class IAlgorithm(QuantConnect.Interfaces.ISecurityInitializerProvider, QuantConnect.Interfaces.IAccountCurrencyProvider, metaclass=abc.ABCMeta):
    ...
    def on_end_of_day(self, symbol: typing.Union[QuantConnect.Symbol, str, QuantConnect.Data.Market.BaseContract]) -> None:
...
class IShortableProvider(metaclass=abc.ABCMeta):
    ...
    def fee_rate(self, symbol: typing.Union[QuantConnect.Symbol, str, QuantConnect.Data.Market.BaseContract], local_time: typing.Union[datetime.datetime, datetime.date]) -> float:
        """
    ...
    def rebate_rate(self, symbol: typing.Union[QuantConnect.Symbol, str, QuantConnect.Data.Market.BaseContract], local_time: typing.Union[datetime.datetime, datetime.date]) -> float:
        """
    ...
    def shortable_quantity(self, symbol: typing.Union[QuantConnect.Symbol, str, QuantConnect.Data.Market.BaseContract], local_time: typing.Union[datetime.datetime, datetime.date]) -> typing.Optional[int]:
        """
