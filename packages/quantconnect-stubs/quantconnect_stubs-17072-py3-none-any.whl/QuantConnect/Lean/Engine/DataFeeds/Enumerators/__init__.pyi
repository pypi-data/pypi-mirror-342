...
class SortEnumerator(typing.Generic[QuantConnect_Lean_Engine_DataFeeds_Enumerators_SortEnumerator_TKey], System.Object):
    ...
    def __init__(self, data: typing.Iterable[QuantConnect.Data.BaseData], key_selector: typing.Callable[[QuantConnect.Data.BaseData], QuantConnect_Lean_Engine_DataFeeds_Enumerators_SortEnumerator_TKey] = None) -> None:
        """
...
class ScheduledEnumerator(System.Object):
    ...
    def __init__(self, underlying_enumerator: System.Collections.Generic.IEnumerator[QuantConnect.Data.BaseData], scheduled_times: typing.Iterable[datetime.datetime], frontier_time_provider: QuantConnect.ITimeProvider, schedule_time_zone: typing.Any, start_time: typing.Union[datetime.datetime, datetime.date]) -> None:
        """
        Creates a new instance
