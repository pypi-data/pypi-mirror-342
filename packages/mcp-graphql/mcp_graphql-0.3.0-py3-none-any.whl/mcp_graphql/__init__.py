...
@click.option(
    "--auth-headers",
    type=JsonParamType(),
    help='Custom authentication headers as JSON string (e.g. \'{"Authorization": "Bearer token", "X-API-Key": "key"}\')',
)
def main(api_url: str, auth_token: str | None, auth_type: str, auth_headers: dict | None) -> None:
