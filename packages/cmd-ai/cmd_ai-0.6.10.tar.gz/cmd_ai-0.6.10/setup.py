...
setup(
    ...
    install_requires=["fire", "console", "click", "pandas", "openai", "prompt_toolkit","googlesearch-python","unidecode", "anthropic",  "google-api-python-client", "google-auth-httplib2", "google-auth-oauthlib" ,"tiktoken","selenium", "beautifulsoup4", "sympy" ,"webdriver-manager","Pillow"]
)
