...
from energymeter2mqtt.cli_dev import PACKAGE_ROOT, app
...
def install():
    """
    Install requirements and 'energymeter2mqtt' via pip as editable.
    """
...
def publish():
    ...
    publish_package(module=energymeter2mqtt, package_path=PACKAGE_ROOT)
