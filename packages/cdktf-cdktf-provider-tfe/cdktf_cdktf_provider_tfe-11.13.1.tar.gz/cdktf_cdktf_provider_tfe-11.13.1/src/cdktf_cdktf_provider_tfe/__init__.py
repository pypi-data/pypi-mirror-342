r'''
# CDKTF prebuilt bindings for hashicorp/tfe provider version 0.65.1

This repo builds and publishes the [Terraform tfe provider](https://registry.terraform.io/providers/hashicorp/tfe/0.65.1/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform tfe provider](https://registry.terraform.io/providers/hashicorp/tfe/0.65.1)
