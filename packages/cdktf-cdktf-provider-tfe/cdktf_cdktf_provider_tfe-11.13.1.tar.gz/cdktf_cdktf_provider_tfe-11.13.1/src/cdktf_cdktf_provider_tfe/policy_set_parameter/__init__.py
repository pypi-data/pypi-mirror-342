...
Refer to the Terraform Registry for docs: [`tfe_policy_set_parameter`](https://registry.terraform.io/providers/hashicorp/tfe/0.65.1/docs/resources/policy_set_parameter).
'''
...
class PolicySetParameter(
    ...
    def __init__(
        ...
        *,
        ...
        :param key: Name of the parameter. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.65.1/docs/resources/policy_set_parameter#key PolicySetParameter#key}
        :param policy_set_id: The ID of the policy set that owns the parameter. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.65.1/docs/resources/policy_set_parameter#policy_set_id PolicySetParameter#policy_set_id}
        :param sensitive: Whether the value is sensitive. If true then the parameter is written once and not visible thereafter. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.65.1/docs/resources/policy_set_parameter#sensitive PolicySetParameter#sensitive}
        :param value: Value of the parameter. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.65.1/docs/resources/policy_set_parameter#value PolicySetParameter#value}
        :param value_wo: Value of the parameter in write-only mode. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.65.1/docs/resources/policy_set_parameter#value_wo PolicySetParameter#value_wo}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing PolicySetParameter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.65.1/docs/resources/policy_set_parameter#import import section} in the documentation of this resource for the id to use
