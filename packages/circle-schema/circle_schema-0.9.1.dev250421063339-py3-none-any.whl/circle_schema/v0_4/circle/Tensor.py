...
class Tensor(object):
    ...
    def Quantization(self):
        ...
        if o != 0:
            ...
            from circle_schema.v0_4.circle.QuantizationParameters import QuantizationParameters
    ...
    def Sparsity(self):
        ...
        if o != 0:
            x = self._tab.Indirect(o + self._tab.Pos)
            from circle_schema.v0_4.circle.SparsityParameters import SparsityParameters
...
def TensorEnd(builder):
    ...
    return End(builder)
import circle_schema.v0_4.circle.QuantizationParameters
import circle_schema.v0_4.circle.SparsityParameters
try:
...
class TensorT(object):
    ...
    def __init__(self):
        ...
        self.quantization = None  # type: Optional[circle_schema.v0_4.circle.QuantizationParameters.QuantizationParametersT]
        self.isVariable = False  # type: bool
        self.sparsity = None  # type: Optional[circle_schema.v0_4.circle.SparsityParameters.SparsityParametersT]
    ...
    def _UnPack(self, tensor):
        ...
        if tensor.Quantization() is not None:
            self.quantization = circle_schema.v0_4.circle.QuantizationParameters.QuantizationParametersT.InitFromObj(tensor.Quantization())
        self.isVariable = tensor.IsVariable()
        if tensor.Sparsity() is not None:
            self.sparsity = circle_schema.v0_4.circle.SparsityParameters.SparsityParametersT.InitFromObj(tensor.Sparsity())
