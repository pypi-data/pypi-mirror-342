        ...
        while True:
            ...
            if user_prompt == "h":
                ...
                if pipeline == "1" or pipeline == 1:
                    logger.debug("\n #### The `SnowX` is currently embarking on a quest to locate relevant files.")
                    ...
                    logger.debug("\n #### The `SnowX` is presently engaged in processing your query and formulating a comprehensive response.")
