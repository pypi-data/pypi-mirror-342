...
class IdeaDevelopment:
    ...
    def initial_setup(self, role, crawl_logs, context, file_attachments, assets_link):
        ...
        system_prompt = (
            ...
            "- MANDATORY: Include a color system with appropriate color roles (primary, secondary, etc.)\n"
            "- MANDATORY: Define typography specifications appropriate for the project\n"
            "- Example: 'Navigation Component: Describe layout, color scheme, typography, animations, and responsive behavior'\n"
            "- Example: 'Content Display Component: Describe layout approach, responsive behavior, and interaction patterns'\n"
            "- MANDATORY: Ensure all interactive elements have appropriate states (hover/focus/active)\n"
            "- MANDATORY: Consider accessibility requirements including color contrast and keyboard navigation\n"
