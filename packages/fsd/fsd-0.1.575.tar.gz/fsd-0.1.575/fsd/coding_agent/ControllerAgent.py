...
"""
                        ...
                        user_prompt = f"As an expert {'SVG designer' if is_svg else f'{techStack} developer'}, implement the following task:\n"
                        user_prompt += f"File: {file_name}\n"
                        
                        if is_svg:
                            user_prompt += "Create a visually appealing SVG design with elegant UI.\n"
                        else:
                            user_prompt += (
                                "Guidelines:\n"
                                "- Only use variables, functions, and imports that are needed\n"
                                "- Follow project structure for correct imports\n"
                                "- Use appropriate syntax for the tech stack\n"
                                "- Ensure proper error handling and data flow\n"
                                "- Analyze relevant files before coding\n"
                            )
