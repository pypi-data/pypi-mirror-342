...
class IdeaDevelopment:
    ...
    def initial_setup(self, role, crawl_logs, context, file_attachments, assets_link):
        ...
        system_prompt = (
            f"You are a senior {role} architect. Analyze the project files and develop a production-ready implementation plan that balances speed with scalability. Your plan must be clear, specific, and build a foundation for future growth. Follow these guidelines:\n\n"
