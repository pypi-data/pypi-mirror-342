...
class ContextPrepareAgent:
    ...
    async def get_file_planning(self, idea, file_attachments, focused_files, assets_link):
        ...
        prompt = (
            ...
            "2. Configuration files relevant to the task (package.json, tsconfig.json, .eslintrc, pom.xml, requirements.txt, etc.) "
            "3. Route definition files (routes.js, urls.py, web.php, etc.) based on the tech stack "
            "4. Model/schema definitions related to the task "
            "5. Service/controller/component files that implement related functionality "
            "6. Test files for components being modified "
            "7. Utility files referenced by the above files "
