...
class IdeaDevelopment:
    ...
    def initial_setup(self, role, crawl_logs, context, file_attachments, assets_link):
        ...
        system_prompt = (
            ...
            "- MANDATORY: Include basic layout structure and component hierarchy\n"
            "- Example: 'LoginForm: Email input (with validation), password input (with masking), submit button, error message display. State: form values, validation errors, loading state'\n\n"
