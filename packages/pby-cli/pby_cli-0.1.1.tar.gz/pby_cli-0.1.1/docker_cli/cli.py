...
from docker_cli.docker_logic.cli_functions.util import copy_files_from_package, parse_packages
...
def run(
    ...
    workspace: Path = typer.Option(None, help="Dossier du code source à monter"),
