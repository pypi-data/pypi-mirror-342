...
setup(
    name='faketaxi',  # * Your package will have this name
    packages=['invoicing'],  # * Name the package again
    version='6.9',  # * To be increased every time your change your library
    ...
    author='Sky Cowboy',  # Your name
    author_email='skycowboy@noreply.com',  # Your email
    url='https://skycowboy.com',  # Homepage of your library (e.g. github or your website)
    keywords=['taxi', 'fake taxi', 'fake'],  # Keywords users can search on pypi.org
