...
class xy_common:
	...
	def __init__(self):
		...
		self.varx["holiday_list"] =  self.varx["solar_holiday_list"].extend(self.varx["lunar_holiday_list"])
		...
		self.varx["data"]["암호변경_jamo_vs_eng"] = {
		...
		self.varx["data"]["암호변경_eng_vs_jamo"] = {
		...
		self.varx["data"]["암호변경_eng_jamo_pair"] = [
			[['sox', 'ㅙ'], ['ugx', 'ㅞ'],],
		...
		self.varx["data"]["전국_인구수_변화_2000년_에서_2023년"] = [
		...
		self.varx["data"]["기자재_이름변경용_l2d_02"] = {"밸브": "valve", "교반기": "agitator", "아지테이터": "agitator",
		...
		self.varx["data"]["님의침묵_시"] = """한용운의 시, 님의 침묵
...
제 곡조를 못 이기는 사랑의 노래는 님의 침묵을 휩싸고 돕니다"""
		...
		self.varx["data"]["2차원_복합자료_001_l2d"] = [[11, 12, 13, 14, 15, 16, 17, 18, 19],
		...
		self.varx["data"]["2차원_복합자료_002_l2d"] = [
		...
		self.varx["data"]["비교자료형_숫자묶음_l2d_01"] = [[11, 12, 13, 14, 15, 16, 17, 18, 19],
												  [21, 22, 23, 24, 25, 26, 27, 28, 29],
												  [31, 32, 33, "abc", 35, 36, 37, 38, "zzz"],
												  [41, 42, 43, 44, 45, 46, 47, 48, ""],
												  [51, 52, 53, 54, 55, 56, 57, 58, 59],
		...
		self.varx["data"]["기자재_vs_영어"] = {"밸브": "valve", "교반기": "agitator", "아지테이터": "agitator",
							   "송풍기": "blower", "블로어": "blower", "s/p": "spare part",
							   "케이블": "cable", "스페어파트": "spare part", "컨트롤밸브": "control valve",
							   "컨트롤벨브": "control valve",
							   "컨테이너": "container", "정화관": "", "배터리": "battery", "차저": "charger",
		...
		self.varx["data"]["정규표현식_여러샘플"] = {"abc중 c만 1번이상 반복되는것 찾기": [4, "abc[1~]", "type_z0"],
		...
		self.varx["data"]["그리드용_자료_001"] = [{"x": 2, "y": 1, "kind_1": "basic", "kind_2": "date", "value": datetime.datetime(2002, 2, 2)},
		...
		self.varx["data"]["님의침묵_시_02"] ="""1한용운의 시, 님의 침묵
2
...
"""
		...
		self.varx["data"]["글자분석용_9줄자료"] = """1: 1234567890가나다라마바사아자차카파파하
...
"""
		...
		self.varx["data"]["여러자료형자료_01"] = [
			"1번째열_2번째", 'A1', "", None,  [], (), '러시아_인가?', 'Capital', 'Moscow', '면적---', 6601670,   '인구', "14617_1015"]

		self.varx["data"]["여러자료형자료_02"] = [12345, 12345.67, "1234567",
						'A1B2', "가나다#$%@", None, [],
						(), 'abcd=efgh', 'Capital',
						'Moscow', '면적---', 6601670,
						'인구', "14617_1015"]

		self.varx["data"]["여러_시간과_날짜용자료"] = [
			"20230301",
			'02/28/2023 02:30 PM',
			'180919 015519',
			'18/09/19 01:55:19',
		...
		self.varx["data"]["기자재_종류들_l1d"] = ['fitting', 'ball',
										'flowmeter', 'on-off',
										'battery', 'flange',
										'electric', 'cable',
										'gasket', 'seal',
		...
		self.varx["data"]["나라이름들"] = ['가나', '가봉', '가이아나',
								 '감비아', '과테말라', '그레나다',
								 '그루지야',
								 '그리스', '기니', '기니비사우',
								 '나미비아', '나우루', '나이지리아',
		...
		self.varx["data"]["엑셀입력용_자료들_l2d"]=[["엑셀","쓰기", "3333셀(2,2)에 값넣기", """excel.write_value_in_cell("", [2, 2], "테스트입니다")"""],
		...
		self.varx["data"]["나라이름들_l2d"] = [['가나', '가봉', '가이아나', '감비아', '과테말라', '그레나다', '그루지야'],
		...
		self.varx["data"]["비교자료형_숫자묶음_l2d_02"] = [["abc", "abc", 13, 14, 15, 16, 17, 18, 19],
												  ["abc", 22, 23, "abc", 25, 26, 27, 28, "zzz"],
												  [31, 32, 33, "abc", "abc", 36, 37, 38, "zzz"],
												  ["3/1", 42, 43, "3/1", "3/1", 46, 47, 48, ""],
												  [51, "가나다", "3/1", 54, 55, 56, 57, 58, 59],
		...
		self.varx["data"]["win32api_마우스이벤트코드"] = """
