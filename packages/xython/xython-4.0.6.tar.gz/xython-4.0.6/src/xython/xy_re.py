...
class xy_re:
    ...
    def change_with_list_1d(self, input_xsql, list_1d, changed_text=""):
        """
    ...
    def concate_xyre_result(self, input_list_2d, chain_word=": "):
        """
    ...
    def delete_with_list_1d(self, input_xsql, list_1d):
        """
    ...
    def match_for_list_2d_by_xsql(self, input_xsql,input_l2d):
        """
    ...
    def search_again_for_searched_result(self, result_list_2d, input_xsql):
        """
        ...
        for list_1d in result_list_2d:
            start_no = list_1d[1]
            temp_2d = self.search_with_xsql(input_xsql, list_1d[0])
            if temp_2d:
    ...
    def search_for_ip_address(self, input_text):
        ...
        :return:
		"""
        resql = "((?:(?:25[0-5]|2[0-4]\\d|[01]?\\d?\\d)\\.){3}(?:25[0-5]|2[0-4]\\d|[01]?\\d?\\d))"
        result = self.search_with_resql(resql, input_text)
        return result
