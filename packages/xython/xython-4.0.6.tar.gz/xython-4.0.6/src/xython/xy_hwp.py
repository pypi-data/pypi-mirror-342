...
class xy_hwp:
	...
	def set_basic_font_style(self, **input_dic):
		...
		if "color" in input_dic.keys():
			self.varx["han"]["rgb_int"] = self.colorx.change_xcolor_to_rgbint(input_dic["color"])
	...
	def set_font_color_for_selection_by_xcolor(self, input_xcolor):
		...
		:return:
		"""
		input_rgb = self.colorx.change_xcolor_to_rgb(input_xcolor)
	...
	def write_today_at_cursor(self):
		...
		:return:
		"""
		yyyymmdd = self.timex.get_yyyy_mm_dd_for_today()
