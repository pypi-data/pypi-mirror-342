...
def main():
    ...
    # draft_list = wechat.get_draft_list(offset=0, count=5, no_content=True)
    # print(draft_list)
    # if draft_list:
    #     print("获取到草稿列表：")
    ...
    # e. 创建草稿
    # 示例：新增永久图片素材
    # ['7W9OX-_svPHG2Ejnx73Q201O3lqOYmeZm-xRfAqQ-0TRoTe8FRB3dZiv2cuOCW8W', 'http://mmbiz.qpic.cn/sz_mmbiz_jpg/OAeCMzEJygKtKZYe6Z247zMsOl4lbXAicBFUOICzKqLHrboGoPvjZvjZC8a2sK75FzzIWTboRgMxBaddGIIiargg/0?wx_fmt=jpeg']
    # image_info = wechat.add_permanent_material(material_type="image", file_path="./test.jpg")
    # cover_image_id = image_info[0]
    # cover_image_id = "7W9OX-_svPHG2Ejnx73Q201O3lqOYmeZm-xRfAqQ-0TRoTe8FRB3dZiv2cuOCW8W"
