...
#                   parity=re.sub(".0$",".",parity)
          ...
          if item["coded_information"] is not None:
            ...
            if item["coded_information"]["author"] is not None:
              ...
              f.write(",")
            if item["coded_information"]["subaccession_number"] is not None:
              f.write(item["coded_information"]["subaccession_number"]+",")
            else:
              f.write(",")
          ...
          if item["coded_information"] is not None:
            ...
            if item["coded_information"]["subaccession_number"] is not None:
              f.write("("+item["coded_information"]["status"][0]+","+\
                          ...
                          item["coded_information"]["subaccession_number"]+")")
