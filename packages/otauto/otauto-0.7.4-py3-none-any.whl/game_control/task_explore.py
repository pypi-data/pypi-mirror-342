...
class Explore(TaskLogic):
    ...
    def __init__(self,vnc,vnc_port,queue_handle ,dungeons_name):
        ...
        self.filter_par = basic_parameter["filter"]
    ...
    def task_解除控制(self):
        # 截图
        # numpy_data=self.capture_as_numpy()
        logger.debug("解除控制")
        filter_res = template_match(self.data_numpy, self.filter_par)
