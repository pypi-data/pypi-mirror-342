...
def build(
    ...
    copy_files_from_package("docker_cli.docker_logic.conf_files", "", "./conf_files_copy")
    copy_files_from_package("docker_cli.docker_logic.templates", "", "./templates_copy")
    copy_files_from_package("docker_cli.docker_logic.scripts", "", "./scripts_copy")
