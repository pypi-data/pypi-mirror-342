...
# def get_from_args_or_env(cli_arg: str, args: argparse.Namespace, env_arg:Optional[str] = None,) -> str:
#     """
#     Pull a value from parsed arparse, if it's not there look for it
#     in the environment. Optionally provide a different name for this environment variable.
#     """
#     if getattr(args, cli_arg, False):
#         return args.arg

#     env_arg = env_arg if env_arg else cli_arg.replace("-", "_").upper()
#     if getenv(env_arg):
