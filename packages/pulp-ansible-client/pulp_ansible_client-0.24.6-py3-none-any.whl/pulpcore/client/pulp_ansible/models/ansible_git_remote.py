...
class AnsibleGitRemote(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["sock_read_timeout", "max_retries", "client_cert", "proxy_username", "connect_timeout", "proxy_password", "rate_limit", "username", "url", "headers", "download_concurrency", "ca_cert", "sock_connect_timeout", "pulp_labels", "password", "total_timeout", "tls_validation", "client_key", "proxy_url", "name", "metadata_only", "git_ref"]
