...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, client_cert=None, pulp_href=None, headers=None, sock_read_timeout=None, url=None, name=None, rate_limit=None, sock_connect_timeout=None, pulp_labels=None, connect_timeout=None, max_retries=None, total_timeout=None, pulp_last_updated=None, pulp_created=None, ca_cert=None, proxy_url=None, tls_validation=None, download_concurrency=None, hidden_fields=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
