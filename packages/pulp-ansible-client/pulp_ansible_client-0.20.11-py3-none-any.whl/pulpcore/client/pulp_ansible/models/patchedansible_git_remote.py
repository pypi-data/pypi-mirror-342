...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, client_cert=None, username=None, headers=None, sock_read_timeout=None, password=None, url=None, name=None, client_key=None, rate_limit=None, proxy_username=None, sock_connect_timeout=None, pulp_labels=None, connect_timeout=None, max_retries=None, total_timeout=None, ca_cert=None, proxy_url=None, tls_validation=None, download_concurrency=None, proxy_password=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
