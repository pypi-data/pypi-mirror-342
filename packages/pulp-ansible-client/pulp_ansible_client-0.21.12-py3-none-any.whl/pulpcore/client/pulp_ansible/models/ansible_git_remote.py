...
class AnsibleGitRemote(object):
    ...
    def __init__(self, proxy_password=None, username=None, tls_validation=None, sock_connect_timeout=None, url=None, ca_cert=None, name=None, headers=None, client_key=None, sock_read_timeout=None, max_retries=None, pulp_labels=None, connect_timeout=None, proxy_url=None, client_cert=None, rate_limit=None, total_timeout=None, password=None, download_concurrency=None, proxy_username=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
