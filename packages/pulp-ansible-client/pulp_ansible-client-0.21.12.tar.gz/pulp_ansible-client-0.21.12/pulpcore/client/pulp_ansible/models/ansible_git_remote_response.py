...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, tls_validation=None, sock_connect_timeout=None, url=None, ca_cert=None, pulp_href=None, name=None, headers=None, sock_read_timeout=None, max_retries=None, pulp_labels=None, connect_timeout=None, proxy_url=None, client_cert=None, pulp_last_updated=None, rate_limit=None, pulp_created=None, total_timeout=None, download_concurrency=None, hidden_fields=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
