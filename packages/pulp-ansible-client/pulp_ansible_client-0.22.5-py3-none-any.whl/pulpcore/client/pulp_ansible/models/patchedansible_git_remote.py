...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, proxy_url=None, pulp_labels=None, ca_cert=None, total_timeout=None, sock_read_timeout=None, username=None, client_cert=None, sock_connect_timeout=None, name=None, max_retries=None, download_concurrency=None, proxy_password=None, rate_limit=None, tls_validation=None, password=None, url=None, headers=None, connect_timeout=None, client_key=None, proxy_username=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
