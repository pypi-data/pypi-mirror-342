...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, proxy_url=None, pulp_labels=None, ca_cert=None, total_timeout=None, pulp_last_updated=None, sock_read_timeout=None, client_cert=None, pulp_created=None, sock_connect_timeout=None, name=None, hidden_fields=None, max_retries=None, prn=None, download_concurrency=None, rate_limit=None, tls_validation=None, url=None, headers=None, pulp_href=None, connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
