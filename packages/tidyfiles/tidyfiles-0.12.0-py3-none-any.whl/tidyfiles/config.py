...
def get_settings(
    ...
    enable_console_logging: bool = DEFAULT_SETTINGS["enable_console_logging"],
    enable_file_logging: bool = DEFAULT_SETTINGS["enable_file_logging"],
    console_log_level: str = DEFAULT_SETTINGS["console_log_level"],
    file_log_level: str = DEFAULT_SETTINGS["file_log_level"],
    log_file_name: str = DEFAULT_SETTINGS["log_file_name"],
    log_folder_name: str = DEFAULT_SETTINGS["log_folder_name"],
    file_mode: str = DEFAULT_SETTINGS["file_mode"],
    log_rotation: str = DEFAULT_SETTINGS["log_rotation"],
    log_retention: str = DEFAULT_SETTINGS["log_retention"],
    ...
    settings = {
        ...
        "enable_console_logging": raw_settings["enable_console_logging"],
        "enable_file_logging": raw_settings["enable_file_logging"],
        "console_log_level": raw_settings["console_log_level"],
        "file_log_level": raw_settings["file_log_level"],
        "log_file_path": log_file_path,
        "file_mode": raw_settings["file_mode"],
        "log_rotation": raw_settings["log_rotation"],
        "log_retention": raw_settings["log_retention"],
