...
class Anonymiser:
    ...
    def anonymise(self, text: str = None, dataset: str = None) -> None:
        self.logger.info(
            "Anonymising text data. n.b 'anonymise' method overwrites the text column."
        )
        self._run(text=text, dataset=dataset, replace=True)
