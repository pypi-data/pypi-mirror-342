...
from petharbor.utils.advance_processor import ModelProcessor
...
class Anonymiser:
    ...
    def predict(
        ...
        self.logger.info(f"Anonymising text data. n.b 'predict' method predicts onto the {label_column} column.")
        self.label_column = label_column
        self._run(
            text=text, dataset=dataset, replace=False
        )
    ...
    def anonymise_predict(
        ...
        self.logger.info(f"Anonymising text data. n.b 'anonymise_predict' method predicts onto the {label_column} column and overwrites the text column.")
        self.label_column = label_column
        self._run(
            text=text, dataset=dataset, replace='both'
        )
