...
class AnnotationRequestCondensedDTOTypedDict(TypedDict):
    priority: int
...
class AnnotationRequestCondensedDTO(BaseModel):
    priority: int
    r"""The priority of an annotation request
    determines the order of processing within
    the project.
    ...
    clip_count: Annotated[int, pydantic.Field(alias="clipCount")]
    r"""The clips to be annotated
    in the request
    """
