...
ERROR_EXPRESSION_IS_BIGGER_THAN_MAX_OBJECT_SIZE = "Object exceeds maximum object size. To retrieve long objects, add them as watch expressions to a snapshot"
ERROR_EXPRESSION_IS_BIGGER_THAN_MAX_WATCH_EXPRESSION_SIZE = (
    "Object exceeds maximum length for a watch expression value. To increase the maximum watch expression value length, please refer to the documentation"
)
...
def toJson(err):
    return {"format": err.value, "id": err.id}
