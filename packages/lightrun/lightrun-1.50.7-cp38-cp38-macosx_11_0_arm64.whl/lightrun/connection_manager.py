...
class ConnectionManager(object):
    ...
    def SendHttpRequest(self, method, endpoint_path, request_body=None):
        ...
        return self.SendHttpRequestByteArray(method, endpoint_path, request_body)

    def SendHttpRequestByteArray(self, method, endpoint_path, request_body):
        """
        ...
        with self._OpenConnection() as conn:
            headers = {"Authorization": "Bearer " + lightrun_config.GetCompanySecret(), "Content-Type": "application/json"}
