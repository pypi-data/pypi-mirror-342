...
class V1AiAudioLdmAiGeneratedAudioDetectionPostRequest(BaseModel):
    """
    V1AiAudioLdmAiGeneratedAudioDetectionPostRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["contentAudioPath", "webhook"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V1AiAudioLdmAiGeneratedAudioDetectionPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V1AiAudioLdmAiGeneratedAudioDetectionPostRequest from a dict"""
        if obj is None:
            return None
