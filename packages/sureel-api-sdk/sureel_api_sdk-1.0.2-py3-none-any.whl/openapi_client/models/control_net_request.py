...
class ControlNetRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["prompt", "contentImagePath", "controlNet", "negativePrompt", "applyWatermark", "customWatermark", "stylePreset", "artistPreset", "inferenceSteps", "cfg", "seed", "generateAttribution", "batchSize", "generatePreview", "webhook"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ControlNetRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ControlNetRequest from a dict"""
        if obj is None:
            return None
