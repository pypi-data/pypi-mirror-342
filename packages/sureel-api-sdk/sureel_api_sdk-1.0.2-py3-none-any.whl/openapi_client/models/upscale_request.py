...
class UpscaleRequest(BaseModel):
    ...
    upscale: TextToImageRequestUpscale
    ...
    __properties: ClassVar[List[str]] = ["contentImagePath", "upscale", "applyWatermark", "customWatermark", "removeBg", "generatePreview", "webhook"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpscaleRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpscaleRequest from a dict"""
        if obj is None:
            return None
