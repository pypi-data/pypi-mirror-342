...
RESOLUTION_ANY_OF_SCHEMAS = ["str"]

class Resolution(BaseModel):
    """
    Desired resolution of the output image in the format {width}x{height}.
    """
    ...
    # data type: str
    anyof_schema_11_validator: Optional[StrictStr] = None
    # data type: str
    anyof_schema_12_validator: Optional[StrictStr] = None
    if TYPE_CHECKING:
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = Resolution.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in Resolution with anyOf schemas: str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Resolution with anyOf schemas: str. Details: " + ", ".join(error_messages))
        else:
            return instance
