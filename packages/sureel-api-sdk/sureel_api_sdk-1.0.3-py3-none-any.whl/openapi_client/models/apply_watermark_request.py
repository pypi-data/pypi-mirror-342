...
class ApplyWatermarkRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["contentImagePath", "customWatermark", "upscale", "removeBg", "generatePreview", "webhook"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApplyWatermarkRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApplyWatermarkRequest from a dict"""
        if obj is None:
            return None
