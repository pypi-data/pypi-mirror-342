...
class TestPromptHistoryEntry(unittest.TestCase):
    """PromptHistoryEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PromptHistoryEntry:
        """Test PromptHistoryEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PromptHistoryEntry`
        """
    ...
    def testPromptHistoryEntry(self):
        """Test PromptHistoryEntry"""
