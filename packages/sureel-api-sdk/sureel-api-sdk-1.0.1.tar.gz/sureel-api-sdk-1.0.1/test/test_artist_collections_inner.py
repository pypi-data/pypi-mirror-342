...
class TestArtistCollectionsInner(unittest.TestCase):
    """ArtistCollectionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArtistCollectionsInner:
        """Test ArtistCollectionsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArtistCollectionsInner`
        """
        model = ArtistCollectionsInner()
        if include_optional:
            return ArtistCollectionsInner(
                collection_uuid = '',
                username = '',
                collection_name = '',
    ...
    def testArtistCollectionsInner(self):
        """Test ArtistCollectionsInner"""
