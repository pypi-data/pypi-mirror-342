...
class StyleTransferRequest(BaseModel):
    ...
    """ # noqa: E501
    prompt: Optional[StrictStr] = Field(default=None, description="Optional text input to condition the image synthesis.     If provided, it should be brief, otherwise the prompt can overwrite the influence of the desired style specified in `artistPreset`.")
    ...
    artist_preset: Annotated[List[V1AiAudioLdmTextToArtistAudioPostRequestArtistPresetInner], Field(min_length=1, max_length=1)] = Field(description="List of artist collections who should contribute to the generated data.", alias="artistPreset")
    ...
    __properties: ClassVar[List[str]] = ["prompt", "contentImagePath", "negativePrompt", "applyWatermark", "customWatermark", "stylePreset", "artistPreset", "upscale", "inferenceSteps", "cfg", "seed", "strength", "generateAttribution", "batchSize", "removeBg", "generatePreview", "webhook"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StyleTransferRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StyleTransferRequest from a dict"""
        if obj is None:
            return None
