...
AIINFLUENCE_ANY_OF_SCHEMAS = ["str"]

class AiInfluence(BaseModel):
    """
    Whether the uploaded images are completely generated without AI, refined with AI, AI generated, or the AI influnce is unknown.
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = AiInfluence.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in AiInfluence with anyOf schemas: str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into AiInfluence with anyOf schemas: str. Details: " + ", ".join(error_messages))
        else:
            return instance
