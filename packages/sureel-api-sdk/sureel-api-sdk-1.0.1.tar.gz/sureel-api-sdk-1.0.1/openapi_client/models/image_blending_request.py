...
class ImageBlendingRequest(BaseModel):
    """
    ImageBlendingRequest
    """ # noqa: E501
    ...
    content_image_weight: Optional[ContentImageWeight] = Field(default=None, alias="contentImageWeight")
    ...
    __properties: ClassVar[List[str]] = ["prompt", "contentImagePath", "contentImageWeight", "styleImages", "negativePrompt", "applyWatermark", "customWatermark", "stylePreset", "upscale", "inferenceSteps", "cfg", "seed", "generateAttribution", "generateProvenance", "batchSize", "removeBg", "generatePreview", "webhook"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ImageBlendingRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of content_image_weight
        if self.content_image_weight:
            _dict['contentImageWeight'] = self.content_image_weight.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ImageBlendingRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "contentImageWeight": ContentImageWeight.from_dict(obj["contentImageWeight"]) if obj.get("contentImageWeight") is not None else None,
