...
class ReimagineRequest(BaseModel):
    ...
    artist_preset: Optional[List[V1AiAudioLdmTextToArtistAudioPostRequestArtistPresetInner]] = Field(default=None, alias="artistPreset")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReimagineRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReimagineRequest from a dict"""
        if obj is None:
            return None
