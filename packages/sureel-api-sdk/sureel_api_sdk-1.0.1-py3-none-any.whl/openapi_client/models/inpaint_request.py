...
class InpaintRequest(BaseModel):
    ...
    mask_image_path: StrictStr = Field(description="The `maskImagePath` can either be an image URL or the image path returned from the `/ldm/upload-images` or `/artist/post-upload-urls` endpoint.         Supported formats include JPG and PNG.", alias="maskImagePath")
    creative_inpainting: Optional[StrictBool] = Field(default=True, description="Flag whether to allow creative inpainting, where the masked part can also be slightly changed.", alias="creativeInpainting")
    ...
    artist_preset: Optional[Annotated[List[V1AiAudioLdmTextToArtistAudioPostRequestArtistPresetInner], Field(max_length=1)]] = Field(default=None, description="List of artist collections who should contribute to the generated data.", alias="artistPreset")
    ...
    __properties: ClassVar[List[str]] = ["prompt", "contentImagePath", "maskImagePath", "creativeInpainting", "negativePrompt", "applyWatermark", "customWatermark", "stylePreset", "artistPreset", "upscale", "inferenceSteps", "cfg", "seed", "strength", "generateAttribution", "batchSize", "removeBg", "generatePreview", "webhook"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InpaintRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InpaintRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "maskImagePath": obj.get("maskImagePath"),
            "creativeInpainting": obj.get("creativeInpainting") if obj.get("creativeInpainting") is not None else True,
            ...
            "cfg": obj.get("cfg"),
            "seed": obj.get("seed"),
            "strength": Strength.from_dict(obj["strength"]) if obj.get("strength") is not None else None,
