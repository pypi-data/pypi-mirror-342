...
class TestAnalysisHistoryEntryRequestDataAnyOf(unittest.TestCase):
    """AnalysisHistoryEntryRequestDataAnyOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalysisHistoryEntryRequestDataAnyOf:
        """Test AnalysisHistoryEntryRequestDataAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalysisHistoryEntryRequestDataAnyOf`
        """
        model = AnalysisHistoryEntryRequestDataAnyOf()
        if include_optional:
            return AnalysisHistoryEntryRequestDataAnyOf(
                user_id = '',
                request_id = '',
    ...
    def testAnalysisHistoryEntryRequestDataAnyOf(self):
        """Test AnalysisHistoryEntryRequestDataAnyOf"""
