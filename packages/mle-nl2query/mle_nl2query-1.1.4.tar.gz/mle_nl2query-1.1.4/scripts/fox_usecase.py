...
if __name__ == "__main__":
    load_dotenv()
    interrupt_before = ["intent_ambiguity_handler_node", "user_followup_query_node"]
    table_info = [
        "VW_NIELSEN_PROGRAM_VIEWERSHIP_DAILY",
        "DIM_CONFORMED_NETWORK",
    ]
    table_selector_instance = TableSelector(table_info=table_info)
