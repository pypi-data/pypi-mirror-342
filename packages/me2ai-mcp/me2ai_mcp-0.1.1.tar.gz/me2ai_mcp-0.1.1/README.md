...
The ME2AI MCP package extends the official MCP (Model Context Protocol) package with enhanced functionality for building robust MCP servers with standardized patterns, tools, and utilities. Version 0.1.1 introduces comprehensive database integrations with PostgreSQL and MySQL, plus improved LangChain compatibility for seamless integration with agent frameworks.
