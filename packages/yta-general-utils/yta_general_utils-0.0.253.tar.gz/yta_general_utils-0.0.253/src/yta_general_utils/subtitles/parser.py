...
def parse_srv1(text: str) -> Subtitles:
    """
...
def parse_srv2(text: str) -> Subtitles:
    """
...
def parse_srv3(text: str) -> Subtitles:
    """
...
def parse_json3(json: dict) -> Subtitles:
    """
...
def parse_vtt(text: str) -> Subtitles:
    """
...
def parse_ttml(text: str) -> Subtitles:
