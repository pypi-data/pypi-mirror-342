...
from ...types import (
    trackdetail_list_params,
    trackdetail_count_params,
    trackdetail_tuple_params,
    trackdetail_create_bulk_params,
)
from .history import (
    HistoryResource,
...
class TrackdetailsResource(SyncAPIResource):
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"ts": ts}, trackdetail_list_params.TrackdetailListParams),
            ),
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"ts": ts}, trackdetail_count_params.TrackdetailCountParams),
            ),
            cast_to=str,
        )
    ...
    def create_bulk(
        self,
        *,
        body: Iterable[trackdetail_create_bulk_params.Body],
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        return self._post(
            ...
            body=maybe_transform(body, Iterable[trackdetail_create_bulk_params.Body]),
            options=make_request_options(
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    trackdetail_tuple_params.TrackdetailTupleParams,
                ),
            ),
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"ts": ts}, trackdetail_list_params.TrackdetailListParams),
            ),
            cast_to=TrackdetailListResponse,
        )
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"ts": ts}, trackdetail_count_params.TrackdetailCountParams),
            ),
            cast_to=str,
        )
    ...
    async def create_bulk(
        ...
        *,
        ...
        return await self._post(
            "/udl/trackdetails/createBulk",
            body=await async_maybe_transform(body, Iterable[trackdetail_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class TrackdetailsResourceWithRawResponse:
    def __init__(self, trackdetails: TrackdetailsResource) -> None:
        self._trackdetails = trackdetails
        ...
        self.create_bulk = to_raw_response_wrapper(
            trackdetails.create_bulk,
        )
        self.queryhelp = to_raw_response_wrapper(
            trackdetails.queryhelp,
        )
    ...
    def history(self) -> HistoryResourceWithRawResponse:
        return HistoryResourceWithRawResponse(self._trackdetails.history)


class AsyncTrackdetailsResourceWithRawResponse:
    def __init__(self, trackdetails: AsyncTrackdetailsResource) -> None:
        self._trackdetails = trackdetails
    ...
    def history(self) -> AsyncHistoryResourceWithRawResponse:
        return AsyncHistoryResourceWithRawResponse(self._trackdetails.history)
...
class TrackdetailsResourceWithStreamingResponse:
    ...
    def history(self) -> HistoryResourceWithStreamingResponse:
        return HistoryResourceWithStreamingResponse(self._trackdetails.history)
...
class AsyncTrackdetailsResourceWithStreamingResponse:
    ...
    def history(self) -> AsyncHistoryResourceWithStreamingResponse:
        return AsyncHistoryResourceWithStreamingResponse(self._trackdetails.history)
