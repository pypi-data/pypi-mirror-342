...
from ..types import airloadplan_update_params
...
class AirloadplansResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        air_load_plan_hazmat_actuals: Iterable[airloadplan_update_params.AirLoadPlanHazmatActual]
        | NotGiven = NOT_GIVEN,
        air_load_plan_hr: Iterable[airloadplan_update_params.AirLoadPlanHr] | NotGiven = NOT_GIVEN,
        air_load_plan_pallet_details: Iterable[airloadplan_update_params.AirLoadPlanPalletDetail]
        | NotGiven = NOT_GIVEN,
        air_load_plan_pax_cargo: Iterable[airloadplan_update_params.AirLoadPlanPaxCargo] | NotGiven = NOT_GIVEN,
        air_load_plan_uln_actuals: Iterable[airloadplan_update_params.AirLoadPlanUlnActual] | NotGiven = NOT_GIVEN,
        ...
        return self._put(
            ...
            body=maybe_transform(
                ...
                airloadplan_update_params.AirloadplanUpdateParams,
            ),
...
class AirloadplansResourceWithRawResponse:
    def __init__(self, airloadplans: AirloadplansResource) -> None:
        self._airloadplans = airloadplans
...
class AsyncAirloadplansResourceWithRawResponse:
    def __init__(self, airloadplans: AsyncAirloadplansResource) -> None:
        self._airloadplans = airloadplans
