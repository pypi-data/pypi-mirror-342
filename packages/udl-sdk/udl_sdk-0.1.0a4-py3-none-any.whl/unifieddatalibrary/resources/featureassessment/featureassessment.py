...
from ...types import (
    featureassessment_count_params,
...
from ...types.featureassessment_query_response import FeatureassessmentQueryResponse
from ...types.featureassessment_tuple_response import FeatureassessmentTupleResponse
from ...types.featureassessment_retrieve_response import FeatureassessmentRetrieveResponse
...
class FeatureassessmentResource(SyncAPIResource):
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                featureassessment_create_params.FeatureassessmentCreateParams,
            ),
    ...
    def create_bulk(
        self,
        *,
        body: Iterable[featureassessment_create_bulk_params.Body],
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        return self._post(
            ...
            body=maybe_transform(body, Iterable[featureassessment_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class AsyncFeatureassessmentResource(AsyncAPIResource):
    ...
    async def create_bulk(
        ...
        *,
        ...
        return await self._post(
            "/udl/featureassessment/createBulk",
            body=await async_maybe_transform(body, Iterable[featureassessment_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class FeatureassessmentResourceWithRawResponse:
    def __init__(self, featureassessment: FeatureassessmentResource) -> None:
        self._featureassessment = featureassessment

        self.create = to_raw_response_wrapper(
            featureassessment.create,
        )
        self.retrieve = to_raw_response_wrapper(
            featureassessment.retrieve,
        )
        self.count = to_raw_response_wrapper(
            featureassessment.count,
        )
    ...
    def history(self) -> HistoryResourceWithRawResponse:
        return HistoryResourceWithRawResponse(self._featureassessment.history)


class AsyncFeatureassessmentResourceWithRawResponse:
    def __init__(self, featureassessment: AsyncFeatureassessmentResource) -> None:
        self._featureassessment = featureassessment
    ...
    def history(self) -> AsyncHistoryResourceWithRawResponse:
        return AsyncHistoryResourceWithRawResponse(self._featureassessment.history)
...
class FeatureassessmentResourceWithStreamingResponse:
    ...
    def history(self) -> HistoryResourceWithStreamingResponse:
        return HistoryResourceWithStreamingResponse(self._featureassessment.history)
...
class AsyncFeatureassessmentResourceWithStreamingResponse:
    ...
    def history(self) -> AsyncHistoryResourceWithStreamingResponse:
        return AsyncHistoryResourceWithStreamingResponse(self._featureassessment.history)
