...
from ...types.featureassessment import history_count_params, history_query_params, history_write_aodr_params
from ...types.featureassessment.history_query_response import HistoryQueryResponse
...
class HistoryResource(SyncAPIResource):
    ...
    def count(
        ...
        *,
        ...
        return self._get(
            "/udl/featureassessment/history/count",
    ...
    def write_aodr(
        ...
        *,
        ...
        return self._get(
            "/udl/featureassessment/history/aodr",
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
