...
from ...types.udl.sensormaintenance.sensormaintenance_full import SensormaintenanceFull
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                sensormaintenance_create_params.SensormaintenanceCreateParams,
            ),
        ...
        *,
        ...
        return self._put(
            ...
            body=maybe_transform(
                ...
                sensormaintenance_update_params.SensormaintenanceUpdateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def create_bulk(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(body, Iterable[sensormaintenance_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                ...
                query=maybe_transform(
                    ...
                    sensormaintenance_create_bulk_params.SensormaintenanceCreateBulkParams,
                ),
            ),
            cast_to=NoneType,
        )
...
class AsyncSensormaintenanceResource(AsyncAPIResource):
    ...
    async def create_bulk(
        ...
        *,
        ...
        return await self._post(
            "/udl/sensormaintenance/createBulk",
            body=await async_maybe_transform(body, Iterable[sensormaintenance_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
...
class SensormaintenanceResourceWithRawResponse:
    def __init__(self, sensormaintenance: SensormaintenanceResource) -> None:
        self._sensormaintenance = sensormaintenance

        self.create = to_raw_response_wrapper(
            sensormaintenance.create,
        )
        self.update = to_raw_response_wrapper(
            sensormaintenance.update,
        )
        self.list = to_raw_response_wrapper(
            sensormaintenance.list,
        )
        self.delete = to_raw_response_wrapper(
            sensormaintenance.delete,
        )
        self.count = to_raw_response_wrapper(
            sensormaintenance.count,
        )
        self.create_bulk = to_raw_response_wrapper(
            sensormaintenance.create_bulk,
        )
        self.current = to_raw_response_wrapper(
            sensormaintenance.current,
        )
        self.get = to_raw_response_wrapper(
            sensormaintenance.get,
        )
        self.queryhelp = to_raw_response_wrapper(
            sensormaintenance.queryhelp,
        )
        self.tuple = to_raw_response_wrapper(
            sensormaintenance.tuple,
        )

    @cached_property
    def history(self) -> HistoryResourceWithRawResponse:
        return HistoryResourceWithRawResponse(self._sensormaintenance.history)


class AsyncSensormaintenanceResourceWithRawResponse:
    def __init__(self, sensormaintenance: AsyncSensormaintenanceResource) -> None:
        self._sensormaintenance = sensormaintenance
    ...
    def history(self) -> AsyncHistoryResourceWithRawResponse:
        return AsyncHistoryResourceWithRawResponse(self._sensormaintenance.history)
...
class SensormaintenanceResourceWithStreamingResponse:
    ...
    def history(self) -> HistoryResourceWithStreamingResponse:
        return HistoryResourceWithStreamingResponse(self._sensormaintenance.history)
...
class AsyncSensormaintenanceResourceWithStreamingResponse:
    ...
    def history(self) -> AsyncHistoryResourceWithStreamingResponse:
        return AsyncHistoryResourceWithStreamingResponse(self._sensormaintenance.history)
