...
from ...types.weatherreport_list_response import WeatherreportListResponse
from ...types.weatherreport_tuple_response import WeatherreportTupleResponse
from ...types.weatherreport.weather_report_full import WeatherReportFull
...
class WeatherreportResource(SyncAPIResource):
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                weatherreport_create_params.WeatherreportCreateParams,
            ),
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"ob_time": ob_time}, weatherreport_list_params.WeatherreportListParams),
            ),
            cast_to=WeatherreportListResponse,
        )
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    weatherreport_tuple_params.WeatherreportTupleParams,
                ),
            ),
    ...
    def unvalidated_publish(
        self,
        *,
        body: Iterable[weatherreport_unvalidated_publish_params.Body],
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        return self._post(
            ...
            body=maybe_transform(body, Iterable[weatherreport_unvalidated_publish_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class AsyncWeatherreportResource(AsyncAPIResource):
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                query=await async_maybe_transform(
                    {"ob_time": ob_time}, weatherreport_list_params.WeatherreportListParams
                ),
            ),
            cast_to=WeatherreportListResponse,
        )
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=await async_maybe_transform(
                    {"ob_time": ob_time}, weatherreport_count_params.WeatherreportCountParams
                ),
            ),
            cast_to=str,
        )
    ...
    async def unvalidated_publish(
        ...
        *,
        ...
        return await self._post(
            "/filedrop/udl-weatherreport",
            body=await async_maybe_transform(body, Iterable[weatherreport_unvalidated_publish_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class WeatherreportResourceWithRawResponse:
    def __init__(self, weatherreport: WeatherreportResource) -> None:
        self._weatherreport = weatherreport
        ...
        self.queryhelp = to_raw_response_wrapper(
            weatherreport.queryhelp,
        )
        self.tuple = to_raw_response_wrapper(
            weatherreport.tuple,
        )
        self.unvalidated_publish = to_raw_response_wrapper(
            weatherreport.unvalidated_publish,
        )

    @cached_property
    def history(self) -> HistoryResourceWithRawResponse:
        return HistoryResourceWithRawResponse(self._weatherreport.history)


class AsyncWeatherreportResourceWithRawResponse:
    def __init__(self, weatherreport: AsyncWeatherreportResource) -> None:
        self._weatherreport = weatherreport
    ...
    def history(self) -> AsyncHistoryResourceWithRawResponse:
        return AsyncHistoryResourceWithRawResponse(self._weatherreport.history)
...
class WeatherreportResourceWithStreamingResponse:
    ...
    def history(self) -> HistoryResourceWithStreamingResponse:
        return HistoryResourceWithStreamingResponse(self._weatherreport.history)
...
class AsyncWeatherreportResourceWithStreamingResponse:
    ...
    def history(self) -> AsyncHistoryResourceWithStreamingResponse:
        return AsyncHistoryResourceWithStreamingResponse(self._weatherreport.history)
