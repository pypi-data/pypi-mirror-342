...
from ..types import (
    launchdetection_tuple_params,
    launchdetection_create_params,
    launchdetection_update_params,
)
...
from ..types.launchdetection_get_response import LaunchdetectionGetResponse
from ..types.launchdetection_list_response import LaunchdetectionListResponse
from ..types.launchdetection_tuple_response import LaunchdetectionTupleResponse
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                launchdetection_create_params.LaunchdetectionCreateParams,
            ),
        ...
        *,
        ...
        return self._put(
            ...
            body=maybe_transform(
                ...
                launchdetection_update_params.LaunchdetectionUpdateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=LaunchdetectionListResponse,
        )
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"columns": columns}, launchdetection_tuple_params.LaunchdetectionTupleParams),
            ),
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                query=await async_maybe_transform(
                    {"columns": columns}, launchdetection_tuple_params.LaunchdetectionTupleParams
                ),
            ),
            cast_to=LaunchdetectionTupleResponse,
        )
...
class LaunchdetectionResourceWithRawResponse:
    def __init__(self, launchdetection: LaunchdetectionResource) -> None:
        self._launchdetection = launchdetection

        self.create = to_raw_response_wrapper(
            launchdetection.create,
        )
        self.update = to_raw_response_wrapper(
            launchdetection.update,
        )
        self.list = to_raw_response_wrapper(
            launchdetection.list,
        )
        self.delete = to_raw_response_wrapper(
            launchdetection.delete,
        )
        self.count = to_raw_response_wrapper(
            launchdetection.count,
        )
        self.get = to_raw_response_wrapper(
            launchdetection.get,
        )
        self.queryhelp = to_raw_response_wrapper(
            launchdetection.queryhelp,
        )
        self.tuple = to_raw_response_wrapper(
            launchdetection.tuple,
        )


class AsyncLaunchdetectionResourceWithRawResponse:
    def __init__(self, launchdetection: AsyncLaunchdetectionResource) -> None:
        self._launchdetection = launchdetection
