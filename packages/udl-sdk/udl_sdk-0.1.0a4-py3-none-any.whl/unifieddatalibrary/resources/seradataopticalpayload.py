...
from ..types import (
    seradataopticalpayload_tuple_params,
    seradataopticalpayload_create_params,
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                seradataopticalpayload_create_params.SeradataopticalpayloadCreateParams,
            ),
        ...
        *,
        ...
        return self._put(
            ...
            body=maybe_transform(
                ...
                seradataopticalpayload_update_params.SeradataopticalpayloadUpdateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"columns": columns}, seradataopticalpayload_tuple_params.SeradataopticalpayloadTupleParams
                ),
            ),
...
class SeradataopticalpayloadResourceWithRawResponse:
    def __init__(self, seradataopticalpayload: SeradataopticalpayloadResource) -> None:
        self._seradataopticalpayload = seradataopticalpayload

        self.create = to_raw_response_wrapper(
            seradataopticalpayload.create,
        )
        self.update = to_raw_response_wrapper(
            seradataopticalpayload.update,
        )
        self.list = to_raw_response_wrapper(
            seradataopticalpayload.list,
        )
        self.delete = to_raw_response_wrapper(
            seradataopticalpayload.delete,
        )
        self.count = to_raw_response_wrapper(
            seradataopticalpayload.count,
        )
        self.get = to_raw_response_wrapper(
            seradataopticalpayload.get,
        )
        self.queryhelp = to_raw_response_wrapper(
            seradataopticalpayload.queryhelp,
        )
        self.tuple = to_raw_response_wrapper(
            seradataopticalpayload.tuple,
        )


class AsyncSeradataopticalpayloadResourceWithRawResponse:
    def __init__(self, seradataopticalpayload: AsyncSeradataopticalpayloadResource) -> None:
        self._seradataopticalpayload = seradataopticalpayload
