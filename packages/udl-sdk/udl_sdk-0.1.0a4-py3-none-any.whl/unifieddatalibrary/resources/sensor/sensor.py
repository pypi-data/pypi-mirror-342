        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"columns": columns}, sensor_tuple_params.SensorTupleParams),
            ),
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"columns": columns}, sensor_tuple_params.SensorTupleParams),
            ),
            cast_to=SensorTupleResponse,
        )
