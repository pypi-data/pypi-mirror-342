...
from ...types import (
    sarobservation_list_params,
    sarobservation_count_params,
...
class SarobservationResource(SyncAPIResource):
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                sarobservation_create_params.SarobservationCreateParams,
            ),
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"collection_start": collection_start}, sarobservation_list_params.SarobservationListParams
                ),
            ),
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform(
                    {"collection_start": collection_start}, sarobservation_count_params.SarobservationCountParams
                ),
            ),
            cast_to=str,
        )
    ...
    def create_bulk(
        self,
        *,
        body: Iterable[sarobservation_create_bulk_params.Body],
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        return self._post(
            ...
            body=maybe_transform(body, Iterable[sarobservation_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class AsyncSarobservationResource(AsyncAPIResource):
    ...
    async def create_bulk(
        ...
        *,
        ...
        return await self._post(
            "/udl/sarobservation/createBulk",
            body=await async_maybe_transform(body, Iterable[sarobservation_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class SarobservationResourceWithRawResponse:
    def __init__(self, sarobservation: SarobservationResource) -> None:
        self._sarobservation = sarobservation

        self.create = to_raw_response_wrapper(
            sarobservation.create,
        )
        self.list = to_raw_response_wrapper(
            sarobservation.list,
        )
        self.count = to_raw_response_wrapper(
            sarobservation.count,
        )
    ...
    def history(self) -> HistoryResourceWithRawResponse:
        return HistoryResourceWithRawResponse(self._sarobservation.history)


class AsyncSarobservationResourceWithRawResponse:
    def __init__(self, sarobservation: AsyncSarobservationResource) -> None:
        self._sarobservation = sarobservation
    ...
    def history(self) -> AsyncHistoryResourceWithRawResponse:
        return AsyncHistoryResourceWithRawResponse(self._sarobservation.history)
...
class SarobservationResourceWithStreamingResponse:
    ...
    def history(self) -> HistoryResourceWithStreamingResponse:
        return HistoryResourceWithStreamingResponse(self._sarobservation.history)
...
class AsyncSarobservationResourceWithStreamingResponse:
    ...
    def history(self) -> AsyncHistoryResourceWithStreamingResponse:
        return AsyncHistoryResourceWithStreamingResponse(self._sarobservation.history)
