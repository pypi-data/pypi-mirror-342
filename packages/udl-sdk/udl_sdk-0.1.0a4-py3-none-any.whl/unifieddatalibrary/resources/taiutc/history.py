...
from ...types.taiutc import history_aodr_params, history_list_params, history_count_params
from ...types.taiutc.history_list_response import HistoryListResponse
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"adjustment_date": adjustment_date}, history_count_params.HistoryCountParams),
            ),
            cast_to=str,
        )
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=await async_maybe_transform(
                    {"adjustment_date": adjustment_date}, history_count_params.HistoryCountParams
                ),
            ),
            cast_to=str,
        )
