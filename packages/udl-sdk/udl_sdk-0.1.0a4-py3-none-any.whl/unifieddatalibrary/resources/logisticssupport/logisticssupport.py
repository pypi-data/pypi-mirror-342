...
from ...types.logisticssupport_get_response import LogisticssupportGetResponse
from ...types.logisticssupport_list_response import LogisticssupportListResponse
from ...types.logisticssupport_tuple_response import LogisticssupportTupleResponse
...
class LogisticssupportResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        logistics_discrepancy_infos: Iterable[logisticssupport_create_params.LogisticsDiscrepancyInfo]
        | NotGiven = NOT_GIVEN,
        logistics_record_id: str | NotGiven = NOT_GIVEN,
        logistics_remarks: Iterable[logisticssupport_create_params.LogisticsRemark] | NotGiven = NOT_GIVEN,
        logistics_support_items: Iterable[logisticssupport_create_params.LogisticsSupportItem] | NotGiven = NOT_GIVEN,
        logistics_transportation_plans: Iterable[logisticssupport_create_params.LogisticsTransportationPlan]
        | NotGiven = NOT_GIVEN,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                logisticssupport_create_params.LogisticssupportCreateParams,
            ),
    ...
    def update(
        ...
        *,
        ...
        ext_system_id: str | NotGiven = NOT_GIVEN,
        logistic_action: str | NotGiven = NOT_GIVEN,
        logistics_discrepancy_infos: Iterable[logisticssupport_update_params.LogisticsDiscrepancyInfo]
        | NotGiven = NOT_GIVEN,
        logistics_record_id: str | NotGiven = NOT_GIVEN,
        logistics_remarks: Iterable[logisticssupport_update_params.LogisticsRemark] | NotGiven = NOT_GIVEN,
        logistics_support_items: Iterable[logisticssupport_update_params.LogisticsSupportItem] | NotGiven = NOT_GIVEN,
        logistics_transportation_plans: Iterable[logisticssupport_update_params.LogisticsTransportationPlan]
        | NotGiven = NOT_GIVEN,
        maint_status_code: str | NotGiven = NOT_GIVEN,
        mc_time: Union[str, datetime] | NotGiven = NOT_GIVEN,
        me_time: Union[str, datetime] | NotGiven = NOT_GIVEN,
        ...
        return self._put(
            ...
            body=maybe_transform(
                ...
                logisticssupport_update_params.LogisticssupportUpdateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=LogisticssupportListResponse,
        )
...
class AsyncLogisticssupportResource(AsyncAPIResource):
    ...
    async def create_bulk(
        ...
        *,
        ...
        return await self._post(
            "/udl/logisticssupport/createBulk",
            body=await async_maybe_transform(body, Iterable[logisticssupport_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                query=await async_maybe_transform(
                    {"columns": columns}, logisticssupport_tuple_params.LogisticssupportTupleParams
                ),
            ),
            cast_to=LogisticssupportTupleResponse,
        )
...
class LogisticssupportResourceWithRawResponse:
    def __init__(self, logisticssupport: LogisticssupportResource) -> None:
        self._logisticssupport = logisticssupport

        self.create = to_raw_response_wrapper(
            logisticssupport.create,
        )
        self.update = to_raw_response_wrapper(
            logisticssupport.update,
        )
        self.list = to_raw_response_wrapper(
            logisticssupport.list,
        )
        self.count = to_raw_response_wrapper(
            logisticssupport.count,
        )
    ...
    def history(self) -> HistoryResourceWithRawResponse:
        return HistoryResourceWithRawResponse(self._logisticssupport.history)


class AsyncLogisticssupportResourceWithRawResponse:
    def __init__(self, logisticssupport: AsyncLogisticssupportResource) -> None:
        self._logisticssupport = logisticssupport
    ...
    def history(self) -> AsyncHistoryResourceWithRawResponse:
        return AsyncHistoryResourceWithRawResponse(self._logisticssupport.history)
...
class LogisticssupportResourceWithStreamingResponse:
    ...
    def history(self) -> HistoryResourceWithStreamingResponse:
        return HistoryResourceWithStreamingResponse(self._logisticssupport.history)
...
class AsyncLogisticssupportResourceWithStreamingResponse:
    ...
    def history(self) -> AsyncHistoryResourceWithStreamingResponse:
        return AsyncHistoryResourceWithStreamingResponse(self._logisticssupport.history)
