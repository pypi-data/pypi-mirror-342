...
from ..types import (
    ...
    launchevent_unvalidated_publish_params,
)
...
class LauncheventResource(SyncAPIResource):
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                launchevent_create_params.LauncheventCreateParams,
            ),
    ...
    def create_bulk(
        self,
        *,
        body: Iterable[launchevent_create_bulk_params.Body],
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        return self._post(
            ...
            body=maybe_transform(body, Iterable[launchevent_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
    ...
    def unvalidated_publish(
        self,
        *,
        body: Iterable[launchevent_unvalidated_publish_params.Body],
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        return self._post(
            ...
            body=maybe_transform(body, Iterable[launchevent_unvalidated_publish_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class AsyncLauncheventResource(AsyncAPIResource):
    ...
    async def create_bulk(
        ...
        *,
        ...
        return await self._post(
            "/udl/launchevent/createBulk",
            body=await async_maybe_transform(body, Iterable[launchevent_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
    ...
    async def unvalidated_publish(
        ...
        *,
        ...
        return await self._post(
            "/filedrop/udl-launchevent",
            body=await async_maybe_transform(body, Iterable[launchevent_unvalidated_publish_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class LauncheventResourceWithRawResponse:
    def __init__(self, launchevent: LauncheventResource) -> None:
        self._launchevent = launchevent
        ...
        self.queryhelp = to_raw_response_wrapper(
            launchevent.queryhelp,
        )
        self.tuple = to_raw_response_wrapper(
            launchevent.tuple,
        )
        self.unvalidated_publish = to_raw_response_wrapper(
            launchevent.unvalidated_publish,
        )


class AsyncLauncheventResourceWithRawResponse:
    def __init__(self, launchevent: AsyncLauncheventResource) -> None:
        self._launchevent = launchevent
