...
from ...types.missionassignment import history_aodr_params, history_count_params, history_query_params
from ...types.missionassignment.history_query_response import HistoryQueryResponse
...
class HistoryResource(SyncAPIResource):
    ...
    def aodr(
        ...
        *,
        ...
        return self._get(
            "/udl/missionassignment/history/aodr",
    ...
    def count(
        ...
        *,
        ...
        return self._get(
            "/udl/missionassignment/history/count",
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
