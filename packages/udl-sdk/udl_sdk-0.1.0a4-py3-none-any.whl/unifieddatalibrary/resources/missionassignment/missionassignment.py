...
from ...types import (
    missionassignment_list_params,
    missionassignment_count_params,
    missionassignment_tuple_params,
    missionassignment_create_params,
    missionassignment_update_params,
    missionassignment_create_bulk_params,
)
from .history import (
    HistoryResource,
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                missionassignment_create_params.MissionassignmentCreateParams,
            ),
        ...
        *,
        ...
        return self._put(
            ...
            body=maybe_transform(
                ...
                missionassignment_update_params.MissionassignmentUpdateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class MissionassignmentResourceWithRawResponse:
    ...
    def history(self) -> HistoryResourceWithRawResponse:
        return HistoryResourceWithRawResponse(self._missionassignment.history)
