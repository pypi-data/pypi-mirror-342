...
from ...types.diplomatic_clearance.history_list_response import HistoryListResponse
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"first_dep_date": first_dep_date}, history_count_params.HistoryCountParams),
            ),
            cast_to=str,
        )
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=await async_maybe_transform(
                    {"first_dep_date": first_dep_date}, history_count_params.HistoryCountParams
                ),
            ),
            cast_to=str,
        )
