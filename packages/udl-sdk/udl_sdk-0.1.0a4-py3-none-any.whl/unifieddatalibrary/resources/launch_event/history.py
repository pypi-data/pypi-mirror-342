...
from ...types.launch_event import history_aodr_params, history_list_params, history_count_params
from ...types.launch_event.history_list_response import HistoryListResponse
...
class HistoryResource(SyncAPIResource):
    ...
    def count(
        ...
        *,
        ...
        return self._get(
            "/udl/launchevent/history/count",
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"msg_create_date": msg_create_date}, history_count_params.HistoryCountParams),
            ),
            cast_to=str,
        )
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=await async_maybe_transform(
                    {"msg_create_date": msg_create_date}, history_count_params.HistoryCountParams
                ),
            ),
            cast_to=str,
        )
