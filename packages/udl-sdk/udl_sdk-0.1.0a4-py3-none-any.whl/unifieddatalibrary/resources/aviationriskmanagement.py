...
from ..types import (
    aviationriskmanagement_count_params,
    aviationriskmanagement_query_params,
...
from ..types.aviationriskmanagement_query_response import AviationriskmanagementQueryResponse
from ..types.aviationriskmanagement_tuple_response import AviationriskmanagementTupleResponse
from ..types.aviationriskmanagement_retrieve_response import AviationriskmanagementRetrieveResponse
...
class AviationriskmanagementResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        aviation_risk_management_worksheet_record: Iterable[
            aviationriskmanagement_create_params.AviationRiskManagementWorksheetRecord
        ]
        | NotGiven = NOT_GIVEN,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                aviationriskmanagement_create_params.AviationriskmanagementCreateParams,
            ),
    ...
    def update(
        ...
        *,
        ...
        aviation_risk_management_worksheet_record: Iterable[
            aviationriskmanagement_update_params.AviationRiskManagementWorksheetRecord
        ]
        | NotGiven = NOT_GIVEN,
        ext_mission_id: str | NotGiven = NOT_GIVEN,
        mission_number: str | NotGiven = NOT_GIVEN,
        ...
        return self._put(
            ...
            body=maybe_transform(
                ...
                aviationriskmanagement_update_params.AviationriskmanagementUpdateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def create_bulk(
        self,
        *,
        body: Iterable[aviationriskmanagement_create_bulk_params.Body],
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        return self._post(
            ...
            body=maybe_transform(body, Iterable[aviationriskmanagement_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class AsyncAviationriskmanagementResource(AsyncAPIResource):
    ...
    async def create_bulk(
        ...
        *,
        ...
        return await self._post(
            "/udl/aviationriskmanagement/createBulk",
            body=await async_maybe_transform(body, Iterable[aviationriskmanagement_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class AviationriskmanagementResourceWithRawResponse:
    def __init__(self, aviationriskmanagement: AviationriskmanagementResource) -> None:
        self._aviationriskmanagement = aviationriskmanagement

        self.create = to_raw_response_wrapper(
            aviationriskmanagement.create,
        )
        self.retrieve = to_raw_response_wrapper(
            aviationriskmanagement.retrieve,
        )
        self.update = to_raw_response_wrapper(
            aviationriskmanagement.update,
        )
        self.delete = to_raw_response_wrapper(
            aviationriskmanagement.delete,
        )
        self.count = to_raw_response_wrapper(
            aviationriskmanagement.count,
        )
        ...
        self.query_help = to_raw_response_wrapper(
            aviationriskmanagement.query_help,
        )
...
class AsyncAviationriskmanagementResourceWithRawResponse:
    def __init__(self, aviationriskmanagement: AsyncAviationriskmanagementResource) -> None:
        self._aviationriskmanagement = aviationriskmanagement
