...
from ..types import onorbitevent_tuple_params, onorbitevent_create_params, onorbitevent_update_params
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=OnorbiteventListResponse,
        )
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"columns": columns}, onorbitevent_tuple_params.OnorbiteventTupleParams),
            ),
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                query=await async_maybe_transform(
                    {"columns": columns}, onorbitevent_tuple_params.OnorbiteventTupleParams
                ),
            ),
            cast_to=OnorbiteventTupleResponse,
        )
