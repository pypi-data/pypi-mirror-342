...
from ...types.statevector import history_aodr_params, history_list_params, history_count_params
from ...types.statevector.history_list_response import HistoryListResponse
...
class HistoryResource(SyncAPIResource):
    ...
    def count(
        ...
        *,
        ...
        return self._get(
            "/udl/statevector/history/count",
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"epoch": epoch}, history_count_params.HistoryCountParams),
            ),
            cast_to=str,
        )
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"epoch": epoch}, history_count_params.HistoryCountParams),
            ),
            cast_to=str,
        )
