...
from ..types import airfield_status_tuple_params, airfield_status_update_params
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"columns": columns}, airfield_status_tuple_params.AirfieldStatusTupleParams),
            ),
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                query=await async_maybe_transform(
                    {"columns": columns}, airfield_status_tuple_params.AirfieldStatusTupleParams
                ),
            ),
            cast_to=AirfieldStatusTupleResponse,
        )
