...
from ..types import (
    seradataradarpayload_tuple_params,
    seradataradarpayload_create_params,
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                seradataradarpayload_create_params.SeradataradarpayloadCreateParams,
            ),
        ...
        *,
        ...
        return self._put(
            ...
            body=maybe_transform(
                ...
                seradataradarpayload_update_params.SeradataradarpayloadUpdateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"columns": columns}, seradataradarpayload_tuple_params.SeradataradarpayloadTupleParams
                ),
            ),
...
class SeradataradarpayloadResourceWithRawResponse:
    def __init__(self, seradataradarpayload: SeradataradarpayloadResource) -> None:
        self._seradataradarpayload = seradataradarpayload

        self.create = to_raw_response_wrapper(
            seradataradarpayload.create,
        )
        self.update = to_raw_response_wrapper(
            seradataradarpayload.update,
        )
        self.list = to_raw_response_wrapper(
            seradataradarpayload.list,
        )
        self.delete = to_raw_response_wrapper(
            seradataradarpayload.delete,
        )
        self.count = to_raw_response_wrapper(
            seradataradarpayload.count,
        )
        self.get = to_raw_response_wrapper(
            seradataradarpayload.get,
        )
        self.queryhelp = to_raw_response_wrapper(
            seradataradarpayload.queryhelp,
        )
        self.tuple = to_raw_response_wrapper(
            seradataradarpayload.tuple,
        )


class AsyncSeradataradarpayloadResourceWithRawResponse:
    def __init__(self, seradataradarpayload: AsyncSeradataradarpayloadResource) -> None:
        self._seradataradarpayload = seradataradarpayload
