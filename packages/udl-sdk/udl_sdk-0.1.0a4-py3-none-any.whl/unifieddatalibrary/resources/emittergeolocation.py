...
from ..types import (
    emittergeolocation_count_params,
...
from ..types.emittergeolocation_query_response import EmittergeolocationQueryResponse
from ..types.emittergeolocation_tuple_response import EmittergeolocationTupleResponse
from ..types.emittergeolocation_retrieve_response import EmittergeolocationRetrieveResponse
...
class EmittergeolocationResource(SyncAPIResource):
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                emittergeolocation_create_params.EmittergeolocationCreateParams,
            ),
    ...
    def create_bulk(
        self,
        *,
        body: Iterable[emittergeolocation_create_bulk_params.Body],
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        return self._post(
            ...
            body=maybe_transform(body, Iterable[emittergeolocation_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class AsyncEmittergeolocationResource(AsyncAPIResource):
    ...
    async def create_bulk(
        ...
        *,
        ...
        return await self._post(
            "/udl/emittergeolocation/createBulk",
            body=await async_maybe_transform(body, Iterable[emittergeolocation_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class EmittergeolocationResourceWithRawResponse:
    def __init__(self, emittergeolocation: EmittergeolocationResource) -> None:
        self._emittergeolocation = emittergeolocation

        self.create = to_raw_response_wrapper(
            emittergeolocation.create,
        )
        self.retrieve = to_raw_response_wrapper(
            emittergeolocation.retrieve,
        )
        self.delete = to_raw_response_wrapper(
            emittergeolocation.delete,
        )
        self.count = to_raw_response_wrapper(
            emittergeolocation.count,
        )
...
class AsyncEmittergeolocationResourceWithRawResponse:
    def __init__(self, emittergeolocation: AsyncEmittergeolocationResource) -> None:
        self._emittergeolocation = emittergeolocation
