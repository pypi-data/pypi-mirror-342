...
class PassiveradarobservationResource(SyncAPIResource):
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                passiveradarobservation_create_params.PassiveradarobservationCreateParams,
            ),
    ...
    def create_bulk(
        self,
        *,
        body: Iterable[passiveradarobservation_create_bulk_params.Body],
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
...
class AsyncPassiveradarobservationResource(AsyncAPIResource):
    ...
    async def create_bulk(
        ...
        *,
        ...
        return await self._post(
            "/udl/passiveradarobservation/createBulk",
            body=await async_maybe_transform(body, Iterable[passiveradarobservation_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class PassiveradarobservationResourceWithRawResponse:
    def __init__(self, passiveradarobservation: PassiveradarobservationResource) -> None:
        self._passiveradarobservation = passiveradarobservation

        self.create = to_raw_response_wrapper(
            passiveradarobservation.create,
        )
        self.list = to_raw_response_wrapper(
            passiveradarobservation.list,
        )
        self.count = to_raw_response_wrapper(
            passiveradarobservation.count,
        )
        ...
        self.queryhelp = to_raw_response_wrapper(
            passiveradarobservation.queryhelp,
        )
        self.tuple = to_raw_response_wrapper(
            passiveradarobservation.tuple,
        )

    @cached_property
    def history(self) -> HistoryResourceWithRawResponse:
        return HistoryResourceWithRawResponse(self._passiveradarobservation.history)


class AsyncPassiveradarobservationResourceWithRawResponse:
    def __init__(self, passiveradarobservation: AsyncPassiveradarobservationResource) -> None:
        self._passiveradarobservation = passiveradarobservation
    ...
    def history(self) -> AsyncHistoryResourceWithRawResponse:
        return AsyncHistoryResourceWithRawResponse(self._passiveradarobservation.history)
...
class PassiveradarobservationResourceWithStreamingResponse:
    ...
    def history(self) -> HistoryResourceWithStreamingResponse:
        return HistoryResourceWithStreamingResponse(self._passiveradarobservation.history)
...
class AsyncPassiveradarobservationResourceWithStreamingResponse:
    ...
    def history(self) -> AsyncHistoryResourceWithStreamingResponse:
        return AsyncHistoryResourceWithStreamingResponse(self._passiveradarobservation.history)
