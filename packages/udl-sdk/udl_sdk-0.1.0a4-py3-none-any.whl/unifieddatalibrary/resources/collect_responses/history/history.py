...
from .aodr import (
    AodrResource,
    AsyncAodrResource,
    AodrResourceWithRawResponse,
    AsyncAodrResourceWithRawResponse,
    AodrResourceWithStreamingResponse,
    AsyncAodrResourceWithStreamingResponse,
)
...
from ....types.collect_responses import history_list_params, history_count_params
from ....types.collect_responses.history_list_response import HistoryListResponse
...
class HistoryResource(SyncAPIResource):
    @cached_property
    def aodr(self) -> AodrResource:
        return AodrResource(self._client)
...
class AsyncHistoryResource(AsyncAPIResource):
    @cached_property
    def aodr(self) -> AsyncAodrResource:
        return AsyncAodrResource(self._client)
...
class HistoryResourceWithRawResponse:
    ...
    @cached_property
    def aodr(self) -> AodrResourceWithRawResponse:
        return AodrResourceWithRawResponse(self._history.aodr)
...
class AsyncHistoryResourceWithRawResponse:
    ...
    @cached_property
    def aodr(self) -> AsyncAodrResourceWithRawResponse:
        return AsyncAodrResourceWithRawResponse(self._history.aodr)
...
class HistoryResourceWithStreamingResponse:
    ...
    @cached_property
    def aodr(self) -> AodrResourceWithStreamingResponse:
        return AodrResourceWithStreamingResponse(self._history.aodr)
...
class AsyncHistoryResourceWithStreamingResponse:
    ...
    @cached_property
    def aodr(self) -> AsyncAodrResourceWithStreamingResponse:
        return AsyncAodrResourceWithStreamingResponse(self._history.aodr)
