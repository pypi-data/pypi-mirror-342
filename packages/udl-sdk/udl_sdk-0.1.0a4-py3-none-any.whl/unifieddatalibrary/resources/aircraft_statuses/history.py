...
from ...types.aircraft_statuses import history_list_params
from ...types.aircraft_statuses.history_list_response import HistoryListResponse
...
class HistoryResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        """
        return self._get(
            "/udl/aircraftstatus/history",
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"columns": columns}, history_list_params.HistoryListParams),
            ),
    ...
    def count(
        ...
        *,
        ...
        return self._get(
            "/udl/aircraftstatus/history/count",
            options=make_request_options(
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"columns": columns}, history_list_params.HistoryListParams),
            ),
            cast_to=HistoryListResponse,
        )
