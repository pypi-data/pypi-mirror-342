        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                airfieldslotconsumption_create_params.AirfieldslotconsumptionCreateParams,
            ),
        ...
        *,
        ...
        return self._put(
            ...
            body=maybe_transform(
                ...
                airfieldslotconsumption_update_params.AirfieldslotconsumptionUpdateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class AirfieldslotconsumptionsResourceWithRawResponse:
    def __init__(self, airfieldslotconsumptions: AirfieldslotconsumptionsResource) -> None:
        self._airfieldslotconsumptions = airfieldslotconsumptions

        self.create = to_raw_response_wrapper(
            airfieldslotconsumptions.create,
        )
        self.retrieve = to_raw_response_wrapper(
            airfieldslotconsumptions.retrieve,
        )
        self.update = to_raw_response_wrapper(
            airfieldslotconsumptions.update,
        )
        self.list = to_raw_response_wrapper(
            airfieldslotconsumptions.list,
        )
        self.delete = to_raw_response_wrapper(
            airfieldslotconsumptions.delete,
        )
        self.count = to_raw_response_wrapper(
            airfieldslotconsumptions.count,
        )
        self.queryhelp = to_raw_response_wrapper(
            airfieldslotconsumptions.queryhelp,
        )
        self.tuple = to_raw_response_wrapper(
            airfieldslotconsumptions.tuple,
        )


class AsyncAirfieldslotconsumptionsResourceWithRawResponse:
    def __init__(self, airfieldslotconsumptions: AsyncAirfieldslotconsumptionsResource) -> None:
        self._airfieldslotconsumptions = airfieldslotconsumptions
