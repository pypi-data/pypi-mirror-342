...
from ...types import (
    sortieppr_list_params,
    sortieppr_count_params,
    sortieppr_tuple_params,
...
class SortiepprResource(SyncAPIResource):
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                sortieppr_create_params.SortiepprCreateParams,
            ),
        ...
        *,
        ...
        return self._put(
            ...
            body=maybe_transform(
                ...
                sortieppr_update_params.SortiepprUpdateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"id_sortie": id_sortie}, sortieppr_list_params.SortiepprListParams),
            ),
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"id_sortie": id_sortie}, sortieppr_count_params.SortiepprCountParams),
            ),
            cast_to=str,
        )
    ...
    def create_bulk(
        self,
        *,
        body: Iterable[sortieppr_create_bulk_params.Body],
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        return self._post(
            ...
            body=maybe_transform(body, Iterable[sortieppr_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class AsyncSortiepprResource(AsyncAPIResource):
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"id_sortie": id_sortie}, sortieppr_list_params.SortiepprListParams),
            ),
            cast_to=SortiepprListResponse,
        )
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                query=await async_maybe_transform(
                    {"id_sortie": id_sortie}, sortieppr_count_params.SortiepprCountParams
                ),
            ),
            cast_to=str,
        )
    ...
    async def create_bulk(
        ...
        *,
        ...
        return await self._post(
            "/udl/sortieppr/createBulk",
            body=await async_maybe_transform(body, Iterable[sortieppr_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class SortiepprResourceWithRawResponse:
    ...
    def history(self) -> HistoryResourceWithRawResponse:
        return HistoryResourceWithRawResponse(self._sortieppr.history)


class AsyncSortiepprResourceWithRawResponse:
    def __init__(self, sortieppr: AsyncSortiepprResource) -> None:
        self._sortieppr = sortieppr
    ...
    def history(self) -> AsyncHistoryResourceWithRawResponse:
        return AsyncHistoryResourceWithRawResponse(self._sortieppr.history)
...
class SortiepprResourceWithStreamingResponse:
    ...
    def history(self) -> HistoryResourceWithStreamingResponse:
        return HistoryResourceWithStreamingResponse(self._sortieppr.history)
...
class AsyncSortiepprResourceWithStreamingResponse:
    ...
    def history(self) -> AsyncHistoryResourceWithStreamingResponse:
        return AsyncHistoryResourceWithStreamingResponse(self._sortieppr.history)
