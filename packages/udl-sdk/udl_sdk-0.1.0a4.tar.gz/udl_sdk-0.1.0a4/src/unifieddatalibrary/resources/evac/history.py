...
from ...types.evac import history_list_params, history_count_params
from ..._base_client import make_request_options
from ...types.evac.history_list_response import HistoryListResponse
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"req_time": req_time}, history_count_params.HistoryCountParams),
            ),
            cast_to=str,
        )
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"req_time": req_time}, history_count_params.HistoryCountParams),
            ),
            cast_to=str,
        )
