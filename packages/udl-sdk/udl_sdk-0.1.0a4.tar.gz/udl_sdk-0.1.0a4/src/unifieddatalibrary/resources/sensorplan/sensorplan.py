...
from ...types import (
    sensorplan_list_params,
    sensorplan_count_params,
...
class SensorplanResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        collect_requests: Iterable[sensorplan_create_params.CollectRequest] | NotGiven = NOT_GIVEN,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                sensorplan_create_params.SensorplanCreateParams,
            ),
    ...
    def update(
        ...
        *,
        ...
        collect_requests: Iterable[sensorplan_update_params.CollectRequest] | NotGiven = NOT_GIVEN,
        customer: str | NotGiven = NOT_GIVEN,
        end_time: Union[str, datetime] | NotGiven = NOT_GIVEN,
        id_sensor: str | NotGiven = NOT_GIVEN,
        name: str | NotGiven = NOT_GIVEN,
        ...
        return self._put(
            ...
            body=maybe_transform(
                ...
                sensorplan_update_params.SensorplanUpdateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"start_time": start_time}, sensorplan_list_params.SensorplanListParams),
            ),
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"start_time": start_time}, sensorplan_count_params.SensorplanCountParams),
            ),
            cast_to=str,
        )
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    sensorplan_tuple_params.SensorplanTupleParams,
                ),
            ),
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                query=await async_maybe_transform(
                    {"start_time": start_time}, sensorplan_list_params.SensorplanListParams
                ),
            ),
            cast_to=SensorplanListResponse,
        )
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=await async_maybe_transform(
                    {"start_time": start_time}, sensorplan_count_params.SensorplanCountParams
                ),
            ),
            cast_to=str,
        )
...
class SensorplanResourceWithRawResponse:
    ...
    def history(self) -> HistoryResourceWithRawResponse:
        return HistoryResourceWithRawResponse(self._sensorplan.history)


class AsyncSensorplanResourceWithRawResponse:
    def __init__(self, sensorplan: AsyncSensorplanResource) -> None:
        self._sensorplan = sensorplan
    ...
    def history(self) -> AsyncHistoryResourceWithRawResponse:
        return AsyncHistoryResourceWithRawResponse(self._sensorplan.history)
...
class SensorplanResourceWithStreamingResponse:
    ...
    def history(self) -> HistoryResourceWithStreamingResponse:
        return HistoryResourceWithStreamingResponse(self._sensorplan.history)
...
class AsyncSensorplanResourceWithStreamingResponse:
    ...
    def history(self) -> AsyncHistoryResourceWithStreamingResponse:
        return AsyncHistoryResourceWithStreamingResponse(self._sensorplan.history)
