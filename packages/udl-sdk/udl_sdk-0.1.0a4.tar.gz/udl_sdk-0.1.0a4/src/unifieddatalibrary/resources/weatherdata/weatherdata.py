...
from ...types import (
    ...
    weatherdata_create_params,
    weatherdata_create_bulk_params,
    weatherdata_unvalidated_publish_params,
)
from .history import (
    HistoryResource,
...
class WeatherdataResource(SyncAPIResource):
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                weatherdata_create_params.WeatherdataCreateParams,
            ),
    ...
    def create_bulk(
        self,
        *,
        body: Iterable[weatherdata_create_bulk_params.Body],
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        return self._post(
            ...
            body=maybe_transform(body, Iterable[weatherdata_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
    ...
    def unvalidated_publish(
        self,
        *,
        body: Iterable[weatherdata_unvalidated_publish_params.Body],
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        return self._post(
            ...
            body=maybe_transform(body, Iterable[weatherdata_unvalidated_publish_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class AsyncWeatherdataResource(AsyncAPIResource):
    ...
    async def create_bulk(
        ...
        *,
        ...
        return await self._post(
            "/udl/weatherdata/createBulk",
            body=await async_maybe_transform(body, Iterable[weatherdata_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
    ...
    async def unvalidated_publish(
        ...
        *,
        ...
        return await self._post(
            "/filedrop/udl-weatherdata",
            body=await async_maybe_transform(body, Iterable[weatherdata_unvalidated_publish_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class WeatherdataResourceWithRawResponse:
    def __init__(self, weatherdata: WeatherdataResource) -> None:
        ...
        self.create_bulk = to_raw_response_wrapper(
            weatherdata.create_bulk,
        )
        self.get = to_raw_response_wrapper(
            weatherdata.get,
        )
        self.queryhelp = to_raw_response_wrapper(
            weatherdata.queryhelp,
        )
        self.tuple = to_raw_response_wrapper(
            weatherdata.tuple,
        )
        self.unvalidated_publish = to_raw_response_wrapper(
            weatherdata.unvalidated_publish,
        )

    @cached_property
    def history(self) -> HistoryResourceWithRawResponse:
        return HistoryResourceWithRawResponse(self._weatherdata.history)


class AsyncWeatherdataResourceWithRawResponse:
    def __init__(self, weatherdata: AsyncWeatherdataResource) -> None:
        self._weatherdata = weatherdata
    ...
    def history(self) -> AsyncHistoryResourceWithRawResponse:
        return AsyncHistoryResourceWithRawResponse(self._weatherdata.history)
...
class WeatherdataResourceWithStreamingResponse:
    ...
    def history(self) -> HistoryResourceWithStreamingResponse:
        return HistoryResourceWithStreamingResponse(self._weatherdata.history)
...
class AsyncWeatherdataResourceWithStreamingResponse:
    ...
    def history(self) -> AsyncHistoryResourceWithStreamingResponse:
        return AsyncHistoryResourceWithStreamingResponse(self._weatherdata.history)
