...
from ....types.observations.radarobservation import history_aodr_params, history_list_params, history_count_params
from ....types.observations.radarobservation.history_list_response import HistoryListResponse
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"ob_time": ob_time}, history_count_params.HistoryCountParams),
            ),
            cast_to=str,
        )
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"ob_time": ob_time}, history_count_params.HistoryCountParams),
            ),
            cast_to=str,
        )
