        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                objectofinterest_create_params.ObjectofinterestCreateParams,
            ),
        ...
        *,
        ...
        return self._put(
            ...
            body=maybe_transform(
                ...
                objectofinterest_update_params.ObjectofinterestUpdateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"columns": columns}, objectofinterest_tuple_params.ObjectofinterestTupleParams),
            ),
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                query=await async_maybe_transform(
                    {"columns": columns}, objectofinterest_tuple_params.ObjectofinterestTupleParams
                ),
            ),
            cast_to=ObjectofinterestTupleResponse,
        )
...
class ObjectofinterestResourceWithRawResponse:
    def __init__(self, objectofinterest: ObjectofinterestResource) -> None:
        self._objectofinterest = objectofinterest

        self.create = to_raw_response_wrapper(
            objectofinterest.create,
        )
        self.update = to_raw_response_wrapper(
            objectofinterest.update,
        )
        self.list = to_raw_response_wrapper(
            objectofinterest.list,
        )
        self.delete = to_raw_response_wrapper(
            objectofinterest.delete,
        )
        self.count = to_raw_response_wrapper(
            objectofinterest.count,
        )
        self.get = to_raw_response_wrapper(
            objectofinterest.get,
        )
        self.queryhelp = to_raw_response_wrapper(
            objectofinterest.queryhelp,
        )
        self.tuple = to_raw_response_wrapper(
            objectofinterest.tuple,
        )


class AsyncObjectofinterestResourceWithRawResponse:
    def __init__(self, objectofinterest: AsyncObjectofinterestResource) -> None:
        self._objectofinterest = objectofinterest
