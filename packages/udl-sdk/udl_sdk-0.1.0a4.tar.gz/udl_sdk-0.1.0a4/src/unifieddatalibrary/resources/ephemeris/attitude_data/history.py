...
from ....types.ephemeris.attitude_data import history_aodr_params, history_count_params, history_retrieve_params
from ....types.ephemeris.attitude_data.history_retrieve_response import HistoryRetrieveResponse
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"as_id": as_id}, history_count_params.HistoryCountParams),
            ),
            cast_to=str,
        )
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"as_id": as_id}, history_count_params.HistoryCountParams),
            ),
            cast_to=str,
        )
