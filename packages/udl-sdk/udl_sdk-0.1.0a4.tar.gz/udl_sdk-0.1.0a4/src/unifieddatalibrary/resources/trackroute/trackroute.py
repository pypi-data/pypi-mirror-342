...
from ...types import (
    trackroute_list_params,
    trackroute_count_params,
    trackroute_tuple_params,
...
class TrackrouteResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        altitude_blocks: Iterable[trackroute_update_params.AltitudeBlock] | NotGiven = NOT_GIVEN,
        apn_setting: str | NotGiven = NOT_GIVEN,
        apx_beacon_code: str | NotGiven = NOT_GIVEN,
        artcc_message: str | NotGiven = NOT_GIVEN,
        creating_org: str | NotGiven = NOT_GIVEN,
        ...
        location_track_id: str | NotGiven = NOT_GIVEN,
        origin: str | NotGiven = NOT_GIVEN,
        poc: Iterable[trackroute_update_params.Poc] | NotGiven = NOT_GIVEN,
        pri_freq: float | NotGiven = NOT_GIVEN,
        receiver_tanker_ch_code: str | NotGiven = NOT_GIVEN,
        region_code: str | NotGiven = NOT_GIVEN,
        region_name: str | NotGiven = NOT_GIVEN,
        review_date: Union[str, datetime] | NotGiven = NOT_GIVEN,
        route_points: Iterable[trackroute_update_params.RoutePoint] | NotGiven = NOT_GIVEN,
        scheduler_org_name: str | NotGiven = NOT_GIVEN,
        scheduler_org_unit: str | NotGiven = NOT_GIVEN,
        sec_freq: float | NotGiven = NOT_GIVEN,
        short_name: str | NotGiven = NOT_GIVEN,
        ...
        return self._put(
            ...
            body=maybe_transform(
                ...
                trackroute_update_params.TrackrouteUpdateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"last_update_date": last_update_date}, trackroute_list_params.TrackrouteListParams
                ),
            ),
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform(
                    {"last_update_date": last_update_date}, trackroute_count_params.TrackrouteCountParams
                ),
            ),
            cast_to=str,
        )
    ...
    def create_bulk(
        self,
        *,
        body: Iterable[trackroute_create_bulk_params.Body],
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        return self._post(
            ...
            body=maybe_transform(body, Iterable[trackroute_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class AsyncTrackrouteResource(AsyncAPIResource):
    ...
    async def create_bulk(
        ...
        *,
        ...
        return await self._post(
            "/udl/trackroute/createBulk",
            body=await async_maybe_transform(body, Iterable[trackroute_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class TrackrouteResourceWithRawResponse:
    def __init__(self, trackroute: TrackrouteResource) -> None:
        self._trackroute = trackroute
    ...
    def history(self) -> HistoryResourceWithRawResponse:
        return HistoryResourceWithRawResponse(self._trackroute.history)


class AsyncTrackrouteResourceWithRawResponse:
    def __init__(self, trackroute: AsyncTrackrouteResource) -> None:
        self._trackroute = trackroute
    ...
    def history(self) -> AsyncHistoryResourceWithRawResponse:
        return AsyncHistoryResourceWithRawResponse(self._trackroute.history)
...
class TrackrouteResourceWithStreamingResponse:
    ...
    def history(self) -> HistoryResourceWithStreamingResponse:
        return HistoryResourceWithStreamingResponse(self._trackroute.history)
...
class AsyncTrackrouteResourceWithStreamingResponse:
    ...
    def history(self) -> AsyncHistoryResourceWithStreamingResponse:
        return AsyncHistoryResourceWithStreamingResponse(self._trackroute.history)
