...
from ..types import location_tuple_params, location_create_params, location_update_params
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"columns": columns}, location_tuple_params.LocationTupleParams),
            ),
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"columns": columns}, location_tuple_params.LocationTupleParams),
            ),
            cast_to=LocationTupleResponse,
        )
