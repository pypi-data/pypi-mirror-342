...
from ..types.routestat_query_response import RoutestatQueryResponse
from ..types.routestat_tuple_response import RoutestatTupleResponse
from ..types.routestat_retrieve_response import RoutestatRetrieveResponse
...
class RoutestatsResource(SyncAPIResource):
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                routestat_create_params.RoutestatCreateParams,
            ),
        ...
        *,
        ...
        return self._put(
            ...
            body=maybe_transform(
                ...
                routestat_update_params.RoutestatUpdateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def create_bulk(
        self,
        *,
        body: Iterable[routestat_create_bulk_params.Body],
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        return self._post(
            ...
            body=maybe_transform(body, Iterable[routestat_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class AsyncRoutestatsResource(AsyncAPIResource):
    ...
    async def create_bulk(
        ...
        *,
        ...
        return await self._post(
            "/udl/routestats/createBulk",
            body=await async_maybe_transform(body, Iterable[routestat_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"columns": columns}, routestat_tuple_params.RoutestatTupleParams),
            ),
            cast_to=RoutestatTupleResponse,
        )
...
class AsyncRoutestatsResourceWithRawResponse:
    def __init__(self, routestats: AsyncRoutestatsResource) -> None:
        self._routestats = routestats
