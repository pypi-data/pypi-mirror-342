...
from ...types.sensormaintenance import history_aodr_params, history_count_params, history_retrieve_params
from ...types.sensormaintenance.history_retrieve_response import HistoryRetrieveResponse
...
class HistoryResource(SyncAPIResource):
    ...
    def aodr(
        ...
        *,
        ...
        return self._get(
            "/udl/sensormaintenance/history/aodr",
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
    ...
    def count(
        ...
        *,
        ...
        return self._get(
            "/udl/sensormaintenance/history/count",
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
