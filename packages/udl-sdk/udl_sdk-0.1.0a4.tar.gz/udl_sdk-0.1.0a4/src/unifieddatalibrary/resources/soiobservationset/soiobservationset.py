...
class SoiobservationsetResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        calibrations: Iterable[soiobservationset_create_params.Calibration] | NotGiven = NOT_GIVEN,
        ...
        optical_soi_observation_list: Iterable[soiobservationset_create_params.OpticalSoiObservationList]
        | NotGiven = NOT_GIVEN,
        ...
        radar_soi_observation_list: Iterable[soiobservationset_create_params.RadarSoiObservationList]
        | NotGiven = NOT_GIVEN,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                soiobservationset_create_params.SoiobservationsetCreateParams,
            ),
    ...
    def create_bulk(
        self,
        *,
        body: Iterable[soiobservationset_create_bulk_params.Body],
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        return self._post(
            ...
            body=maybe_transform(body, Iterable[soiobservationset_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class AsyncSoiobservationsetResource(AsyncAPIResource):
    ...
    async def create_bulk(
        ...
        *,
        ...
        return await self._post(
            "/udl/soiobservationset/createBulk",
            body=await async_maybe_transform(body, Iterable[soiobservationset_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class SoiobservationsetResourceWithRawResponse:
    def __init__(self, soiobservationset: SoiobservationsetResource) -> None:
        self._soiobservationset = soiobservationset

        self.create = to_raw_response_wrapper(
            soiobservationset.create,
        )
        self.list = to_raw_response_wrapper(
            soiobservationset.list,
        )
        self.count = to_raw_response_wrapper(
            soiobservationset.count,
        )
    ...
    def history(self) -> HistoryResourceWithRawResponse:
        return HistoryResourceWithRawResponse(self._soiobservationset.history)


class AsyncSoiobservationsetResourceWithRawResponse:
    def __init__(self, soiobservationset: AsyncSoiobservationsetResource) -> None:
        self._soiobservationset = soiobservationset
    ...
    def history(self) -> AsyncHistoryResourceWithRawResponse:
        return AsyncHistoryResourceWithRawResponse(self._soiobservationset.history)
...
class SoiobservationsetResourceWithStreamingResponse:
    ...
    def history(self) -> HistoryResourceWithStreamingResponse:
        return HistoryResourceWithStreamingResponse(self._soiobservationset.history)
...
class AsyncSoiobservationsetResourceWithStreamingResponse:
    ...
    def history(self) -> AsyncHistoryResourceWithStreamingResponse:
        return AsyncHistoryResourceWithStreamingResponse(self._soiobservationset.history)
