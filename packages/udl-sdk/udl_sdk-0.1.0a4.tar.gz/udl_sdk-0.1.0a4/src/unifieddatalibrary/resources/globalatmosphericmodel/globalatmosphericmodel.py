...
from ...types.globalatmosphericmodel_query_response import GlobalatmosphericmodelQueryResponse
from ...types.globalatmosphericmodel_tuple_response import GlobalatmosphericmodelTupleResponse
from ...types.globalatmosphericmodel_retrieve_response import GlobalatmosphericmodelRetrieveResponse
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                globalatmosphericmodel_unvalidated_publish_params.GlobalatmosphericmodelUnvalidatedPublishParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class GlobalatmosphericmodelResourceWithRawResponse:
    def __init__(self, globalatmosphericmodel: GlobalatmosphericmodelResource) -> None:
        self._globalatmosphericmodel = globalatmosphericmodel

        self.retrieve = to_raw_response_wrapper(
            globalatmosphericmodel.retrieve,
        )
        self.count = to_raw_response_wrapper(
            globalatmosphericmodel.count,
        )
        self.get_file = to_custom_raw_response_wrapper(
            globalatmosphericmodel.get_file,
            BinaryAPIResponse,
        )
        self.query = to_raw_response_wrapper(
            globalatmosphericmodel.query,
        )
        self.query_help = to_raw_response_wrapper(
            globalatmosphericmodel.query_help,
        )
        self.tuple = to_raw_response_wrapper(
            globalatmosphericmodel.tuple,
        )
        self.unvalidated_publish = to_raw_response_wrapper(
            globalatmosphericmodel.unvalidated_publish,
        )

    @cached_property
    def history(self) -> HistoryResourceWithRawResponse:
        return HistoryResourceWithRawResponse(self._globalatmosphericmodel.history)


class AsyncGlobalatmosphericmodelResourceWithRawResponse:
    def __init__(self, globalatmosphericmodel: AsyncGlobalatmosphericmodelResource) -> None:
        self._globalatmosphericmodel = globalatmosphericmodel
    ...
    def history(self) -> AsyncHistoryResourceWithRawResponse:
        return AsyncHistoryResourceWithRawResponse(self._globalatmosphericmodel.history)
...
class GlobalatmosphericmodelResourceWithStreamingResponse:
    ...
    def history(self) -> HistoryResourceWithStreamingResponse:
        return HistoryResourceWithStreamingResponse(self._globalatmosphericmodel.history)
...
class AsyncGlobalatmosphericmodelResourceWithStreamingResponse:
    ...
    def history(self) -> AsyncHistoryResourceWithStreamingResponse:
        return AsyncHistoryResourceWithStreamingResponse(self._globalatmosphericmodel.history)
