...
from ...types.globalatmosphericmodel import history_count_params, history_query_params, history_write_aodr_params
from ...types.globalatmosphericmodel.history_query_response import HistoryQueryResponse
...
class HistoryResource(SyncAPIResource):
    ...
    def count(
        ...
        *,
        ...
        return self._get(
            "/udl/globalatmosphericmodel/history/count",
