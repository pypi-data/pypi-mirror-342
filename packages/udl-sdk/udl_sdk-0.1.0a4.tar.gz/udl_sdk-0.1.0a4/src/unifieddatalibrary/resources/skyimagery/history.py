...
from ...types.skyimagery import history_aodr_params, history_list_params, history_count_params
from ...types.skyimagery.history_list_response import HistoryListResponse
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"exp_start_time": exp_start_time}, history_count_params.HistoryCountParams),
            ),
            cast_to=str,
        )
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=await async_maybe_transform(
                    {"exp_start_time": exp_start_time}, history_count_params.HistoryCountParams
                ),
            ),
            cast_to=str,
        )
