...
from ..types import launchvehicledetail_create_params, launchvehicledetail_update_params
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                launchvehicledetail_create_params.LaunchvehicledetailCreateParams,
            ),
        ...
        *,
        ...
        return self._put(
            ...
            body=maybe_transform(
                ...
                launchvehicledetail_update_params.LaunchvehicledetailUpdateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class LaunchvehicledetailsResourceWithRawResponse:
    def __init__(self, launchvehicledetails: LaunchvehicledetailsResource) -> None:
        self._launchvehicledetails = launchvehicledetails

        self.create = to_raw_response_wrapper(
            launchvehicledetails.create,
        )
        self.update = to_raw_response_wrapper(
            launchvehicledetails.update,
        )
        self.list = to_raw_response_wrapper(
            launchvehicledetails.list,
        )
        self.delete = to_raw_response_wrapper(
            launchvehicledetails.delete,
        )
        self.get = to_raw_response_wrapper(
            launchvehicledetails.get,
        )


class AsyncLaunchvehicledetailsResourceWithRawResponse:
    def __init__(self, launchvehicledetails: AsyncLaunchvehicledetailsResource) -> None:
        self._launchvehicledetails = launchvehicledetails
