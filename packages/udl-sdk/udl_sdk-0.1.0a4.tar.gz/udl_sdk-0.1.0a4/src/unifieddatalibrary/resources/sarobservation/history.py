...
from ...types.sarobservation import history_aodr_params, history_count_params, history_retrieve_params
from ...types.sarobservation.history_retrieve_response import HistoryRetrieveResponse
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"collection_start": collection_start}, history_count_params.HistoryCountParams),
            ),
            cast_to=str,
        )
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=await async_maybe_transform(
                    {"collection_start": collection_start}, history_count_params.HistoryCountParams
                ),
            ),
            cast_to=str,
        )
