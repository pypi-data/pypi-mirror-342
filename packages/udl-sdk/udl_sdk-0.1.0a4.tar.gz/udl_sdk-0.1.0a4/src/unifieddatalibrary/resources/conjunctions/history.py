...
from ...types.conjunctions import history_aodr_params, history_count_params
...
class HistoryResource(SyncAPIResource):
    ...
    def count(
        ...
        *,
        ...
        return self._get(
            "/udl/conjunction/history/count",
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"tca": tca}, history_count_params.HistoryCountParams),
            ),
            cast_to=str,
        )
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"tca": tca}, history_count_params.HistoryCountParams),
            ),
            cast_to=str,
        )
