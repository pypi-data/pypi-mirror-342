...
from ..types import comm_tuple_params, comm_create_params, comm_update_params
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"columns": columns}, comm_tuple_params.CommTupleParams),
            ),
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"columns": columns}, comm_tuple_params.CommTupleParams),
            ),
            cast_to=CommTupleResponse,
        )
