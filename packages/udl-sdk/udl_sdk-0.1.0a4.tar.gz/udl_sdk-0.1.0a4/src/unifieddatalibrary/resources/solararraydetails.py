...
class SolararraydetailsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        junction_technology: str | NotGiven = NOT_GIVEN,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                solararraydetail_create_params.SolararraydetailCreateParams,
            ),
        ...
        *,
        ...
        return self._put(
            ...
            body=maybe_transform(
                ...
                solararraydetail_update_params.SolararraydetailUpdateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class SolararraydetailsResourceWithRawResponse:
    def __init__(self, solararraydetails: SolararraydetailsResource) -> None:
        self._solararraydetails = solararraydetails

        self.create = to_raw_response_wrapper(
            solararraydetails.create,
        )
        self.update = to_raw_response_wrapper(
            solararraydetails.update,
        )
        self.list = to_raw_response_wrapper(
            solararraydetails.list,
        )
        self.delete = to_raw_response_wrapper(
            solararraydetails.delete,
        )
        self.get = to_raw_response_wrapper(
            solararraydetails.get,
        )


class AsyncSolararraydetailsResourceWithRawResponse:
    def __init__(self, solararraydetails: AsyncSolararraydetailsResource) -> None:
        self._solararraydetails = solararraydetails
