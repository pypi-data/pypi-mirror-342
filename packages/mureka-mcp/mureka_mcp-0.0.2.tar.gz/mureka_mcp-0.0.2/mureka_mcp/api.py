...
_api_url = "https://api.mureka.ai"
api_url = "https://api-test.mureka.ai"
...
@mcp.tool(
 ...
 ⚠️ COST WARNING: This tool makes an API call to mureka.ai which may incur costs. Only use when explicitly requested by the user.
    Args:
        prompt: The prompt to generate lyrics for song
    Returns:
...
@mcp.tool(
    ...
    ⚠️ COST WARNING: This tool makes an API call to mureka.ai which may incur costs. Only use when explicitly requested by the user.
    Args:
        lyrics: The lyrics to generate song
        prompt: Control song generation by inputting a prompt.For example:r&b, slow, passionate, male vocal.
...
@mcp.tool(
    ...
    ⚠️ COST WARNING: This tool makes an API call to mureka.ai which may incur costs. Only use when explicitly requested by the user.
    Args:
        prompt: Control music generation by inputting a prompt.For example:r&b, slow, passionate, male vocal.
        output_directory: Directory where files should be saved.
            Defaults to $HOME/Desktop if not provided.
    """)
