...
class vagranthost:
    ...
    def exec(self, command:str) -> typing.Dict[str, typing.Union[str, int]]:
        ...
        output["stdout"] = b"".join(chan.makefile("rb")).decode()
        output["stderr"] = b"".join(chan.makefile_stderr("rb")).decode()
        output["rc"] = chan.recv_exit_status()
