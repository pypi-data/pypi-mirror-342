...
from relationalai.early_access.dsl import Relation, ExternalRelation
    ...
    def to_relation(self, ctx: CompilerContext, item:Atom, name:str) -> ir.Relation:
        ...
        if entity_id not in self.relations:
            if name in builtins.builtin_relations_by_name:
                ...
                annotations = [builtins.external_annotation] if isinstance(item.relcomp, ExternalRelation) else []
