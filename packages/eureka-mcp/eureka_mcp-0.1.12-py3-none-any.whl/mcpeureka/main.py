...
async def just_get_version():
    f"""
    Get the version of the MCP protocol being used. currently: {__version__}
    
    Returns:
        str: The version of the MCP protocol.
    """
    return get_mcp_version()

@mcp.tool()
async def get_all_services(eureka_url: str, username: Optional[str] = None, password: Optional[str] = None) -> Dict[str, Any]:
    """
...
@mcp.tool()
async def get_service_instances(eureka_url: str, app_id: str, username: Optional[str] = None, password: Optional[str] = None) -> Dict[str, Any]:
    """
...
@mcp.tool()
async def get_instance_details(eureka_url: str, app_id: str, instance_id: str, username: Optional[str] = None, password: Optional[str] = None) -> \
        Dict[str, Any]:
    """
