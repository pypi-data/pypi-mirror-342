...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++",
        "name": "mettagrid.event",
        "sources": [
            "mettagrid/event.pyx"
        ]
    },
    "module_name": "mettagrid.event"
}
END: Cython Metadata */
...
#define __PYX_HAVE__mettagrid__event
#define __PYX_HAVE_API__mettagrid__event
/* Early includes */
#include "ios"
#include "new"
#include "stdexcept"
...
#define __Pyx_MODULE_NAME "mettagrid.event"
extern int __pyx_module_is_main_mettagrid__event;
int __pyx_module_is_main_mettagrid__event = 0;

/* Implementation of "mettagrid.event" */
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_mettagrid__event) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "mettagrid.event")) {
      if (unlikely((PyDict_SetItemString(modules, "mettagrid.event", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  #endif
  __Pyx_TraceCall("__Pyx_PyMODINIT_FUNC PyInit_event(void)", __pyx_f[0], 1, 0, __PYX_ERR(0, 1, __pyx_L1_error));

  /* "mettagrid/event.pyx":1
             # <<<<<<<<<<<<<<
 */
  ...
  if (__pyx_m) {
    if (__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init mettagrid.event", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init mettagrid.event");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
