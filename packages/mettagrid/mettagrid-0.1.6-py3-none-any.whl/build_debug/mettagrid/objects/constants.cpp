...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++",
        "name": "mettagrid.objects.constants",
        "sources": [
            "mettagrid/objects/constants.pyx"
        ]
    },
    "module_name": "mettagrid.objects.constants"
}
END: Cython Metadata */
...
#define __PYX_HAVE__mettagrid__objects__constants
#define __PYX_HAVE_API__mettagrid__objects__constants
/* Early includes */
#include "ios"
#include "new"
#include "stdexcept"
...
#define __Pyx_MODULE_NAME "mettagrid.objects.constants"
extern int __pyx_module_is_main_mettagrid__objects__constants;
int __pyx_module_is_main_mettagrid__objects__constants = 0;

/* Implementation of "mettagrid.objects.constants" */
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_mettagrid__objects__constants) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "mettagrid.objects.constants")) {
      if (unlikely((PyDict_SetItemString(modules, "mettagrid.objects.constants", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "mettagrid/objects/constants.pyx":1
             # <<<<<<<<<<<<<<
 */
  ...
  if (__pyx_m) {
    if (__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init mettagrid.objects.constants", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init mettagrid.objects.constants");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
