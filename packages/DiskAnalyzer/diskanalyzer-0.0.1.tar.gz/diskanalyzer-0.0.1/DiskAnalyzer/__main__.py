...
if __package__:
    from .DiskAnalyzer import main as disk_analyzer
    from .NtfsAnalyzer import main as ntfs_analyzer
    from .MftAnalyzer import main as mft_analyzer
else:
    from DiskAnalyzer import main as disk_analyzer
    from NtfsAnalyzer import main as ntfs_analyzer
    from MftAnalyzer import main as mft_analyzer
...
def main() -> int:
    return disk_analyzer() or ntfs_analyzer() or mft_analyzer()
