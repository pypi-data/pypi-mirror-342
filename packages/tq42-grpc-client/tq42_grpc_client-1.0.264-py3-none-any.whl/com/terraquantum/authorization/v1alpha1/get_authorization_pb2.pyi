...
class GetAuthorizationRequest(_message.Message):
    __slots__ = ("resource_type", "resource_id", "principal_mask")
    ...
    resource_id: str
    principal_mask: str
    def __init__(self, resource_type: _Optional[_Union[_check_authorization_pb2.ResourceType, str]] = ..., resource_id: _Optional[str] = ..., principal_mask: _Optional[str] = ...) -> None: ...
