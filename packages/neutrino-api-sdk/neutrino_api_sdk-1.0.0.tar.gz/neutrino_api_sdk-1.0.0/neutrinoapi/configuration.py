...
class Configuration(HttpClientConfiguration):
    ...
    environments = {
        ...
        Environment.BACKUP: {
            Server.DEFAULT: 'https://neutrinoapi.com'
        },
        Environment.EU: {
            Server.DEFAULT: 'https://eu.neutrinoapi.net'
        },
        Environment.AUS: {
            Server.DEFAULT: 'https://aus.neutrinoapi.net'
        },
        Environment.USA: {
            Server.DEFAULT: 'https://usa.neutrinoapi.net'
        }
    }
