...
adagrad_model = Optimizers(optimizer=adagrad_optimizer)
adagrad_model.train_and_evaluate()

# RMSProp optimizer
rmsprop_optimizer = RMSprop(learning_rate=0.001)
rmsprop_model = Optimizers(optimizer=rmsprop_optimizer)
rmsprop_model.train_and_evaluate()

# Adam optimizer
adam_optimizer = Adam(learning_rate=0.001)
adam_model = Optimizers(optimizer=adam_optimizer)
