...
def xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_csr_input(row_pointers: Annotated[Any, _atypes.Int32], sorted_sample_ids: Annotated[Any, _atypes.Int32], sorted_token_ids: Annotated[Any, _atypes.Int32], sorted_pos_ids: Annotated[Any, _atypes.Int32], sorted_gains: Annotated[Any, _atypes.Float32], weights: Annotated[Any, _atypes.Float32], preserved_valencies: Annotated[Any, _atypes.Int32], preserved_vectors: Annotated[Any, _atypes.Float32], activation_gradients: Annotated[Any, _atypes.Float32], tables: Annotated[List[Any], _atypes.Float32], hyperparameters: Annotated[List[Any], _atypes.Float32], combiner_weights_learning_rate: Annotated[Any, _atypes.Float32], max_valency: int, num_weights: int, combiner_table_vjp_computation, combiner_weights_vjp_computation, optimizer_custom_computation, table_name: str, name=None):
  r"""TODO: add doc.
...
def xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_csr_input_eager_fallback(row_pointers: Annotated[Any, _atypes.Int32], sorted_sample_ids: Annotated[Any, _atypes.Int32], sorted_token_ids: Annotated[Any, _atypes.Int32], sorted_pos_ids: Annotated[Any, _atypes.Int32], sorted_gains: Annotated[Any, _atypes.Float32], weights: Annotated[Any, _atypes.Float32], preserved_valencies: Annotated[Any, _atypes.Int32], preserved_vectors: Annotated[Any, _atypes.Float32], activation_gradients: Annotated[Any, _atypes.Float32], tables: Annotated[List[Any], _atypes.Float32], hyperparameters: Annotated[List[Any], _atypes.Float32], combiner_weights_learning_rate: Annotated[Any, _atypes.Float32], max_valency: int, num_weights: int, combiner_table_vjp_computation, combiner_weights_vjp_computation, optimizer_custom_computation, table_name: str, name, ctx):
  ...
  _inputs_flat = [row_pointers, sorted_sample_ids, sorted_token_ids, sorted_pos_ids, sorted_gains, weights, preserved_valencies, preserved_vectors, activation_gradients] + list(tables) + list(hyperparameters) + [combiner_weights_learning_rate]
...
def xla_sparse_dense_matmul_custom_combiner_on_tc_with_csr_input_eager_fallback(row_pointers: Annotated[Any, _atypes.Int32], sorted_sample_ids: Annotated[Any, _atypes.Int32], sorted_token_ids: Annotated[Any, _atypes.Int32], sorted_pos_ids: Annotated[Any, _atypes.Int32], sorted_gains: Annotated[Any, _atypes.Float32], embedding_table: Annotated[Any, _atypes.Float32], weights: Annotated[Any, _atypes.Float32], input_size: int, max_valency: int, num_weights: int, combiner_computation, quantization_config_low: float, quantization_config_high: float, quantization_config_num_buckets: int, table_name: str, name, ctx):
  input_size = _execute.make_int(input_size, "input_size")
  max_valency = _execute.make_int(max_valency, "max_valency")
  num_weights = _execute.make_int(num_weights, "num_weights")
  quantization_config_low = _execute.make_float(quantization_config_low, "quantization_config_low")
