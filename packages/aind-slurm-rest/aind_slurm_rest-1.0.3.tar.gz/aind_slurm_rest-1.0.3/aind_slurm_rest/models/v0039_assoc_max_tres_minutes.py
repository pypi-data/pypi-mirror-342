...
class V0039AssocMaxTresMinutes(BaseModel):
    """
    V0039AssocMaxTresMinutes
    """ # noqa: E501
    per: Optional[V0039AssocMaxTresMinutesPer] = None
    total: Optional[List[V0039Tres]] = None
    __properties: ClassVar[List[str]] = ["per", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "per": V0039AssocMaxTresMinutesPer.from_dict(obj["per"]) if obj.get("per") is not None else None,
