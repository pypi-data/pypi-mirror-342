...
class V0039ClusterRecAssociations(BaseModel):
    """
    V0039ClusterRecAssociations
    """ # noqa: E501
    root: Optional[V0039AssocShort] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "root": V0039AssocShort.from_dict(obj["root"]) if obj.get("root") is not None else None
        })
        return _obj
