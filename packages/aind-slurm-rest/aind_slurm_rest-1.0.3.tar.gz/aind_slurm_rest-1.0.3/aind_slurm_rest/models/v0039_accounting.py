...
class V0039Accounting(BaseModel):
    """
    V0039Accounting
    """ # noqa: E501
    ...
    tres: Optional[V0039Tres] = Field(default=None, alias="TRES")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "start": obj.get("start"),
            "TRES": V0039Tres.from_dict(obj["TRES"]) if obj.get("TRES") is not None else None
        })
        return _obj
