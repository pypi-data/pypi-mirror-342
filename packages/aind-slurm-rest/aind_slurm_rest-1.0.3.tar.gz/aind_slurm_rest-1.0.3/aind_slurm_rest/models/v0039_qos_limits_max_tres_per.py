...
class V0039QosLimitsMaxTresPer(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "node": [V0039Tres.from_dict(_item) for _item in obj["node"]] if obj.get("node") is not None else None,
