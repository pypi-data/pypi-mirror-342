...
class V0039AssocMaxJobs(BaseModel):
    """
    V0039AssocMaxJobs
    """ # noqa: E501
    per: Optional[V0039AssocMaxJobsPer] = None
    active: Optional[V0039Uint32NoVal] = None
    accruing: Optional[V0039Uint32NoVal] = None
    total: Optional[V0039Uint32NoVal] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "per": V0039AssocMaxJobsPer.from_dict(obj["per"]) if obj.get("per") is not None else None,
            "active": V0039Uint32NoVal.from_dict(obj["active"]) if obj.get("active") is not None else None,
            "accruing": V0039Uint32NoVal.from_dict(obj["accruing"]) if obj.get("accruing") is not None else None,
            "total": V0039Uint32NoVal.from_dict(obj["total"]) if obj.get("total") is not None else None
        })
        return _obj
