...
class V0039AssocMaxTres(BaseModel):
    """
    V0039AssocMaxTres
    """ # noqa: E501
    total: Optional[List[V0039Tres]] = None
    minutes: Optional[V0039AssocMaxTresMinutes] = None
    group: Optional[V0039AssocMaxTresGroup] = None
    per: Optional[V0039AssocMaxTresPer] = None
    __properties: ClassVar[List[str]] = ["total", "minutes", "group", "per"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "minutes": V0039AssocMaxTresMinutes.from_dict(obj["minutes"]) if obj.get("minutes") is not None else None,
            "group": V0039AssocMaxTresGroup.from_dict(obj["group"]) if obj.get("group") is not None else None,
            "per": V0039AssocMaxTresPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
