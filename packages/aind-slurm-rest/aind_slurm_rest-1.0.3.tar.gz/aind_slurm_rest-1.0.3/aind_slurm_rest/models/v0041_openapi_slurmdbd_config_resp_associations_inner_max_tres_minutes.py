...
class V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxTresMinutes(BaseModel):
    ...
    """ # noqa: E501
    total: Optional[List[SlurmdbV0041PostUsersAssociationRequestAssociationConditionAssociationGrptresInner]] = Field(default=None, description="MaxTRESMinsPerJob")
