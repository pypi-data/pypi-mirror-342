...
class SlurmV0041GetLicenses200Response(BaseModel):
    """
    SlurmV0041GetLicenses200Response
    """ # noqa: E501
    licenses: List[SlurmV0041GetLicenses200ResponseLicensesInner] = Field(description="List of licenses")
    last_update: SlurmV0041GetLicenses200ResponseLastUpdate
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "licenses": [SlurmV0041GetLicenses200ResponseLicensesInner.from_dict(_item) for _item in obj["licenses"]] if obj.get("licenses") is not None else None,
            "last_update": SlurmV0041GetLicenses200ResponseLastUpdate.from_dict(obj["last_update"]) if obj.get("last_update") is not None else None,
