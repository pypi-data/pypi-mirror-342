...
class SlurmV0041DeleteJobs200Response(BaseModel):
    """
    SlurmV0041DeleteJobs200Response
    """ # noqa: E501
    status: List[SlurmV0041DeleteJobs200ResponseStatusInner] = Field(description="resultant status of signal request")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "status": [SlurmV0041DeleteJobs200ResponseStatusInner.from_dict(_item) for _item in obj["status"]] if obj.get("status") is not None else None,
