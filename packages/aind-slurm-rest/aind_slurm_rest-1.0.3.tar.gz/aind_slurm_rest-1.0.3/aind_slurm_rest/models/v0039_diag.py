...
class V0039Diag(BaseModel):
    ...
    statistics: Optional[V0039StatsMsg] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "statistics": V0039StatsMsg.from_dict(obj["statistics"]) if obj.get("statistics") is not None else None
        })
        return _obj
