...
class V0039QosLimitsMaxWallClockPer(BaseModel):
    """
    V0039QosLimitsMaxWallClockPer
    """ # noqa: E501
    qos: Optional[V0039Uint32NoVal] = None
    job: Optional[V0039Uint32NoVal] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "qos": V0039Uint32NoVal.from_dict(obj["qos"]) if obj.get("qos") is not None else None,
            "job": V0039Uint32NoVal.from_dict(obj["job"]) if obj.get("job") is not None else None
        })
        return _obj
