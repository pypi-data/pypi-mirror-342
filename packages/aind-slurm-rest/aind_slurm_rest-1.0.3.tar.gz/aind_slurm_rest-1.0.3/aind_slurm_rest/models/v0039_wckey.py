...
class V0039Wckey(BaseModel):
    """
    V0039Wckey
    """ # noqa: E501
    accounting: Optional[List[V0039Accounting]] = None
    cluster: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accounting": [V0039Accounting.from_dict(_item) for _item in obj["accounting"]] if obj.get("accounting") is not None else None,
