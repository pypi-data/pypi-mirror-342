...
class SlurmV0041GetPing200Response(BaseModel):
    """
    SlurmV0041GetPing200Response
    """ # noqa: E501
    pings: List[SlurmV0041GetPing200ResponsePingsInner] = Field(description="pings")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pings": [SlurmV0041GetPing200ResponsePingsInner.from_dict(_item) for _item in obj["pings"]] if obj.get("pings") is not None else None,
