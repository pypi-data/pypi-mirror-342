...
class Dbv0039ResponseAssociationsDelete(BaseModel):
    """
    ...
    removed_associations: Optional[List[StrictStr]] = Field(default=None, description="the associations")
    __properties: ClassVar[List[str]] = ["meta", "errors", "warnings", "removed_associations"]
