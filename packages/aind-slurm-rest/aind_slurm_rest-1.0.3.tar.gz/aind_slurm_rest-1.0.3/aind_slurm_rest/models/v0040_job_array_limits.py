...
class V0040JobArrayLimits(BaseModel):
    """
    V0040JobArrayLimits
    """ # noqa: E501
    max: Optional[V0040JobArrayLimitsMax] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "max": V0040JobArrayLimitsMax.from_dict(obj["max"]) if obj.get("max") is not None else None
        })
        return _obj
