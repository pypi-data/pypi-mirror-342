...
class V0039QosLimitsMaxWallClock(BaseModel):
    """
    V0039QosLimitsMaxWallClock
    """ # noqa: E501
    per: Optional[V0039QosLimitsMaxWallClockPer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "per": V0039QosLimitsMaxWallClockPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
