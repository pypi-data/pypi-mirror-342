...
class SlurmV0041DeleteJobs200ResponseStatusInner(BaseModel):
    """
    List of jobs signal responses
    """ # noqa: E501
    error: Optional[SlurmV0041DeleteJobs200ResponseStatusInnerError] = None
    step_id: StrictStr = Field(description="Job or Step ID that signaling failed")
    job_id: SlurmV0041DeleteJobs200ResponseStatusInnerJobId
    federation: Optional[SlurmV0041DeleteJobs200ResponseStatusInnerFederation] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": SlurmV0041DeleteJobs200ResponseStatusInnerError.from_dict(obj["error"]) if obj.get("error") is not None else None,
            "step_id": obj.get("step_id"),
            "job_id": SlurmV0041DeleteJobs200ResponseStatusInnerJobId.from_dict(obj["job_id"]) if obj.get("job_id") is not None else None,
            "federation": SlurmV0041DeleteJobs200ResponseStatusInnerFederation.from_dict(obj["federation"]) if obj.get("federation") is not None else None
        })
        return _obj
