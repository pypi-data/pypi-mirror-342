...
class SlurmdbV0041PostAccountsAssociationRequest(BaseModel):
    """
    SlurmdbV0041PostAccountsAssociationRequest
    """ # noqa: E501
    association_condition: Optional[SlurmdbV0041PostAccountsAssociationRequestAssociationCondition] = None
    account: Optional[SlurmdbV0041PostAccountsAssociationRequestAccount] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "association_condition": SlurmdbV0041PostAccountsAssociationRequestAssociationCondition.from_dict(obj["association_condition"]) if obj.get("association_condition") is not None else None,
            "account": SlurmdbV0041PostAccountsAssociationRequestAccount.from_dict(obj["account"]) if obj.get("account") is not None else None,
