...
class V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTres(BaseModel):
    ...
    allocated: Optional[List[SlurmdbV0041PostUsersAssociationRequestAssociationConditionAssociationGrptresInner]] = Field(default=None, description="Trackable resources allocated to the step")
