...
class V0039StepTime(BaseModel):
    ...
    system: Optional[V0039StepTimeSystem] = None
    total: Optional[V0039StepTimeSystem] = None
    user: Optional[V0039StepTimeSystem] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "system": V0039StepTimeSystem.from_dict(obj["system"]) if obj.get("system") is not None else None,
            "total": V0039StepTimeSystem.from_dict(obj["total"]) if obj.get("total") is not None else None,
            "user": V0039StepTimeSystem.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
