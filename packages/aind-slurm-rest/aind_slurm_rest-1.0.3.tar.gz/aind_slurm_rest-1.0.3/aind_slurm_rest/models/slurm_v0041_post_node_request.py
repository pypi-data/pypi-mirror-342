...
class SlurmV0041PostNodeRequest(BaseModel):
    """
    ...
    resume_after: Optional[SlurmV0041PostNodeRequestResumeAfter] = None
    weight: Optional[SlurmV0041PostNodeRequestWeight] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resume_after": SlurmV0041PostNodeRequestResumeAfter.from_dict(obj["resume_after"]) if obj.get("resume_after") is not None else None,
            "weight": SlurmV0041PostNodeRequestWeight.from_dict(obj["weight"]) if obj.get("weight") is not None else None
        })
        return _obj
