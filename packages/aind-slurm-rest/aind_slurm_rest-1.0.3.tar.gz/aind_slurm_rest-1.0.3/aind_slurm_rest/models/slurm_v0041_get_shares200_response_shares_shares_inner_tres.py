...
class SlurmV0041GetShares200ResponseSharesSharesInnerTres(BaseModel):
    """
    SlurmV0041GetShares200ResponseSharesSharesInnerTres
    """ # noqa: E501
    run_seconds: Optional[List[SlurmV0041GetShares200ResponseSharesSharesInnerTresRunSecondsInner]] = Field(default=None, description="Currently running tres-secs = grp_used_tres_run_secs")
    group_minutes: Optional[List[SlurmV0041GetShares200ResponseSharesSharesInnerTresRunSecondsInner]] = Field(default=None, description="TRES-minute limit")
    usage: Optional[List[SlurmV0041GetShares200ResponseSharesSharesInnerTresUsageInner]] = Field(default=None, description="Measure of each TRES usage")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "run_seconds": [SlurmV0041GetShares200ResponseSharesSharesInnerTresRunSecondsInner.from_dict(_item) for _item in obj["run_seconds"]] if obj.get("run_seconds") is not None else None,
            "group_minutes": [SlurmV0041GetShares200ResponseSharesSharesInnerTresRunSecondsInner.from_dict(_item) for _item in obj["group_minutes"]] if obj.get("group_minutes") is not None else None,
            "usage": [SlurmV0041GetShares200ResponseSharesSharesInnerTresUsageInner.from_dict(_item) for _item in obj["usage"]] if obj.get("usage") is not None else None
        })
        return _obj
