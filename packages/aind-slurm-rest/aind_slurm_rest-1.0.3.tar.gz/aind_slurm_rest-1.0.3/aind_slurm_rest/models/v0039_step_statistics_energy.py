...
class V0039StepStatisticsEnergy(BaseModel):
    """
    V0039StepStatisticsEnergy
    """ # noqa: E501
    consumed: Optional[V0039Uint64NoVal] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "consumed": V0039Uint64NoVal.from_dict(obj["consumed"]) if obj.get("consumed") is not None else None
        })
        return _obj
