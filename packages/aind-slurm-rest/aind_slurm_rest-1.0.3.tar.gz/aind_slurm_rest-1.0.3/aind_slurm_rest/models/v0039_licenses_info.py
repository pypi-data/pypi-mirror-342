...
class V0039LicensesInfo(BaseModel):
    """
    V0039LicensesInfo
    """ # noqa: E501
    ...
    licenses: Optional[List[V0039License]] = None
    __properties: ClassVar[List[str]] = ["meta", "errors", "warnings", "licenses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "licenses": [V0039License.from_dict(_item) for _item in obj["licenses"]] if obj.get("licenses") is not None else None
        })
        return _obj
