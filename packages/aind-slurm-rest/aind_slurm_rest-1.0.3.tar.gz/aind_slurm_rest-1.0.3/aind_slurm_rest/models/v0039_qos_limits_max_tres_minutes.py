...
class V0039QosLimitsMaxTresMinutes(BaseModel):
    """
    V0039QosLimitsMaxTresMinutes
    """ # noqa: E501
    per: Optional[V0039QosLimitsMaxTresMinutesPer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "per": V0039QosLimitsMaxTresMinutesPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
