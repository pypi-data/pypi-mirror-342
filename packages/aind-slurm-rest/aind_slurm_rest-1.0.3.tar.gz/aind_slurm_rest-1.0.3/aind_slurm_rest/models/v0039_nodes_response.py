...
class V0039NodesResponse(BaseModel):
    """
    V0039NodesResponse
    """ # noqa: E501
    ...
    nodes: Optional[List[V0039Node]] = None
    __properties: ClassVar[List[str]] = ["meta", "errors", "warnings", "nodes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "nodes": [V0039Node.from_dict(_item) for _item in obj["nodes"]] if obj.get("nodes") is not None else None
        })
        return _obj
