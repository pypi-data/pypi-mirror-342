...
class V0039AssocMaxTresGroup(BaseModel):
    """
    V0039AssocMaxTresGroup
    """ # noqa: E501
    minutes: Optional[List[V0039Tres]] = None
    active: Optional[List[V0039Tres]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "minutes": [V0039Tres.from_dict(_item) for _item in obj["minutes"]] if obj.get("minutes") is not None else None,
            "active": [V0039Tres.from_dict(_item) for _item in obj["active"]] if obj.get("active") is not None else None
        })
        return _obj
