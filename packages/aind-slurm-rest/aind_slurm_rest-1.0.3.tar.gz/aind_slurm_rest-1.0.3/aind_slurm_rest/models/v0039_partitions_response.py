...
class V0039PartitionsResponse(BaseModel):
    """
    ...
    partitions: Optional[List[V0039PartitionInfo]] = None
    __properties: ClassVar[List[str]] = ["meta", "errors", "warnings", "partitions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "partitions": [V0039PartitionInfo.from_dict(_item) for _item in obj["partitions"]] if obj.get("partitions") is not None else None
        })
        return _obj
