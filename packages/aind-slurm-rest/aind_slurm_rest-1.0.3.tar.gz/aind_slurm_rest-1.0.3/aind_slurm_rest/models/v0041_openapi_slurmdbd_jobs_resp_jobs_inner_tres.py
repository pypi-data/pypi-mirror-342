...
class V0041OpenapiSlurmdbdJobsRespJobsInnerTres(BaseModel):
    ...
    """ # noqa: E501
    allocated: Optional[List[SlurmdbV0041PostUsersAssociationRequestAssociationConditionAssociationGrptresInner]] = Field(default=None, description="Trackable resources allocated to the job")
    requested: Optional[List[SlurmdbV0041PostUsersAssociationRequestAssociationConditionAssociationGrptresInner]] = Field(default=None, description="Trackable resources requested by job")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "allocated": [SlurmdbV0041PostUsersAssociationRequestAssociationConditionAssociationGrptresInner.from_dict(_item) for _item in obj["allocated"]] if obj.get("allocated") is not None else None,
            "requested": [SlurmdbV0041PostUsersAssociationRequestAssociationConditionAssociationGrptresInner.from_dict(_item) for _item in obj["requested"]] if obj.get("requested") is not None else None
        })
        return _obj
