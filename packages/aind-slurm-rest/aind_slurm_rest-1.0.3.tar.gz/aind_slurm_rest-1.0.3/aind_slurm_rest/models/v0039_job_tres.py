...
class V0039JobTres(BaseModel):
    """
    V0039JobTres
    """ # noqa: E501
    allocated: Optional[List[V0039Tres]] = None
    requested: Optional[List[V0039Tres]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "requested": [V0039Tres.from_dict(_item) for _item in obj["requested"]] if obj.get("requested") is not None else None
        })
        return _obj
