...
class V0039StepCPURequestedFrequency(BaseModel):
    """
    V0039StepCPURequestedFrequency
    """ # noqa: E501
    min: Optional[V0039Uint32NoVal] = None
    max: Optional[V0039Uint32NoVal] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "min": V0039Uint32NoVal.from_dict(obj["min"]) if obj.get("min") is not None else None,
            "max": V0039Uint32NoVal.from_dict(obj["max"]) if obj.get("max") is not None else None
        })
        return _obj
