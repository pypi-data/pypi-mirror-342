    ...
    def make_instance(self, include_optional) -> SlurmV0041GetShares200Response:
        ...
        if include_optional:
            return SlurmV0041GetShares200Response(
                shares = aind_slurm_rest.models.slurm_v0041_get_shares_200_response_shares.slurm_v0041_get_shares_200_response_shares(
                    shares = [
                        aind_slurm_rest.models.slurm_v0041_get_shares_200_response_shares_shares_inner.slurm_v0041_get_shares_200_response_shares_shares_inner(
                            id = 56, 
                            cluster = '', 
                            name = '', 
                            parent = '', 
