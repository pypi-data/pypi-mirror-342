    ...
    def make_instance(self, include_optional) -> V0040OpenapiSlurmdbdConfigResp:
        ...
        if include_optional:
            return V0040OpenapiSlurmdbdConfigResp(
                clusters = [
                    aind_slurm_rest.models.v0/0/40_cluster_rec.v0.0.40_cluster_rec(
                        ...
                        nodes = '', 
                        select_plugin = '', 
                        associations = aind_slurm_rest.models.v0_0_40_cluster_rec_associations.v0_0_40_cluster_rec_associations(
                            root = aind_slurm_rest.models.v0/0/40_assoc_short.v0.0.40_assoc_short(
                                account = '', 
                                cluster = '', 
                                partition = '', 
                                user = '', 
                ...
                accounts = [
                    aind_slurm_rest.models.v0/0/40_account.v0.0.40_account(
                        associations = [
                            aind_slurm_rest.models.v0/0/40_assoc_short.v0.0.40_assoc_short(
                                account = '', 
                                cluster = '', 
                                partition = '', 
                                user = '', 
                        ...
                        coordinators = [
                            aind_slurm_rest.models.v0/0/40_coord.v0.0.40_coord(
                                name = '', 
                                direct = True, )
                            ], 
                        description = '', 
                ...
                users = [
                    aind_slurm_rest.models.v0/0/40_user.v0.0.40_user(
                        administrator_level = [
                            'Not Set'
                            ], 
                        associations = [
                        ...
                        old_name = '', 
                        wckeys = [
                            aind_slurm_rest.models.v0/0/40_wckey.v0.0.40_wckey(
                                accounting = [
                                    aind_slurm_rest.models.v0/0/40_accounting.v0.0.40_accounting(
                                        allocated = aind_slurm_rest.models.v0_0_40_accounting_allocated.v0_0_40_accounting_allocated(
                                            seconds = 56, ), 
                                        id = 56, 
                                        start = 56, 
                                        tres = aind_slurm_rest.models.v0/0/40_tres.v0.0.40_tres(
                                            type = '', 
                                            name = '', 
                                            id = 56, 
                                            count = 56, ), )
                ...
                associations = [
                    aind_slurm_rest.models.v0/0/40_assoc.v0.0.40_assoc(
                        accounting = [
                            aind_slurm_rest.models.v0/0/40_accounting.v0.0.40_accounting(
                                allocated = aind_slurm_rest.models.v0_0_40_accounting_allocated.v0_0_40_accounting_allocated(
                                    seconds = 56, ), 
                        ...
                        max = aind_slurm_rest.models.v0_0_40_assoc_max.v0_0_40_assoc_max(
                            jobs = aind_slurm_rest.models.v0_0_40_assoc_max_jobs.v0_0_40_assoc_max_jobs(
                                per = aind_slurm_rest.models.v0_0_40_assoc_max_jobs_per.v0_0_40_assoc_max_jobs_per(
                                    count = aind_slurm_rest.models.v0/0/40_uint32_no_val.v0.0.40_uint32_no_val(
                                        set = True, 
                                        infinite = True, 
                                        number = 56, ), 
                                ...
                                accruing = , 
                                total = , ), 
                            tres = aind_slurm_rest.models.v0_0_40_assoc_max_tres.v0_0_40_assoc_max_tres(
                                group = aind_slurm_rest.models.v0_0_40_assoc_max_tres_group.v0_0_40_assoc_max_tres_group(
                                    minutes = [
                                        aind_slurm_rest.models.v0/0/40_tres.v0.0.40_tres(
                                            type = '', 
                                            name = '', 
                                ...
                                minutes = aind_slurm_rest.models.v0_0_40_assoc_max_tres_minutes.v0_0_40_assoc_max_tres_minutes(), ), 
                            per = aind_slurm_rest.models.v0_0_40_assoc_max_per.v0_0_40_assoc_max_per(
                                account = aind_slurm_rest.models.v0_0_40_assoc_max_per_account.v0_0_40_assoc_max_per_account(), ), ), 
                        id = aind_slurm_rest.models.v0/0/40_assoc_short.v0.0.40_assoc_short(
                            cluster = '', 
                            partition = '', 
                            user = '', ), 
                        is_default = True, 
                        lineage = '', 
                        min = aind_slurm_rest.models.v0_0_40_assoc_min.v0_0_40_assoc_min(
                            priority_threshold = , ), 
                        parent_account = '', 
                        partition = '', 
                        priority = , 
                ...
                instances = [
                    aind_slurm_rest.models.v0/0/40_instance.v0.0.40_instance(
                        cluster = '', 
                        extra = '', 
                        instance_id = '', 
                        instance_type = '', 
