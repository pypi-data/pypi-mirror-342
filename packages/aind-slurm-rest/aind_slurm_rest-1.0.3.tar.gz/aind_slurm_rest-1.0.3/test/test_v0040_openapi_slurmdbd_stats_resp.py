    ...
    def make_instance(self, include_optional) -> V0040OpenapiSlurmdbdStatsResp:
        ...
        if include_optional:
            return V0040OpenapiSlurmdbdStatsResp(
                statistics = aind_slurm_rest.models.v0/0/40_stats_rec.v0.0.40_stats_rec(
                    time_start = 56, 
                    rollups = [
                    ...
                    rpcs = [
                        aind_slurm_rest.models.v0/0/40_stats_rpc.v0.0.40_stats_rpc(
                            rpc = '', 
                            count = 56, 
                    ...
                    users = [
                        aind_slurm_rest.models.v0/0/40_stats_user.v0.0.40_stats_user(
                            user = '', 
                            count = 56, )
                        ], ),
