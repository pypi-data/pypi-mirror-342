    ...
    def make_instance(self, include_optional) -> V0039UpdateNodeMsg:
        ...
        if include_optional:
            return V0039UpdateNodeMsg(
                ...
                reason = '',
                reason_uid = '',
                resume_after = aind_slurm_rest.models.v0/0/39_uint32_no_val.v0.0.39_uint32_no_val(
                    set = True, 
                    infinite = True, 
                    number = 56, ),
                weight = aind_slurm_rest.models.v0/0/39_uint32_no_val.v0.0.39_uint32_no_val(
                    set = True, 
                    infinite = True, 
                    number = 56, )
            )
