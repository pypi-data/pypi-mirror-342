        ...
        if include_optional:
            return V0040QosLimitsMax(
                ...
                wall_clock = aind_slurm_rest.models.v0_0_40_qos_limits_max_wall_clock.v0_0_40_qos_limits_max_wall_clock(
                    per = aind_slurm_rest.models.v0_0_40_qos_limits_max_wall_clock_per.v0_0_40_qos_limits_max_wall_clock_per(
                ...
                jobs = aind_slurm_rest.models.v0_0_40_qos_limits_max_jobs.v0_0_40_qos_limits_max_jobs(
                    active_jobs = aind_slurm_rest.models.v0_0_40_qos_limits_max_jobs_active_jobs.v0_0_40_qos_limits_max_jobs_active_jobs(
                        per = aind_slurm_rest.models.v0_0_40_qos_limits_max_jobs_active_jobs_per.v0_0_40_qos_limits_max_jobs_active_jobs_per(
                            account = aind_slurm_rest.models.v0/0/40_uint32_no_val.v0.0.40_uint32_no_val(
                                set = True, 
                                infinite = True, 
                                number = 56, ), 
                            user = aind_slurm_rest.models.v0/0/40_uint32_no_val.v0.0.40_uint32_no_val(
                                set = True, 
                                infinite = True, 
                                number = 56, ), ), ), 
                    per = aind_slurm_rest.models.v0_0_40_qos_limits_max_jobs_active_jobs_per.v0_0_40_qos_limits_max_jobs_active_jobs_per(), ),
