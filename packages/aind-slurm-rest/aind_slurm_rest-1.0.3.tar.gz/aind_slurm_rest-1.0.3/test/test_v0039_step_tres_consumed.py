...
class TestV0039StepTresConsumed(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V0039StepTresConsumed:
        """Test V0039StepTresConsumed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V0039StepTresConsumed`
        """
        model = V0039StepTresConsumed()
        if include_optional:
    ...
    def testV0039StepTresConsumed(self):
        """Test V0039StepTresConsumed"""
