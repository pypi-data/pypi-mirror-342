...
class TestV0039AssocMaxTresMinutesPer(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V0039AssocMaxTresMinutesPer:
        """Test V0039AssocMaxTresMinutesPer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V0039AssocMaxTresMinutesPer`
        """
        model = V0039AssocMaxTresMinutesPer()
        if include_optional:
    ...
    def testV0039AssocMaxTresMinutesPer(self):
        """Test V0039AssocMaxTresMinutesPer"""
