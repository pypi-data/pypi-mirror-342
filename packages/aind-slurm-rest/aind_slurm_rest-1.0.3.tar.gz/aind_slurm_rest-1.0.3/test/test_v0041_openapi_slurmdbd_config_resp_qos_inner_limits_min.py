        ...
        if include_optional:
            return V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMin(
                priority_threshold = aind_slurm_rest.models.v0_0_41_openapi_slurmdbd_config_resp_qos_inner_limits_min_priority_threshold.v0_0_41_openapi_slurmdbd_config_resp_qos_inner_limits_min_priority_threshold(
                    ...
                    infinite = True, 
                    number = 56, ),
                tres = aind_slurm_rest.models.v0_0_41_openapi_slurmdbd_config_resp_qos_inner_limits_min_tres.v0_0_41_openapi_slurmdbd_config_resp_qos_inner_limits_min_tres(
