        ...
        if include_optional:
            return V0040Qos(
                ...
                preempt = aind_slurm_rest.models.v0_0_40_qos_preempt.v0_0_40_qos_preempt(
                    ...
                    exempt_time = aind_slurm_rest.models.v0/0/40_uint32_no_val.v0.0.40_uint32_no_val(
                        set = True, 
                        infinite = True, 
                        number = 56, ), ),
                ...
                usage_factor = aind_slurm_rest.models.v0/0/40_float64_no_val.v0.0.40_float64_no_val(
                    ...
                    infinite = True, 
                    number = 1.337, ),
                usage_threshold = aind_slurm_rest.models.v0/0/40_float64_no_val.v0.0.40_float64_no_val(
                    set = True, 
                    infinite = True, 
                    number = 1.337, )
            )
