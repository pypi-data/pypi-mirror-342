...
class SlurmV0041GetDiag200ResponseStatisticsRpcsByMessageTypeInner(BaseModel):
    """
    RPCs by type
    """ # noqa: E501
    ...
    average_time: SlurmV0041GetDiag200ResponseStatisticsRpcsByMessageTypeInnerAverageTime
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "average_time": SlurmV0041GetDiag200ResponseStatisticsRpcsByMessageTypeInnerAverageTime.from_dict(obj["average_time"]) if obj.get("average_time") is not None else None
        })
        return _obj
