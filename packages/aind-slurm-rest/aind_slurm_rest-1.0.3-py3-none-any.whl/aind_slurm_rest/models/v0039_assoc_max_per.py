...
class V0039AssocMaxPer(BaseModel):
    """
    V0039AssocMaxPer
    """ # noqa: E501
    account: Optional[V0039AssocMaxPerAccount] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "account": V0039AssocMaxPerAccount.from_dict(obj["account"]) if obj.get("account") is not None else None
        })
        return _obj
