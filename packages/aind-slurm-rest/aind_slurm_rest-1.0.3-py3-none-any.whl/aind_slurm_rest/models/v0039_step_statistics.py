...
class V0039StepStatistics(BaseModel):
    """
    V0039StepStatistics
    """ # noqa: E501
    cpu: Optional[V0039StepStatisticsCPU] = Field(default=None, alias="CPU")
    energy: Optional[V0039StepStatisticsEnergy] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "CPU": V0039StepStatisticsCPU.from_dict(obj["CPU"]) if obj.get("CPU") is not None else None,
            "energy": V0039StepStatisticsEnergy.from_dict(obj["energy"]) if obj.get("energy") is not None else None
        })
        return _obj
