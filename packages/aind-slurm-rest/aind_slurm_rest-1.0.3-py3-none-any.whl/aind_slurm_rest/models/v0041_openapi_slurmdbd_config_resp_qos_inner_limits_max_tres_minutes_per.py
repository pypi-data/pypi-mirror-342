...
class V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxTresMinutesPer(BaseModel):
    ...
    """ # noqa: E501
    qos: Optional[List[SlurmdbV0041PostUsersAssociationRequestAssociationConditionAssociationGrptresInner]] = Field(default=None, description="GrpTRESRunMins")
    job: Optional[List[SlurmdbV0041PostUsersAssociationRequestAssociationConditionAssociationGrptresInner]] = Field(default=None, description="MaxTRESMinsPerJob")
    account: Optional[List[SlurmdbV0041PostUsersAssociationRequestAssociationConditionAssociationGrptresInner]] = Field(default=None, description="MaxTRESRunMinsPerAccount")
    user: Optional[List[SlurmdbV0041PostUsersAssociationRequestAssociationConditionAssociationGrptresInner]] = Field(default=None, description="MaxTRESRunMinsPerUser")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "qos": [SlurmdbV0041PostUsersAssociationRequestAssociationConditionAssociationGrptresInner.from_dict(_item) for _item in obj["qos"]] if obj.get("qos") is not None else None,
