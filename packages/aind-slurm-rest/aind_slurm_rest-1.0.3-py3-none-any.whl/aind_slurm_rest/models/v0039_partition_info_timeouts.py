...
class V0039PartitionInfoTimeouts(BaseModel):
    """
    V0039PartitionInfoTimeouts
    """ # noqa: E501
    resume: Optional[V0039Uint16NoVal] = None
    suspend: Optional[V0039Uint16NoVal] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resume": V0039Uint16NoVal.from_dict(obj["resume"]) if obj.get("resume") is not None else None,
            "suspend": V0039Uint16NoVal.from_dict(obj["suspend"]) if obj.get("suspend") is not None else None
        })
        return _obj
