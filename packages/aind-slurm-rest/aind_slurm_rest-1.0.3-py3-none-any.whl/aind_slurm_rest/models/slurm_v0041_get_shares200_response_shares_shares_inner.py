...
class SlurmV0041GetShares200ResponseSharesSharesInner(BaseModel):
    """
    ...
    shares_normalized: Optional[SlurmV0041GetShares200ResponseSharesSharesInnerSharesNormalized] = None
    shares: Optional[SlurmV0041GetShares200ResponseSharesSharesInnerShares] = None
    tres: Optional[SlurmV0041GetShares200ResponseSharesSharesInnerTres] = None
    effective_usage: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Effective, normalized usage")
    usage_normalized: Optional[SlurmV0041GetShares200ResponseSharesSharesInnerUsageNormalized] = None
    usage: Optional[StrictInt] = Field(default=None, description="Measure of tresbillableunits usage")
    fairshare: Optional[SlurmV0041GetShares200ResponseSharesSharesInnerFairshare] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "shares_normalized": SlurmV0041GetShares200ResponseSharesSharesInnerSharesNormalized.from_dict(obj["shares_normalized"]) if obj.get("shares_normalized") is not None else None,
            "shares": SlurmV0041GetShares200ResponseSharesSharesInnerShares.from_dict(obj["shares"]) if obj.get("shares") is not None else None,
            "tres": SlurmV0041GetShares200ResponseSharesSharesInnerTres.from_dict(obj["tres"]) if obj.get("tres") is not None else None,
            "effective_usage": obj.get("effective_usage"),
            "usage_normalized": SlurmV0041GetShares200ResponseSharesSharesInnerUsageNormalized.from_dict(obj["usage_normalized"]) if obj.get("usage_normalized") is not None else None,
            "usage": obj.get("usage"),
            "fairshare": SlurmV0041GetShares200ResponseSharesSharesInnerFairshare.from_dict(obj["fairshare"]) if obj.get("fairshare") is not None else None,
            "type": obj.get("type")
        })
        return _obj
