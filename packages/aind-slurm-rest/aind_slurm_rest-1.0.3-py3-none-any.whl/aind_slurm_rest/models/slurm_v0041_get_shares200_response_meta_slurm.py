...
class SlurmV0041GetShares200ResponseMetaSlurm(BaseModel):
    """
    SlurmV0041GetShares200ResponseMetaSlurm
    """ # noqa: E501
    version: Optional[SlurmV0041GetShares200ResponseMetaSlurmVersion] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "version": SlurmV0041GetShares200ResponseMetaSlurmVersion.from_dict(obj["version"]) if obj.get("version") is not None else None,
