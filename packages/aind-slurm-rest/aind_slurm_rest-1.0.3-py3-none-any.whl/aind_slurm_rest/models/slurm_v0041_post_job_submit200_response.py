...
class SlurmV0041PostJobSubmit200Response(BaseModel):
    """
    SlurmV0041PostJobSubmit200Response
    """ # noqa: E501
    result: Optional[SlurmV0041PostJobSubmit200ResponseResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": SlurmV0041PostJobSubmit200ResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None,
