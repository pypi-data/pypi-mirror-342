...
class SlurmdbV0041GetDiag200ResponseStatisticsUsersInner(BaseModel):
    """
    ...
    time: Optional[SlurmdbV0041GetDiag200ResponseStatisticsRPCsInnerTime] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user": obj.get("user"),
            "count": obj.get("count"),
            "time": SlurmdbV0041GetDiag200ResponseStatisticsRPCsInnerTime.from_dict(obj["time"]) if obj.get("time") is not None else None
        })
        return _obj
