...
class V0039JobTime(BaseModel):
    """
    V0039JobTime
    """ # noqa: E501
    elapsed: Optional[StrictInt] = None
    eligible: Optional[StrictInt] = None
    end: Optional[StrictInt] = None
    start: Optional[StrictInt] = None
    submission: Optional[StrictInt] = None
    suspended: Optional[StrictInt] = None
    system: Optional[V0039JobTimeSystem] = None
    limit: Optional[V0039Uint32NoVal] = None
    total: Optional[V0039JobTimeSystem] = None
    user: Optional[V0039JobTimeSystem] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "system": V0039JobTimeSystem.from_dict(obj["system"]) if obj.get("system") is not None else None,
            "limit": V0039Uint32NoVal.from_dict(obj["limit"]) if obj.get("limit") is not None else None,
            "total": V0039JobTimeSystem.from_dict(obj["total"]) if obj.get("total") is not None else None,
            "user": V0039JobTimeSystem.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
