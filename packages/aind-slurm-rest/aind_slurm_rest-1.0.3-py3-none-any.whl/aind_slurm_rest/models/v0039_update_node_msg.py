...
class V0039UpdateNodeMsg(BaseModel):
    """
    V0039UpdateNodeMsg
    """ # noqa: E501
    ...
    resume_after: Optional[V0039Uint32NoVal] = None
    weight: Optional[V0039Uint32NoVal] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resume_after": V0039Uint32NoVal.from_dict(obj["resume_after"]) if obj.get("resume_after") is not None else None,
            "weight": V0039Uint32NoVal.from_dict(obj["weight"]) if obj.get("weight") is not None else None
        })
        return _obj
