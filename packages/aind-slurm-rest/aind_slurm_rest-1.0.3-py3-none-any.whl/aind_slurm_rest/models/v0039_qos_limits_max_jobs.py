...
class V0039QosLimitsMaxJobs(BaseModel):
    """
    V0039QosLimitsMaxJobs
    """ # noqa: E501
    active_jobs: Optional[V0039QosLimitsMaxJobsActiveJobs] = None
    per: Optional[V0039QosLimitsMaxJobsActiveJobsPer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "active_jobs": V0039QosLimitsMaxJobsActiveJobs.from_dict(obj["active_jobs"]) if obj.get("active_jobs") is not None else None,
            "per": V0039QosLimitsMaxJobsActiveJobsPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
