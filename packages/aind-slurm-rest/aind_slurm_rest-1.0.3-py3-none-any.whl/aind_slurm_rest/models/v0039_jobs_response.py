...
class V0039JobsResponse(BaseModel):
    """
    V0039JobsResponse
    """ # noqa: E501
    ...
    jobs: Optional[List[V0039JobInfo]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "jobs": [V0039JobInfo.from_dict(_item) for _item in obj["jobs"]] if obj.get("jobs") is not None else None
        })
        return _obj
