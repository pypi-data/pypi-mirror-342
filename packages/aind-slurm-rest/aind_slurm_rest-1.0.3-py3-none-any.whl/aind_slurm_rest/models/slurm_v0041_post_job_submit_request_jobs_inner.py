...
class SlurmV0041PostJobSubmitRequestJobsInner(BaseModel):
    """
    ...
    begin_time: Optional[SlurmV0041PostJobSubmitRequestJobsInnerBeginTime] = None
    ...
    crontab: Optional[SlurmV0041PostJobSubmitRequestJobsInnerCrontab] = None
    ...
    rlimits: Optional[SlurmV0041PostJobSubmitRequestJobsInnerRlimits] = None
    ...
    distribution_plane_size: Optional[SlurmV0041PostJobSubmitRequestJobsInnerDistributionPlaneSize] = None
    ...
    priority: Optional[SlurmV0041PostJobSubmitRequestJobsInnerPriority] = None
    ...
    time_limit: Optional[SlurmV0041PostJobSubmitRequestJobsInnerTimeLimit] = None
    time_minimum: Optional[SlurmV0041PostJobSubmitRequestJobsInnerTimeMinimum] = None
    ...
    kill_warning_delay: Optional[SlurmV0041PostJobSubmitRequestJobsInnerKillWarningDelay] = None
    ...
    memory_per_cpu: Optional[SlurmV0041PostJobSubmitRequestJobsInnerMemoryPerCpu] = None
    memory_per_node: Optional[SlurmV0041PostJobSubmitRequestJobsInnerMemoryPerCpu] = None
    ...
    required_switches: Optional[SlurmV0041PostJobSubmitRequestJobsInnerRequiredSwitches] = None
    segment_size: Optional[SlurmV0041PostJobSubmitRequestJobsInnerSegmentSize] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "begin_time": SlurmV0041PostJobSubmitRequestJobsInnerBeginTime.from_dict(obj["begin_time"]) if obj.get("begin_time") is not None else None,
            "flags": obj.get("flags"),
            ...
            "crontab": SlurmV0041PostJobSubmitRequestJobsInnerCrontab.from_dict(obj["crontab"]) if obj.get("crontab") is not None else None,
            "deadline": obj.get("deadline"),
            "delay_boot": obj.get("delay_boot"),
            "dependency": obj.get("dependency"),
            "end_time": obj.get("end_time"),
            "environment": obj.get("environment"),
            "rlimits": SlurmV0041PostJobSubmitRequestJobsInnerRlimits.from_dict(obj["rlimits"]) if obj.get("rlimits") is not None else None,
            ...
            "distribution_plane_size": SlurmV0041PostJobSubmitRequestJobsInnerDistributionPlaneSize.from_dict(obj["distribution_plane_size"]) if obj.get("distribution_plane_size") is not None else None,
            "power_flags": obj.get("power_flags"),
            "prefer": obj.get("prefer"),
            "hold": obj.get("hold"),
            "priority": SlurmV0041PostJobSubmitRequestJobsInnerPriority.from_dict(obj["priority"]) if obj.get("priority") is not None else None,
            ...
            "time_limit": SlurmV0041PostJobSubmitRequestJobsInnerTimeLimit.from_dict(obj["time_limit"]) if obj.get("time_limit") is not None else None,
            "time_minimum": SlurmV0041PostJobSubmitRequestJobsInnerTimeMinimum.from_dict(obj["time_minimum"]) if obj.get("time_minimum") is not None else None,
            ...
            "kill_warning_delay": SlurmV0041PostJobSubmitRequestJobsInnerKillWarningDelay.from_dict(obj["kill_warning_delay"]) if obj.get("kill_warning_delay") is not None else None,
            ...
            "memory_per_cpu": SlurmV0041PostJobSubmitRequestJobsInnerMemoryPerCpu.from_dict(obj["memory_per_cpu"]) if obj.get("memory_per_cpu") is not None else None,
            "memory_per_node": SlurmV0041PostJobSubmitRequestJobsInnerMemoryPerCpu.from_dict(obj["memory_per_node"]) if obj.get("memory_per_node") is not None else None,
            "temporary_disk_per_node": obj.get("temporary_disk_per_node"),
            "selinux_context": obj.get("selinux_context"),
            "required_switches": SlurmV0041PostJobSubmitRequestJobsInnerRequiredSwitches.from_dict(obj["required_switches"]) if obj.get("required_switches") is not None else None,
            "segment_size": SlurmV0041PostJobSubmitRequestJobsInnerSegmentSize.from_dict(obj["segment_size"]) if obj.get("segment_size") is not None else None,
