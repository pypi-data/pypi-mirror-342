...
class V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeSignal(BaseModel):
    """
    V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeSignal
    """ # noqa: E501
    id: Optional[V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeSignalId] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeSignalId.from_dict(obj["id"]) if obj.get("id") is not None else None,
            "name": obj.get("name")
        })
        return _obj
