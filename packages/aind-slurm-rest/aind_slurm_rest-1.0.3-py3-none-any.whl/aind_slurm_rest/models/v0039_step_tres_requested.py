...
class V0039StepTresRequested(BaseModel):
    """
    V0039StepTresRequested
    """ # noqa: E501
    max: Optional[List[V0039Tres]] = None
    min: Optional[List[V0039Tres]] = None
    average: Optional[List[V0039Tres]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "max": [V0039Tres.from_dict(_item) for _item in obj["max"]] if obj.get("max") is not None else None,
            "min": [V0039Tres.from_dict(_item) for _item in obj["min"]] if obj.get("min") is not None else None,
            "average": [V0039Tres.from_dict(_item) for _item in obj["average"]] if obj.get("average") is not None else None,
