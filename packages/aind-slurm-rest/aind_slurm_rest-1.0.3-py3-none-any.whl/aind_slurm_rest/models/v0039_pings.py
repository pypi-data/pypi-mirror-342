...
class V0039Pings(BaseModel):
    ...
    pings: Optional[List[V0039ControllerPing]] = None
    __properties: ClassVar[List[str]] = ["meta", "errors", "warnings", "pings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pings": [V0039ControllerPing.from_dict(_item) for _item in obj["pings"]] if obj.get("pings") is not None else None
        })
        return _obj
