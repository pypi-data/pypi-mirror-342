...
class SlurmV0041PostJobSubmitRequest(BaseModel):
    """
    ...
    jobs: Optional[List[SlurmV0041PostJobSubmitRequestJobsInner]] = Field(default=None, description="HetJob description")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "jobs": [SlurmV0041PostJobSubmitRequestJobsInner.from_dict(_item) for _item in obj["jobs"]] if obj.get("jobs") is not None else None,
