...
class V0040JobArrayLimitsMax(BaseModel):
    """
    V0040JobArrayLimitsMax
    """ # noqa: E501
    running: Optional[V0040JobArrayLimitsMaxRunning] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "running": V0040JobArrayLimitsMaxRunning.from_dict(obj["running"]) if obj.get("running") is not None else None
        })
        return _obj
