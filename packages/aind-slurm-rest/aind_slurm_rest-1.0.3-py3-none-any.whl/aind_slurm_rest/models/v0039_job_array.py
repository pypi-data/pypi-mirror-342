...
class V0039JobArray(BaseModel):
    """
    V0039JobArray
    """ # noqa: E501
    job_id: Optional[StrictInt] = None
    limits: Optional[V0039JobArrayLimits] = None
    task_id: Optional[V0039Uint32NoVal] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "limits": V0039JobArrayLimits.from_dict(obj["limits"]) if obj.get("limits") is not None else None,
            "task_id": V0039Uint32NoVal.from_dict(obj["task_id"]) if obj.get("task_id") is not None else None,
            "task": obj.get("task")
        })
        return _obj
