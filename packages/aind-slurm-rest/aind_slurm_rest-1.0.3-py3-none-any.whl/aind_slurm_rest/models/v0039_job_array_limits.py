...
class V0039JobArrayLimits(BaseModel):
    """
    V0039JobArrayLimits
    """ # noqa: E501
    max: Optional[V0039JobArrayLimitsMax] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "max": V0039JobArrayLimitsMax.from_dict(obj["max"]) if obj.get("max") is not None else None
        })
        return _obj
