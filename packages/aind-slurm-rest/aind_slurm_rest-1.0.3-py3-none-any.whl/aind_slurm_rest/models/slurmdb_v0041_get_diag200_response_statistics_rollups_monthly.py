...
class SlurmdbV0041GetDiag200ResponseStatisticsRollupsMonthly(BaseModel):
    """
    ...
    duration: Optional[SlurmdbV0041GetDiag200ResponseStatisticsRollupsMonthlyDuration] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "duration": SlurmdbV0041GetDiag200ResponseStatisticsRollupsMonthlyDuration.from_dict(obj["duration"]) if obj.get("duration") is not None else None
        })
        return _obj
