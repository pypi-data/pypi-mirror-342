...
class V0039QosLimitsMax(BaseModel):
    """
    V0039QosLimitsMax
    """ # noqa: E501
    active_jobs: Optional[V0039QosLimitsMaxActiveJobs] = None
    tres: Optional[V0039QosLimitsMaxTres] = None
    wall_clock: Optional[V0039QosLimitsMaxWallClock] = None
    jobs: Optional[V0039QosLimitsMaxJobs] = None
    accruing: Optional[V0039QosLimitsMaxJobsActiveJobs] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "active_jobs": V0039QosLimitsMaxActiveJobs.from_dict(obj["active_jobs"]) if obj.get("active_jobs") is not None else None,
            "tres": V0039QosLimitsMaxTres.from_dict(obj["tres"]) if obj.get("tres") is not None else None,
            "wall_clock": V0039QosLimitsMaxWallClock.from_dict(obj["wall_clock"]) if obj.get("wall_clock") is not None else None,
            "jobs": V0039QosLimitsMaxJobs.from_dict(obj["jobs"]) if obj.get("jobs") is not None else None,
            "accruing": V0039QosLimitsMaxJobsActiveJobs.from_dict(obj["accruing"]) if obj.get("accruing") is not None else None
        })
        return _obj
