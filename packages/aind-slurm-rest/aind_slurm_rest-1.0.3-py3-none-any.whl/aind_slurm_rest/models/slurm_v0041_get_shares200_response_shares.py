...
class SlurmV0041GetShares200ResponseShares(BaseModel):
    """
    fairshare info
    """ # noqa: E501
    shares: Optional[List[SlurmV0041GetShares200ResponseSharesSharesInner]] = Field(default=None, description="Association shares")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "shares": [SlurmV0041GetShares200ResponseSharesSharesInner.from_dict(_item) for _item in obj["shares"]] if obj.get("shares") is not None else None,
