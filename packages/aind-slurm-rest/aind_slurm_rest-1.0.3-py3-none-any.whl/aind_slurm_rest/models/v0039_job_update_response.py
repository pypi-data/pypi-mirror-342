...
class V0039JobUpdateResponse(BaseModel):
    """
    ...
    results: Optional[List[V0039JobArrayResponseMsgInner]] = Field(default=None, description="Result per ArrayJob")
    __properties: ClassVar[List[str]] = ["meta", "errors", "warnings", "results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [V0039JobArrayResponseMsgInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
