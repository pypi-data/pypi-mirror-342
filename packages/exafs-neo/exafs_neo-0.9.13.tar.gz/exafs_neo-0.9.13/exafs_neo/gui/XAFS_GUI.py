...
from exafs_neo.gui.Misc_Function import *
...
class App:
    ...
    def __init__(self):
        ...
        # Initialize sabcor
        self.check_sabcor = check_sabcor_folder(self.os)
    ...
    def Build_background_tab(self):
        ...
        def button_bkg_draw():
            ...
            bkg_plot.initial_parameters(self.temp_data_file, self.r_bkg, self.bkg_kw, self.bkg_kmax, self.kmin,
    ...
    def Build_expert_tab(self):
        ...
        if not self.check_sabcor:
            sabcor_toggle.configure(state='disabled')
            sabcor_input_file.configure(state='disabled')
            button_sabcor_input_file.configure(state='disabled')
