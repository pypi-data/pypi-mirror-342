...
from tkinter import ttk,Tk,N,W,E,S,StringVar,IntVar,DoubleVar,BooleanVar, filedialog,messagebox,PhotoImage,LabelFrame,scrolledtext
...
class App:
    ...
    def Build_background_tab(self):
        ...
        def button_bkg_draw():
            ...
            bkg_plot.initial_parameters(self.temp_data_file, self.r_bkg, self.bkg_kw, self.bkg_kmax, self.kmin, self.kmax, self.delta_k, self.k_weight)
