...
class TestPatchedostreeOstreeRepository(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PatchedostreeOstreeRepository:
        """Test PatchedostreeOstreeRepository
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedostreeOstreeRepository`
        """
        model = PatchedostreeOstreeRepository()
        if include_optional:
