...
class TestOstreeOstreeRemoteResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OstreeOstreeRemoteResponse:
        """Test OstreeOstreeRemoteResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OstreeOstreeRemoteResponse`
        """
        model = OstreeOstreeRemoteResponse()
        if include_optional:
