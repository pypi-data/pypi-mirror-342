...
class CodeIndexer:
    ...
    async def _process_document_batch_async(self, 
        ...
        # Function to embed a single chunk with semaphore control
        async def embed_chunk(i, text):
        ...
        # Create embedding tasks for all chunks
        tasks = [embed_chunk(i, text) for i, text in enumerate(texts)]
