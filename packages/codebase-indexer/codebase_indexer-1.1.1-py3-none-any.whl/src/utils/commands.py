...
def setup_arg_parser():
    ...
    index_parser.add_argument("--chunk-size", type=int, default=800, help="Size of code chunks (recommended: 500-1500)")
    index_parser.add_argument("--chunk-overlap", type=int, default=150, help="Overlap between chunks (recommended: 50-200)")
