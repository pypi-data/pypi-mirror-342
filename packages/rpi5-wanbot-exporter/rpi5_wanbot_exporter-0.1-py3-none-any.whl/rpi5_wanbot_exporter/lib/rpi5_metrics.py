...
if os.getenv("DOCKER"):
    ...
    FAN_SPEED_PATH = pathlib.Path('/sensors/sensors/fan')
    CPU_TEMP_PATH = pathlib.Path('/sensors/temp')
else:
    FAN_SPEED_PATH = pathlib.Path('/sys/devices/platform/cooling_fan/hwmon/hwmon2/fan1_input')
    CPU_TEMP_PATH = pathlib.Path('/sys/class/thermal/thermal_zone0/temp:/sensors/temp')
