...
class BaseCdpWebDriver(object):
    def __init__(self, browser_type) -> None:
        self._webdriver = _InvokerService.get_cdpwebdriver(
            _ConvertEnumService.convert_browser_type_enum(browser_type))
    ...
    def open(
        ...
        userdata_folder_mode: Literal["automatic",
                                      "default", "custom"] = WebUserDataMode.Automatic,
        ...
        open_options = _ConvertOptionService.convert_open_browser_option(
            userdata_folder_mode, userdata_folder_path, args)
        tab_object = self._webdriver.New(
            url, is_maximize, is_wait_complete, timeout * 1000, open_options)
