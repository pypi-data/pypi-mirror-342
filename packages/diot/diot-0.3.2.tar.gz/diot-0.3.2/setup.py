...
extras_require = \
{'all': ['pyyaml>=6,<7'],
 'all:sys_platform != "linux"': ['tomli>=2.0,<3.0'],
 'all:sys_platform == "linux"': ['rtoml>=0.12,<0.13'],
 'toml:sys_platform != "linux"': ['tomli>=2.0,<3.0'],
 'toml:sys_platform == "linux"': ['rtoml>=0.12,<0.13'],
 'yaml': ['pyyaml>=6,<7']}
