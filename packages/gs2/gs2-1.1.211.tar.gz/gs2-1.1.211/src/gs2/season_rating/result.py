...
class DescribeMatchSessionsResult(core.Gs2Result):
    items: List[MatchSession] = None
    next_page_token: str = None

    def with_items(self, items: List[MatchSession]) -> DescribeMatchSessionsResult:
        self.items = items
        return self

    def with_next_page_token(self, next_page_token: str) -> DescribeMatchSessionsResult:
        self.next_page_token = next_page_token
        return self
    ...
    def from_dict(
        data: Dict[str, Any],
    ) -> Optional[DescribeMatchSessionsResult]:
        if data is None:
            return None
        return DescribeMatchSessionsResult()\
            .with_items(None if data.get('items') is None else [
                MatchSession.from_dict(data.get('items')[i])
                for i in range(len(data.get('items')))
            ])\
            .with_next_page_token(data.get('nextPageToken'))
...
class CreateMatchSessionResult(core.Gs2Result):
    item: MatchSession = None

    def with_item(self, item: MatchSession) -> CreateMatchSessionResult:
        self.item = item
        return self
    ...
    def from_dict(
        data: Dict[str, Any],
    ) -> Optional[CreateMatchSessionResult]:
        if data is None:
            return None
        return CreateMatchSessionResult()\
            .with_item(MatchSession.from_dict(data.get('item')))
...
class GetMatchSessionResult(core.Gs2Result):
    item: MatchSession = None

    def with_item(self, item: MatchSession) -> GetMatchSessionResult:
        self.item = item
        return self
    ...
    def from_dict(
        data: Dict[str, Any],
    ) -> Optional[GetMatchSessionResult]:
        if data is None:
            return None
...
class DeleteMatchSessionResult(core.Gs2Result):
    item: MatchSession = None

    def with_item(self, item: MatchSession) -> DeleteMatchSessionResult:
        self.item = item
        return self
    ...
    def from_dict(
        data: Dict[str, Any],
    ) -> Optional[DeleteMatchSessionResult]:
        if data is None:
            return None
...
class ExportMasterResult(core.Gs2Result):
    item: CurrentSeasonModelMaster = None

    def with_item(self, item: CurrentSeasonModelMaster) -> ExportMasterResult:
        self.item = item
        return self
    ...
    def from_dict(
        ...
        return ExportMasterResult()\
            .with_item(CurrentSeasonModelMaster.from_dict(data.get('item')))
...
class GetCurrentSeasonModelMasterResult(core.Gs2Result):
    item: CurrentSeasonModelMaster = None

    def with_item(self, item: CurrentSeasonModelMaster) -> GetCurrentSeasonModelMasterResult:
        self.item = item
        return self
    ...
    def from_dict(
        data: Dict[str, Any],
    ) -> Optional[GetCurrentSeasonModelMasterResult]:
        if data is None:
            return None
...
class UpdateCurrentSeasonModelMasterResult(core.Gs2Result):
    item: CurrentSeasonModelMaster = None

    def with_item(self, item: CurrentSeasonModelMaster) -> UpdateCurrentSeasonModelMasterResult:
        self.item = item
        return self
    ...
    def from_dict(
        data: Dict[str, Any],
    ) -> Optional[UpdateCurrentSeasonModelMasterResult]:
        if data is None:
            return None
...
class UpdateCurrentSeasonModelMasterFromGitHubResult(core.Gs2Result):
    item: CurrentSeasonModelMaster = None

    def with_item(self, item: CurrentSeasonModelMaster) -> UpdateCurrentSeasonModelMasterFromGitHubResult:
        self.item = item
        return self
    ...
    def from_dict(
        data: Dict[str, Any],
    ) -> Optional[UpdateCurrentSeasonModelMasterFromGitHubResult]:
        if data is None:
            return None
