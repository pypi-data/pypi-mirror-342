...
class SubgraphStep(BasePipelineStep, HasInputsMixin):
    ...
    def __init__(self, name: str, subgraph: Pipeline, input_state_map: dict[str, str], output_state_map: dict[str, str], runtime_config_map: dict[str, str] | None = None, fixed_args: dict[str, Any] | None = None) -> None:
    ...
    async def execute(self, state: dict[str, Any], config: RunnableConfig) -> dict[str, Any]:
        ...
        Raises:
            RuntimeError: If an error occurs during subgraph execution.
        """
