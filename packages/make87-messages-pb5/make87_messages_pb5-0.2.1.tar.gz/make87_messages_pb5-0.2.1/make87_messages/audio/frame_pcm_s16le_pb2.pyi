...
class FramePcmS16le(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., data: _Optional[bytes] = ..., pts: _Optional[int] = ..., time_base: _Optional[_Union[FramePcmS16le.Fraction, _Mapping]] = ...) -> None: ...
