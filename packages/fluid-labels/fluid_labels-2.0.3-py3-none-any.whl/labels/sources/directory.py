...
class DirectoryPathResolver(BaseModel, PathResolver):
    root: str
    exclude: tuple[str, ...]
...
class DirectoryContentResolver(BaseModel, ContentResolver):
    root: str
...
class DirectoryMetadataResolver(BaseModel, MetadataResolver):
    root: str
