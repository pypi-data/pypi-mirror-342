...
from labels.internal.package_information.php import (
...
from labels.pkg.cataloger.php.model import (
    PhpComposerAuthors,
...
def is_stable_php_version(version: str) -> bool:
    if version.removeprefix("v").startswith("dev-"):
        return False
