...
from labels.internal.collection.json import (
...
from labels.pkg.cataloger.php.model import PhpComposerInstalledEntry, PhpComposerLockEntry
from labels.pkg.cataloger.php.package import (
