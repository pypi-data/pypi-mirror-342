...
from labels.internal.package_information.python import (
    PyPIResponse,
    get_pypi_package,
)
...
from labels.pkg.cataloger.python.model import (
    PythonPackage,
)
from labels.pkg.cataloger.python.parse_wheel_egg_metadata import (
    ParsedData,
)
...
def is_stable_pip_version(version: str) -> bool:
    unstable_indicators = (
        "dev",
        "a",
        "b",
