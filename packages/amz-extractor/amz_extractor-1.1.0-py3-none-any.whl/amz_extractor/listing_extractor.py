...
if __name__ == '__main__':
    with open(
            r"C:\Users\lonely\OneDrive\桌面\Anker station de recharge MagSafe 3-en-1, socle de recharge à induction compatible MagSafe et certifié Qi2 15W, pour iPhone Séries 16_15, AirPodsPro, Apple Watch Ultra (chargeur et câble USB-C inclus) _ Amazon.fr_ High-Tech.html",
            'r', encoding='utf-8') as f:
        html = f.read()
    lp = ListingParser(html)
    print(lp.get_all())
