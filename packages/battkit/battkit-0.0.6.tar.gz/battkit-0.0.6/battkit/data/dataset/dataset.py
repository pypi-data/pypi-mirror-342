...
class Dataset:
	...
	def add_files(self, dir_files:Union[Path, List[Path]], group_by:Union[str, List[str]]=None, data_converter:str=None, custom_tags:Dict[str,Any]=None, n_jobs=-1):
		"""
		...
		# 4. Extract and save raw standardized data
		df_summary = standardize_files(df_group_by, data_converter, self._dir_storage, n_jobs)
		...
		# 5. Update Timeseries/Frequency tables
