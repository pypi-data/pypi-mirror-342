...
) -> ErrorResponse | HTTPValidationError | list["InspectedBuilding"] | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | HTTPValidationError | list["InspectedBuilding"]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[ErrorResponse, HTTPValidationError, list['InspectedBuilding']]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResponse, HTTPValidationError, list['InspectedBuilding']]
    """
