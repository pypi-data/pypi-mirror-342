...
) -> HTTPValidationError | MessageResponseDTO | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | MessageResponseDTO]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[HTTPValidationError, MessageResponseDTO]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[HTTPValidationError, MessageResponseDTO]
    """
