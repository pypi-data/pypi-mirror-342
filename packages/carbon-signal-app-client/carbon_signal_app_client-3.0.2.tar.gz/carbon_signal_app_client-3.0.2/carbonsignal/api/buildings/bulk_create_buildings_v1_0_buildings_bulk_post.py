...
) -> ErrorResponse | HTTPValidationError | list["Building"] | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | HTTPValidationError | list["Building"]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[ErrorResponse, HTTPValidationError, list['Building']]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResponse, HTTPValidationError, list['Building']]
    """
