...
) -> ErrorResponse | HTTPValidationError | UserBuildingRole | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | HTTPValidationError | UserBuildingRole]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ErrorResponse, HTTPValidationError, UserBuildingRole]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ErrorResponse, HTTPValidationError, UserBuildingRole]
    """
