...
from ...models.bulk_trigger_interventions_dto import BulkTriggerInterventionsDTO
...
def _get_kwargs(
    *,
    body: BulkTriggerInterventionsDTO,
    team_id: int,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        team_id (int):
        body (BulkTriggerInterventionsDTO): Bulk trigger interventions DTO.
