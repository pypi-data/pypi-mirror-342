...
) -> HTTPValidationError | Union["AuthProviderPassword", "AuthProviderSSO"] | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | Union["AuthProviderPassword", "AuthProviderSSO"]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[HTTPValidationError, Union['AuthProviderPassword', 'AuthProviderSSO']]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[HTTPValidationError, Union['AuthProviderPassword', 'AuthProviderSSO']]
    """
