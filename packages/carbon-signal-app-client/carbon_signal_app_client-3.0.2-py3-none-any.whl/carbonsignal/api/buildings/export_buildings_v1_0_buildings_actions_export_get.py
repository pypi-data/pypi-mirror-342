...
def _get_kwargs(
    *,
    team_id: int,
    building_ids: None | Unset | str = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}

    params["team_id"] = team_id

    json_building_ids: None | Unset | str
    json_building_ids = UNSET if isinstance(building_ids, Unset) else building_ids
...
def sync_detailed(
    *,
    ...
    Args:
        team_id (int):
        building_ids (Union[None, Unset, str]):
