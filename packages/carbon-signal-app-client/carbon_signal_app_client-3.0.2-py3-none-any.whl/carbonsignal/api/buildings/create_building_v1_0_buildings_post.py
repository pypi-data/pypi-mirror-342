...
) -> Building | ErrorResponse | HTTPValidationError | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Building | ErrorResponse | HTTPValidationError]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Building, ErrorResponse, HTTPValidationError]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Building, ErrorResponse, HTTPValidationError]
    """
