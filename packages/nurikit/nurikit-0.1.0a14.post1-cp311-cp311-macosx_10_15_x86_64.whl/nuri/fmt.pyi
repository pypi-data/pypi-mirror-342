...
import os
import typing
__all__ = ['CifBlock', 'CifFrame', 'CifParser', 'CifTable', 'MoleculeReader', 'cif_ddl2_frame_as_dict', 'mmcif_load_frame', 'read_cif', 'readfile', 'readstring', 'to_mol2', 'to_pdb', 'to_sdf', 'to_smiles']
class CifBlock:
    @property
