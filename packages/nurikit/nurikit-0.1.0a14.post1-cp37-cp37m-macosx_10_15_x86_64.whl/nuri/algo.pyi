...
import typing
__all__ = ['find_all_rings', 'find_relevant_rings', 'find_sssr', 'generate_coords', 'guess_all_types', 'guess_connectivity', 'guess_everything']
@typing.overload
...
def find_sssr(sub: nuri.core._core.ProxySubstructure, max_size: int | None = None) -> list[nuri.core._core.Substructure]:
    ...
    """
def generate_coords(mol: nuri.core._core.Molecule, method: str = 'DG', max_trial: int = 10, seed: int = 0) -> None:
    """
