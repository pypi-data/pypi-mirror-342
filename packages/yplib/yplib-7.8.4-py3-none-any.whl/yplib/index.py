...
def to_print_file_thread(*args, file_path=None, file_name=None, mode='a', interval=None):
    """
...
def to_print_date_file(*args, file_path=None, file_name=None, mode='a', interval=None):
    """
    将 文本输出到 date_file 中
    例如
    """
...
def to_print_file(*args, file_path=None, file_name=None, mode='a', interval=None):
    """
...
def to_print_txt(*args, file_path=None, file_name=None, mode='a', interval=None):
    """
...
def to_log_file(*args, file_path=None, file_name=None, time_prefix=True, mode='a', interval=None):
    """
...
def to_log_txt(*args, file_path=None, file_name=None, time_prefix=True, mode='a', interval=None):
    """
