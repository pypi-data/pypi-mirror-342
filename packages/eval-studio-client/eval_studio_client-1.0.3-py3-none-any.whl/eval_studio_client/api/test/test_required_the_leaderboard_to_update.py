...
class TestRequiredTheLeaderboardToUpdate(unittest.TestCase):
    """RequiredTheLeaderboardToUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequiredTheLeaderboardToUpdate:
        """Test RequiredTheLeaderboardToUpdate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequiredTheLeaderboardToUpdate`
        """
        model = RequiredTheLeaderboardToUpdate()
        if include_optional:
    ...
    def testRequiredTheLeaderboardToUpdate(self):
        """Test RequiredTheLeaderboardToUpdate"""
