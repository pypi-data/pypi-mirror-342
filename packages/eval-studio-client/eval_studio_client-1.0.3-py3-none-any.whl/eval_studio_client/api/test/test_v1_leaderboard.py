...
class TestV1Leaderboard(unittest.TestCase):
    """V1Leaderboard unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1Leaderboard:
        """Test V1Leaderboard
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1Leaderboard`
        """
        model = V1Leaderboard()
        if include_optional:
