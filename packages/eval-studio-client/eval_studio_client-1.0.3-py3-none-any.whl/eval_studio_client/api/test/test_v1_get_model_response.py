...
class TestV1GetModelResponse(unittest.TestCase):
    """V1GetModelResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GetModelResponse:
        """Test V1GetModelResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GetModelResponse`
        """
        model = V1GetModelResponse()
        if include_optional:
    ...
    def testV1GetModelResponse(self):
        """Test V1GetModelResponse"""
