...
class TestV1BatchGetLeaderboardsResponse(unittest.TestCase):
    """V1BatchGetLeaderboardsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1BatchGetLeaderboardsResponse:
        """Test V1BatchGetLeaderboardsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1BatchGetLeaderboardsResponse`
        """
        model = V1BatchGetLeaderboardsResponse()
        if include_optional:
            return V1BatchGetLeaderboardsResponse(
                leaderboards = [
    ...
    def testV1BatchGetLeaderboardsResponse(self):
        """Test V1BatchGetLeaderboardsResponse"""
