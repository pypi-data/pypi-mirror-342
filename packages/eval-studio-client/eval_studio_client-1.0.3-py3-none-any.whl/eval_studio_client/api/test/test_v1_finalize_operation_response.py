...
class TestV1FinalizeOperationResponse(unittest.TestCase):
    """V1FinalizeOperationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1FinalizeOperationResponse:
        """Test V1FinalizeOperationResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1FinalizeOperationResponse`
        """
        model = V1FinalizeOperationResponse()
        if include_optional:
    ...
    def testV1FinalizeOperationResponse(self):
        """Test V1FinalizeOperationResponse"""
