...
class PromptGenerationServiceApi:
    ...
    @validate_call
    def prompt_generation_service_auto_generate_prompts(
        self,
        name: Annotated[str, Field(strict=True, description="Required. The Test for which to generate TestCases.")],
        body: PromptGenerationServiceAutoGeneratePromptsRequest,
        ...
        :type name: str
        :param body: (required)
        :type body: PromptGenerationServiceAutoGeneratePromptsRequest
        ...
        _param = self._prompt_generation_service_auto_generate_prompts_serialize(
            name=name,
            body=body,
    ...
    @validate_call
    def prompt_generation_service_auto_generate_prompts_with_http_info(
        self,
        name: Annotated[str, Field(strict=True, description="Required. The Test for which to generate TestCases.")],
        body: PromptGenerationServiceAutoGeneratePromptsRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def prompt_generation_service_auto_generate_prompts_without_preload_content(
        self,
        name: Annotated[str, Field(strict=True, description="Required. The Test for which to generate TestCases.")],
        body: PromptGenerationServiceAutoGeneratePromptsRequest,
        _request_timeout: Union[
    ...
    def _prompt_generation_service_auto_generate_prompts_serialize(
        self,
        name,
        body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/{name}:autoGeneratePrompts',
