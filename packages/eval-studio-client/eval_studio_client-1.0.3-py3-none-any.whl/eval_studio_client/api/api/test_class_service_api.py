...
class TestClassServiceApi:
    ...
    def test_class_service_get_test_class(
        self,
        name_8: Annotated[str, Field(strict=True, description="The name of the TestClass to retrieve. Format: testClasses/<UUID>")],
        ...
        :param name_8: The name of the TestClass to retrieve. Format: testClasses/<UUID> (required)
        :type name_8: str
