...
class WhoAmIServiceApi:
    ...
    def who_am_i_service_who_am_i(
        ...
        _param = self._who_am_i_service_who_am_i_serialize(
    ...
    @validate_call
    def who_am_i_service_who_am_i_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def who_am_i_service_who_am_i_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _who_am_i_service_who_am_i_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
