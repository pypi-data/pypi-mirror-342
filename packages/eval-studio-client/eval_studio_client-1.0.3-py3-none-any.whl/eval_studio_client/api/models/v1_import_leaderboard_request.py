...
class V1ImportLeaderboardRequest(BaseModel):
    """
    ...
    evaluator: Optional[StrictStr] = Field(default=None, description="Required. Resource name of the Evaluator used in this Leaderboard.")
    ...
    leaderboard_display_name: Optional[StrictStr] = Field(default=None, description="Required. Display name of the newly created Leaderboard.", alias="leaderboardDisplayName")
    leaderboard_description: Optional[StrictStr] = Field(default=None, description="Optional. Description of the newly created Leaderboard.", alias="leaderboardDescription")
    leaderboard_type: Optional[V1LeaderboardType] = Field(default=None, alias="leaderboardType")
    __properties: ClassVar[List[str]] = ["testLabJson", "url", "evaluator", "model", "testDisplayName", "testDescription", "leaderboardDisplayName", "leaderboardDescription", "leaderboardType"]
