...
class V1BatchDeleteLeaderboardsRequest(BaseModel):
    """
    V1BatchDeleteLeaderboardsRequest
    """ # noqa: E501
    names: Optional[List[StrictStr]] = Field(default=None, description="Required. The names of the Leaderboards to delete. A maximum of 1000 can be specified.")
    view: Optional[V1LeaderboardView] = None
    __properties: ClassVar[List[str]] = ["names", "view"]
