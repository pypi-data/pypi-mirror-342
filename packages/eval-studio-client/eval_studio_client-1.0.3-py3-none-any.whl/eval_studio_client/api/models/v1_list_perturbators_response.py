...
class V1ListPerturbatorsResponse(BaseModel):
    """
    V1ListPerturbatorsResponse
    """ # noqa: E501
    perturbators: Optional[List[V1Perturbator]] = Field(default=None, description="The list of Perturbators.")
    __properties: ClassVar[List[str]] = ["perturbators"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.perturbators:
            for _item in self.perturbators:
                if _item:
