...
class V1GetOperationProgressByParentResponse(BaseModel):
    """
    V1GetOperationProgressByParentResponse
    """ # noqa: E501
    operation_progress: Optional[V1OperationProgress] = Field(default=None, alias="operationProgress")
    __properties: ClassVar[List[str]] = ["operationProgress"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of operation_progress
        if self.operation_progress:
            _dict['operationProgress'] = self.operation_progress.to_dict()
        return _dict
