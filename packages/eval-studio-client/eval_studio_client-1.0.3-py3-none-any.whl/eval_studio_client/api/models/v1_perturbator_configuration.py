...
class V1PerturbatorConfiguration(BaseModel):
    """
    PerturbatorConfiguration represents the configuration of a perturbator to use during the perturbation process.
    """ # noqa: E501
    name: Optional[StrictStr] = None
    intensity: Optional[V1PerturbatorIntensity] = None
    params: Optional[StrictStr] = Field(default=None, description="Optional. The parameters to pass to the perturbator.")
    __properties: ClassVar[List[str]] = ["name", "intensity", "params"]
