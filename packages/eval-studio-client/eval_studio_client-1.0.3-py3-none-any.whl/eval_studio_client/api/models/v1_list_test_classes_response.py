...
class V1ListTestClassesResponse(BaseModel):
    """
    V1ListTestClassesResponse
    """ # noqa: E501
    test_classes: Optional[List[V1TestClass]] = Field(default=None, description="The TestClasses that match the request.", alias="testClasses")
    __properties: ClassVar[List[str]] = ["testClasses"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.test_classes:
            for _item in self.test_classes:
                if _item:
