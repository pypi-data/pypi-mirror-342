...
class V1BatchDeleteDocumentsRequest(BaseModel):
    """
    V1BatchDeleteDocumentsRequest
    """ # noqa: E501
    names: Optional[List[StrictStr]] = Field(default=None, description="Required. The names of the Documents to delete. A maximum of 1000 can be specified.")
