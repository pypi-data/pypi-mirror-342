...
class V1BatchDeleteTestCasesResponse(BaseModel):
    """
    V1BatchDeleteTestCasesResponse
    """ # noqa: E501
    test_cases: Optional[List[V1TestCase]] = Field(default=None, description="The list of deleted TestCases.", alias="testCases")
