...
class V1BatchDeleteModelsRequest(BaseModel):
    """
    V1BatchDeleteModelsRequest
    """ # noqa: E501
    names: Optional[List[StrictStr]] = Field(default=None, description="The names of the Models to delete. A maximum of 1000 can be specified.")
