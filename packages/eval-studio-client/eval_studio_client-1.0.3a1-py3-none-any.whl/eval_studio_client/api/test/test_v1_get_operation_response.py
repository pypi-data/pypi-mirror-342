...
class TestV1GetOperationResponse(unittest.TestCase):
    """V1GetOperationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GetOperationResponse:
        """Test V1GetOperationResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GetOperationResponse`
        """
        model = V1GetOperationResponse()
        if include_optional:
    ...
    def testV1GetOperationResponse(self):
        """Test V1GetOperationResponse"""
