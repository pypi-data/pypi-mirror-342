...
class TestV1UpdateLeaderboardResponse(unittest.TestCase):
    """V1UpdateLeaderboardResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1UpdateLeaderboardResponse:
        """Test V1UpdateLeaderboardResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1UpdateLeaderboardResponse`
        """
        model = V1UpdateLeaderboardResponse()
        if include_optional:
            return V1UpdateLeaderboardResponse(
    ...
    def testV1UpdateLeaderboardResponse(self):
        """Test V1UpdateLeaderboardResponse"""
