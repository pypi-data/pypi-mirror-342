...
class TestV1BatchCreateLeaderboardsRequest(unittest.TestCase):
    """V1BatchCreateLeaderboardsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1BatchCreateLeaderboardsRequest:
        """Test V1BatchCreateLeaderboardsRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1BatchCreateLeaderboardsRequest`
        """
        model = V1BatchCreateLeaderboardsRequest()
        if include_optional:
            return V1BatchCreateLeaderboardsRequest(
                requests = [
    ...
    def testV1BatchCreateLeaderboardsRequest(self):
        """Test V1BatchCreateLeaderboardsRequest"""
