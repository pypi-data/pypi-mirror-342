...
class TestV1GetLeaderboardResponse(unittest.TestCase):
    """V1GetLeaderboardResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GetLeaderboardResponse:
        """Test V1GetLeaderboardResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GetLeaderboardResponse`
        """
        model = V1GetLeaderboardResponse()
        if include_optional:
    ...
    def testV1GetLeaderboardResponse(self):
        """Test V1GetLeaderboardResponse"""
