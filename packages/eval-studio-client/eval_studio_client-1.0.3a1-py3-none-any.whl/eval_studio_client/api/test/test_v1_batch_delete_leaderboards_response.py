...
class TestV1BatchDeleteLeaderboardsResponse(unittest.TestCase):
    """V1BatchDeleteLeaderboardsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1BatchDeleteLeaderboardsResponse:
        """Test V1BatchDeleteLeaderboardsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1BatchDeleteLeaderboardsResponse`
        """
        model = V1BatchDeleteLeaderboardsResponse()
        if include_optional:
            return V1BatchDeleteLeaderboardsResponse(
                leaderboards = [
    ...
    def testV1BatchDeleteLeaderboardsResponse(self):
        """Test V1BatchDeleteLeaderboardsResponse"""
