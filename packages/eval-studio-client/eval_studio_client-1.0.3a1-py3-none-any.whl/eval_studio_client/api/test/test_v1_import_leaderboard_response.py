...
class TestV1ImportLeaderboardResponse(unittest.TestCase):
    """V1ImportLeaderboardResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ImportLeaderboardResponse:
        """Test V1ImportLeaderboardResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ImportLeaderboardResponse`
        """
        model = V1ImportLeaderboardResponse()
        if include_optional:
    ...
    def testV1ImportLeaderboardResponse(self):
        """Test V1ImportLeaderboardResponse"""
