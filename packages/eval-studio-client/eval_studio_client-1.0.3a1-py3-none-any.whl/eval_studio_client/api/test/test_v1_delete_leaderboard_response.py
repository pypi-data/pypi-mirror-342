...
class TestV1DeleteLeaderboardResponse(unittest.TestCase):
    """V1DeleteLeaderboardResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1DeleteLeaderboardResponse:
        """Test V1DeleteLeaderboardResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1DeleteLeaderboardResponse`
        """
        model = V1DeleteLeaderboardResponse()
        if include_optional:
    ...
    def testV1DeleteLeaderboardResponse(self):
        """Test V1DeleteLeaderboardResponse"""
