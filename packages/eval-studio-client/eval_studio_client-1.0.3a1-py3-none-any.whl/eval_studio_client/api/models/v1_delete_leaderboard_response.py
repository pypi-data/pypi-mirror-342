...
class V1DeleteLeaderboardResponse(BaseModel):
    """
    V1DeleteLeaderboardResponse
    """ # noqa: E501
    leaderboard: Optional[V1Leaderboard] = None
    __properties: ClassVar[List[str]] = ["leaderboard"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of leaderboard
        if self.leaderboard:
            _dict['leaderboard'] = self.leaderboard.to_dict()
        return _dict
