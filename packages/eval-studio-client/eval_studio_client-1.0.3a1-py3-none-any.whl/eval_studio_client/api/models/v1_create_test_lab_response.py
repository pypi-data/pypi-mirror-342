...
class V1CreateTestLabResponse(BaseModel):
    """
    V1CreateTestLabResponse
    """ # noqa: E501
    test_lab: Optional[V1TestLab] = Field(default=None, alias="testLab")
    __properties: ClassVar[List[str]] = ["testLab"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of test_lab
        if self.test_lab:
            _dict['testLab'] = self.test_lab.to_dict()
        return _dict
