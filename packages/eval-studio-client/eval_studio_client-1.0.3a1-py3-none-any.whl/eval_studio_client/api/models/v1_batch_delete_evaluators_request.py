...
class V1BatchDeleteEvaluatorsRequest(BaseModel):
    """
    V1BatchDeleteEvaluatorsRequest
    """ # noqa: E501
    names: Optional[List[StrictStr]] = Field(default=None, description="Required. The names of the Evaluators to delete. A maximum of 1000 can be specified.")
