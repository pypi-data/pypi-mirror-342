...
class V1BatchDeleteLeaderboardsResponse(BaseModel):
    """
    V1BatchDeleteLeaderboardsResponse
    """ # noqa: E501
    leaderboards: Optional[List[V1Leaderboard]] = Field(default=None, description="The deleted Leaderboards.")
    __properties: ClassVar[List[str]] = ["leaderboards"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.leaderboards:
            for _item in self.leaderboards:
                if _item:
