...
class V1GetPerturbatorResponse(BaseModel):
    """
    V1GetPerturbatorResponse
    """ # noqa: E501
    perturbator: Optional[V1Perturbator] = None
    __properties: ClassVar[List[str]] = ["perturbator"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of perturbator
        if self.perturbator:
            _dict['perturbator'] = self.perturbator.to_dict()
        return _dict
