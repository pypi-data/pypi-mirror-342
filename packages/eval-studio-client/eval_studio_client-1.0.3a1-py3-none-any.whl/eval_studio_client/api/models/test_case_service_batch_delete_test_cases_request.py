...
class TestCaseServiceBatchDeleteTestCasesRequest(BaseModel):
    """
    TestCaseServiceBatchDeleteTestCasesRequest
    """ # noqa: E501
    names: Optional[List[StrictStr]] = Field(default=None, description="The list of TestCase IDs to delete.")
