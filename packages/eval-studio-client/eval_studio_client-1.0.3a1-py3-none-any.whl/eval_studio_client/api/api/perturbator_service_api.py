...
class PerturbatorServiceApi:
    ...
    def perturbator_service_get_perturbator(
        self,
        name_6: Annotated[str, Field(strict=True, description="Required. The name of the Perturbator to retrieve.")],
        ...
        :param name_6: Required. The name of the Perturbator to retrieve. (required)
        :type name_6: str
