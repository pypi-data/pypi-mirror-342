...
class InfoServiceApi:
    ...
    def info_service_get_info(
        ...
        _param = self._info_service_get_info_serialize(
    ...
    @validate_call
    def info_service_get_info_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def info_service_get_info_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _info_service_get_info_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
