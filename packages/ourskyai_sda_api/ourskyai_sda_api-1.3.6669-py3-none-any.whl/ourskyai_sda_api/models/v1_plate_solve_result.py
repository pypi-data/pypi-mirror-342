...
from ourskyai_sda_api.models.v1_plate import V1Plate
...
class V1PlateSolveResult(BaseModel):
    ...
    __properties = ["plates", "pixelWidth", "pixelHeight", "numberMatchedStars", "centerRightAscensionRadians", "centerDeclinationRadians", "xSizeRadians", "ySizeRadians", "isMatched", "transformation"]
    ...
    def from_dict(cls, obj: dict) -> V1PlateSolveResult:
        ...
        _obj = V1PlateSolveResult.parse_obj({
            "plates": [V1Plate.from_dict(_item) for _item in obj.get("plates")] if obj.get("plates") is not None else None,
