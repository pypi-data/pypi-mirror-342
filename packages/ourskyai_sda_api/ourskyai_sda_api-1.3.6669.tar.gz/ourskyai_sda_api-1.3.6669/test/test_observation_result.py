...
from ourskyai_sda_api.models.observation_result import ObservationResult  # noqa: E501

class TestObservationResult(unittest.TestCase):
    """ObservationResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ObservationResult:
        """Test ObservationResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ObservationResult`
        """
        model = ObservationResult()  # noqa: E501
        if include_optional:
    ...
    def testObservationResult(self):
        """Test ObservationResult"""
