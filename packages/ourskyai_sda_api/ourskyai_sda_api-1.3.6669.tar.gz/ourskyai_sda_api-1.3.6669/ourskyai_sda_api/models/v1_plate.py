...
class V1Plate(BaseModel):
    ...
    __properties = ["xCentroid", "yCentroid", "sequenceNumber", "magnitude", "raRad", "decRad", "catalogOffsetRad"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1Plate:
        """Create an instance of V1Plate from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1Plate:
        """Create an instance of V1Plate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1Plate.parse_obj(obj)

        _obj = V1Plate.parse_obj({
