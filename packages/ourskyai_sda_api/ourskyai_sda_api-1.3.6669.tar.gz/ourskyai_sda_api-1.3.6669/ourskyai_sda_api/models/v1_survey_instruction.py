...
class V1SurveyInstruction(BaseModel):
    ...
    steps: conlist(V1SurveyInstructionStep) = Field(..., description="Each step indicates a sidereal observation attempt at a given (Ra, Dec) or local az/el. If az/el is used, a node ID must also be provided.")
