...
class RpmModulemdResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, name=None, stream=None, version=None, static_context=None, context=None, arch=None, artifacts=None, dependencies=None, packages=None, profiles=None, description=None, local_vars_configuration=None):  # noqa: E501
