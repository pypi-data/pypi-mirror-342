...
class ContentModulemdObsoletesApi(object):
    ...
    def create_with_http_info(self, rpm_modulemd_obsolete,  **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('rpm_modulemd_obsolete' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `rpm_modulemd_obsolete` when calling `create`")  # noqa: E501
        ...
        body_params = None
        if 'rpm_modulemd_obsolete' in local_var_params:
            body_params = local_var_params['rpm_modulemd_obsolete']
        # HTTP header `Accept`
