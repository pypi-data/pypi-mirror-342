...
# Configure logging
logging.basicConfig(level=logging.ERROR)  # Set to ERROR to suppress info messages
...
last_command_time = 0  # Track when the last command was processed
...
def transcribe_audio():
    ...
    global recognized_text, is_running, segments, last_text, last_command_time
                ...
                try:
                    ...
                    if text and text != last_text:
                        ...
                        if contains_wake_word(recent_text, wake_word):
                            ...
                            if current_time - last_command_time >= processing_delay:
