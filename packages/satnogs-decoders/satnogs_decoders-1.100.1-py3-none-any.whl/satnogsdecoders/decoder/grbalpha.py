    ...
    class GrbalphaT(KaitaiStruct):
        ...
        def _read(self):
            ...
            if _on == 2393146465:
                ...
                self.type_check = Grbalpha.Obc(self._io, self, self._root)
            elif _on == 2393146481:
    ...
    class Obc(KaitaiStruct):
        ...
        def _read(self):
            ...
            if not self.skip_ax25_header == 178959006690963876281585086672433775600:
                raise kaitaistruct.ValidationNotEqualError(178959006690963876281585086672433775600, self.skip_ax25_header, self._io, u"/types/obc/seq/0")
            self._io.align_to_byte()
