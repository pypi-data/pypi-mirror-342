...
#    group1 = parser.add_argument_group('Ejecución remota')
    ...
    group2.add_argument('-i', '--indir', action=StorePath, metavar='PATH', default=getcwd(), help='Buscar los archivos de entrada en el directorio PATH.')
    group2.add_argument('-o', '--outdir', action=StorePath, metavar='PATH', default=SUPPRESS, help='Escribir los archivos de salida en el directorio PATH.')
