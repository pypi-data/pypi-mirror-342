...
class TasksMode:
    def pricing(self):
        ...
        def tax_rate_from_oldPriceAndNewPrice():
            ...
            old_price=Prompt.__init2__(None,func=FormBuilderMkText,ptext="Old Price ($):",helpText="A float or integer",data="float")
            if old_price is None:
                return None

            new_price=Prompt.__init2__(None,func=FormBuilderMkText,ptext="New Price ($):",helpText="A float or integer",data="float")
