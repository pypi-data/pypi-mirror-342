...
def control_payload(
    ...
    learn_likelihoods (bool): Whether to learn likelihoods.
    learn_transitions (bool): Whether to learn transitions.
    learn_initial_state_priors (bool): Whether to learn initial state priors.
