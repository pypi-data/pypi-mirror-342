...
def gather_environ(keys: Dict[str, Dict[str, Any]]) -> Dict[str, Any]:
    ...
    :param keys: Dict[str, Dict[str, Any]]
        The environ keys to use, each of them correlating to
        `int`, `list`, `boolean`, `enum` or `filter`
    :return: Dict[str, Any]: A dict of the found environ values
    """
    environs = {}
...
def short_msg(msg: str, chars: Optional[int] = 150) -> str:
    """
...
def redact(
    ...
    replace_value: Optional[str] = 'xxxREDACTEDxxx'
) -> str:
    """
