...
with importlib.resources.path(MyUI.assets, "default.png") as path:
    default_icon_path = path
with importlib.resources.path(MyUI.assets, "blurred.png") as path:
    blurred_icon_path = path
with importlib.resources.path(MyUI.assets, "icon.png") as path:
    icon_path = path
...
class App:
    ...
    - Normal components render in order and receive events exclusively.
    ...
    def __init__(self, size: InputVector, fps_target: float = 60, background_color: InputColor = (255, 255, 255), flags: int = 0):
        ...
        pygame.display.set_icon(pygame.image.load(default_icon_path))
        self.size: pygame.math.Vector2 = pygame.math.Vector2(size)
