...
AGENT_EVAL_LOG_TRACES_TO_MLFLOW_ENABLED = _BooleanEnvironmentVariable(
    "AGENT_EVAL_LOG_TRACES_TO_MLFLOW_ENABLED", True
)

# Temporary flag to gate the release of logging of assessments to MLflow.
AGENT_EVAL_LOG_ASSESSMENTS_TO_MLFLOW_ENABLED = _BooleanEnvironmentVariable(
    "AGENT_EVAL_LOG_ASSESSMENTS_TO_MLFLOW_ENABLED", False
)
...
AGENT_EVAL_LOG_ARTIFACTS_TO_MLFLOW_ENABLED = _BooleanEnvironmentVariable(
    "AGENT_EVAL_LOG_ARTIFACTS_TO_MLFLOW_ENABLED", True
)
