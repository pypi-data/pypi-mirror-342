...
from ..util.provider_job_utils import is_valid_job_arn, is_valid_quantum_task_arn
...
class BraketHandlerFactory(HandlerFactory):
    ...
    def create_handler(event, circuit_preparation_fn, post_processing_fn) -> Handler:
        ...
        if is_valid_quantum_task_arn(provider_job_id) or is_valid_job_arn(provider_job_id):
            logger.info("Valid providerJobId found, returning JobFetchingHandler")
