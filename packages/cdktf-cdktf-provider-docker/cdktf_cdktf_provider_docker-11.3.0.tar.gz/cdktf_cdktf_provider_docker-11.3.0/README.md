# CDKTF prebuilt bindings for kreuzwerker/docker provider version 3.3.0

This repo builds and publishes the [Terraform docker provider](https://registry.terraform.io/providers/kreuzwerker/docker/3.3.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform docker provider](https://registry.terraform.io/providers/kreuzwerker/docker/3.3.0)
