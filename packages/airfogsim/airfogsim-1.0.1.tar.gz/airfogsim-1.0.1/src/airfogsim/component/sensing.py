...
class SensingComponent(Component):
    ...
    def _calculate_performance_metrics(self) -> Dict[str, Any]:
        ...
        is_sensing = self.agent.get_state('is_sensing', False)
        ...
        if self.agent.get_state('is_moving', False):
