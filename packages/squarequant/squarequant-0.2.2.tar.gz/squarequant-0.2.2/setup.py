...
setup(
    ...
    install_requires=[
        ...
        "matplotlib>=3.3.0",
        "statsmodels>=0.12.0",
        "requests>=2.25.0",  # Added for Theta data provider
    ],
    extras_require={
    ...
    keywords="finance, risk, portfolio, investment, stocks, analysis, visualization, drawdown, var, cvar, entropic, ulcer index, theta data",
)